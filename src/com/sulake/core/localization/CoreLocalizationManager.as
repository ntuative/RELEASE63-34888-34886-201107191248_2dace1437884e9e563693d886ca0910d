package com.sulake.core.localization
{
   ...
   public class CoreLocalizationManager extends Component implements ICoreLocalizationManager
   {
      ...
      private var var_73:Dictionary;
      
      private var var_1124:Map;
      ...
      {
         return this.var_1124[param1] as ILocalizationDefinition;
      }
      
      public function getActiveLocalizationDefinition() : ILocalizationDefinition
      {
         return this.getLocalizationDefinition(this.var_2975);
      }
      ...
      protected function onLocalizationFailed(param1:AssetLoaderEvent) : void
      {
         ...
         Core.error("Failed to download localization",true,Core.const_1959);
      }
      
      public function hasKey(param1:String) : Boolean
      {
         var _loc2_:Localization = this.var_73[param1] as Localization;
         return _loc2_ != null;
      }
      
      public function getKey(param1:String, param2:String = "") : String
      {
         var _loc3_:Localization = this.var_73[param1] as Localization;
         if(_loc3_ == null)
         {
      ...
      {
         var _loc3_:Localization = this.var_73[param1];
         if(_loc3_ == null)
         {
            _loc3_ = new Localization(param1,param2);
            this.var_73[param1] = _loc3_;
         }
         else
         {
         ...
         {
            _loc3_.registerParameter("predefined",this.var_2171);
         }
      }
      ...
      {
         var _loc1_:* = null;
         for each(_loc1_ in this.var_73)
         {
      ...
      {
         var _loc5_:Localization = this.var_73[param1];
         if(_loc5_ == null)
         {
            _loc5_ = new Localization(param1);
            this.var_73[param1] = _loc5_;
         }
      ...
      {
         return this.var_73[param1] as ILocalization;
      }
      ...
      protected function setPredefinedUrl(param1:String) : void
      {
         ...
         for each(_loc2_ in this.var_73)
         {
            if(_loc2_.raw.indexOf("%predefined%") >= 0)
            {
               _loc2_.registerParameter("predefined",this.var_2171);
            }
         }
      }
   }
