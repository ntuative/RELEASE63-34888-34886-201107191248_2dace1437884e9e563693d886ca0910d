package com.sulake.core.assets
{
   ...
   public class BitmapDataAsset implements ILazyAsset
   {
      ...
      protected static var var_541:uint = 0;
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            if(this._bitmap)
            {
               try
               {
                  var_541 -= this._bitmap.width * this._bitmap.height * 4;
      ...
      public function prepareLazyContent() : void
      {
         ...
         if(this.var_124 is BitmapDataAsset)
         {
            ...
            this.var_1638 = BitmapDataAsset(this.var_124).var_1638;
            this.var_1639 = BitmapDataAsset(this.var_124).var_1639;
            if(this._bitmap != null)
            {
               this.var_124 = null;
               return;
         ...
         while(_loc2_ < param1.length())
         {
            ...
            switch(_loc3_)
            {
               case "offset":
                  ...
                  break;
               case "flipH":
                  this.var_1638 = _loc4_ == "1" || _loc4_ == "true";
                  break;
               case "flipV":
                  this.var_1639 = _loc4_ == "1" || _loc4_ == "true";
                  break;
            }
            _loc2_++;
         }
