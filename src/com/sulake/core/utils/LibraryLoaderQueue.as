package com.sulake.core.utils
{
   ...
   public class LibraryLoaderQueue extends EventDispatcher implements IDisposable
   {
      ...
      protected static const const_1761:int = 4;
      ...
      {
         return this.var_462.length + this.var_315.length;
      }
      ...
      private function next() : void
      {
         ...
         if(!disposed)
         {
            while(this.var_315.length < const_1761 && this.var_462.length > 0)
            {
               _loc1_ = this.var_462.shift();
      ...
      private function removeLoader(param1:LibraryLoader) : void
      {
         ...
         try
         {
            index = this.var_462.indexOf(loader);
            if(index > -1)
            {
               this.var_462.splice(index,1);
            }
