package com.sulake.core.utils.debug
{
   ...
   public class GarbageMonitor implements IDisposable
   {
      ...
      private var var_948:Dictionary;
      
      public function GarbageMonitor()
      {
         super();
         this.var_948 = new Dictionary(true);
      }
      ...
      public function dispose() : void
      {
         ...
         if(!this._disposed)
         {
            for each(_loc1_ in this.var_948)
            {
               delete this.var_948[_loc1_];
            }
            this.var_948 = null;
            this._disposed = true;
         }
      ...
      {
         this.var_948[param1] = param2 == null ? param1.toString() : param2;
      }
