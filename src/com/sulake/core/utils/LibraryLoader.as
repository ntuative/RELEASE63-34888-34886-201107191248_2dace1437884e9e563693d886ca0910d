package com.sulake.core.utils
{
   ...
   public class LibraryLoader extends EventDispatcher implements IDisposable
   {
      ...
      protected static const const_2058:uint = 1;
      
      protected static const const_2060:uint = 2;
      
      protected static const const_2059:uint = 4;
      
      protected static const const_2061:uint = 3;
      
      protected static const name_5:uint = 7;
      
      public static const const_1967:int = 5;
      
      public static const LIBRARY_LOADER_FINALIZE:String = "LIBRARY_LOADER_FINALIZE";
      
      public static const const_1168:Boolean = false;
      
      public static const const_1761:int = 2;
      ...
      protected var var_662:Class;
      
      protected var var_514:uint = 0;
      
      protected var _name:String;
      
      protected var var_1152:Boolean = false;
      ...
      protected var var_3064:String = "";
      
      protected var var_2271:int;
      
      protected var var_1427:int;
      
      protected var var_1428:int;
      
      protected var var_3127:uint = 0;
      
      protected var var_3065:Boolean = true;
      ...
      protected static function queue(param1:LibraryLoader) : void
      {
         if(const_1168)
         {
            if(var_1092.indexOf(param1) == -1)
            {
               var_1092.push(param1);
            }
            throttle();
         }
         else
      ...
      protected static function throttle() : void
      {
         ...
         if(const_1168)
         {
            ...
            while(_loc2_ > -1)
            {
               _loc1_ = var_889[_loc2_] as LibraryLoader;
            ...
            while(var_889.length < const_1761 && false)
            {
               _loc1_ = var_1092.shift() as LibraryLoader;
      ...
      {
         return !!this.var_1152 ? uint(this.var_1427 - this.var_2271) : uint(getTimer() - this.var_2271);
      }
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            dispatchEvent(new LibraryLoaderEvent(LibraryLoaderEvent.LIBRARY_LOADER_EVENT_DISPOSE,this.var_433,this.bytesTotal,this.bytesLoaded,this.elapsedTime));
            try
            {
               this.var_44.close();
            }
      ...
      {
         if(this.var_1151 && !_disposed)
         {
            this.var_1151 = false;
            if(!this.var_1152 && this.var_269)
            {
               this.var_1427 = -1;
               this.var_2271 = getTimer();
               queue(this);
            }
         }
      }
      ...
      {
         if(!this.var_1152 && !_disposed && this.var_1428 > 0)
         {
            try
            {
               this.var_44.close();
            ...
            this.addRequestCounterToUrlRequest(this.var_269,const_1967 - this.var_1428);
            if(this.var_3065)
            {
      ...
      protected function loadEventHandler(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case HTTPStatusEvent.HTTP_STATUS:
               ...
               this.debug("Load event STATUS " + this.var_433 + " for file \"" + this.url + "\"");
               break;
            case Event.UNLOAD:
               this.debug("Load event UNLOAD for file \"" + this.url + "\"");
               dispatchEvent(new LibraryLoaderEvent(LibraryLoaderEvent.LIBRARY_LOADER_EVENT_UNLOAD,this.var_433,this.bytesTotal,this.bytesLoaded,this.elapsedTime));
               break;
            case ProgressEvent.PROGRESS:
               this.debug("Load event PROGRESS for file \"" + this.url + "\"  bytes: " + this.bytesLoaded + "/" + this.bytesTotal);
               dispatchEvent(new LibraryLoaderEvent(LibraryLoaderEvent.LIBRARY_LOADER_EVENT_PROGRESS,this.var_433,this.bytesTotal,this.bytesLoaded,this.elapsedTime));
               break;
            case IOErrorEvent.IO_ERROR:
               this.debug("Load event IO ERROR for file \"" + this.url + "\"");
               if(!this.handleHttpStatus(this.var_433))
               {
                  this.var_1427 = getTimer();
            ...
            case TimerEvent.TIMER:
               ...
               if(!_disposed)
               {
                  this.var_514 = LibraryLoader.name_5;
         ...
         if(this.var_514 == LibraryLoader.const_2061)
         {
         ...
         if(this.var_514 == LibraryLoader.name_5)
         {
            if(this.prepareLibrary())
            {
               ...
               this.removeEventListeners();
               throttle();
               dispatchEvent(new LibraryLoaderEvent(LibraryLoaderEvent.LIBRARY_LOADER_EVENT_COMPLETE,this.var_433,this.bytesTotal,this.bytesLoaded,this.elapsedTime));
      ...
      protected function prepareLibrary() : Boolean
      {
         ...
         this.var_662 = this.getDefinition(this._name) as Class;
         ...
         try
         {
            xmlClass = this.var_662.manifest as Class;
            if(xmlClass == null)
            {
               return false;
            }
      ...
      protected function debug(param1:String) : void
      {
         ...
         if(this._debug)
         {
            dispatchEvent(new LibraryLoaderEvent(LibraryLoaderEvent.LIBRARY_LOADER_EVENT_DEBUG,this.var_433,this.bytesTotal,this.bytesLoaded,this.elapsedTime));
         }
      }
      ...
      protected function failure(param1:String) : void
      {
         ...
         throttle();
         dispatchEvent(new LibraryLoaderEvent(LibraryLoaderEvent.LIBRARY_LOADER_EVENT_ERROR,this.var_433,this.bytesTotal,this.bytesLoaded,this.elapsedTime));
         dispatchEvent(new Event(LIBRARY_LOADER_FINALIZE));
      }
