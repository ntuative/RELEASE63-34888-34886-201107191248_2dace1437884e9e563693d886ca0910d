package com.sulake.core.window.components
{
   ...
   public class ButtonController extends InteractiveController implements IButtonWindow, ITouchAwareWindow
   {
      ...
      protected static const const_464:String = "_BTN_TEXT";
      
      protected static const const_1416:Number = 0.5;
      ...
      override public function set caption(param1:String) : void
      {
         ...
         var _loc2_:IWindow = getChildByName(const_464);
         if(_loc2_ != null)
         {
         ...
         if(event is WindowEvent)
         {
            switch(event.type)
            {
               ...
               case WindowEvent.const_291:
                  try
                  {
                     getChildByName(const_464).blend = getChildByName(const_464).blend + const_1416;
                  }
                  catch(e:Error)
                  {
                  }
         ...
         else if(event is WindowTouchEvent)
         {
            ...
            switch(event.type)
            {
               ...
               case WindowTouchEvent.const_1276:
                  type = "null";
                  break;
               case WindowTouchEvent.const_801:
                  type = "null";
            }
