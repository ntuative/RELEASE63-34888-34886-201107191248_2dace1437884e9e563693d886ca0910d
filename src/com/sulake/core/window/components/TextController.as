package com.sulake.core.window.components
{
   ...
   public class TextController extends WindowController implements ITextWindow, ITextFieldContainer, ILocalizable
   {
      ...
      protected static const const_1423:Dictionary = createPropertySetterTable();
       
      
      protected var _field:TextField;
      
      protected var var_939:Number;
      
      protected var var_609:Number;
      
      protected var var_610:Boolean;
      
      protected var var_43:TextMargins;
      
      protected var _autoSize:String = "none";
      
      protected var var_150:Boolean = false;
      
      protected var var_1153:Boolean = false;
      ...
      public function TextController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         setTextFormatting(this._field,this.var_473,this._explicitStyle);
      ...
      private static function setTextStyle(param1:TextController, param2:TextStyle) : void
      {
         ...
         if(_loc3_)
         {
            param1.var_473 = _loc3_.name;
            setTextFormatting(param1._field,param1.var_473,param1._explicitStyle);
            param1.refreshTextImage();
         }
      }
      ...
      protected static function setTextFormatting(param1:TextField, param2:String, param3:TextStyle) : void
      {
         ...
         if(!_loc4_)
         {
            _loc4_ = TextStyleManager.getStyle(TextStyleManager.const_224);
         }
         ...
         {
            _loc5_.underline = _loc4_.textDecoration == TextStyle.const_947 ? true : null;
         }
      ...
      {
         this.var_939 = param1;
         this._field.scrollH = this.var_939 * Number(this._field.maxScrollH);
      ...
      {
         return new Rectangle(this.var_939 * this.maxScrollH,this.var_609 * this.maxScrollV,width,height);
      }
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct(PropertyDefaults.const_747,this._field.antiAliasType,PropertyStruct.const_53,this._field.antiAliasType != _loc2_.antiAliasType,PropertyDefaults.const_1410));
         _loc1_.push(this._autoSize != PropertyDefaults.const_1387 ? new PropertyStruct(PropertyDefaults.const_807,this._autoSize,PropertyStruct.const_53,true,PropertyDefaults.const_1291) : PropertyDefaults.const_1804);
         _loc1_.push(new PropertyStruct("border",this._field.border,PropertyStruct.const_37,this._field.border == true));
         _loc1_.push(new PropertyStruct("border_color",this._field.borderColor,PropertyStruct.const_156,this._field.borderColor != 0));
         ...
         _loc1_.push(this._field.gridFitType != PropertyDefaults.const_1368 ? new PropertyStruct(PropertyDefaults.const_1362,this._field.gridFitType,PropertyStruct.const_53,true,PropertyDefaults.const_1260) : PropertyDefaults.const_1847);
         _loc1_.push((_loc2_.color != null ? this._field.textColor != _loc2_.color : this._field.textColor != PropertyDefaults.const_909) ? new PropertyStruct(PropertyDefaults.const_425,this._field.textColor,PropertyStruct.const_156,true) : PropertyDefaults.const_1322);
         ...
         _loc1_.push(this.var_43.left != PropertyDefaults.const_927 ? new PropertyStruct(PropertyDefaults.const_248,this.var_43.left,PropertyStruct.const_36,true) : PropertyDefaults.const_943);
         _loc1_.push(this.var_43.top != PropertyDefaults.const_750 ? new PropertyStruct(PropertyDefaults.const_288,this.var_43.top,PropertyStruct.const_36,true) : PropertyDefaults.const_817);
         _loc1_.push(this.var_43.right != PropertyDefaults.const_855 ? new PropertyStruct(PropertyDefaults.const_279,this.var_43.right,PropertyStruct.const_36,true) : PropertyDefaults.const_846);
         _loc1_.push(this.var_43.bottom != PropertyDefaults.const_978 ? new PropertyStruct(PropertyDefaults.const_306,this.var_43.bottom,PropertyStruct.const_36,true) : PropertyDefaults.const_827);
         _loc1_.push(this._field.mouseWheelEnabled != PropertyDefaults.const_1364 ? new PropertyStruct(PropertyDefaults.const_880,this._field.mouseWheelEnabled,PropertyStruct.const_37,true) : PropertyDefaults.const_1970);
         _loc1_.push(new PropertyStruct("max_chars",this._field.maxChars,PropertyStruct.const_36,this._field.maxChars != 0));
         ...
         _loc1_.push(new PropertyStruct("sharpness",this._field.sharpness,PropertyStruct.const_138,this._field.sharpness != 0));
         _loc1_.push(new PropertyStruct("thickness",this._field.thickness,PropertyStruct.const_138,this._field.thickness != 0));
         ...
         _loc1_.push(new PropertyStruct("spacing",this._field.defaultTextFormat.letterSpacing,PropertyStruct.const_138,this._field.defaultTextFormat.letterSpacing != 0));
         return _loc1_;
      }
   }
}
