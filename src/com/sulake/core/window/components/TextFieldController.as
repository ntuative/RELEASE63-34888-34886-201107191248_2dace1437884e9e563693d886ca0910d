package com.sulake.core.window.components
{
   ...
   public class TextFieldController extends TextController implements ITextFieldWindow
   {
      ...
      protected var var_1718:uint = 500;
      ...
      {
         this.var_1429 = param1 == null ? "" : param1;
      }
      ...
      override public function getGraphicContext(param1:Boolean) : IGraphicContext
      {
         if(param1 && !var_21)
         {
            var_21 = new GraphicContext("GC {" + _name + "}",GraphicContext.const_1389,var_10);
         }
         return var_21;
      }
      ...
      protected function refreshAutoSize() : void
      {
         ...
         var _loc2_:* = null;
         var _loc3_:* = null;
         if(this.var_865 && autoSize != TextFieldAutoSize.NONE)
         {
            if(false)
            {
      ...
      private function onKeyDownEvent(param1:KeyboardEvent) : void
      {
         ...
         try
         {
            windowEvent = WindowKeyboardEvent.allocate(WindowKeyboardEvent.const_190,event,this,null);
            this.update(this,windowEvent);
            windowEvent.recycle();
         }
         catch(e:Error)
         {
            _context.handleError(WindowContext.const_408,e);
         }
      }
      ...
      private function onKeyUpEvent(param1:KeyboardEvent) : void
      {
         ...
         {
            var_17 = _field.text;
            windowEvent = WindowKeyboardEvent.allocate(WindowKeyboardEvent.const_321,event,this,null);
            this.update(this,windowEvent);
            windowEvent.recycle();
         }
         catch(e:Error)
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(true ? new PropertyStruct(PropertyDefaults.const_784,false,PropertyStruct.const_37,true) : PropertyDefaults.const_1835);
         _loc1_.push(this.var_1426 != PropertyDefaults.const_1349 ? new PropertyStruct(PropertyDefaults.const_981,this.var_1426,PropertyStruct.const_37,true) : PropertyDefaults.const_1941);
         _loc1_.push(_field.selectable != PropertyDefaults.const_1336 ? new PropertyStruct(PropertyDefaults.const_802,_field.selectable,PropertyStruct.const_37,true) : PropertyDefaults.const_1989);
         _loc1_.push(_field.displayAsPassword != PropertyDefaults.const_1339 ? new PropertyStruct("display_as_password",_field.displayAsPassword,PropertyStruct.const_37,true) : PropertyDefaults.const_1914);
         return _loc1_;
      }
      ...
      override public function set properties(param1:Array) : void
      {
         ...
         for each(_loc2_ in param1)
         {
            switch(_loc2_.key)
            {
               case PropertyDefaults.const_981:
                  this.var_1426 = _loc2_.value as Boolean;
                  if(this.var_1426)
                  {
               ...
               case PropertyDefaults.const_784:
                  ...
                  break;
               case PropertyDefaults.const_1402:
