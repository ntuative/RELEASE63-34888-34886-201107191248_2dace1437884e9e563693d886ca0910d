package com.sulake.core.window.components
{
   ...
   public class ScrollableItemListWindow extends WindowController implements IScrollableListWindow
   {
      ...
      private var var_1243:IItemListWindow;
      
      private var var_446:IScrollbarWindow;
      ...
      public function ScrollableItemListWindow(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function = null, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         if(this._scrollBar.testStateFlag(WindowState.const_93))
         {
            this.hideScrollBar();
         }
      }
      ...
      override public function dispose() : void
      {
         if(this.var_446)
         {
            this.var_446.removeEventListener(WindowEvent.const_291,this.scrollBarEventProc);
            this.var_446.removeEventListener(WindowEvent.const_283,this.scrollBarEventProc);
            this.var_446 = null;
         }
         if(this.var_1243)
         {
      ...
      protected function get _itemList() : IItemListWindow
      {
         if(!this.var_1243)
         {
            this.var_1243 = findChildByTag("_ITEMLIST") as IItemListWindow;
         }
      ...
      protected function get _scrollBar() : IScrollbarWindow
      {
         if(!this.var_446)
         {
            this.var_446 = findChildByTag("_SCROLLBAR") as IScrollbarWindow;
            if(this.var_446)
            {
               this.var_446.addEventListener(WindowEvent.const_291,this.scrollBarEventProc);
               this.var_446.addEventListener(WindowEvent.const_283,this.scrollBarEventProc);
            }
         }
         return this.var_446;
      }
      ...
      {
         if(param1.type == WindowEvent.const_291)
         {
            this.showScrollBar();
         }
         else if(param1.type == WindowEvent.const_283)
         {
            this.hideScrollBar();
         }
      }
