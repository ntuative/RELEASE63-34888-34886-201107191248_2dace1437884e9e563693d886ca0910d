package com.sulake.core.window.components
{
   ...
   public class ScrollbarController extends InteractiveController implements IScrollbarWindow, ITouchAwareWindow
   {
      ...
      private static const const_1666:String = "increment";
      
      private static const const_1665:String = "decrement";
      
      private static const const_1145:String = "slider_track";
      
      private static const const_725:String = "slider_bar";
       
      
      protected var _offset:Number = 0;
      
      protected var var_753:Number = 0.1;
      ...
      public function ScrollbarController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function, param9:Array = null, param10:Array = null, param11:uint = 0, param12:IScrollableWindow = null)
      {
         ...
         var_191 = false;
         this.var_18 = param12;
         this._horizontal = param2 == WindowType.const_659;
      ...
      public function set scrollable(param1:IScrollableWindow) : void
      {
         if(this.var_18 != null && !this.var_18.disposed)
         {
            ...
            this.var_18.removeEventListener(WindowEvent.const_499,this.onScrollableScrolled);
         }
         this.var_18 = param1;
         if(this.var_18 != null && !this.var_18.disposed)
         {
            this.var_18.addEventListener(WindowEvent.const_40,this.onScrollableResized);
            this.var_18.addEventListener(WindowEvent.const_499,this.onScrollableScrolled);
            this.updateLiftSizeAndPosition();
         }
      }
      ...
      override public function set properties(param1:Array) : void
      {
         ...
         while(_loc4_ < _loc2_)
         {
            ...
            {
               this.var_1095 = _loc3_.value as String;
               this.var_18 = null;
            }
            _loc4_++;
         }
      ...
      {
         return findChildByName(const_1145) as WindowController;
      }
      
      protected function get lift() : WindowController
      {
         return this.track.findChildByName(const_725) as WindowController;
      }
      ...
      override public function update(param1:WindowController, param2:WindowEvent) : Boolean
      {
         switch(param1.name)
         {
            case ScrollbarController.const_725:
               if(param2.type == WindowEvent.const_232)
               {
                  if(!this.var_1344)
                  {
                     if(this._horizontal)
         ...
         if(param2.type == WindowEvent.const_616)
         {
            if(this.var_18 == null)
            {
         ...
         if(param1 == this)
         {
            ...
            else if(param2.type == WindowMouseEvent.const_349)
            {
               if(WindowMouseEvent(param2).delta > 0)
               {
                  if(this._horizontal)
                  {
                     this.scrollH -= this.var_753;
                  }
                  else
                  {
                     this.scrollV -= this.var_753;
                  }
               }
      ...
      private function scrollButtonEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.const_45 || param1.type == WindowTouchEvent.const_801)
         {
            ...
            else if(param2.name == const_1665)
            {
               if(this.var_18)
               {
                  this.var_1344 = true;
            ...
            else if(param2.name == const_1145)
            {
               ...
               _loc6_ = WindowController(param2).getChildByName(ScrollbarController.const_725).rectangle;
               if(this._horizontal)
               {
                  if(_loc4_ < _loc6_.x)
                  {
         ...
         if(param1.type == WindowMouseEvent.const_349)
         {
      ...
      private function resolveScrollTarget() : Boolean
      {
         ...
         {
            _loc1_ = findParentByName(this.var_1095) as IScrollableWindow;
            if(_loc1_ == null && _parent is IWindowContainer)
            {
               _loc1_ = IWindowContainer(_parent).findChildByName(this.var_1095) as IScrollableWindow;
               if(_loc1_)
               {
