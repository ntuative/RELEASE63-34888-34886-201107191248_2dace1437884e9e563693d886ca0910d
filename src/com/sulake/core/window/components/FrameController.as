package com.sulake.core.window.components
{
   ...
   public class FrameController extends ContainerController implements IFrameWindow
   {
      ...
      private static const const_1445:String = "_TITLE";
      
      private static const const_1443:String = "_HEADER";
      
      private static const const_1444:String = "_CONTENT";
      
      private static const const_1442:String = "_SCALER";
       
      
      private var _title:ILabelWindow;
      
      private var var_1447:IHeaderWindow;
      ...
      public function get title() : ILabelWindow
      {
         if(this._title == null)
         {
            this._title = findChildByTag(const_1445) as ILabelWindow;
            if(!this._title)
            {
      ...
      public function get header() : IHeaderWindow
      {
         ...
         {
            this.var_1447 = findChildByTag(const_1443) as IHeaderWindow;
            if(!this.var_1447)
            {
      ...
      public function get content() : IWindowContainer
      {
         ...
         {
            this.var_196 = findChildByTag(const_1444) as IWindowContainer;
            if(!this.var_196)
            {
      ...
      {
         return findChildByTag(const_1442) as IScalerWindow;
      }
      ...
      override public function set color(param1:uint) : void
      {
         ...
         groupChildrenWithTag(const_1413,_loc2_,false);
      ...
      {
         return this.content != null && this.var_1152 ? this.content.iterator : new Iterator(this);
      }
      ...
      private function setupScaling() : void
      {
         ...
         var _loc2_:Boolean = testParamFlag(WindowParam.const_361);
         var _loc3_:Boolean = testParamFlag(WindowParam.const_246);
         var _loc4_:Boolean = testParamFlag(WindowParam.const_313);
         if(_loc1_)
         {
            if(_loc3_ || _loc2_)
            {
               _loc1_.setParamFlag(WindowParam.const_246,true);
            }
            else
            {
               _loc1_.setParamFlag(WindowParam.const_246,false);
            }
            if(_loc4_ || _loc2_)
            {
               _loc1_.setParamFlag(WindowParam.const_313,true);
            }
            else
            {
               _loc1_.setParamFlag(WindowParam.const_313,false);
            }
      ...
      private function marginsCallback(param1:IMargins) : void
      {
         ...
         if(_loc5_)
         {
            _loc2_.setParamFlag(WindowParam.const_342,false);
         }
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct(PropertyDefaults.const_248,_loc3_.left,PropertyStruct.const_36,_loc2_));
         _loc1_.push(new PropertyStruct(PropertyDefaults.const_288,_loc3_.top,PropertyStruct.const_36,_loc2_));
         _loc1_.push(new PropertyStruct(PropertyDefaults.const_279,0 - _loc3_.right,PropertyStruct.const_36,_loc2_));
         _loc1_.push(new PropertyStruct(PropertyDefaults.const_306,0 - _loc3_.bottom,PropertyStruct.const_36,_loc2_));
         return _loc1_;
      }
