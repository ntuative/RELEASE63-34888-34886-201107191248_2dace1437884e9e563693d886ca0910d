package com.sulake.core.window.components
{
   ...
   public class InteractiveController extends WindowController implements IInteractiveWindow
   {
      ...
      {
         if(param1.toolTipCaption != PropertyDefaults.const_557)
         {
         ...
         for each(_loc3_ in param2)
         {
            switch(_loc3_.key)
            {
               case PropertyDefaults.const_990:
                  ...
                  break;
               case PropertyDefaults.const_972:
      ...
      public static function writeInteractiveWindowProperties(param1:IInteractiveWindow, param2:Array) : Array
      {
         if(param1.toolTipCaption != PropertyDefaults.const_557)
         {
            param2.push(new PropertyStruct(PropertyDefaults.const_990,param1.toolTipCaption,PropertyStruct.const_53,true));
         }
         else
         {
            param2.push(PropertyDefaults.const_1975);
         }
         if(param1.toolTipDelay != PropertyDefaults.const_1340)
         {
            param2.push(new PropertyStruct(PropertyDefaults.const_972,param1.toolTipDelay,PropertyStruct.const_263,true));
         }
         else
         {
