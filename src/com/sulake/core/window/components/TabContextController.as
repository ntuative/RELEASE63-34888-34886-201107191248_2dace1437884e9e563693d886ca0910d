package com.sulake.core.window.components
{
   ...
   public class TabContextController extends WindowController implements ITabContextWindow, IIterable
   {
      ...
      private static const const_1469:String = "_SELECTOR";
      
      private static const const_1468:String = "_CONTENT";
       
      
      protected var var_1144:ITabSelectorWindow;
      
      protected var var_2251:IWindowContainer;
      ...
      public function get selector() : ITabSelectorWindow
      {
         ...
         {
            this.var_1144 = findChildByTag(const_1469) as ITabSelectorWindow;
            if(this.var_1144 != null)
            {
               this.var_1144.procedure = this.selectorEventProc;
            }
         }
      ...
      {
         if(this.var_2251 == null)
         {
            this.var_2251 = findChildByTag(const_1468) as IWindowContainer;
         }
      ...
      {
         return !!this.var_865 ? this.selector.iterator : null;
      }
      
      public function get numTabItems() : uint
      {
         return this.var_1144.numSelectables;
      }
