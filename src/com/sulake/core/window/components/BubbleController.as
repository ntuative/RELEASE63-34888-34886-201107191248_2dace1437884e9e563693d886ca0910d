package com.sulake.core.window.components
{
   ...
   public class BubbleController extends FrameController implements IBubbleWindow
   {
      ...
      private static const const_2073:String = "_POINTER_UP";
      
      private static const const_2074:String = "_POINTER_DOWN";
      
      private static const const_2071:String = "_POINTER_LEFT";
      
      private static const const_2072:String = "_POINTER_RIGHT";
      ...
      public function set direction(param1:String) : void
      {
         ...
         if(param1 != this._direction)
         {
            ...
            this.pointerOffset = this.var_769;
         }
      }
      ...
      override public function get properties() : Array
      {
         ...
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_755,this._direction,PropertyStruct.const_53,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1751);
         }
         if(this.var_769 != 0)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_733,this.var_769,PropertyStruct.const_36,true));
         }
         else
         {
         ...
         for each(_loc2_ in param1)
         {
            switch(_loc2_.key)
            {
               case PropertyDefaults.const_755:
                  ...
                  break;
               case PropertyDefaults.const_733:
