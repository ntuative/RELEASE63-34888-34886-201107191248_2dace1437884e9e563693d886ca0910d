package com.sulake.core.window.graphics
{
   ...
   public class SkinContainer implements ISkinContainer
   {
      ...
      private static const const_1144:uint = 8;
      
      private static const const_1664:String = "skin";
      
      private static const const_1663:String = "bitmap";
      
      private static const const_1660:String = "fill";
      
      private static const const_1661:String = "text";
      
      private static const const_1659:String = "label";
      
      private static const const_1662:String = "shape";
      ...
      public function SkinContainer(param1:XML, param2:IAssetLibrary)
      {
         ...
         TypeCodeTable.fillTables(this.var_2105,this.var_2876);
         this.var_2878 = new Dictionary();
         this.var_2877 = new Dictionary();
         StateCodeTable.fillTables(this.var_2878,this.var_2877);
         this.var_472 = new Dictionary();
         this.var_472[const_1664] = BitmapSkinRenderer;
         this.var_472[const_1663] = BitmapDataRenderer;
         this.var_472[const_1660] = FillSkinRenderer;
         this.var_472[const_1661] = TextSkinRenderer;
         this.var_472[const_1659] = LabelRenderer;
         this.var_472[const_1662] = ShapeSkinRenderer;
         this.var_472[RENDERER_TYPE_UNKNOWN] = SkinRenderer;
         this.var_472[RENDERER_TYPE_NULL] = NullSkinRenderer;
         if(var_365 == null)
         {
            var_365 = new Array();
            var_365.push(WindowState.const_77);
            var_365.push(WindowState.const_93);
            var_365.push(WindowState.const_100);
            var_365.push(WindowState.const_56);
            var_365.push(WindowState.const_90);
            var_365.push(WindowState.const_94);
            var_365.push(WindowState.const_91);
            var_365.push(WindowState.const_103);
         }
         if(param1 != null)
         {
            ...
            if(_loc4_ > 0)
            {
               ...
               while(_loc18_ < _loc4_)
               {
                  ...
                  _loc17_.var_3042 = !!_loc5_.@treshold[0] ? uint(uint(_loc5_.@treshold[0])) : uint(10);
                  ...
                  this.addSkinRenderer(this.var_2105[_loc7_],uint(_loc8_),_loc14_,_loc17_);
                  _loc18_++;
               }
            }
         }
      ...
      public function addSkinRenderer(param1:uint, param2:uint, param3:ISkinRenderer, param4:DefaultAttStruct) : void
      {
         ...
         {
            this.var_1093[param1] = new Array(const_1144);
         }
         this.var_1093[param1][param2] = param3;
         if(this.var_1094[param1] == null)
         {
            this.var_1094[param1] = new Array(const_1144);
         }
      ...
      public function getSkinRendererByTypeAndStyle(param1:uint, param2:uint) : ISkinRenderer
      {
         ...
         if(_loc3_)
         {
            ...
            if(!_loc4_ && param2 != WindowStyle.const_101)
            {
               _loc4_ = _loc3_["null"];
            }
         }
