package com.sulake.core.window.graphics
{
   ...
   public class GraphicContext extends Sprite implements IGraphicContext
   {
      ...
      public static const const_1799:uint = 0;
      
      public static const const_1000:uint = 1;
      
      public static const const_1389:uint = 2;
      
      public static const const_816:uint = 4;
      
      public static const const_1925:uint = 8;
      
      public static const const_1889:uint = 16;
      
      public static const const_2160:uint = 64;
      
      public static const const_2292:uint = 128;
      
      public static const const_1259:uint = 256;
      ...
      public function GraphicContext(param1:String, param2:uint, param3:Rectangle)
      {
         ...
         switch(param2)
         {
            ...
            case GraphicContext.const_1389:
               ...
               break;
            case GraphicContext.const_1925:
               this.setDisplayObject(new Shape());
               break;
            case GraphicContext.const_1889:
               this.setDisplayObject(new MorphShape());
               break;
            case GraphicContext.const_816:
               this.setDisplayObject(new Sprite());
               break;
            case GraphicContext.const_1259:
               break;
            case GraphicContext.const_1799:
               break;
            default:
         ...
         if(this.var_931)
         {
            ...
            if(displayObject is Bitmap)
            {
               ...
               if(bitmap == null && width > 0 && height > 0)
               {
                  try
                  {
                     bitmap = new TrackedBitmapData(this,width,height,this.var_2249,16777215);
                  }
                  catch(e:Error)
                  {
                     bitmap = new TrackedBitmapData(this,1,1,var_2249,16777215);
                  }
                  var_364 += bitmap.width * bitmap.height * 4;
               }
