package com.sulake.core.window.graphics
{
   ...
   public class WindowRendererItem implements IDisposable
   {
      ...
      private static const const_699:uint = 0;
      
      private static const const_1069:uint = 1;
      
      private static const const_1068:uint = 2;
       
      
      private var var_129:BitmapData;
      
      private var var_178:WindowRenderer;
      ...
      public function render(param1:IWindow, param2:Point, param3:Rectangle) : Boolean
      {
         ...
         var _loc5_:uint = !!param1.background ? uint(const_1068) : uint(const_699);
         var _loc6_:Boolean = this.var_199.width > 0 && this.var_199.height > 0;
         var _loc7_:ISkinRenderer = this.resolveSkinRenderer(param1);
         if(_loc7_ != null)
         {
            if(_loc7_.isStateDrawable(this.var_980))
            {
               _loc5_ = const_1069;
            }
         }
         ...
         if(_loc5_ != const_699)
         {
            this.var_1487 = this.var_980;
            _loc4_ = param1.fetchDrawBuffer() as BitmapData;
            if(_loc4_ != null)
            {
               _loc4_.lock();
               if(_loc5_ == const_1069)
               {
                  _loc6_ = true;
                  ...
                  if(this.var_634)
                  {
                     ...
                     _loc7_.draw(param1,this.var_129,this.var_129.rect,this.var_980,false);
                  }
                  if(param1.blend < 1 && param1.testParamFlag(WindowParam.const_33))
                  {
                     this.var_1148.tx = param2.x;
                     this.var_1148.ty = param2.y;
                     this.var_858.alphaMultiplier = param1.blend;
                     param3.offset(param2.x,param2.y);
                     _loc4_.draw(this.var_129,this.var_1148,this.var_858,null,param3,false);
                     param3.offset(-param2.x,-param2.y);
                  }
                  else
                  {
      ...
      public function invalidate(param1:IWindow, param2:Rectangle, param3:uint) : Boolean
      {
         ...
         switch(param3)
         {
            ...
            case WindowRedrawFlag.RESIZE:
               ...
               _loc4_ = true;
               break;
            case WindowRedrawFlag.const_1255:
               if(param1.testParamFlag(WindowParam.const_33))
               {
                  _loc4_ = true;
               }
               ...
               break;
            case WindowRedrawFlag.const_822:
               this.var_980 = this._skinContainer.getTheActualState(param1.type,param1.style,param1.state);
               if(this.var_980 != this.var_1487)
               {
                  this.var_634 = true;
                  _loc4_ = true;
               }
               break;
            case WindowRedrawFlag.const_1288:
               if(param1.testParamFlag(WindowParam.const_33))
               {
                  this.var_634 = true;
                  _loc4_ = true;
