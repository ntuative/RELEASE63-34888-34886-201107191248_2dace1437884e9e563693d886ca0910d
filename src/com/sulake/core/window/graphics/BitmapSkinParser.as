package com.sulake.core.window.graphics
{
   ...
   public class BitmapSkinParser
   {
      ...
      public static const const_103:String = "default";
      
      public static const const_91:String = "active";
      
      public static const const_94:String = "focused";
      
      public static const const_90:String = "hovering";
      
      public static const const_56:String = "selected";
      
      public static const const_100:String = "pressed";
      
      public static const const_93:String = "disabled";
      
      public static const const_77:String = "locked";
      ...
      protected static function parseLayoutEntity(param1:XML, param2:Map) : SkinLayoutEntity
      {
         ...
         if(_loc8_.length() > 0)
         {
            ...
            {
               case "fixed":
                  _loc5_.var_360 = SkinLayoutEntity.const_613;
                  break;
               case "move":
                  _loc5_.var_360 = SkinLayoutEntity.const_382;
                  break;
               case "strech":
                  _loc5_.var_360 = SkinLayoutEntity.const_496;
                  break;
               case "tiled":
                  _loc5_.var_360 = SkinLayoutEntity.const_348;
                  break;
               case "center":
                  _loc5_.var_360 = SkinLayoutEntity.const_584;
            }
            ...
            {
               case "fixed":
                  _loc5_.var_357 = SkinLayoutEntity.const_613;
                  break;
               case "move":
                  _loc5_.var_357 = SkinLayoutEntity.const_382;
                  break;
               case "strech":
                  _loc5_.var_357 = SkinLayoutEntity.const_496;
                  break;
               case "tiled":
                  _loc5_.var_357 = SkinLayoutEntity.const_348;
                  break;
               case "center":
                  _loc5_.var_357 = SkinLayoutEntity.const_584;
            }
         }
      ...
      protected static function parseState(param1:ISkinRenderer, param2:XML, param3:Dictionary, param4:Map) : void
      {
         ...
         switch(_loc5_)
         {
            case BitmapSkinParser.const_91:
               _loc10_ = 0;
               break;
            case BitmapSkinParser.const_103:
               _loc10_ = 0;
               break;
