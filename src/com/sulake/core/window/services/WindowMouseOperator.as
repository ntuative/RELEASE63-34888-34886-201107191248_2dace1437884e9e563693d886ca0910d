package com.sulake.core.window.services
{
   ...
   public class WindowMouseOperator implements IDisposable
   {
      ...
      protected var var_755:Point;
      
      protected var var_1491:uint;
      ...
      public function operate(param1:int, param2:int) : void
      {
         ...
         this.getMousePositionRelativeTo(this._window,this._mouse,this.var_755);
         this._window.offset(this.var_755.x - this._offset.x,this.var_755.y - this._offset.y);
      }
