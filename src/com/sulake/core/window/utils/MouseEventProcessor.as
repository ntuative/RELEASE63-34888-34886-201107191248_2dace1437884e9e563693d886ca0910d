package com.sulake.core.window.utils
{
   ...
   public class MouseEventProcessor implements IEventProcessor, IDisposable
   {
      ...
      protected static var var_435:Point = new Point();
      ...
      protected var var_178:IWindowRenderer;
      ...
      public function MouseEventProcessor()
      {
         ...
         {
            var_366 = new Array();
            var_366[0] = MouseCursorType.const_380;
            var_366[1] = MouseCursorType.const_31;
            var_366[2] = MouseCursorType.const_380;
            var_366[3] = MouseCursorType.const_380;
            var_366[4] = MouseCursorType.const_380;
            var_366[5] = MouseCursorType.const_31;
            var_366[6] = MouseCursorType.const_380;
         }
         if(var_318 == null)
         {
            var_318 = new Array();
            var_318[0] = WindowState.const_91;
            var_318[1] = WindowState.const_94;
            var_318[2] = WindowState.const_90;
            var_318[3] = WindowState.const_77;
            var_318[4] = WindowState.const_56;
            var_318[5] = WindowState.const_100;
            var_318[6] = WindowState.const_93;
         }
      }
      ...
      protected static function convertMouseEventType(param1:MouseEvent, param2:IWindow, param3:IWindow) : WindowMouseEvent
      {
         ...
         switch(param1.type)
         {
            ...
            case MouseEvent.MOUSE_UP:
               ...
               _loc4_ = !!_loc6_ ? "null" : WindowMouseEvent.const_252;
               break;
      ...
      public function process(param1:EventProcessorState, param2:IEventQueue) : void
      {
         ...
         this.var_193 = state.var_1411 as WindowController;
         this.var_178 = state.renderer;
         ...
         while(true)
         {
            ...
            if(index == 0)
            {
               if(event.type == MouseEvent.MOUSE_MOVE)
               {
                  ...
                  {
                     this.var_71.getGlobalPosition(var_435);
               ...
               if(child != null && child.visible)
               {
                  if(event.type == MouseEvent.MOUSE_MOVE)
                  {
                     if(child != this.var_71)
                     {
                        ...
                        if(!child.disposed)
                        {
                           child.getGlobalPosition(var_435);
         ...
         state.var_1411 = this.var_193;
         state.renderer = this.var_178;
      ...
      private function passMouseEvent(param1:WindowController, param2:MouseEvent, param3:Boolean = false) : WindowController
      {
         ...
         if(param1.testStateFlag(WindowState.const_93))
         {
            return null;
         }
         ...
         var _loc5_:BitmapData = this.var_178.getDrawBufferForRenderable(param1);
         if(!param1.validateLocalPointIntersection(_loc4_,_loc5_))
         {
            return null;
         }
         if(param1.testParamFlag(WindowParam.const_500))
         {
