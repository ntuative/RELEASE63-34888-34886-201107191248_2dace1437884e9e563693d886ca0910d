package com.sulake.core.window.utils
{
   ...
   public class TextStyleManager
   {
      ...
      public static const const_224:String = "regular";
      
      public static const ITALIC:String = "italic";
      
      public static const BOLD:String = "bold";
      
      private static var var_100:Map;
      
      private static var var_567:Array;
      
      private static var _eventDispatcher:IEventDispatcher;
      
      private static const const_714:String = "{";
      
      private static const const_715:String = "}";
      
      private static const const_1633:String = "/*";
      
      private static const const_1634:String = "*/";
      ...
      {
         return var_100.getWithIndex(param1);
      }
      
      public static function setStyle(param1:String, param2:TextStyle) : void
      {
         var _loc3_:* = var_100.getKeys().indexOf(param1) == -1;
         param2.name = param1;
         var_100[param1] = param2;
         if(_loc3_)
         {
            var_567.push(param1);
      ...
      public static function setStyles(param1:Array, param2:Boolean = false) : void
      {
         ...
         if(param2)
         {
            _loc5_ = [var_100[const_224],var_100[ITALIC],var_100[BOLD]];
            var_100.reset();
            var_100[const_224] = _loc5_[0];
            var_100[ITALIC] = _loc5_[1];
            var_100[BOLD] = _loc5_[2];
         }
         var _loc3_:int = 0;
         for each(_loc4_ in param1)
         {
            var_100[_loc4_.name] = _loc4_;
            if(var_567.indexOf(_loc4_.name) == -1)
            {
               var_567.push(_loc4_.name);
            }
         }
         _eventDispatcher.dispatchEvent(new Event(Event.CHANGE));
         if(var_100.length != _loc3_)
         {
            _eventDispatcher.dispatchEvent(new Event(Event.ADDED));
         }
      }
      ...
      public static function enumerateStyles() : Array
      {
         ...
         while(_loc3_ < _loc2_)
         {
            _loc1_.push(var_100.getWithIndex(_loc3_));
            _loc3_++;
         }
         return _loc1_;
      }
      ...
      private static function parseStyleNamesFromCSS(param1:String) : Array
      {
         ...
         var _loc4_:Array = _loc3_.split(const_715);
         if(countSubStrings(param1,const_714) != countSubStrings(param1,const_715))
         {
            throw new Error("Mismatching amount of \"" + const_714 + "\" versus \"" + const_715 + "\", please check the CSS!");
         }
         for each(_loc5_ in _loc4_)
         {
            while(_loc5_.indexOf(const_1633) == 0)
            {
               _loc5_ = _loc5_.substring(_loc5_.indexOf(const_1634) + 2,_loc5_.length);
            }
            _loc5_ = _loc5_.slice(0,_loc5_.indexOf(const_714)).split(" ").join("");
            if(_loc5_.length)
            {
               _loc2_.push(_loc5_);
            }
