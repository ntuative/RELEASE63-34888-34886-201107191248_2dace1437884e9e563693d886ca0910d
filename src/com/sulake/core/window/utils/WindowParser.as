package com.sulake.core.window.utils
{
   ...
   public class WindowParser implements IWindowParser
   {
      ...
      public static const const_2209:String = "_INCLUDE";
      
      public static const const_2328:String = "_TEMP";
      
      private static const const_1453:String = "layout";
      
      private static const const_1045:String = "window";
      
      private static const const_1046:String = "variables";
      
      private static const const_1047:String = "filters";
      
      private static const const_683:String = "name";
      
      private static const const_1462:String = "style";
      
      private static const const_684:String = "params";
      ...
      private static const const_1450:String = "visible";
      
      private static const const_1461:String = "caption";
      
      private static const ID:String = "id";
      
      private static const const_4:String = "background";
      
      private static const const_1288:String = "blend";
      
      private static const const_1452:String = "clipping";
      
      private static const COLOR:String = "color";
      
      private static const const_1458:String = "treshold";
      
      private static const const_1463:String = "children";
      
      private static const const_1457:String = "width_min";
      
      private static const WIDTH_MAX:String = "width_max";
      
      private static const const_1459:String = "height_min";
      
      private static const const_1456:String = "height_max";
      
      private static const const_685:String = "true";
      
      private static const const_193:String = "0";
      
      private static const const_1454:String = "$";
      
      private static const const_1451:String = ",";
      
      private static const const_50:String = "";
      
      private static const const_1449:RegExp = /^(\s|\n|\r|\t|\v)*/m;
      ...
      protected var var_1415:Dictionary;
      
      protected var var_1143:Dictionary;
      
      protected var var_1706:Dictionary;
      
      protected var var_2250:Map;
      ...
      public function WindowParser(param1:IWindowContext)
      {
         ...
         TypeCodeTable.fillTables(this.var_1414,this.var_1415);
         this.var_1143 = new Dictionary();
         this.var_1706 = new Dictionary();
         ParamCodeTable.fillTables(this.var_1143,this.var_1706);
         this.var_2250 = new Map();
      }
      
      private static function trimWhiteSpace(param1:String) : String
      {
         param1 = param1.replace(const_1455,const_50);
         return param1.replace(const_1449,const_50);
      }
      ...
      public function dispose() : void
      {
         ...
         if(!this._disposed)
         {
            for(_loc1_ in this.var_1414)
            {
               delete this.var_1414[_loc1_];
            }
            for(_loc1_ in this.var_1415)
            {
               delete this.var_1415[_loc1_];
            }
            for(_loc1_ in this.var_1143)
            {
               delete this.var_1143[_loc1_];
            }
            for(_loc1_ in this.var_1706)
            {
               delete this.var_1706[_loc1_];
            }
            this.var_2250.dispose();
            this.var_2250 = null;
            this._context = null;
            this._disposed = true;
         }
      ...
      public function parseAndConstruct(param1:XML, param2:IWindow, param3:Map) : IWindow
      {
         ...
         var _loc12_:* = null;
         var _loc13_:int = 0;
         if(param1.localName() == const_1453)
         {
            _loc8_ = param1.child(const_1046);
            if(_loc8_.length() > 0)
            {
               _loc10_ = _loc8_[0];
            ...
            _loc9_ = param1.child(const_1047).children();
            if(_loc9_.length() > 0)
            {
               _loc12_ = new Array();
               _loc13_ = 0;
            ...
            _loc4_ = param1.child(const_1045);
         ...
         if(param1.localName() == const_1045)
         {
      ...
      private function parseSingleWindowEntity(param1:XML, param2:WindowController, param3:Map) : IWindow
      {
         ...
         var id:int = 0;
         type = this.var_1414[xml.localName()];
         name = unescape(String(this.parseAttribute(xml,const_683,variables,"")));
         style = uint(this.parseAttribute(xml,const_1462,variables,style));
         params = uint(this.parseAttribute(xml,const_684,variables,params));
         tag = unescape(String(this.parseAttribute(xml,const_1460,variables,tag)));
         rect = new Rectangle();
         rect.x = Number(this.parseAttribute(xml,X,variables,const_193));
         rect.y = Number(this.parseAttribute(xml,Y,variables,const_193));
         rect.width = Number(this.parseAttribute(xml,name_2,variables,const_193));
         rect.height = Number(this.parseAttribute(xml,name_1,variables,const_193));
         visible = this.parseAttribute(xml,const_1450,variables,visible.toString()) == const_685;
         id = int(this.parseAttribute(xml,ID,variables,id.toString()));
         if(xml.child(const_684).length() > 0)
         {
            list = xml.child(const_684).children();
            length = list.length();
            i = 0;
            while(i < length)
            {
               node = list[i];
               param = this.parseAttribute(node,const_683,variables,"") as String;
               if(this.var_1143[param] == null)
               {
                  throw new Error("Unknown window parameter \"" + String(node.attribute(const_683)) + "\"!");
               }
               params |= this.var_1143[param];
               i++;
            }
         }
         caption = !!(params & 0) ? (!!parent ? parent.caption : const_50) : const_50;
         caption = unescape(String(this.parseAttribute(xml,const_1461,variables,caption)));
         if(tag != const_50)
         {
            tags = tag.split(const_1451);
            length = tags.length;
            i = 0;
            while(i < length)
            {
         ...
         window = this._context.create(name,null,type,style,params,rect,null,parent is IIterable ? null : parent,id,this.parseProperties(xml.child(const_1046)[0]),tags) as WindowController;
         window.limits.minWidth = int(this.parseAttribute(xml,const_1457,variables,window.limits.minWidth));
         window.limits.maxWidth = int(this.parseAttribute(xml,WIDTH_MAX,variables,window.limits.maxWidth));
         window.limits.minHeight = int(this.parseAttribute(xml,const_1459,variables,window.limits.minHeight));
         window.limits.maxHeight = int(this.parseAttribute(xml,const_1456,variables,window.limits.maxHeight));
         background = this.parseAttribute(xml,const_4,variables,window.background.toString()) == const_685;
         blend = Number(this.parseAttribute(xml,const_1288,variables,window.blend.toString()));
         clipping = this.parseAttribute(xml,const_1452,variables,window.clipping.toString()) == const_685;
         color = String(this.parseAttribute(xml,COLOR,variables,window.color.toString()));
         treshold = uint(this.parseAttribute(xml,const_1458,variables,window.mouseThreshold.toString()));
         ...
         list = xml.child(const_1047).children();
         length = list.length();
         if(length > 0)
         {
            filters = new Array();
         ...
         if(window != null)
         {
            if(parent != null)
            {
               if(parent is IIterable)
               {
                  ...
                  {
                     if((params & 0) == WindowParam.const_207)
                     {
                        window.x = rect.x;
                     }
                     if((params & 0) == WindowParam.const_206)
                     {
                        window.y = rect.y;
                     }
                  }
      ...
      public function windowToXMLString(param1:IWindow) : String
      {
         ...
         var _loc2_:* = const_50;
         var _loc3_:String = this.var_1415[param1.type];
