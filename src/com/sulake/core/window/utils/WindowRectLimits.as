package com.sulake.core.window.utils
{
   ...
   public class WindowRectLimits implements IRectLimiter
   {
      ...
      private var var_351:int = 2.147483647E9;
      ...
      {
         this.var_354 = param1;
         if(this.var_354 > int.MIN_VALUE && !this._target.disposed && this._target.width < this.var_354)
         {
            this._target.width = this.var_354;
         }
      }
      ...
      {
         this.var_352 = param1;
         if(this.var_352 > int.MIN_VALUE && !this._target.disposed && this._target.height < this.var_352)
         {
      ...
      {
         this.var_351 = param1;
         if(this.var_351 < int.MAX_VALUE && !this._target.disposed && this._target.height > this.var_351)
         {
      ...
      {
         return this.var_354 == int.MIN_VALUE && this.var_353 == int.MAX_VALUE && this.var_352 == int.MIN_VALUE && this.var_351 == int.MAX_VALUE;
      }
      ...
      public function limit() : void
      {
         ...
         {
            if(this._target.width < this.var_354)
            {
               this._target.width = this.var_354;
            }
            ...
            if(this._target.height < this.var_352)
            {
               this._target.height = this.var_352;
            }
            else if(this._target.height > this.var_351)
            {
               this._target.height = this.var_351;
            }
         }
