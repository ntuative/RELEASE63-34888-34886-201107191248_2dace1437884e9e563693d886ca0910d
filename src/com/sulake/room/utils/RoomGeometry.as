package com.sulake.room.utils
{
   ...
   public class RoomGeometry implements IRoomGeometry
   {
      ...
      public static const const_674:Number = 64;
      
      public static const const_1196:Number = 32;
      ...
      private var var_477:Number = 1.0;
      
      private var var_478:Number = 1.0;
      
      private var var_479:Number = 1.0;
      ...
      private var var_3099:Number = 500.0;
      ...
      public function RoomGeometry(param1:Number, param2:IVector3d, param3:IVector3d, param4:IVector3d = null)
      {
         ...
         this.var_1349 = new Vector3d();
         this.var_475 = new Vector3d();
         this._direction = new Vector3d();
         this.var_1350 = new Vector3d();
         this.var_2114 = 1;
         this.var_2113 = 1;
         this.x_scale = 1;
         this.y_scale = 1;
         this.var_2112 = Math.sqrt(0.5) / Math.sqrt(0.75);
         this.method_10 = 1;
      ...
      {
         this.var_475.assign(this.var_106);
         this.var_475.x *= this.var_477;
         this.var_475.y *= this.var_478;
         this.var_475.z *= this.var_479;
         return this.var_475;
      }
      ...
      {
         if(this.var_477 != param1 * this.var_2114)
         {
            this.var_477 = param1 * this.var_2114;
            ++this.var_187;
         }
      }
      ...
      {
         if(this.var_478 != param1 * this.var_2113)
         {
            this.var_478 = param1 * this.var_2113;
            ++this.var_187;
         }
      }
      ...
      {
         if(this.var_479 != param1 * this.var_2112)
         {
            this.var_479 = param1 * this.var_2112;
            ++this.var_187;
         }
      }
      ...
      public function set location(param1:IVector3d) : void
      {
         ...
         this.var_106.x /= this.var_477;
         this.var_106.y /= this.var_478;
         this.var_106.z /= this.var_479;
      ...
      public function set direction(param1:IVector3d) : void
      {
         ...
         var _loc2_:Number = this.var_476.x;
         var _loc3_:Number = this.var_476.y;
         var _loc4_:Number = this.var_476.z;
         this.var_476.assign(param1);
         this._direction.assign(param1);
         if(this.var_476.x != _loc2_ || this.var_476.y != _loc3_ || this.var_476.z != _loc4_)
         {
            ++this.var_187;
         }
         ...
         if(_loc10_ != 0)
         {
            ...
            this.var_176.assign(_loc25_);
            this.var_1349.assign(this.var_176);
         }
         else
         {
            this._x.assign(_loc18_);
            this.var_175.assign(_loc19_);
            this.var_176.assign(_loc20_);
            this.var_1349.assign(this.var_176);
         }
      }
      ...
      public function setDisplacement(param1:IVector3d, param2:IVector3d) : void
      {
         ...
         if(this.var_586 != null)
         {
            ...
            this.var_586.remove(_loc3_);
            _loc4_ = new Vector3d();
            _loc4_.assign(param2);
            this.var_586.add(_loc3_,_loc4_);
            ++this.var_187;
         }
      }
      ...
      private function method_8(param1:IVector3d) : IVector3d
      {
         ...
         if(this.var_586 != null)
         {
            ...
            return this.var_586.getValue(_loc2_);
         }
         return null;
      }
      ...
      public function setDepthVector(param1:IVector3d) : void
      {
         ...
         if(_loc7_ != 0)
         {
            ...
            this.var_1350.assign(_loc22_);
         }
         else
         {
            this.var_1350.assign(_loc17_);
         }
         ++this.var_187;
      }
      ...
      {
         if(param1 == null || this.var_176 == null)
         {
            return;
         }
         var _loc3_:Vector3d = Vector3d.product(this.var_176,-param2);
      ...
      public function getCoordinatePosition(param1:IVector3d) : IVector3d
      {
         ...
         var _loc4_:Number = Vector3d.scalarProjection(param1,this.var_176);
      ...
      public function getScreenPosition(param1:IVector3d) : IVector3d
      {
         ...
         _loc2_.x *= this.var_477;
         _loc2_.y *= this.var_478;
         _loc2_.z *= this.var_479;
         var _loc3_:Number = Vector3d.scalarProjection(_loc2_,this.var_1350);
         if(_loc3_ < this.var_3098 || _loc3_ > this.var_3099)
         {
            return null;
         }
         ...
         if(_loc6_ != null)
         {
            ...
            _loc2_.y *= this.var_478;
            _loc2_.z *= this.var_479;
            _loc3_ = Vector3d.scalarProjection(_loc2_,this.var_1350);
         }
         _loc2_.x = _loc4_;
         _loc2_.y = _loc5_;
         _loc2_.z = _loc3_;
      ...
      public function getPlanePosition(param1:Point, param2:IVector3d, param3:IVector3d, param4:IVector3d) : Point
      {
         ...
         var _loc8_:Vector3d = new Vector3d(this.var_106.x * this.var_477,this.var_106.y * this.var_478,this.var_106.z * this.var_479);
         _loc8_.add(_loc7_);
         var _loc9_:IVector3d = this.var_176;
         var _loc10_:Vector3d = new Vector3d(param2.x * this.var_477,param2.y * this.var_478,param2.z * this.var_479);
         var _loc11_:Vector3d = new Vector3d(param3.x * this.var_477,param3.y * this.var_478,param3.z * this.var_479);
         var _loc12_:Vector3d = new Vector3d(param4.x * this.var_477,param4.y * this.var_478,param4.z * this.var_479);
      ...
      public function performZoom() : void
      {
         if(this.isZoomedIn())
         {
            this.scale = const_1196;
         }
         else
         {
            this.scale = const_674;
         }
      }
      
      public function isZoomedIn() : Boolean
      {
         return this.scale == const_674;
      }
