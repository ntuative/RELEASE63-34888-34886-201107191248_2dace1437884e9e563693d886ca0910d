package com.sulake.room.object.logic
{
   ...
   public class ObjectLogicBase implements IRoomObjectEventHandler
   {
      ...
      private var var_378:IRoomObjectController;
      ...
      {
         if(this.var_378 == param1)
         {
            return;
         }
         if(this.var_378 != null)
         {
            this.var_378.setEventHandler(null);
         }
         if(param1 == null)
         {
            this.dispose();
         ...
         {
            this.var_378 = param1;
            this.var_378.setEventHandler(this);
         }
      }
      ...
      public function processUpdateMessage(param1:RoomObjectUpdateMessage) : void
      {
         if(param1 != null)
         {
            if(this.var_378 != null)
            {
               this.var_378.setLocation(param1.loc);
               this.var_378.setDirection(param1.dir);
            }
         }
      }
