package com.sulake.room.object.visualization
{
   ...
   public class RoomObjectSpriteVisualization implements IRoomObjectSpriteVisualization
   {
      ...
      private var var_378:IRoomObject;
      
      private var var_798:IGraphicAssetCollection;
      
      protected var var_508:int = -1;
      ...
      public function dispose() : void
      {
         ...
         {
            while(this.var_221.length > 0)
            {
               _loc1_ = this.var_221[0] as RoomObjectSprite;
               if(_loc1_ != null)
               {
                  _loc1_.dispose();
               }
      ...
      public function set assetCollection(param1:IGraphicAssetCollection) : void
      {
         ...
         {
            this.var_798.removeReference();
         }
         this.var_798 = param1;
         if(this.var_798 != null)
         {
            this.var_798.addReference();
         }
      }
      ...
      {
         var _loc2_:* = null;
         while(this.var_221.length > param1)
         {
            _loc2_ = this.var_221[this.var_221.length - 1] as RoomObjectSprite;
            if(_loc2_ != null)
            {
               _loc2_.dispose();
            }
      ...
      {
         if(param1 >= 0 && param1 < this.var_221.length)
         {
