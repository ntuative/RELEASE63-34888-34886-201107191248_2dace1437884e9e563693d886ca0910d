package com.sulake.room
{
   ...
   public class RoomManager extends Component implements IRoomManager, IRoomInstanceContainer
   {
      ...
      private var var_185:IRoomManagerListener;
      
      private var var_3119:IRoomContentLoader;
      
      private var var_703:IRoomObjectFactory = null;
      
      private var var_570:IRoomObjectVisualizationFactory = null;
      
      private var _state:int = 0;
      
      private var var_1321:XML = null;
      ...
      public function RoomManager(param1:IContext, param2:uint = 0)
      {
         ...
         events.addEventListener(RoomContentLoadedEvent.const_418,this.onContentLoaded);
         events.addEventListener(RoomContentLoadedEvent.const_567,this.onContentLoaded);
         events.addEventListener(RoomContentLoadedEvent.const_948,this.onContentLoaded);
      }
      ...
      private function objectFactoryReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_703 = param2 as IRoomObjectFactory;
      ...
      {
         var _loc1_:* = null;
         if(this.var_703 == null || this.var_570 == null)
         {
            return;
         }
         this._state = const_1763;
         if(this.var_1321 != null)
         {
            _loc1_ = this.var_1321;
            this.var_1321 = null;
            this.initialize(_loc1_,this.var_185);
         }
      }
      ...
      public function initialize(param1:XML, param2:IRoomManagerListener) : Boolean
      {
         ...
         while(_loc4_ < _loc3_.length)
         {
            ...
            if(this.var_704.indexOf(_loc5_) < 0)
            {
               this.var_60.loadObjectContent(_loc5_,events);
               this.var_704.push(_loc5_);
            }
            _loc4_++;
         }
         this._state = const_1404;
         return true;
      }
      ...
      public function createRoomObject(param1:String, param2:int, param3:String, param4:int) : IRoomObject
      {
         ...
         var _loc17_:IRoomObjectGraphicVisualization = this.var_570.createRoomObjectVisualization(_loc10_);
         if(_loc17_ == null)
         {
            _loc5_.disposeObject(param2,param4);
            return null;
         ...
         var _loc18_:* = null;
         _loc18_ = this.var_570.getRoomObjectVisualizationData(_loc12_,_loc10_,_loc8_);
         ...
         var _loc19_:IRoomObjectEventHandler = this.var_703.createRoomObjectLogic(_loc11_);
      ...
      public function createRoomObjectManager() : IRoomObjectManager
      {
         if(this.var_703 != null)
         {
            return this.var_703.createRoomObjectManager();
         }
         return null;
      }
      ...
      private function processInitialContentLoad(param1:String) : void
      {
         ...
         if(this.var_60.getGraphicAssetCollection(param1) != null)
         {
            _loc2_ = this.var_704.indexOf(param1);
            if(_loc2_ >= 0)
            {
               this.var_704.splice(_loc2_,1);
            }
            if(this.var_704.length == 0)
            {
               this._state = const_792;
               if(this.var_185 != null)
               {
                  this.var_185.roomManagerInitialized();
               }
            }
         }
         else
         {
            this._state = const_810;
            this.var_185.roomManagerInitialized(false);
         }
      }
      ...
      private function onContentLoaded(param1:RoomContentLoadedEvent) : void
      {
         ...
         if(_loc2_ == null)
         {
            if(this.var_185 != null)
            {
               this.var_185.contentLoaded(null,false);
            }
            return;
         }
         if(this.var_1071.indexOf(_loc2_) < 0)
         {
            this.var_1071.push(_loc2_);
         }
      }
      ...
      private function processLoadedContentTypes() : void
      {
         ...
         {
            _loc2_ = this.var_1071[0];
            this.var_1071.splice(0,1);
            _loc3_ = this.var_60.getVisualizationXML(_loc2_);
            if(_loc3_ == null)
            {
               if(this.var_185 != null)
               {
                  this.var_185.contentLoaded(_loc2_,false);
               }
               return;
            }
            ...
            if(this.var_185 != null)
            {
               this.var_185.contentLoaded(_loc2_,true);
            }
            if(this.var_704.length > 0)
            {
            ...
            _loc5_ = getTimer();
            if(_loc5_ - _loc1_ >= CONTENT_PROCESSING_TIME_LIMIT_MILLISECONDS && this.var_2800)
            {
               this.var_2059 = true;
               break;
            }
      ...
      private function updateObjectContents(param1:String) : void
      {
         ...
         if(this.var_60 == null || this.var_570 == null)
         {
            return;
         }
         ...
         var _loc7_:IRoomObjectVisualizationData = this.var_570.getRoomObjectVisualizationData(param1,_loc5_,_loc2_);
            ...
            if(_loc9_ != null)
            {
               ...
               for each(_loc12_ in _loc11_)
               {
                  ...
                  while(_loc14_ >= 0)
                  {
                     ...
                     if(_loc15_ != null)
                     {
                        _loc16_ = this.var_570.createRoomObjectVisualization(_loc5_);
                        if(_loc16_ != null)
                        {
                           ...
                           else
                           {
                              ...
                              _loc17_ = this.var_703.createRoomObjectLogic(_loc6_);
                              ...
                              if(this.var_185 != null)
                              {
                                 this.var_185.objectInitialized(_loc10_,_loc15_.getId(),_loc12_);
                              }
                           }
                        }
                        else
