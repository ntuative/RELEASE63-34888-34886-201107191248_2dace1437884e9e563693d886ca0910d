package com.sulake.room.renderer.utils
{
   ...
   public class ExtendedSprite extends Bitmap
   {
      ...
      private var var_1513:int = 128;
      
      private var var_1512:Boolean = false;
      
      private var var_3079:Point;
      ...
      {
         if(param1 != this.var_1868 || param2 != this.var_1867)
         {
      ...
      {
         if(this.var_1513 > 255 || bitmapData == null)
         {
            return false;
         }
