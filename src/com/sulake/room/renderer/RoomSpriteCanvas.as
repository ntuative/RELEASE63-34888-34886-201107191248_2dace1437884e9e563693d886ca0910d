package com.sulake.room.renderer
{
   ...
   public class RoomSpriteCanvas implements IRoomRenderingCanvas
   {
      ...
      private static const const_1537:int = 50;
      
      private static const const_1073:Number = 60;
      
      private static const const_1538:Number = 50;
      ...
      private var var_280:BitmapDataCache;
      
      private var var_644:RoomObjectCache;
      
      private var var_536:Array;
      
      private var var_640:Array;
      
      private var var_1497:IRoomRenderingCanvasMouseListener = null;
      ...
      private var var_2494:Number = -1.0E7;
      
      private var var_2492:Number = -1.0E7;
      ...
      private var var_639:Matrix;
      
      private var var_520:Number = 0.0;
      ...
      private var var_3077:Boolean = false;
      
      private var var_2493:Array;
      
      private var var_786:int = 0;
      
      private var var_1842:Number = 0.0;
      ...
      public function RoomSpriteCanvas(param1:IRoomSpriteCanvasContainer, param2:String, param3:int, param4:int, param5:int)
      {
         ...
         this._id = param2;
         this.var_281 = new Sprite();
         this.var_281.mouseEnabled = false;
         this.var_112 = new Sprite();
         this.var_112.name = "canvas";
         this.var_112.mouseEnabled = false;
         this.var_281.addChild(this.var_112);
         ...
         this.var_280 = new BitmapDataCache(16,32,1);
         var _loc6_:* = null;
         ...
         this.var_644 = new RoomObjectCache(_loc6_);
         this.var_858 = new ColorTransform();
         this.var_639 = new Matrix();
      ...
      {
         this.var_534.x -= param1 - this.var_643;
         this.var_643 = param1;
      }
      
      public function set screenOffsetY(param1:int) : void
      {
         this.var_534.y -= param1 - this.var_641;
         this.var_641 = param1;
      }
      ...
      {
         if(param1 && !this.var_1030)
         {
            this.var_1030 = true;
            if(this.var_156 != null && !this.var_281.contains(this.var_156))
            {
               this.var_281.addChild(this.var_156);
               this.var_112.mask = this.var_156;
            }
         }
         else if(!param1 && this.var_1030)
         {
            this.var_1030 = false;
            if(this.var_156 != null && this.var_281.contains(this.var_156))
            {
               this.var_281.removeChild(this.var_156);
      ...
      public function dispose() : void
      {
         ...
         {
            while(this.var_281.numChildren > 0)
            {
               this.var_281.removeChildAt(0);
            }
            this.var_281 = null;
         }
         this.var_112 = null;
         ...
         {
            _loc1_ = 0;
            while(_loc1_ < this.var_640.length)
            {
               this.cleanSprite(this.var_640[_loc1_] as ExtendedSprite,true);
               _loc1_++;
            }
            this.var_640 = [];
         }
      ...
      {
         this.var_644.removeObjectCache(param1);
      }
      
      public function render(param1:int) : void
      {
         this.var_1840 = !this.var_1840;
         if(this._container == null || this._geometry == null)
         {
            return;
         }
         if(param1 == this.var_1498)
         {
            return;
         }
         this.calculateUpdateInterval(param1);
         this.var_280.compress();
         ...
         if(this.var_535 != this.var_2497 || this.var_533 != this.var_2495)
         {
            _loc8_ = true;
         }
         if(this.var_112.x != this.var_643 || this.var_112.y != this.var_641)
         {
            this.var_112.x = this.var_643;
            this.var_112.y = this.var_641;
            _loc8_ = true;
         }
         _loc4_ = 0;
         while(_loc4_ < _loc3_)
         ...
         this.var_536.sortOn("z",0 | 0);
         if(_loc5_ < this.var_536.length)
         {
            this.var_536.splice(_loc5_);
         }
         var _loc9_:* = null;
         _loc4_ = 0;
         while(_loc4_ < _loc5_)
         {
            _loc9_ = this.var_536[_loc4_] as SortableSprite;
            if(_loc9_ != null)
            {
         ...
         this.var_2497 = this.var_535;
         this.var_2495 = this.var_533;
      }
      ...
      private function calculateUpdateInterval(param1:int) : void
      {
         ...
         if(this.var_1498 > 0)
         {
            _loc2_ = param1 - this.var_1498;
            if(_loc2_ > const_1073 * 3)
            {
            ...
            {
               ++this.var_787;
               if(this.var_787 == const_386 + 1)
               {
                  this.var_520 = _loc2_;
                  this.var_1842 = this.var_2491;
               }
               else if(this.var_787 > const_386 + 1)
               {
                  _loc3_ = Number(this.var_787 - const_386);
                  this.var_520 = this.var_520 * (_loc3_ - 1) / _loc3_ + Number(_loc2_) / _loc3_;
                  this.var_1842 = this.var_1842 * (_loc3_ - 1) / _loc3_ + Number(this.var_2491) / _loc3_;
                  if(this.var_787 > const_386 + const_1537)
                  {
                     this.var_787 = const_386;
                     if(!this.var_1227 && this.var_520 > const_1073)
                     {
                        this.var_1227 = true;
                        Logger.log("Room canvas updating really slow - now entering frame skipping mode...");
                     }
                     else if(this.var_1227 && this.var_520 < const_1538)
                     {
                        this.var_1227 = false;
      ...
      private function renderObject(param1:IRoomObject, param2:String, param3:int, param4:Boolean, param5:int) : int
      {
         ...
         if(_loc6_ == null)
         {
            this.var_644.removeObjectCache(param2);
            return 0;
         }
         var _loc7_:RoomObjectCacheItem = this.var_644.getObjectCache(param2);
         ...
         _loc6_.update(this._geometry,param3,!_loc9_.isEmpty || param4,this.var_1840 && this.var_1227);
         ...
         _loc13_ += int(this.var_535 / 2);
         _loc14_ += int(this.var_533 / 2);
         var _loc16_:int = 0;
         var _loc17_:* = null;
         var _loc18_:* = null;
         var _loc19_:int = 0;
         ...
         while(_loc21_ < _loc12_)
         {
            ...
            if(_loc18_ != null && _loc18_.visible)
            {
               ...
               if(_loc22_ != null)
               {
                  _loc19_ = _loc13_ + _loc18_.offsetX + this.var_643;
                  ...
                  if(this.rectangleVisible(_loc19_,_loc20_,_loc22_.width,_loc22_.height))
                  {
                     ...
                     if(_loc17_ == null)
                     {
                        ...
                        this.var_536.push(_loc17_);
                        _loc17_.name = param2;
                     }
                     _loc17_.sprite = _loc18_;
                     _loc17_.x = _loc19_ - this.var_643;
      ...
      {
         if(param1 < this.var_535 && param1 + param3 >= 0 && (param2 < this.var_533 && param2 + param4 >= 0))
         {
            if(!this.var_3077)
            {
               return true;
      ...
      private function rectangleVisibleWithExclusion(param1:int, param2:int, param3:int, param4:int) : Boolean
      {
         ...
         if(param1 + param3 >= this.var_535)
         {
            param3 -= this.var_535 + 1 - (param1 + param3);
         }
         if(param2 + param4 >= this.var_533)
         {
            param4 -= this.var_533 + 1 - (param2 + param4);
         }
         for each(_loc5_ in this.var_2493)
         {
      ...
      {
         if(param1 < 0 || param1 >= this.var_988)
         {
            return null;
         }
      ...
      private function createSprite(param1:SortableSprite, param2:int = -1) : void
      {
         ...
         if(this.var_640.length > 0)
         {
            _loc3_ = this.var_640.pop() as ExtendedSprite;
         }
         if(_loc3_ == null)
         {
         ...
         if(param2 < 0 || param2 >= this.var_988)
         {
      ...
      private function cleanSprites(param1:int, param2:Boolean = false) : void
      {
         ...
         var _loc3_:* = null;
         if(param1 < this.var_786 || this.var_786 == 0)
         {
            _loc4_ = this.var_988 - 1;
            while(_loc4_ >= param1)
            {
      ...
      {
         if(param1 < 0 || param1 >= this.var_536.length)
         {
            return null;
         }
         return this.var_536[param1] as SortableSprite;
      }
      ...
      private function getBitmapData(param1:BitmapData, param2:String, param3:Boolean, param4:Boolean, param5:int) : BitmapData
      {
         ...
         if((param3 || param4) && param5 != 16777215)
         {
            ...
            if(param2.length > 0)
            {
               _loc6_ = this.var_280.getBitmapData(_loc7_);
            }
            if(_loc6_ == null)
            {
               ...
               if(_loc6_ != null)
               {
                  ...
                  if(param2.length > 0)
                  {
                     this.var_280.addBitmapData(_loc7_,_loc6_);
                  }
                  return _loc6_;
               }
      ...
      private function getFlippedBitmapData(param1:BitmapData, param2:String, param3:Boolean = false, param4:Boolean = true, param5:Boolean = false) : ExtendedBitmapData
      {
         ...
         if(name.length > 0)
         {
            finalData = this.var_280.getBitmapData(cacheName);
            if(!allowCreation)
            {
               return finalData;
            }
         ...
         if(finalData == null)
         {
            ...
            this.var_639.identity();
            if(flipH)
            {
               this.var_639.scale(-1,1);
               this.var_639.translate(data.width,0);
            }
            if(flipV)
            {
               this.var_639.scale(1,-1);
               this.var_639.translate(0,data.height);
            }
            finalData.draw(data,this.var_639);
            if(name.length > 0)
            {
               this.var_280.addBitmapData(cacheName,finalData);
            }
         }
         return finalData;
      }
      ...
      private function getColoredBitmapData(param1:BitmapData, param2:String, param3:int, param4:Boolean = false) : ExtendedBitmapData
      {
         ...
         if(finalData == null)
         {
            ...
            {
               finalData = new ExtendedBitmapData(data.width,data.height,true,16777215);
               finalData.copyPixels(data,data.rect,const_703);
            }
            catch(e:Error)
            {
               finalData = new ExtendedBitmapData(1,1,true,16777215);
            }
            this.var_858.redMultiplier = tR;
            this.var_858.greenMultiplier = tG;
            this.var_858.blueMultiplier = tB;
            finalData.colorTransform(finalData.rect,this.var_858);
            if(name.length > 0)
            {
               this.var_280.addBitmapData(cacheName,finalData);
            }
      ...
      public function handleMouseEvent(param1:int, param2:int, param3:String, param4:Boolean, param5:Boolean, param6:Boolean, param7:Boolean) : Boolean
      {
         param1 -= this.var_643;
         param2 -= this.var_641;
         this.var_534.x = param1;
         this.var_534.y = param2;
         if(this.var_1228 > 0 && param3 == MouseEvent.MOUSE_MOVE)
         {
            return this.var_1841;
         }
         this.var_1841 = this.checkMouseHits(param1,param2,param3,param4,param5,param6,param7);
         ++this.var_1228;
         return this.var_1841;
      }
      ...
      {
         var _loc11_:Number = param1 - this.var_535 / 2;
         var _loc12_:Number = param2 - this.var_533 / 2;
         var _loc13_:* = null;
         return new RoomSpriteMouseEvent(param5,this._id + "_" + this.var_1843,this._id,param6,_loc11_,_loc12_,param3,param4,param8,param7,param9,param10);
      }
      ...
      private function checkMouseHits(param1:int, param2:int, param3:String, param4:Boolean = false, param5:Boolean = false, param6:Boolean = false, param7:Boolean = false) : Boolean
      {
         ...
         while(_loc14_ >= 0)
         {
            ...
            if(_loc10_ != null && _loc10_.hitTestPoint(param1 - _loc10_.x,param2 - _loc10_.y))
            {
               if(!_loc10_.clickHandling || param3 != MouseEvent.CLICK && param3 != MouseEvent.DOUBLE_CLICK)
               {
                  ...
                  {
                     _loc16_ = _loc10_.tag;
                     _loc13_ = this.var_642.getValue(_loc9_) as ObjectMouseData;
                     if(_loc13_ != null)
                     {
                     ...
                     if(_loc13_ == null)
                     {
                        ...
                        this.var_642.add(_loc9_,_loc13_);
                     }
                     _loc13_.spriteTag = _loc16_;
                     if(param3 != MouseEvent.MOUSE_MOVE || param1 != this.var_2494 || param2 != this.var_2492)
                     {
                        this.bufferMouseEvent(_loc11_,_loc9_);
                     }
                     _loc12_.push(_loc9_);
         ...
         var _loc15_:Array = this.var_642.getKeys();
         _loc14_ = 0;
         ...
         while(_loc14_ < _loc15_.length)
         {
            ...
            if(_loc9_ != null)
            {
               _loc13_ = this.var_642.remove(_loc9_) as ObjectMouseData;
               if(_loc13_ != null)
               {
                  _loc11_ = this.createMouseEvent(0,0,0,0,MouseEvent.ROLL_OUT,_loc13_.spriteTag,param4,param5,param6,param7);
                  this.bufferMouseEvent(_loc11_,_loc9_);
      ...
      {
         if(this.var_377 != null && param1 != null)
         {
            this.var_377.add(param2,param1);
         }
      }
      ...
      private function processMouseEvents() : void
      {
         ...
         var _loc4_:* = null;
         var _loc5_:* = null;
         if(this._container == null || this.var_377 == null)
         {
            return;
         }
         var _loc1_:int = 0;
         ...
         {
            _loc2_ = this.var_377.getKey(_loc1_);
            _loc3_ = this.var_377.getWithIndex(_loc1_);
            if(_loc2_ != null && _loc3_ != null)
            {
               ...
               if(_loc4_ != null)
               {
                  ...
                  {
                     this.var_1497.processRoomCanvasMouseEvent(_loc3_,_loc4_,this.geometry);
                  }
                  else
                  {
      ...
      public function update() : void
      {
         if(this.var_1228 == 0)
         {
            this.checkMouseHits(this.var_534.x,this.var_534.y,MouseEvent.MOUSE_MOVE);
         }
         this.var_1228 = 0;
         ++this.var_1843;
      }
