package com.sulake.room.renderer.cache
{
   ...
   public class RoomObjectLocationCacheItem
   {
      ...
      private var var_427:Vector3d = null;
      ...
      public function getScreenLocation(param1:IRoomObject, param2:IRoomGeometry) : IVector3d
      {
         ...
         if(param2.updateId != this.var_1735 || param1.getUpdateID() != this.var_3013)
         {
            this.var_3013 = param1.getUpdateID();
            if(param2.updateId != this.var_1735 || _loc4_.x != this.var_1403.x || _loc4_.y != this.var_1403.y || _loc4_.z != this.var_1403.z)
            {
               this.var_1735 = param2.updateId;
               this.var_1403.assign(_loc4_);
               _loc3_ = true;
            }
         }
         this.var_3014 = _loc3_;
         if(_loc3_)
         {
            ...
            if(isNaN(_loc6_) || _loc6_ == 0)
            {
               ...
               if(_loc7_.x != _loc4_.x || _loc7_.y != _loc4_.y)
               {
                  ...
                  this.var_427.assign(_loc5_);
                  if(_loc8_ != null)
                  {
                     this.var_427.z = _loc8_.z;
                  }
               }
               else
               {
            ...
            this.var_427.x = Math.round(this.var_427.x);
            this.var_427.y = Math.round(this.var_427.y);
         }
         return this.var_427;
      }
   }
