package com.sulake.habbo.inventory.marketplace
{
   ...
   public class MarketplaceModel implements IInventoryModel
   {
      ...
      {
         if(this.var_27 != null && this.var_27.furniModel != null && this.var_253 != null)
         {
            this.var_27.furniModel.removeLockFrom(this.var_253.id);
            this.var_253 = null;
         }
      }
      ...
      public function getItemStats() : void
      {
         ...
         this.var_2437 = _loc2_;
         this.var_2433 = this.var_253.type;
      ...
      public function proceedOfferMaking(param1:int, param2:int) : void
      {
         ...
         switch(param1)
         {
            ...
            case 3:
               ...
               break;
            case 4:
               this._view.showBuyTokens(this.var_1877,this.var_1876);
         }
      }
      ...
      {
         if(param1 != this.var_2437 || param2 != this.var_2433)
         {
            return;
         }
         if(!this._view)
         ...
         this._view.updateAveragePrice(param3,this.var_2441);
      }
