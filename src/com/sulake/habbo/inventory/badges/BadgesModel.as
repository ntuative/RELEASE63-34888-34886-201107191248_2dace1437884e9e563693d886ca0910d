package com.sulake.habbo.inventory.badges
{
   ...
   public class BadgesModel implements IInventoryModel
   {
      ...
      public static const const_1927:int = -1;
      ...
      private const const_2361:int = 5;
      ...
      public function BadgesModel(param1:HabboInventory, param2:IHabboWindowManager, param3:IHabboCommunicationManager, param4:IAssetLibrary, param5:ISessionDataManager)
      {
         ...
         this.var_379 = param5;
         this.var_379.events.addEventListener(BadgeImageReadyEvent.const_217,this.onBadgeImageReady);
         this._view = new BadgesView(this,param2,param4);
         this.var_652 = [];
         this.var_1250 = new Map();
      }
      ...
      public function dispose() : void
      {
         ...
         {
            this.var_379.events.removeEventListener(BadgeImageReadyEvent.const_217,this.onBadgeImageReady);
            this.var_379 = null;
         }
      }
      ...
      {
         var _loc2_:int = 0;
         while(_loc2_ < this.var_794.length)
         {
            if(this.var_794[_loc2_] == param1)
            {
               this.var_794.splice(_loc2_,1);
      ...
      public function updateBadge(param1:String, param2:Boolean, param3:int = 0) : void
      {
         ...
         if(param3 > 0)
         {
            this.var_1250.add(param1,param3);
         }
         ...
         else
         {
            ...
            _loc10_ = this.var_652.indexOf(param3) != -1;
            _loc11_ = new Badge(param1,_loc7_,_loc10_);
            _loc11_.iconImage = this.var_379.getBadgeImage(param1);
            if(_loc10_)
            {
               this.var_248.unshift(_loc11_);
            }
            else
            {
               this.var_248.push(_loc11_);
            }
            if(param2)
            {
      ...
      public function saveBadgeSelection() : void
      {
         ...
         var _loc2_:Array = this.getBadges(const_333);
         var _loc3_:int = 0;
      ...
      public function setBadgeSelected(param1:String) : void
      {
         ...
         while(_loc2_ < this.var_248.length)
         {
            _loc3_ = this.var_248[_loc2_] as Badge;
            if(_loc3_ != null)
            {
      ...
      public function forceSelection() : void
      {
         ...
         var _loc2_:Array = this.getBadges(const_603);
         ...
         var _loc3_:Array = this.getBadges(const_333);
      ...
      {
         return this.getItemInIndex(param1,const_333);
      }
      
      public function getBadgeFromInactive(param1:int) : Badge
      {
         return this.getItemInIndex(param1,const_603);
      }
      ...
      {
         if(param1 == InventoryCategory.const_209 && this.var_27.isVisible)
         {
      ...
      public function addUnseenBadges(param1:Array) : void
      {
         ...
         {
            if(this.var_652.indexOf(_loc2_) == -1)
            {
               this.var_652.push(_loc2_);
            }
         }
      }
      ...
      public function resetUnseenItems() : void
      {
         ...
         if(this.var_652 && this.var_652.length > 0)
         {
            _loc1_.send(new ResetUnseenItemsComposer(UnseenItemCategoryEnum.const_1282));
            this.var_652 = [];
