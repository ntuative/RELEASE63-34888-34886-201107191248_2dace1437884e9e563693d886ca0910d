package com.sulake.habbo.inventory.items
{
   ...
   public class GroupItem implements IGetImageListener
   {
      ...
      private static const const_1582:int = 13421772;
      
      private static const const_1581:int = 10275685;
      ...
      protected var var_936:int = 0;
      
      protected var var_748:BitmapData;
      ...
      protected var var_3059:BitmapData;
      
      private var var_1585:Boolean;
      
      private const const_2099:Number = 1;
      
      private const const_2100:Number = 0.2;
      ...
      public function GroupItem(param1:int, param2:String, param3:int, param4:IWindowContainer, param5:IRoomEngine, param6:BitmapData, param7:Boolean, param8:String = null, param9:Number = NaN, param10:BitmapData = null, param11:Boolean = false)
      {
         ...
         this.var_2672 = this._window.findChildByName("outline");
      ...
      public function initImage(param1:Boolean = true) : void
      {
         ...
         if(this.var_2264 == FurniModelCategory.const_38)
         {
            _loc2_ = this._roomEngine.getFurnitureIcon(this._type,this,String(this.var_1493));
         }
         else
         {
            _loc2_ = this._roomEngine.getWallItemIcon(this._type,this,this.var_2265);
         }
         if(_loc2_.id > 0)
         {
            if(param1)
      ...
      public function getTotalCount() : int
      {
         ...
         var _loc2_:int = 0;
         var _loc3_:* = null;
         if(this.category == FurniCategory.const_828)
         {
            _loc1_ = 0;
            _loc2_ = 0;
            while(_loc2_ < this._items.length)
      ...
      public function updateThumbData() : void
      {
         ...
         if(_loc1_)
         {
            ...
            if(_loc2_ <= 0)
            {
               this._window.blend = this.const_2100;
               _loc1_.blend = this.const_2100;
            }
            else
            {
               this._window.blend = this.const_2099;
               _loc1_.blend = this.const_2099;
            }
         }
         this.var_1509.color = !!this.var_1585 ? uint(const_1581) : uint(const_1582);
         this.var_2672.visible = this.isSelected;
         ...
         if(_loc5_)
         {
            if(this.var_2266 && this.getRecyclableCount() > 0)
            {
               _loc5_.bitmap = this.var_3059;
               _loc5_.visible = true;
            }
            else
            {
