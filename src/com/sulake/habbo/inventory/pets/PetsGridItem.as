package com.sulake.habbo.inventory.pets
{
   ...
   public class PetsGridItem
   {
      ...
      private function eventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         switch(param1.type)
         {
            case WindowMouseEvent.const_45:
               this.var_1648.setSelectedGridItem(this);
               this.var_1647 = true;
               break;
            ...
            case WindowMouseEvent.const_25:
               ...
               {
                  this.var_1647 = false;
                  this.var_1648.placePetToRoom(this._petData.id,true);
               }
         }
      }
      ...
      public function setSelected(param1:Boolean) : void
      {
         ...
         if(!this._window || !this.var_1509)
         {
            return;
         }
         this.var_1509.color = !!this.var_1566 ? uint(const_1581) : uint(const_1582);
         this.var_2672.visible = param1;
      }
