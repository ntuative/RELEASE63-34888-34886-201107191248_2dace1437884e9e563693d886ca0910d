package com.sulake.habbo.inventory
{
   ...
   public class HabboInventory extends Component implements IHabboInventory
   {
      ...
      private const const_2362:int = 500;
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_67)
         {
            _loc1_ = this.var_67.getKeys();
            _loc2_ = 0;
            while(_loc2_ < _loc1_.length)
            {
               _loc3_ = _loc1_[_loc2_];
               _loc4_ = this.var_67.getValue(_loc3_) as IInventoryModel;
               if(_loc4_ != null)
               {
                  _loc4_.dispose();
               }
         ...
         if(this.var_15 != null)
         {
            this.var_15.events.removeEventListener(RoomSessionEvent.const_71,this.roomSessionEventHandler);
            this.var_15.events.removeEventListener(RoomSessionEvent.const_86,this.roomSessionEventHandler);
            this.var_15.events.removeEventListener(RoomSessionPropertyUpdateEvent.const_546,this.roomSessionEventHandler);
      ...
      public function get furniModel() : FurniModel
      {
         ...
         return FurniModel(this.var_67.getValue(InventoryCategory.const_73));
      }
      ...
      public function get tradingModel() : TradingModel
      {
         ...
         return TradingModel(this.var_67.getValue(InventorySubCategory.const_353));
      }
      ...
      public function get effectsModel() : EffectsModel
      {
         ...
         return EffectsModel(this.var_67.getValue(InventoryCategory.const_147));
      }
      ...
      public function get badgesModel() : BadgesModel
      {
         ...
         return BadgesModel(this.var_67.getValue(InventoryCategory.const_209));
      }
      ...
      public function get recyclerModel() : RecyclerModel
      {
         ...
         return RecyclerModel(this.var_67.getValue(InventorySubCategory.const_1400));
      }
      ...
      public function get petsModel() : PetsModel
      {
         ...
         return PetsModel(this.var_67.getValue(InventoryCategory.const_136));
      }
      ...
      public function get marketplaceModel() : MarketplaceModel
      {
         ...
         return this.var_67.getValue(InventoryCategory.const_441) as MarketplaceModel;
      }
      ...
      {
         return this.var_113.clubDays;
      }
      
      public function get clubPeriods() : int
      {
         return this.var_113.clubPeriods;
      }
      
      public function get clubPastPeriods() : int
      {
         return this.var_113.clubPastPeriods;
      }
      
      public function get clubHasEverBeenMember() : Boolean
      {
         return this.var_113.clubHasEverBeenMember;
      }
      
      public function get clubIsExpiring() : Boolean
      {
         return this.var_113.clubIsExpiring;
      }
      ...
      {
         this.var_113.clubPeriods = param1;
         this.var_113.clubDays = param2;
         this.var_113.clubHasEverBeenMember = param3;
         this.var_113.isVIP = param4;
         this.var_113.clubIsExpiring = param5;
      ...
      private function onRoomSessionManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_15.events.addEventListener(RoomSessionEvent.const_71,this.roomSessionEventHandler);
         this.var_15.events.addEventListener(RoomSessionEvent.const_86,this.roomSessionEventHandler);
         this.var_15.events.addEventListener(RoomSessionPropertyUpdateEvent.const_546,this.roomSessionEventHandler);
         this.initInventory();
      }
      ...
      private function roomSessionEventHandler(param1:RoomSessionEvent) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case RoomSessionEvent.const_86:
               ...
               break;
            case RoomSessionPropertyUpdateEvent.const_546:
               if(this.petsModel != null)
               {
                  this.petsModel.updatePetsAllowed();
               }
      ...
      {
         if(!this._communication || !this._windowManager || !this._localization || !this._roomEngine || !this.var_379 || !this._config || !this._catalog || !this._avatarRenderer || !this.var_15 || !this._toolbar || !this._soundManager)
         {
            return;
         }
         ...
         this.var_67.add(InventoryCategory.const_441,_loc1_);
         ...
         this.var_67.add(InventoryCategory.const_147,_loc4_);
         ...
         this.var_67.add(InventorySubCategory.const_353,_loc5_);
         ...
         this.var_67.add(InventorySubCategory.const_1400,_loc6_);
         ...
         this.var_67.add(InventoryCategory.const_136,_loc7_);
      ...
      {
         var _loc2_:IInventoryModel = IInventoryModel(this.var_67.getValue(param1));
         if(_loc2_ == null)
         {
            return null;
         }
      ...
      public function toggleInventorySubPage(param1:String) : void
      {
         ...
         {
            _loc3_ = this.var_67.getWithIndex(_loc2_) as IInventoryModel;
            _loc3_.subCategorySwitch(param1);
            _loc2_++;
         }
         switch(param1)
         {
            case InventorySubCategory.const_353:
               this._view.toggleCategoryView(InventoryCategory.const_73,false);
         }
      }
      ...
      public function closingInventoryView() : void
      {
         ...
         {
            _loc2_ = this.var_67.getWithIndex(_loc1_) as IInventoryModel;
      ...
      public function setInventoryCategoryInit(param1:String, param2:Boolean = true) : void
      {
         ...
         {
            _loc3_ = this.var_1006.indexOf(param1);
            if(_loc3_ >= 0)
            {
      ...
      {
         var _loc2_:IInventoryModel = this.var_67.getValue(param1) as IInventoryModel;
         if(_loc2_ != null)
         {
            _loc2_.requestInitialization(this.const_2362);
         }
      }
      
      public function notifyChangedEffects() : void
      {
         events.dispatchEvent(new HabboInventoryEffectsEvent(HabboInventoryEffectsEvent.const_264));
      }
      ...
      public function updateUnseenItemCounts() : void
      {
         ...
         if(_loc1_ != this.var_2569)
         {
            this.var_2569 = _loc1_;
