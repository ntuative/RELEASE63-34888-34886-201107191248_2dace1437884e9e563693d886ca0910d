package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniModel extends FurniModelCategory implements IInventoryModel
   {
      ...
      private static const const_1565:int = 1000;
      ...
      private var var_1541:Vector.<Array>;
      ...
      public function FurniModel(param1:HabboInventory, param2:MarketplaceModel, param3:IHabboWindowManager, param4:IHabboCommunicationManager, param5:IAssetLibrary, param6:IRoomEngine, param7:IHabboCatalog, param8:IHabboSoundManager)
      {
         ...
         this.var_449 = [];
         this.var_450 = [];
         this.var_659 = new Timer(const_1566,1);
         this.var_659.addEventListener(TimerEvent.TIMER_COMPLETE,this.onImageUpdateTimerEvent);
         var _loc9_:IAsset = this._assets.getAssetByName("inventory_thumb_xml");
         var _loc10_:XmlAsset = XmlAsset(_loc9_);
         this.var_2609 = XML(_loc10_.content);
         this.clearFurniList();
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            if(this._roomEngine != null)
            {
               ...
               {
                  this._roomEngine.events.removeEventListener(RoomEngineObjectEvent.const_162,this.onObjectPlaced);
               }
            ...
            {
               this.var_659.removeEventListener(TimerEvent.TIMER_COMPLETE,this.onImageUpdateTimerEvent);
               this.var_659.stop();
               this.var_659 = null;
            }
            if(this.var_223 != null)
            {
               this.var_223.removeEventListener(TimerEvent.TIMER_COMPLETE,this.initTimeout);
               this.var_223.stop();
               this.var_223 = null;
            }
      ...
      public function insertFurniList(param1:String, param2:Array, param3:int, param4:int) : void
      {
         ...
         if(param3 >= param4 && param3 > 1)
         {
            if(param1 == const_38)
            {
               ...
               {
                  this.var_1541 = new Vector.<Array>(param3,true);
               }
               _loc15_ = this.var_1541;
            }
            else
            {
         ...
         this.var_27.setInventoryCategoryInit(InventoryCategory.const_73);
      ...
      public function createNewGroupItemTemplate(param1:int, param2:String, param3:int, param4:String = null, param5:Number = NaN, param6:Boolean = false) : GroupItem
      {
         ...
         else if(param3 == FurniCategory.const_379)
         {
         ...
         else if(param3 == FurniCategory.const_378)
         {
         ...
         if(this.var_804 == null)
         {
            this.var_804 = this._windowManager.buildFromXML(this.var_2609) as IWindowContainer;
            _loc12_ = this._assets.getAssetByName("thumb_selected_outline_png") as BitmapDataAsset;
            _loc13_ = this.var_804.findChildByName("outline") as IBitmapWrapperWindow;
            _loc13_.bitmap = _loc12_.content as BitmapData;
            _loc13_.disposesBitmap = false;
         }
         var _loc11_:IWindowContainer = this.var_804.clone() as IWindowContainer;
      ...
      public function initListImages() : void
      {
         ...
         var _loc3_:* = null;
         var _loc6_:int = 0;
         var _loc4_:Array = [const_38,const_46];
         var _loc5_:int = 0;
      ...
      public function requestInitialization(param1:int = 0) : void
      {
         if(param1 > 0)
         {
            ...
            this.var_223 = new Timer(param1,1);
            this.var_223.addEventListener(TimerEvent.TIMER_COMPLETE,this.initTimeout);
            this.var_223.start();
         }
         else
         {
      ...
      {
         if(param1 == InventoryCategory.const_73 && this.var_27.isVisible)
         {
            switch(this._view.visibleCategoryId)
            {
               ...
               case const_46:
                  ...
                  break;
               case const_299:
                  this.var_27.toggleInventoryPage(InventoryCategory.const_136);
            }
         }
      }
      ...
      {
         this.var_27.checkCategoryInitilization(InventoryCategory.const_441);
      ...
      public function updateItemLocks() : void
      {
         ...
         var _loc7_:Array = [const_38,const_46];
         var _loc8_:int = 0;
      ...
      public function addLockTo(param1:int) : void
      {
         ...
         var _loc4_:* = null;
         var _loc7_:int = 0;
         var _loc5_:Array = [const_38,const_46];
         var _loc6_:int = 0;
      ...
      public function clearFurniList() : void
      {
         ...
         this.var_660.add(const_38,new Array());
         this.var_660.add(const_46,new Array());
         if(this._view != null)
         {
      ...
      public function addFurniAt(param1:IItem, param2:Boolean = false, param3:int = -1, param4:Boolean = false) : void
      {
         ...
         {
            _loc6_ = const_38;
            _loc5_ = this.var_449.indexOf(param1.ref) > -1;
         }
         else
         {
            ...
            _loc6_ = const_46;
            _loc5_ = this.var_450.indexOf(param1.ref) > -1;
         }
         ...
         else
         {
            ...
            for(; _loc10_ < _loc8_.length; _loc10_++)
            {
               ...
               if(_loc9_.type == param1.type)
               {
                  if(param1.category != FurniCategory.const_210)
                  {
                     _loc7_ = _loc9_;
                  }
         ...
         if(param4)
         {
            if(this._view.visibleCategoryId == const_299)
            {
      ...
      {
         return getTimer() < this.var_2608 + const_1565;
      }
      ...
      {
         return this.var_27.getSubCategoryViewId() == InventorySubCategory.const_353;
      }
      ...
      public function requestSelectedFurniPlacement(param1:Boolean = false) : Boolean
      {
         ...
         if(_loc3_.category == FurniCategory.const_379 || _loc3_.category == FurniCategory.const_345 || _loc3_.category == FurniCategory.const_378)
         {
            if(param1)
            {
               return false;
      ...
      public function getAllStripIds(param1:String, param2:Array) : void
      {
         ...
         var _loc5_:int = 0;
         var _loc6_:int = 0;
         var _loc3_:Array = this.var_660.getValue(param1) as Array;
         if(_loc3_ != null)
         {
            for each(_loc4_ in _loc3_)
            {
               _loc5_ = _loc4_.getTotalCount();
               if(_loc4_.category == FurniCategory.const_828)
               {
                  _loc5_ = 1;
               }
               _loc6_ = 0;
      ...
      public function addUnseenFloorItems(param1:Array) : void
      {
         ...
         {
            if(this.var_449.indexOf(_loc2_) == -1)
            {
               this.var_449.push(_loc2_);
            }
         }
      }
      ...
      public function addUnseenWallItems(param1:Array) : void
      {
         ...
         for each(_loc2_ in param1)
         {
            if(this.var_450.indexOf(_loc2_) == -1)
            {
               this.var_450.push(_loc2_);
            }
         }
      }
      ...
      public function getUnseenItemCount(param1:int = 0) : int
      {
         switch(param1)
         {
            case UnseenItemCategoryEnum.const_462:
               return this.var_449.length;
            case UnseenItemCategoryEnum.const_394:
               return this.var_450.length;
            default:
               return this.var_449.length + this.var_450.length;
         }
      }
      ...
      public function resetUnseenItems(param1:String = null) : void
      {
         ...
         {
            case const_46:
               if(this.var_450 && this.var_450.length > 0)
               {
               ...
               break;
            case const_38:
               if(this.var_449 && this.var_449.length > 0)
               {
                  _loc2_.send(new ResetUnseenItemsComposer(UnseenItemCategoryEnum.const_462));
                  this.var_449 = [];
                  _loc3_ = this.getCategoryContent(param1);
               }
         }
