package com.sulake.habbo.inventory
{
   ...
   public class InventoryMainView
   {
      ...
      private var var_1831:IWindowContainer;
      
      private const const_2079:Point = new Point(120,150);
      ...
      public function showInventory() : void
      {
         ...
         _loc1_.visible = true;
         this.var_27.inventoryViewOpened(this.var_785);
      }
      ...
      public function updateSubCategoryView() : void
      {
         ...
         this.setSubViewToCategory(this.var_785);
      }
      ...
      private function resetUnseenCounters(param1:String) : void
      {
         switch(param1)
         {
            case InventoryCategory.const_73:
               this.var_27.furniModel.resetUnseenItems();
               break;
            case InventoryCategory.const_136:
               this.var_27.petsModel.resetUnseenItems();
               break;
            case InventoryCategory.const_209:
      ...
      private function setViewToCategory(param1:String) : void
      {
         ...
         _loc2_.container.removeChild(this.var_1832);
         _loc2_.invalidate();
      ...
      private function onHabboToolbarEvent(param1:HabboToolbarEvent) : void
      {
         ...
         {
            if(this.var_376 == InventoryCategory.const_136)
            {
               this.toggleCategoryView(InventoryCategory.const_136);
            }
            else if(this.var_376 == InventoryCategory.const_73)
            {
               this.toggleCategoryView(InventoryCategory.const_73);
            }
            else if(this.var_27 != null)
            {
               this.var_27.toggleInventoryPage(InventoryCategory.const_73);
            }
         }
      }
      ...
      private function updateUnseenBadgeCount() : void
      {
         if(!this.var_1831)
         {
            this.var_1831 = this.createCounter("badges");
         }
         var _loc1_:int = this.var_27.badgesModel.getUnseenItemCount();
         this.updateCounter(this.var_1831,_loc1_);
