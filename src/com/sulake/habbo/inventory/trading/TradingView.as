package com.sulake.habbo.inventory.trading
{
   ...
   public class TradingView implements IInventoryView, IGetImageListener
   {
      ...
      private static const const_1111:uint = 4284532064;
      
      private static const const_1110:uint = 2577770;
      ...
      private var var_689:ItemPopupCtrl;
      ...
      private var var_1058:GroupItem;
      ...
      public function TradingView(param1:TradingModel, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IRoomEngine, param5:IHabboLocalizationManager, param6:IHabboSoundManager)
      {
         ...
         this.var_689 = new ItemPopupCtrl(_loc9_,this._assetLibrary);
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            if(this.var_226)
            {
               this.var_226.removeEventListener(TimerEvent.TIMER,this.timerEventHandler);
               this.var_226.stop();
               this.var_226 = null;
            }
      ...
      public function getWindowContainer() : IWindowContainer
      {
         ...
         {
            this.var_2020 = this.createMinimizedWindow();
         }
         if(!this.var_1156)
         {
            return this.var_80;
      ...
      public function updateUserInterface() : void
      {
         ...
         if(this.var_80)
         {
            ...
            if(_loc1_)
            {
               _loc1_.color = !!this.var_19.ownUserAccepts ? uint(const_1111) : uint(const_1110);
            }
            ...
            if(_loc1_)
            {
               _loc1_.color = !!this.var_19.otherUserAccepts ? uint(const_1111) : uint(const_1110);
            }
      ...
      public function startConfirmCountdown() : void
      {
         ...
         {
            this.var_226 = new Timer(1000,3);
            this.var_226.addEventListener(TimerEvent.TIMER,this.timerEventHandler);
         }
         this.var_226.reset();
         this.var_226.repeatCount = 3;
         this.var_226.start();
      ...
      {
         this._windowManager.registerLocalizationParameter("inventory.trading.countdown","counter",String(3 - this.var_226.currentCount));
         if(this.var_226.currentCount == 3)
         {
      ...
      public function removeSelection() : void
      {
         if(this.var_1058)
         {
            this.var_1058.isSelected = false;
            this.var_1058 = null;
         }
      }
      ...
      private function thumbEventProc(param1:WindowEvent, param2:IWindow, param3:Boolean) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER)
         {
            ...
            if(_loc5_.category == FurniCategory.const_1853)
            {
            ...
            this.var_689.updateContent(param2 as IWindowContainer,_loc7_,_loc6_,ItemPopupCtrl.const_638);
            this.var_689.show();
         }
         else if(param1.type == WindowMouseEvent.const_25)
         {
            this.var_689.hideDelayed();
         }
      }
         ...
         if(this.var_208.length > 0)
         {
            ...
            if(_loc5_.extra == param1.id)
            {
               if(_loc2_ && this.var_19.ownUserItems.getWithIndex(_loc4_) == _loc3_ || !_loc2_ && this.var_19.otherUserItems.getWithIndex(_loc4_) == _loc3_)
               {
                  ...
                  this.var_689.updateContent(_loc8_ as IWindowContainer,_loc6_,_loc7_,ItemPopupCtrl.const_638);
               }
            }
            else
            {
