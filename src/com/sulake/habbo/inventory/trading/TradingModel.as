package com.sulake.habbo.inventory.trading
{
   ...
   public class TradingModel implements IInventoryModel, IGetImageListener
   {
      ...
      public static const const_1774:uint = 9;
      
      public static const const_218:uint = 0;
      
      public static const const_211:uint = 1;
      
      public static const const_401:uint = 2;
      
      public static const const_344:uint = 3;
      
      public static const const_531:uint = 4;
      ...
      public function startTrading(param1:int, param2:String, param3:Boolean, param4:int, param5:String, param6:Boolean) : void
      {
         ...
         this.var_925 = false;
         this.var_3037 = param3;
         this.var_1700 = param4;
         this.var_3036 = param5;
         ...
         this.var_61.updateItemList(this.var_924);
         this.var_61.updateItemList(this.var_1700);
         this.var_61.updateUserInterface();
         this.var_61.method_12();
      ...
      public function close() : void
      {
         if(this.var_902)
         {
            if(this._state != const_218 && this._state != const_274)
            {
      ...
      {
         this.var_61.setMinimized(param1 != InventoryCategory.const_73);
         this.var_12.updateSubView();
      }
      
      public function set state(param1:uint) : void
      {
         Logger.log("OLD STATE: " + this._state + " NEW STATE: " + param1 + " OWN: " + this.var_925 + " OTHER: " + this.var_1407);
         ...
         {
            case const_218:
               if(param1 == const_211 || param1 == const_274)
               {
                  this._state = param1;
                  _loc2_ = true;
               }
      ...
      public function getOwnItemIdsInTrade() : Array
      {
         ...
         var _loc4_:int = 0;
         while(_loc4_ < this.var_312.length)
         {
            _loc2_ = this.var_312.getWithIndex(_loc4_) as GroupItem;
            if(_loc2_ != null)
            {
               _loc5_ = 0;
      ...
      public function handleMessageEvent(param1:IMessageEvent) : void
      {
         ...
         if(param1 is TradingAlreadyOpenEvent)
         {
            ...
            this.var_61.alertPopup(TradingView.const_1303);
         }
         else if(param1 is TradingAcceptEvent)
         {
            Logger.log("TRADING::TradingAcceptEvent");
            if(TradingAcceptEvent(param1).userID == this.var_924)
            {
               this.var_925 = TradingAcceptEvent(param1).userAccepts != 0;
            }
            else
            {
               this.var_1407 = TradingAcceptEvent(param1).userAccepts != 0;
            }
            this.var_61.updateUserInterface();
         }
         ...
         else if(param1 is TradingCloseEvent)
         {
            ...
            if(_loc2_.userID != this.var_924)
            {
               this.var_61.alertPopup(TradingView.const_1334);
            }
            this.close();
         }
      ...
      public function requestAddItemToTrading(param1:int, param2:int, param3:int, param4:Boolean, param5:String = "") : Boolean
      {
         ...
         if(this.var_312.length < const_1774)
         {
         ...
         else
         {
            ...
            if(param3 == FurniCategory.const_210)
            {
               _loc6_ = String(param2) + "poster" + param5;
            }
            if(this.var_312.getValue(_loc6_) == null)
            {
               return false;
            }
            this._communication.getHabboMainConnection(null).send(new AddItemToTradeComposer(param1));
