package com.sulake.habbo.ui.widget.memenu
{
   ...
   public class MeMenuSoundSettingsView implements IMeMenuView
   {
      ...
      private var var_1001:MeMenuSoundSettingsSlider;
      ...
      public function updateSettings(param1:RoomWidgetSettingsUpdateEvent) : void
      {
         ...
         if(this.var_1001 != null)
         {
            this.var_1001.setValue(this.var_996);
         }
      ...
      private function createWindow(param1:String) : void
      {
         ...
         if(_loc5_ != null && _loc5_.content != null)
         {
            this.var_997 = (_loc5_.content as BitmapData).clone();
         }
         this.var_1001 = new MeMenuSoundSettingsSlider(this,this._window.findChildByName("volume_container") as IWindowContainer,this._widget.assets,0,1);
         this.updateSoundIcons();
         ...
         this._widget.messageListener.processWidgetMessage(new RoomWidgetGetSettingsMessage(RoomWidgetGetSettingsMessage.const_861));
      }
      ...
      private function updateSoundIcons() : void
      {
         if(this.var_996 == 0)
         {
            this.setBitmapWrapperContent("sounds_on_icon",this.var_997);
            this.setBitmapWrapperContent("sounds_off_icon",this.var_998);
         }
         else
         {
            this.setBitmapWrapperContent("sounds_on_icon",this.var_1000);
      ...
      public function saveVolume(param1:Number, param2:Boolean = true) : void
      {
         ...
         if(param2)
         {
            _loc3_ = new RoomWidgetStoreSettingsMessage(RoomWidgetStoreSettingsMessage.const_1022);
         }
         else
         {
            _loc3_ = new RoomWidgetStoreSettingsMessage(RoomWidgetStoreSettingsMessage.const_963);
         }
