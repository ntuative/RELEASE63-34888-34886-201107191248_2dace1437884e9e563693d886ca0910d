package com.sulake.habbo.ui.widget.infostand
{
   ...
   public class InfoStandUserView
   {
      ...
      protected var var_108:IWindowContainer;
      
      private var var_48:IBorderWindow;
      
      private var var_1049:TagListRenderer;
      
      private var var_155:IBorderWindow;
      
      private var var_2460:int;
      
      private var var_2461:Boolean = true;
      
      private const const_1071:int = 5;
      
      private const const_2350:int = 3;
      
      private const const_1524:int = 11184810;
      
      private const const_1523:int = 16777215;
      ...
      public function InfoStandUserView(param1:InfostandWidget, param2:String)
      {
         ...
         this.var_1049 = new TagListRenderer(param1,this.onTagSelected);
         this.var_2461 = !this._widget.config.getBoolean("menu.avatar.enabled",false);
      }
      ...
      protected function createWindow(param1:String, param2:Boolean) : void
      {
         ...
         var _loc3_:* = [];
         this.var_108.groupChildrenWithTag("CMD_BUTTON",_loc3_,true);
         ...
         var _loc5_:IBitmapWrapperWindow = this.var_48.findChildByName("home_icon") as IBitmapWrapperWindow;
         ...
         var _loc6_:IWindow = this.var_48.findChildByTag("close");
         if(_loc6_ != null)
         {
         ...
         while(_loc8_ < 5)
         {
            _loc7_ = this.var_48.findChildByName("badge_" + _loc8_);
            if(_loc7_ != null)
            {
         ...
         _loc7_ = this.var_48.findChildByName("badge_group");
      ...
      private function showGroupBadgeInfo(param1:WindowMouseEvent) : void
      {
         ...
         _loc3_ = this.var_155.getChildByName("name") as ITextWindow;
         if(_loc3_ != null)
         {
            _loc3_.text = "Group Info";
         }
         _loc4_ = this.var_155.getChildByName("description") as ITextWindow;
         if(_loc4_ != null)
         {
         ...
         this.var_155.x = _loc5_.left - this.var_155.width;
         this.var_155.y = _loc5_.top + (_loc5_.height - this.var_155.height) / 2;
      }
      ...
      private function showBadgeInfo(param1:WindowMouseEvent) : void
      {
         ...
         this.createBadgeDetails();
         _loc6_ = this.var_155.getChildByName("name") as ITextWindow;
         if(_loc6_ != null)
         {
            _loc6_.text = this._widget.localizations.getBadgeName(_loc5_);
         }
         _loc6_ = this.var_155.getChildByName("description") as ITextWindow;
         if(_loc6_ != null)
         {
         ...
         this.var_155.x = _loc7_.left - this.var_155.width;
         this.var_155.y = _loc7_.top + (_loc7_.height - this.var_155.height) / 2;
      }
      ...
      private function createBadgeDetails() : void
      {
         ...
         this.var_155 = this._widget.windowManager.buildFromXML(_loc1_.content as XML) as IBorderWindow;
         if(this.var_155 == null)
         {
            throw new Error("Failed to construct window from XML!");
         }
      ...
      public function set realName(param1:String) : void
      {
         ...
         _loc2_.height = _loc2_.textHeight + this.const_1071;
      ...
      public function setMotto(param1:String, param2:Boolean) : void
      {
         ...
         if(param2)
         {
            ...
            if(param1 == "")
            {
               ...
               _loc5_.textColor = this.const_1524;
            }
            else
            {
               _loc5_.textColor = this.const_1523;
            }
            _loc5_.enable();
         }
         else
         ...
         _loc5_.text = param1;
         _loc5_.height = Math.min(_loc5_.textHeight + this.const_1071,this.const_2351);
         _loc5_.height = Math.max(_loc5_.height,this.const_2352);
         _loc3_.height = _loc5_.height + this.const_2350;
         if(param2)
         {
            _loc5_.addEventListener(WindowKeyboardEvent.const_321,this.onMottoKeyboard);
            _loc5_.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onMottoClicked);
         }
         else
         {
            _loc5_.removeEventListener(WindowKeyboardEvent.const_321,this.onMottoClicked);
         }
         this.updateWindow();
      }
      ...
      public function setTags(param1:Array, param2:Array = null) : void
      {
         ...
         if(param1.length != 0)
         {
            _loc3_.height = this.var_1049.renderTags(param1,_loc3_,param2);
            _loc4_.height = 1;
         }
         else
         {
      ...
      protected function updateInfo(param1:RoomWidgetUserInfoUpdateEvent) : void
      {
         ...
         this.setMotto(param1.motto,param1.type == RoomWidgetUserInfoUpdateEvent.const_109);
      ...
      private function enableButton(param1:String, param2:Boolean = true) : void
      {
         ...
         var _loc3_:IRegionWindow = this.var_108.getChildByName(param1) as IRegionWindow;
      ...
      protected function setTradeButtonTooltip(param1:int) : void
      {
         ...
         switch(param1)
         {
            case RoomWidgetUserInfoUpdateEvent.const_905:
               _loc2_ = "${infostand.button.trade.tooltip.shutdown}";
               break;
            case RoomWidgetUserInfoUpdateEvent.const_840:
      ...
      protected function onMottoKeyboard(param1:WindowKeyboardEvent) : void
      {
         ...
         {
            _loc6_ = getTimer();
            if(_loc6_ - this.var_2460 > this.const_2353 && _loc4_ != this._widget.localizations.getKey("infostand.motto.change"))
            {
               ...
               this.var_2460 = _loc6_;
               _loc3_.textColor = this.const_1523;
            }
         }
         else
         {
            _loc3_.textColor = this.const_1524;
         }
      }
