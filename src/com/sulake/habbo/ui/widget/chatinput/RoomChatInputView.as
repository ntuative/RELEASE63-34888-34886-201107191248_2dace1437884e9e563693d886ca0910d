package com.sulake.habbo.ui.widget.chatinput
{
   ...
   public class RoomChatInputView
   {
      ...
      private static const const_1612:int = 250;
      
      private static const const_1613:int = 0;
      
      private static const BOTTOM_MARGIN:int = 55;
      
      private static const const_1614:String = "${widgets.chatinput.say}";
      ...
      private var var_2015:IWindow;
      
      private var _button:IWindow;
      
      private var var_2016:IWindow;
      ...
      public function RoomChatInputView(param1:RoomChatInputWidget)
      {
         super();
         this._widget = param1;
         this.var_1303 = param1.localizations.getKey("widgets.chatinput.mode.whisper",":tell");
         this.var_2744 = param1.localizations.getKey("widgets.chatinput.mode.shout",":shout");
         this.var_2745 = param1.localizations.getKey("widgets.chatinput.mode.speak",":speak");
         this.var_398 = new Timer(1000,1);
         this.var_398.addEventListener(TimerEvent.TIMER_COMPLETE,this.onTypingTimerComplete);
         this.var_461 = new Timer(10000,1);
         this.var_461.addEventListener(TimerEvent.TIMER_COMPLETE,this.onIdleTimerComplete);
         this.createWindow();
      }
      ...
      public function dispose() : void
      {
         ...
         {
            this.var_461.reset();
            this.var_461.removeEventListener(TimerEvent.TIMER_COMPLETE,this.onIdleTimerComplete);
            this.var_461 = null;
         }
      }
      ...
      private function createWindow() : void
      {
         ...
         this.var_2015 = this._window.findChildByName("input_border");
         this._button = this._window.findChildByName("send_button");
         this.var_2016 = this._window.findChildByName("send_button_text");
         this.var_1588 = this._window.findChildByName("block_text");
         this.var_2016.caption = const_1614;
         ...
         this.var_26.addEventListener(WindowKeyboardEvent.const_190,this.windowKeyEventProcessor);
         this.var_26.addEventListener(WindowKeyboardEvent.const_321,this.keyUpHandler);
         ...
         this.var_1589 = true;
         this.var_686 = "";
         this._window.addEventListener(WindowEvent.const_640,this.updatePosition);
      ...
      private function updatePosition(param1:WindowEvent = null) : void
      {
         ...
         var _loc4_:int = (this._window.desktop.width - this.var_2015.width) / 2 - _loc3_;
         var _loc5_:int = this._window.desktop.width - this._window.width - const_1612 - _loc3_;
         this._window.x = Math.max(Math.min(_loc4_,_loc5_),const_1613);
      }
      ...
      private function windowKeyEventProcessor(param1:WindowEvent = null, param2:IWindow = null) : void
      {
         ...
         if(_loc3_ == Keyboard.BACKSPACE)
         {
            if(this.var_26 != null)
            {
               ...
               _loc8_ = _loc7_.split(" ");
               if(_loc8_[0] == this.var_1303 && _loc8_.length == 3 && _loc8_[2] == "")
               {
                  this.var_26.text = "";
                  this.var_686 = "";
               }
      ...
      private function onInputChanged(param1:WindowEvent) : void
      {
         ...
         {
            if(_loc2_.text.length > this.var_686.length + 1)
            {
      ...
      private function sendTypingMessage() : void
      {
         ...
         var _loc1_:RoomWidgetChatTypingMessage = new RoomWidgetChatTypingMessage(this.var_685);
      ...
      private function sendChatFromInputField(param1:Boolean = false) : void
      {
         ...
         var _loc2_:int = !!param1 ? 0 : int(RoomWidgetChatMessage.const_139);
