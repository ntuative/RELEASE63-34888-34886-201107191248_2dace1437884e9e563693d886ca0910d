package com.sulake.habbo.ui.widget.playlisteditor
{
   ...
   public class PlayListStatusView
   {
      ...
      public static const const_763:String = "PLSV_ADD_SONGS";
      
      public static const const_1184:String = "PLSV_START_PLAYBACK";
      
      public static const const_554:String = "PLSV_NOW_PLAYING";
      ...
      {
         if(this.var_53 != const_554)
         {
            return;
         }
         var _loc2_:IWindowContainer = this.var_502[this.var_53];
      ...
      public function set addSongsBackgroundImage(param1:BitmapData) : void
      {
         ...
         var _loc2_:IWindowContainer = this.var_502[const_763];
         if(_loc2_ == null)
         {
            return;
         }
      ...
      private function createWindows() : void
      {
         ...
         if(_loc1_ != null)
         {
            this.var_502.add(const_554,_loc1_);
