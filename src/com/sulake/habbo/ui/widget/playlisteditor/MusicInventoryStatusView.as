package com.sulake.habbo.ui.widget.playlisteditor
{
   ...
   public class MusicInventoryStatusView
   {
      ...
      public static const const_989:String = "MISV_BUY_MORE";
      
      public static const const_966:String = "MISV_PREVIEW_PLAYING";
      ...
      private var var_53:String;
      
      private var var_2001:ITextWindow;
      
      private var var_2000:ITextWindow;
      ...
      {
         var _loc1_:* = null;
         for each(_loc1_ in this.var_502.getValues())
         {
            _loc1_.destroy();
         }
         this.var_502 = null;
      ...
      public function selectView(param1:String) : void
      {
         ...
         this._container.addChildAt(this.var_502[param1] as IWindowContainer,0);
         this.var_53 = param1;
      }
      ...
      public function set authorName(param1:String) : void
      {
         ...
         this.var_2000.text = param1;
      }
      
      public function setPreviewPlayingBackgroundImage(param1:BitmapData, param2:Boolean = true) : void
      {
         this.blitBackgroundImage(const_966,"preview_play_background_image",param1);
      ...
      {
         this.blitBackgroundImage(const_989,"get_more_music_background_image",param1);
         if(param2 && param1 != null)
         {
            param1.dispose();
         }
      ...
      private function createWindows() : void
      {
         ...
         if(_loc1_ != null)
         {
            this.var_502.add(const_966,_loc1_);
            this.var_2001 = _loc1_.getChildByName("preview_play_track_name") as ITextWindow;
            this.var_2000 = _loc1_.getChildByName("preview_play_author_name") as ITextWindow;
            ...
            this.setPreviewPlayingBackgroundImage(this._widget.getImageGalleryAssetBitmap(PlayListEditorWidgetAssetsEnum.const_548));
         ...
         if(_loc1_ != null)
         {
            this.var_502.add(const_989,_loc1_);
            ...
            this.setGetMoreMusicBackgroundImage(this._widget.getImageGalleryAssetBitmap(PlayListEditorWidgetAssetsEnum.const_538));
         }
      }
      ...
      {
         var _loc6_:* = null;
         var _loc4_:IWindowContainer = this.var_502[param1] as IWindowContainer;
         if(_loc4_ == null)
         {
            return;
         }
