   ...
   public class MusicInventoryGridView
   {
      ...
      public function refresh() : void
      {
         ...
         while(_loc5_ < _loc4_)
         {
            ...
            this.var_714.addGridItem(_loc12_.window);
      ...
      public function setPreviewIconToPause() : void
      {
         ...
         {
            this.var_118.playButtonState = MusicInventoryGridItem.const_1177;
         }
      }
      ...
      public function setPreviewIconToPlay() : void
      {
         if(this.var_118 != null)
         {
            this.var_118.playButtonState = MusicInventoryGridItem.const_576;
         }
      }
      ...
      private function gridItemEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK || _loc3_)
         {
            ...
            {
               if(this.var_118.playButtonState == MusicInventoryGridItem.const_576)
               {
                  this.var_118.playButtonState = MusicInventoryGridItem.const_1350;
