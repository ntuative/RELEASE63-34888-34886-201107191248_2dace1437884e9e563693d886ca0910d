package com.sulake.habbo.ui.widget.avatarinfo
{
   ...
   public class AvatarInfoWidget extends RoomWidgetBase implements IUpdateReceiver
   {
      ...
      private static const const_1135:String = "use_minimized_own_avatar_menu";
      ...
      private var var_260:AvatarInfoData;
      ...
      private var var_3094:Boolean;
      
      private var var_881:AvatarInfoView;
      
      private var var_880:OwnAvatarMenuView;
      
      private var var_879:AvatarMenuView;
      ...
      public function AvatarInfoWidget(param1:IRoomWidgetHandler, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboConfigurationManager, param5:IHabboLocalizationManager, param6:Component)
      {
         ...
         this.var_22 = param6;
         this.var_131 = param4;
         this.var_260 = new AvatarInfoData();
         this.var_2836 = Boolean(this.var_131.getBoolean("menu.avatar.enabled",false));
         this.var_2078 = this.var_131.getBoolean("menu.own_avatar.enabled",false);
         this.var_411 = new Map();
         this.handler.roomEngine.events.addEventListener(RoomEngineObjectEvent.const_198,this.onRoomObjectAdded);
         this.handler.roomEngine.events.addEventListener(RoomEngineObjectEvent.const_402,this.onRoomObjectRemoved);
         this.handler.container.inventory.events.addEventListener(HabboInventoryEffectsEvent.const_264,this.onEffectsChanged);
         this.handler.widget = this;
      }
      
      public function get handler() : AvatarInfoWidgetHandler
      {
         return var_933 as AvatarInfoWidgetHandler;
      }
      ...
      {
         messageListener.processWidgetMessage(new RoomWidgetRoomObjectMessage(RoomWidgetRoomObjectMessage.const_854,0,0));
      }
      ...
      override public function dispose() : void
      {
         ...
         this.handler.roomEngine.events.removeEventListener(RoomEngineObjectEvent.const_198,this.onRoomObjectAdded);
         this.handler.roomEngine.events.removeEventListener(RoomEngineObjectEvent.const_402,this.onRoomObjectRemoved);
         this.handler.container.inventory.events.removeEventListener(HabboInventoryEffectsEvent.const_264,this.onEffectsChanged);
         this._view = null;
         this.var_131 = null;
         super.dispose();
      }
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetFurniInfoUpdateEvent.const_334,this.updateEventHandler);
         param1.addEventListener(RoomWidgetUserInfoUpdateEvent.BOT,this.updateEventHandler);
         param1.addEventListener(RoomWidgetPetInfoUpdateEvent.const_108,this.updateEventHandler);
         param1.addEventListener(RoomWidgetUserDataUpdateEvent.const_124,this.updateEventHandler);
         ...
         param1.addEventListener(RoomWidgetRoomObjectNameEvent.const_502,this.updateEventHandler);
         param1.addEventListener(RoomWidgetRoomObjectUpdateEvent.const_1015,this.updateEventHandler);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetFurniInfoUpdateEvent.const_334,this.updateEventHandler);
         param1.removeEventListener(RoomWidgetUserInfoUpdateEvent.BOT,this.updateEventHandler);
         param1.removeEventListener(RoomWidgetPetInfoUpdateEvent.const_108,this.updateEventHandler);
         param1.removeEventListener(RoomWidgetUserDataUpdateEvent.const_124,this.updateEventHandler);
         ...
         param1.removeEventListener(RoomWidgetRoomObjectNameEvent.const_502,this.updateEventHandler);
      ...
      private function updateEventHandler(param1:RoomWidgetUpdateEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetAvatarInfoEvent.const_128:
               ...
               if(this.var_2078 && _loc2_.allowNameChange)
               {
               ...
               break;
            case RoomWidgetRoomObjectNameEvent.const_502:
            ...
            case RoomWidgetFurniInfoUpdateEvent.const_334:
               if(this._view)
               {
                  this.removeView(this._view,false);
               }
               break;
            case RoomWidgetRoomObjectUpdateEvent.const_1015:
               if(!(this._view is AvatarMenuView || this._view is OwnAvatarMenuView))
               {
                  this.var_2077 = RoomWidgetRoomObjectUpdateEvent(param1).id;
                  messageListener.processWidgetMessage(new RoomWidgetRoomObjectMessage(RoomWidgetRoomObjectMessage.const_1030,RoomWidgetRoomObjectUpdateEvent(param1).id,RoomWidgetRoomObjectUpdateEvent(param1).category));
               }
               break;
            case RoomWidgetRoomObjectUpdateEvent.const_406:
               if(!(this._view is AvatarMenuView || this._view is OwnAvatarMenuView))
               {
                  if(RoomWidgetRoomObjectUpdateEvent(param1).id == this.var_2077)
                  {
            ...
            case RoomWidgetUserInfoUpdateEvent.const_151:
               ...
               this.updateView(_loc3_.webID,_loc3_.name,_loc3_.userRoomId,RoomObjectTypeEnum.const_132,false,!!_loc3_.isSpectatorMode ? null : this.var_260);
               break;
            case RoomWidgetUserInfoUpdateEvent.BOT:
               _loc4_ = param1 as RoomWidgetUserInfoUpdateEvent;
               this.updateView(_loc4_.webID,_loc4_.name,_loc4_.userRoomId,RoomObjectTypeEnum.const_666,false,null);
               break;
            case RoomWidgetPetInfoUpdateEvent.const_108:
               if(this.var_2079)
               {
                  _loc6_ = param1 as RoomWidgetPetInfoUpdateEvent;
                  this.updateView(_loc6_.id,_loc6_.name,_loc6_.roomIndex,RoomObjectTypeEnum.const_230,false,null);
               }
               break;
            case RoomWidgetUserDataUpdateEvent.const_124:
            ...
            case RoomWidgetRoomObjectUpdateEvent.const_184:
               ...
               for each(_loc7_ in this.var_411)
               {
      ...
      public function selectOwnAvatar() : void
      {
         ...
         _loc3_ = new RoomWidgetRoomObjectMessage(RoomWidgetRoomObjectMessage.const_350,_loc2_.id,RoomObjectCategoryEnum.const_29);
      ...
      {
         this.var_260.amIAnyRoomController = param1.amIAnyRoomController;
         this.var_260.amIController = param1.amIController;
         this.var_260.amIOwner = param1.amIOwner;
         this.var_260.canBeAskedAsFriend = param1.canBeAskedAsFriend;
         this.var_260.canBeKicked = param1.canBeKicked;
         this.var_260.canTrade = param1.canTrade;
         this.var_260.canTradeReason = param1.canTradeReason;
         this.var_260.hasFlatControl = param1.hasFlatControl;
         this.var_260.isIgnored = param1.isIgnored;
         this.var_260.respectLeft = param1.respectLeft;
         this.var_260.isOwnUser = param1.type == RoomWidgetUserInfoUpdateEvent.const_109;
         this.var_260.allowNameChange = param1.allowNameChange;
      }
      ...
      private function updateView(param1:int, param2:String, param3:int, param4:int, param5:Boolean, param6:AvatarInfoData) : void
      {
         ...
         if(param6)
         {
            _loc7_ = !!param6.isOwnUser ? Boolean(this.var_2078) : Boolean(this.var_2836);
         }
            ...
            if(!this.var_1828)
            {
               if(_loc7_)
               {
                  if(param6.isOwnUser)
                  {
                     if(!this.var_880)
                     {
                        this.var_880 = new OwnAvatarMenuView(this);
                     }
                     this._view = this.var_880;
                  ...
                  else
                  {
                     if(!this.var_879)
                     {
                        this.var_879 = new AvatarMenuView(this);
                     }
                     this._view = this.var_879;
                     AvatarMenuView.setup(this._view as AvatarMenuView,param1,param2,param3,param4,param6);
                     for each(_loc8_ in this.var_411)
                     {
               ...
               else
               {
                  if(!this.var_881)
                  {
                     this.var_881 = new AvatarInfoView(this);
                  }
                  this._view = this.var_881;
      ...
      public function removeView(param1:AvatarInfoView, param2:Boolean) : void
      {
         if(param1)
         {
            ...
            {
               this.var_411.remove(param1.userName);
               param1.dispose();
               this.checkUpdateNeed();
            }
         }
      ...
      public function checkUpdateNeed() : void
      {
         ...
         if(this._view || this.var_411.length > 0)
         {
      ...
      {
         this.handler.container.avatarEditor.openEditor(AvatarEditorInstanceId.const_222,null,null,true);
         this.handler.container.avatarEditor.loadOwnAvatarInEditor(AvatarEditorInstanceId.const_222);
      }
      ...
      {
         return this.handler.container.config.getBoolean(const_1135,true);
      }
      
      public function set useMinimizedOwnAvatarMenu(param1:Boolean) : void
      {
         this.handler.container.config.setKey(const_1135,!!param1 ? "1" : "0");
      }
   }
}
