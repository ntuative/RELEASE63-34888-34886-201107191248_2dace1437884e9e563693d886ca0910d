package com.sulake.habbo.ui.widget.avatarinfo
{
   ...
   public class AvatarInfoView implements IDisposable
   {
      ...
      protected static const const_1418:uint = 4281149991;
      
      protected static const const_1037:uint = 4282950861;
      
      protected static const const_2052:uint = 4288230144;
      
      protected static const const_1419:uint = 16777215;
      
      protected static const const_1417:uint = 9552639;
      
      protected static const const_2051:uint = 16777215;
      
      protected static const const_2050:uint = 5789011;
      
      protected static const const_2049:uint = 13947341;
      
      protected static const const_2048:uint = 5789011;
      
      private static const const_1567:int = 25;
      ...
      protected var var_2388:int;
      
      protected var var_1757:Boolean;
      
      protected var var_2256:FixedSizeStack;
      
      protected var var_2254:int = -1000000;
      
      protected var _disposed:Boolean;
      
      protected var var_509:Timer;
      
      protected var var_3048:int = 3000;
      ...
      protected var var_3049:int = 500;
      
      protected var var_1147:Boolean;
      
      public function AvatarInfoView(param1:AvatarInfoWidget)
      {
         this.var_2256 = new FixedSizeStack(const_1567);
         super();
         this._widget = param1;
         this.var_1147 = true;
         this.var_1711 = false;
      ...
      public static function setup(param1:AvatarInfoView, param2:int, param3:String, param4:int, param5:int, param6:Boolean = false) : void
      {
         ...
         if(param1.var_1147)
         {
            if(!param1.var_509)
            {
               param1.var_509 = new Timer(param1.var_3048,1);
      ...
      {
         this._widget.messageListener.processWidgetMessage(new RoomWidgetUserActionMessage(RoomWidgetUserActionMessage.const_597));
      ...
      public function update(param1:Rectangle, param2:Point, param3:uint) : void
      {
         ...
         if(this.var_1710)
         {
            ...
            this._blend = 1 - this.var_1709 / Number(this.var_3049);
         }
         else
         {
            this._blend = 1;
         ...
         if(!this.var_1757 || this.var_1916)
         {
            _loc4_ = -this.var_192.height;
            if(this.var_1708 == RoomObjectTypeEnum.const_132 || this.var_1708 == RoomObjectTypeEnum.const_666)
            {
            ...
            if(_loc6_ < this.var_2254 - const_1093)
            {
               _loc6_ = this.var_2254 - const_1093;
            }
            _loc7_ = param2.y - _loc6_;
            this.var_2254 = _loc6_;
