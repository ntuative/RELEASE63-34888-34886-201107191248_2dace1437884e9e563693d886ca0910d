package com.sulake.habbo.ui.widget.furniture.welcomegift
{
   ...
   public class WelcomeGiftWidget extends RoomWidgetBase
   {
      ...
      private const const_701:String = "welcome_gift_email_unverified";
      
      private const const_1080:String = "welcome_gift_email_verified";
      
      private const const_1545:String = "welcome_gift_email_change";
      
      private const const_2358:int = 4;
      ...
      private function createMainView() : void
      {
         ...
         if(this.var_1248)
         {
            this.setViewState(this.const_1080);
         }
         else
         {
            this.setViewState(this.const_701);
         }
      }
      ...
      private function setViewState(param1:String) : void
      {
         ...
         switch(param1)
         {
            case this.const_701:
               ...
               this._view.findChildByName("edit_text").visible = this.var_1002;
               this._view.findChildByName("edit").setParamFlag(WindowParam.const_30,this.var_1002);
               break;
            case this.const_1080:
            ...
            case this.const_1545:
               ...
               this.setBitmap("email_icon","email_icon");
               this.setButtonState("save_email",this.var_1002);
               _loc6_ = this._view.findChildByName("email_input") as ITextFieldWindow;
               _loc6_.caption = this.var_1508;
               _loc6_.focus();
      ...
      {
         this.setViewState(this.const_1545);
      }
      
      private function openGift(param1:WindowMouseEvent) : void
      {
         messageListener.processWidgetMessage(new RoomWidgetFurniActionMessage(RoomWidgetFurniActionMessage.const_740,this._furniId,0));
         this.disposeView();
      }
      
      private function cancelEmailChange(param1:WindowMouseEvent) : void
      {
         this.setViewState(!!this.var_1248 ? this.const_1080 : this.const_701);
      }
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetWelcomeGiftUpdateEvent.const_587,this.updateEventHandler);
         param1.addEventListener(RoomWidgetChangeEmailResultEvent.const_882,this.emailChangeHandler);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetWelcomeGiftUpdateEvent.const_587,this.updateEventHandler);
         param1.removeEventListener(RoomWidgetChangeEmailResultEvent.const_882,this.emailChangeHandler);
      }
      ...
      private function updateEventHandler(param1:RoomWidgetWelcomeGiftUpdateEvent) : void
      {
         switch(param1.type)
         {
            case RoomWidgetWelcomeGiftUpdateEvent.const_587:
               this.var_1508 = param1.email;
               this.var_1248 = param1.isVerified;
               this.var_1002 = param1.allowEmailChange;
      ...
      private function emailChangeHandler(param1:RoomWidgetChangeEmailResultEvent) : void
      {
         if(param1.result == 0)
         {
            this.var_1508 = this.var_1507;
            this.setViewState(this.const_701);
         }
         else
         {
            if(param1.result == this.const_2358)
            {
               this.var_1002 = false;
            }
