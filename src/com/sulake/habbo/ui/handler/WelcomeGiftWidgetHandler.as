package com.sulake.habbo.ui.handler
{
   ...
   public class WelcomeGiftWidgetHandler implements IRoomWidgetHandler
   {
      ...
      {
         return RoomWidgetEnum.const_606;
      }
      ...
      private function addMessageEvents() : void
      {
         ...
         this.var_801 = [];
         this.var_801.push(new WelcomeGiftStatusEvent(this.onWelcomeGiftStatus));
         this.var_801.push(new ChangeEmailResultEvent(this.onChangeEmailResult));
      ...
      {
         var _loc1_:* = null;
         if(!this._container || !this._container.connection || !this.var_801)
         {
            return;
         }
         for each(_loc1_ in this.var_801)
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetFurniActionMessage.const_740);
         _loc1_.push(RoomWidgetChangeEmailMessage.const_773);
         return _loc1_;
      }
