package com.sulake.habbo.ui.handler
{
   ...
   public class FriendRequestWidgetHandler implements IRoomWidgetHandler
   {
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetGetUserLocationMessage.const_1008);
         _loc1_.push(RoomWidgetFriendRequestMessage.const_1009);
         _loc1_.push(RoomWidgetFriendRequestMessage.const_959);
         return _loc1_;
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetGetUserLocationMessage.const_1008:
               ...
               break;
            case RoomWidgetFriendRequestMessage.const_1009:
               ...
               break;
            case RoomWidgetFriendRequestMessage.const_959:
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomSessionFriendRequestEvent.const_175);
         _loc1_.push(FriendRequestEvent.const_60);
         _loc1_.push(FriendRequestEvent.const_228);
         return _loc1_;
      }
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionFriendRequestEvent.const_175:
            ...
            case FriendRequestEvent.const_228:
