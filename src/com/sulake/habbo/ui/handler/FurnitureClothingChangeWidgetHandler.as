package com.sulake.habbo.ui.handler
{
   ...
   public class FurnitureClothingChangeWidgetHandler implements IRoomWidgetHandler, IHabboAvatarEditorDataSaver
   {
      ...
      private static const const_1425:String = "hd-99999-99999.lg-270-62";
      
      private static const const_1424:String = "hd-99999-99999.ch-630-62.lg-695-62";
      ...
      {
         return [RoomWidgetFurniToWidgetMessage.const_794,RoomWidgetClothingChangeMessage.const_1020,RoomWidgetAvatarEditorMessage.const_643];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetFurniToWidgetMessage.const_794:
               ...
               break;
            case RoomWidgetClothingChangeMessage.const_1020:
               ...
               if(_loc2_ != null)
               {
                  ...
                  if(_loc3_ != null)
                  {
                     ...
                     _loc8_ = "null";
                     _loc9_ = _loc3_.getString(RoomObjectVariableEnum.const_1319);
                     ...
                     if(this._container.avatarEditor.openEditor(AvatarEditorInstanceId.const_412,this,[AvatarEditorFigureCategory.const_260,AvatarEditorFigureCategory.const_1017],false,"${widget.furni.clothingchange.editor.title}"))
                     {
                        this._container.avatarEditor.loadAvatarInEditor(AvatarEditorInstanceId.const_412,_loc9_,_loc8_,HabboClubLevelEnum.const_54);
