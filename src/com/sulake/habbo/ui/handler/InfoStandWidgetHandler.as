   ...
   public class InfoStandWidgetHandler implements IRoomWidgetHandler
   {
      ...
      public function InfoStandWidgetHandler(param1:IHabboMusicController)
      {
         ...
         if(this.var_243 != null)
         {
            ...
            this.var_243.events.addEventListener(SongInfoReceivedEvent.const_99,this.onSongInfoReceivedEvent);
         }
      }
      ...
      {
         return RoomWidgetEnum.const_555;
      }
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         if(this._container != null)
         {
            ...
            {
               this._container.sessionDataManager.events.removeEventListener(UserTagsReceivedEvent.const_200,this.onUserTags);
               this._container.sessionDataManager.events.removeEventListener(BadgeImageReadyEvent.const_217,this.onBadgeImage);
            }
            if(this._container.roomSessionManager != null)
            {
               this._container.roomSessionManager.events.removeEventListener(RoomSessionUserFigureUpdateEvent.const_196,this.onFigureUpdate);
         ...
         if(this._container.sessionDataManager != null)
         {
            this._container.sessionDataManager.events.addEventListener(UserTagsReceivedEvent.const_200,this.onUserTags);
            this._container.sessionDataManager.events.addEventListener(BadgeImageReadyEvent.const_217,this.onBadgeImage);
         }
         if(this._container.roomSessionManager != null)
         {
            this._container.roomSessionManager.events.addEventListener(RoomSessionUserFigureUpdateEvent.const_196,this.onFigureUpdate);
      ...
      public function dispose() : void
      {
         ...
         {
            _loc1_ = this.var_690.length - 1;
            while(_loc1_ >= 0)
            {
               _loc2_ = this.var_690.getWithIndex(_loc1_);
               if(_loc2_)
               {
                  _loc2_.dispose();
               }
         ...
         if(this.var_243 != null)
         {
            ...
            this.var_243.events.removeEventListener(SongInfoReceivedEvent.const_99,this.onSongInfoReceivedEvent);
            this.var_243 = null;
         }
         this.var_1145 = true;
         this.container = null;
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetRoomObjectMessage.const_650);
         _loc1_.push(RoomWidgetRoomObjectMessage.const_1030);
         _loc1_.push(RoomWidgetUserActionMessage.const_648);
         _loc1_.push(RoomWidgetUserActionMessage.const_677);
         _loc1_.push(RoomWidgetUserActionMessage.const_571);
         _loc1_.push(RoomWidgetUserActionMessage.const_627);
         _loc1_.push(RoomWidgetUserActionMessage.const_658);
         _loc1_.push(RoomWidgetUserActionMessage.const_460);
         _loc1_.push(RoomWidgetUserActionMessage.const_539);
         ...
         _loc1_.push(RoomWidgetUserActionMessage.const_911);
         _loc1_.push(RoomWidgetFurniActionMessage.const_258);
         _loc1_.push(RoomWidgetFurniActionMessage.const_914);
         _loc1_.push(RoomWidgetFurniActionMessage.const_1006);
         _loc1_.push(RoomWidgetFurniActionMessage.const_798);
         _loc1_.push(RoomWidgetFurniActionMessage.const_1371);
         _loc1_.push(RoomWidgetRoomTagSearchMessage.const_877);
         _loc1_.push(RoomWidgetGetBadgeDetailsMessage.const_953);
         _loc1_.push(RoomWidgetGetBadgeImageMessage.const_867);
         _loc1_.push(RoomWidgetUserActionMessage.const_528);
         _loc1_.push(RoomWidgetUserActionMessage.const_634);
         _loc1_.push(RoomWidgetUserActionMessage.const_574);
         _loc1_.push(RoomWidgetUserActionMessage.const_1973);
         _loc1_.push(RoomWidgetPetCommandMessage.const_594);
         _loc1_.push(RoomWidgetPetCommandMessage.const_968);
         _loc1_.push(RoomWidgetUserActionMessage.const_600);
         _loc1_.push(RoomWidgetUserActionMessage.const_245);
         _loc1_.push(RoomWidgetChangeMottoMessage.const_783);
         return _loc1_;
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(_loc4_.type == RoomWidgetUserActionMessage.const_528)
            {
               _loc3_ = this._container.roomSession.userDataManager.getUserDataByIndex(_loc2_);
            }
            else if(param1.type == RoomWidgetUserActionMessage.const_245 || param1.type == RoomWidgetUserActionMessage.const_600 || param1.type == RoomWidgetUserActionMessage.const_574)
            {
         ...
         switch(param1.type)
         {
            case RoomWidgetRoomObjectMessage.const_650:
               return this.handleGetObjectInfoMessage(param1 as RoomWidgetRoomObjectMessage);
            case RoomWidgetRoomObjectMessage.const_1030:
            ...
            case RoomWidgetUserActionMessage.const_648:
               ...
               break;
            case RoomWidgetUserActionMessage.const_677:
            ...
            case RoomWidgetUserActionMessage.const_571:
               _loc8_ = new RoomWidgetChatInputContentUpdateEvent(RoomWidgetChatInputContentUpdateEvent.const_1173,_loc3_.name);
               this._container.events.dispatchEvent(_loc8_);
               break;
            case RoomWidgetUserActionMessage.const_627:
            ...
            case RoomWidgetUserActionMessage.const_658:
               ...
               break;
            case RoomWidgetUserActionMessage.const_460:
               this._container.roomSession.kickUser(_loc3_.webID);
               break;
            case RoomWidgetUserActionMessage.const_539:
            ...
            case RoomWidgetUserActionMessage.const_588:
               ...
               break;
            case RoomWidgetUserActionMessage.const_911:
            ...
            case RoomWidgetFurniActionMessage.const_1371:
               ...
               break;
            case RoomWidgetUserActionMessage.const_245:
               ...
               break;
            case RoomWidgetRoomTagSearchMessage.const_877:
               ...
               break;
            case RoomWidgetGetBadgeDetailsMessage.const_953:
            ...
            case RoomWidgetUserActionMessage.const_528:
               ...
               break;
            case RoomWidgetUserActionMessage.const_634:
      ...
      private function handleGetObjectNameMessage(param1:RoomWidgetRoomObjectMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.category)
         {
            ...
            case RoomObjectCategoryEnum.const_26:
               ...
               {
                  _loc11_ = _loc7_.getModel().getNumber(RoomObjectVariableEnum.const_293);
      ...
      private function handleGetObjectInfoMessage(param1:RoomWidgetRoomObjectMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.category)
         {
            ...
            case RoomObjectCategoryEnum.const_26:
               ...
               _loc6_ = new RoomWidgetFurniInfoUpdateEvent(RoomWidgetFurniInfoUpdateEvent.const_334);
               _loc6_.id = param1.id;
               _loc6_.category = param1.category;
               _loc7_ = this._container.roomEngine.getRoomObject(_loc2_,_loc3_,param1.id,param1.category);
               _loc8_ = _loc7_.getModel();
               if(_loc8_.getString(RoomWidgetInfostandExtraParamEnum.const_417) != null)
               {
                  _loc6_.extraParam = _loc8_.getString(RoomWidgetInfostandExtraParamEnum.const_417);
               }
               else if(_loc8_.getNumber(RoomObjectVariableEnum.const_1029) == 1)
               {
                  _loc6_.extraParam = RoomWidgetInfostandExtraParamEnum.const_1214;
               }
               ...
               {
                  _loc24_ = _loc8_.getNumber(RoomObjectVariableEnum.const_293);
                  if(param1.category == RoomObjectCategoryEnum.const_27)
                  {
               ...
               _loc10_ = _loc8_.getNumber(RoomObjectVariableEnum.const_1203);
               _loc11_ = _loc8_.getNumber(RoomObjectVariableEnum.const_1249);
               ...
               if(_loc6_.extraParam != null && _loc6_.extraParam.length > 0)
               {
                  ...
                  _loc28_ = "";
                  _loc29_ = "";
                  if(_loc6_.extraParam == RoomWidgetInfostandExtraParamEnum.const_561)
                  {
                  ...
                  else if(_loc6_.extraParam.indexOf(RoomWidgetInfostandExtraParamEnum.const_452) == 0)
                  {
                     _loc31_ = _loc6_.extraParam.substr(RoomWidgetInfostandExtraParamEnum.const_452.length);
            ...
            case RoomObjectCategoryEnum.const_29:
               ...
               if(_loc12_.type == RoomObjectTypeEnum.const_230)
               {
               ...
               {
                  if(_loc12_.type != RoomObjectTypeEnum.const_666)
                  {
                     return null;
                  }
                  _loc13_ = "null";
               ...
               if(_loc13_ == RoomWidgetUserInfoUpdateEvent.const_109)
               {
               ...
               if(_loc13_ == RoomWidgetUserInfoUpdateEvent.const_151)
               {
                  ...
                  if(_loc17_ != null)
                  {
                     _loc38_ = _loc17_.getModel().getString(RoomObjectVariableEnum.const_790);
                  ...
                  if(!_loc34_)
                  {
                     _loc14_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_905;
                  }
                  if(!_loc35_)
                  {
                     _loc14_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_840;
                  }
               ...
               if(_loc13_ == RoomWidgetUserInfoUpdateEvent.BOT)
               {
                  ...
                  _loc15_.push(RoomWidgetUserInfoUpdateEvent.const_1826);
               }
               else
               {
      ...
      {
         return [RoomSessionUserBadgesEvent.const_166];
      }
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionUserBadgesEvent.const_166:
      ...
      private function onPetInfo(param1:RoomSessionPetInfoUpdateEvent) : void
      {
         ...
         var _loc7_:BitmapData = this.var_690.getValue(_loc4_) as BitmapData;
         if(_loc7_ == null)
         {
            _loc7_ = this.getPetImage(_loc4_);
            this.var_690.add(_loc4_,_loc7_);
         }
         if(this._container != null && this._container.events != null)
         {
            ...
            if(_loc13_ != null)
            {
               ...
               if(_loc14_ != null)
               {
                  _loc15_ = _loc14_.getModel().getString(RoomObjectVariableEnum.const_790);
      ...
      private function getPetImage(param1:String) : BitmapData
      {
         ...
         if(_loc3_ < 8)
         {
            _loc4_ = this._container.avatarRenderManager.method_1(param1,AvatarScaleType.const_61,null);
            if(_loc4_ != null)
            {
      ...
      private function onNowPlayingChanged(param1:NowPlayingEvent) : void
      {
         ...
         if(this.var_243 != null)
         {
            ...
            this._container.events.dispatchEvent(new RoomWidgetSongUpdateEvent(RoomWidgetSongUpdateEvent.const_442,_loc2_,_loc3_,_loc4_));
         }
      }
