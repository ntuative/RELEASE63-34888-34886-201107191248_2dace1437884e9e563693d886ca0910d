package com.sulake.habbo.ui.handler
{
   ...
   public class LoadingBarWidgetHandler implements IRoomWidgetHandler
   {
      ...
      {
         return RoomWidgetEnum.const_612;
      }
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(InterstitialEvent.const_631);
         _loc1_.push(InterstitialEvent.const_552);
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case InterstitialEvent.const_631:
               ...
               break;
            case InterstitialEvent.const_552:
