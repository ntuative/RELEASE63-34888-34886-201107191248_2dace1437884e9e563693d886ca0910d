package com.sulake.habbo.ui.handler
{
   ...
   public class MeMenuWidgetHandler implements IRoomWidgetHandler, IAvatarImageListener
   {
      ...
      public function dispose() : void
      {
         ...
         {
            this._container.avatarEditor.close(AvatarEditorInstanceId.const_222);
         }
         this.var_1145 = true;
         this.container = null;
         this.var_12 = null;
      ...
      {
         return RoomWidgetEnum.const_620;
      }
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         if(this._container != null)
         {
            ...
            {
               this._container.sessionDataManager.events.removeEventListener(HabboSessionFigureUpdatedEvent.const_327,this.onFigureUpdate);
            }
            if(this.var_12 && !this.var_12.disposed && this.var_12.events)
            {
               this.var_12.events.removeEventListener(HabboInventoryEffectsEvent.const_264,this.onAvatarEffectsChanged);
               this.var_12.events.removeEventListener(HabboInventoryHabboClubEvent.const_357,this.onHabboClubSubscriptionChanged);
            }
            ...
            {
               this._container.habboHelp.events.removeEventListener(HabboHelpTutorialEvent.const_804,this.onHelpTutorialEvent);
               this._container.habboHelp.events.removeEventListener(HabboHelpTutorialEvent.const_127,this.onHelpTutorialEvent);
            }
            if(this._container.catalog && !this._container.catalog.disposed && this._container.catalog.events)
            {
               this._container.catalog.events.removeEventListener(PurseEvent.const_126,this.onCreditBalance);
            }
         }
         ...
         {
            this._container.sessionDataManager.events.addEventListener(HabboSessionFigureUpdatedEvent.const_327,this.onFigureUpdate);
         }
         this.var_12 = this._container.inventory;
         if(this.var_12 != null)
         {
            this.var_12.events.addEventListener(HabboInventoryEffectsEvent.const_264,this.onAvatarEffectsChanged);
            this.var_12.events.addEventListener(HabboInventoryHabboClubEvent.const_357,this.onHabboClubSubscriptionChanged);
         }
         ...
         {
            this._container.habboHelp.events.addEventListener(HabboHelpTutorialEvent.const_804,this.onHelpTutorialEvent);
            this._container.habboHelp.events.addEventListener(HabboHelpTutorialEvent.const_127,this.onHelpTutorialEvent);
         }
         this._catalog = this._container.catalog;
         if(this._container.catalog != null)
         {
            this._container.catalog.events.addEventListener(PurseEvent.const_126,this.onCreditBalance);
         }
      }
      ...
      private function setMeMenuToolbarIcon() : void
      {
         ...
         if(this._container.avatarRenderManager != null)
         {
            ...
            if(_loc3_ != this.var_1667)
            {
               ...
               this.var_1667 = _loc3_;
               this.var_2161 = _loc1_;
               this.var_2162 = _loc2_;
            }
            else
            {
               _loc1_ = this.var_2161;
               _loc2_ = this.var_2162;
            }
         }
         if(this._toolbar != null)
         {
            ...
            {
               if(_loc1_.height > const_486)
               {
                  _loc7_ = new BitmapData(_loc1_.width,const_486,true,0);
                  _loc8_ = _loc7_.rect.clone();
                  if(_loc2_.height > const_486 - const_1151)
                  {
                     _loc8_.offset(0,_loc2_.height - const_486 + const_1151);
                  }
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetWaveMessage.const_785);
         _loc1_.push(RoomWidgetDanceMessage.const_950);
         _loc1_.push(RoomWidgetGetEffectsMessage.const_955);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_1292);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_1190);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_1238);
         _loc1_.push(RoomWidgetOpenInventoryMessage.const_901);
         _loc1_.push(RoomWidgetOpenCatalogMessage.const_737);
         _loc1_.push(RoomWidgetStopEffectMessage.const_808);
         _loc1_.push(RoomWidgetNavigateToRoomMessage.const_1782);
         _loc1_.push(RoomWidgetNavigateToRoomMessage.const_1258);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_643);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_1753);
         _loc1_.push(RoomWidgetSelectOutfitMessage.const_1185);
         _loc1_.push(RoomWidgetShowOwnRoomsMessage.const_870);
         _loc1_.push(RoomWidgetRequestWidgetMessage.const_830);
         _loc1_.push(RoomWidgetMeMenuMessage.const_935);
         _loc1_.push(RoomWidgetGetSettingsMessage.const_861);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_1767);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_1022);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_963);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_1272);
         _loc1_.push(RoomWidgetRequestWidgetMessage.const_410);
         return _loc1_;
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetRequestWidgetMessage.const_830:
               ...
               break;
            case RoomWidgetWaveMessage.const_785:
               if(this._container != null && this._container.roomSession != null)
               {
                  this._container.roomSession.sendWaveMessage();
               }
               break;
            case RoomWidgetDanceMessage.const_950:
               if(this._container != null && this._container.roomSession != null)
               {
               ...
               break;
            case RoomWidgetGetEffectsMessage.const_955:
               if(this.var_12 != null)
               {
               ...
               break;
            case RoomWidgetSelectEffectMessage.const_1292:
               if(this.var_12 != null)
               {
               ...
               break;
            case RoomWidgetSelectEffectMessage.const_1190:
               if(this.var_12 != null)
               {
               ...
               break;
            case RoomWidgetOpenCatalogMessage.const_737:
               _loc2_ = param1 as RoomWidgetOpenCatalogMessage;
               if(this._catalog != null && _loc2_.pageKey == RoomWidgetOpenCatalogMessage.const_1175)
               {
                  this._catalog.openCatalogPage(CatalogPageName.const_145,true);
               }
               break;
            case RoomWidgetOpenInventoryMessage.const_901:
               ...
               if(this.var_12 != null)
               {
                  ...
                  {
                     case RoomWidgetOpenInventoryMessage.const_1928:
                        this._catalog.openCatalogPage(CatalogPageName.const_1326,true);
                        break;
                     case RoomWidgetOpenInventoryMessage.const_1281:
                        this.var_12.toggleInventoryPage(InventoryCategory.const_209);
                        break;
                     case RoomWidgetOpenInventoryMessage.const_2032:
                        this.var_12.toggleInventoryPage(InventoryCategory.const_73);
                        break;
                     case RoomWidgetOpenInventoryMessage.const_1731:
                        break;
                     default:
               ...
               break;
            case RoomWidgetSelectEffectMessage.const_1238:
            case RoomWidgetStopEffectMessage.const_808:
               ...
               break;
            case RoomWidgetNavigateToRoomMessage.const_1258:
               ...
               break;
            case RoomWidgetShowOwnRoomsMessage.const_870:
               if(this._container != null)
               {
                  this._container.navigator.showOwnRooms();
               }
               break;
            case RoomWidgetMeMenuMessage.const_935:
               ...
               {
                  this._container.events.dispatchEvent(new RoomWidgetPurseUpdateEvent(RoomWidgetPurseUpdateEvent.const_126,this._catalog.getPurse().credits));
               }
            ...
            case RoomWidgetAvatarEditorMessage.const_643:
               ...
               if(this._container)
               {
                  this._container.avatarEditor.openEditor(AvatarEditorInstanceId.const_222,null,null,true);
                  this._container.avatarEditor.loadOwnAvatarInEditor(AvatarEditorInstanceId.const_222);
                  if(this._container.habboHelp && this._container.habboHelp.events)
                  {
                     this._container.habboHelp.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_547));
                  }
               }
               break;
            case RoomWidgetGetSettingsMessage.const_861:
               this._container.events.dispatchEvent(new RoomWidgetSettingsUpdateEvent(RoomWidgetSettingsUpdateEvent.const_453,this._container.soundManager.volume));
               break;
            case RoomWidgetStoreSettingsMessage.const_1022:
               this._container.soundManager.volume = (param1 as RoomWidgetStoreSettingsMessage).volume;
               this._container.events.dispatchEvent(new RoomWidgetSettingsUpdateEvent(RoomWidgetSettingsUpdateEvent.const_453,this._container.soundManager.volume));
               break;
            case RoomWidgetStoreSettingsMessage.const_963:
               this._container.soundManager.previewVolume = (param1 as RoomWidgetStoreSettingsMessage).volume;
               this._container.events.dispatchEvent(new RoomWidgetSettingsUpdateEvent(RoomWidgetSettingsUpdateEvent.const_453,this._container.soundManager.volume));
               break;
            case RoomWidgetAvatarEditorMessage.const_1272:
               if(this._container.habboHelp && this._container.habboHelp.events)
               {
      ...
      private function onCreditBalance(param1:PurseEvent) : void
      {
         ...
         this._container.events.dispatchEvent(new RoomWidgetPurseUpdateEvent(RoomWidgetPurseUpdateEvent.const_126,param1.balance));
      }
      ...
      private function onHelpTutorialEvent(param1:HabboHelpTutorialEvent) : void
      {
         ...
         switch(param1.type)
         {
            case HabboHelpTutorialEvent.const_127:
               this._container.events.dispatchEvent(new RoomWidgetTutorialEvent(RoomWidgetTutorialEvent.const_127));
               break;
            case HabboHelpTutorialEvent.const_804:
               this._container.events.dispatchEvent(new RoomWidgetTutorialEvent(RoomWidgetTutorialEvent.const_575));
         }
      }
