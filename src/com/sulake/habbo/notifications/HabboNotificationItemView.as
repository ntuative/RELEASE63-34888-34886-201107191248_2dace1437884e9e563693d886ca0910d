package com.sulake.habbo.notifications
{
   ...
   public class HabboNotificationItemView implements IUpdateReceiver
   {
      ...
      public static const const_545:int = 70;
      ...
      public function HabboNotificationItemView(param1:IAsset, param2:IHabboWindowManager, param3:Map, param4:Map, param5:HabboNotificationItem)
      {
         ...
         if(_loc7_ != null)
         {
            this.var_2185 = this._window.height - _loc7_.rectangle.bottom;
         }
         else
         {
            this.var_2185 = 15;
         }
         this.var_2186 = this._window.height;
         this.var_1687 = 4;
         this._blend = 0;
         this._state = name_4;
      ...
      public function update(param1:uint) : void
      {
         ...
         switch(this._state)
         {
            ...
            case const_608:
               ...
               _loc2_ = Number(this.var_1402) / Number(this.var_1129["time_fade_in"]);
               if(this.var_1402 > int(this.var_1129["time_fade_in"]))
               {
                  this.startDisplay();
               }
            ...
            case const_1160:
               ...
               if(this.var_1688 > int(this.var_1129["time_display"]) && !this.var_2187)
               {
                  this.startFadeOut();
               }
               break;
            case const_1159:
               ...
               _loc3_ = 1 - Number(this.var_1401) / Number(this.var_1129["time_fade_out"]);
               this.adjustBlend(_loc3_);
               if(this.var_1401 > int(this.var_1129["time_fade_in"]))
               {
                  this.startIdling();
               }
         }
      ...
      private function setNotificationText(param1:String) : void
      {
         ...
         _loc2_.text = param1;
         _loc2_.height = _loc2_.textHeight + this.var_2185;
         if(this._window.height < this.var_2186)
         {
            this._window.height = this.var_2186;
         }
      }
      ...
      {
         this.var_1401 = 0;
         this._state = const_1159;
      }
      
      private function startDisplay() : void
      {
         this.var_1688 = 0;
         this._state = const_1160;
      }
      ...
      public function reposition(param1:int = -1) : void
      {
         ...
         this._window.x = _loc2_.width - this._window.width - const_1881;
         this._window.y = this.var_1687;
      }
