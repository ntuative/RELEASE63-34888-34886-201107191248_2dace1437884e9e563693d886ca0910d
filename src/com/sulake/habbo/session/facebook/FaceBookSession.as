package com.sulake.habbo.session.facebook
{
   ...
   public class FaceBookSession implements IDisposable
   {
      ...
      private static const const_1061:String = "FlashExternalInterface.authenticateFacebook";
      
      private static const const_1482:String = "sendAccessTokenToServer";
      
      private static const const_1481:String = "fbKLogOut";
      ...
      private function onAuthenticate(param1:FaceBookAuthenticateEvent) : void
      {
         ...
         if(false)
         {
            ExternalInterface.addCallback(const_1482,this.jsFaceBookLogInCallback);
            ExternalInterface.addCallback(const_1481,this.jsFaceBookLogOutCallback);
            Logger.log("-- -- ADDED JAVASCRIPT CALLBACK HOOKS!");
            ExternalInterface.call(const_1061);
            Logger.log("-- -- CALLED JAVASCRIPT METHOD " + const_1061);
         }
      }
