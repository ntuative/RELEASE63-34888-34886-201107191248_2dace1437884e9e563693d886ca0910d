package com.sulake.habbo.session
{
   ...
   public class RoomSessionManager extends Component implements IRoomSessionManager, IRoomHandlerListener
   {
      ...
      override public function dispose() : void
      {
         ...
         {
            _loc3_ = 0;
            while(_loc3_ < this.var_90.length)
            {
               _loc4_ = this.var_90[_loc3_] as IDisposable;
               if(_loc4_)
               {
                  _loc4_.dispose();
               }
      ...
      private function createHandlers() : void
      {
         ...
         this.var_90.push(new RoomSessionHandler(this._connection,this));
         this.var_90.push(new RoomChatHandler(this._connection,this));
         this.var_90.push(new RoomUsersHandler(this._connection,this));
         this.var_90.push(new RoomPermissionsHandler(this._connection,this));
         this.var_90.push(new AvatarEffectsHandler(this._connection,this));
         this.var_90.push(new RoomDataHandler(this._connection,this));
         this.var_90.push(new PresentHandler(this._connection,this));
         this.var_90.push(new PlaceObjectErrorHandler(this._connection,this));
         this.var_90.push(new TeleportErrorHandler(this._connection,this));
         this.var_90.push(new GenericErrorHandler(this._connection,this));
         this.var_90.push(new PollHandler(this._connection,this));
         this.var_90.push(new VoteHandler(this._connection,this));
         this.var_90.push(new LidoHandler(this._connection,this));
         this.var_90.push(new RoomDimmerPresetsHandler(this._connection,this));
         this.var_90.push(new ViralFurniHandler(this._connection,this));
         this.var_90.push(new UserNotificationHandler(this._connection,this));
         this.var_90.push(new PetPackageHandler(this._connection,this));
      }
      ...
      private function initializeManager() : void
      {
         ...
         {
            this.gotoRoom(this.var_2944,this.var_2942,this.var_2158);
            this.var_2159 = false;
            this.var_2158 = "";
         }
      }
      ...
      public function gotoRoom(param1:Boolean, param2:int, param3:String = "", param4:String = "") : Boolean
      {
         ...
         events.dispatchEvent(new RoomSessionEvent(RoomSessionEvent.const_270,_loc7_));
         return true;
      }
      
      public function startSession(param1:IRoomSession) : Boolean
      {
         if(param1.state == RoomSessionEvent.const_71)
         {
            return false;
         }
         if(param1.start())
         {
            this.var_1665 = false;
            events.dispatchEvent(new RoomSessionEvent(RoomSessionEvent.const_71,param1));
      ...
      private function updateHandlers(param1:IRoomSession) : void
      {
         var _loc2_:int = 0;
         var _loc3_:* = null;
         if(param1 != null && this.var_90 != null)
         {
            _loc2_ = 0;
            while(_loc2_ < this.var_90.length)
            {
               _loc3_ = this.var_90[_loc2_] as BaseHandler;
               if(_loc3_ != null)
               {
