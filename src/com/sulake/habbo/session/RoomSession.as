package com.sulake.habbo.session
{
   ...
   public class RoomSession implements IRoomSession
   {
      ...
      private const const_2355:int = 2500;
      ...
      private var var_1226:UserDataManager;
      ...
      public function RoomSession(param1:int, param2:int, param3:IHabboTracking, param4:String = "", param5:String = "")
      {
         ...
         this.var_1226 = new UserDataManager();
      }
      ...
      public function set connection(param1:IConnection) : void
      {
         ...
         {
            this.var_1226.connection = param1;
         }
      }
      ...
      {
         if(this._state == RoomSessionEvent.const_270 && this._connection != null)
         {
            this._state = RoomSessionEvent.const_71;
      ...
      {
         this._connection.send(new ChatMessageComposer(param1,this.var_1495));
         this.var_1496.add(this.var_1495,getTimer());
         ++this.var_1495;
      }
      ...
      {
         var _loc3_:int = 0;
         var _loc2_:Object = this.var_1496.remove(param1);
         if(_loc2_ != null)
         {
            _loc3_ = getTimer();
            if(_loc3_ - int(_loc2_) > this.const_2355)
            {
      ...
      {
         return this.var_1226 as IUserDataManager;
      }
