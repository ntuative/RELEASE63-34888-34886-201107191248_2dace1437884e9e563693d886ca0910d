package com.sulake.habbo.help.tutorial
{
   ...
   public class NameChangeView
   {
      ...
      private static var var_1452:uint = 13232628;
      
      private static var var_1762:uint = 11129827;
      ...
      private var var_1761:IWindowContainer;
      ...
      private var var_1170:NameSuggestionListRenderer;
      ...
      {
         return TutorialUI.const_326;
      }
      
      public function set checkedName(param1:String) : void
      {
         this.var_522 = param1;
         if(this.var_1763 == this.var_522)
         {
      ...
      public function showMainView() : void
      {
         if(!this._window)
         {
            ...
            this.var_1761 = this._window.content.getChildAt(0) as IWindowContainer;
         }
      ...
      private function showSelectionView() : void
      {
         if(!this.var_764)
         {
            this.var_764 = this.var_27.buildXmlWindow("welcome_name_selection") as IWindowContainer;
            if(!this.var_764)
            {
               return;
            }
            this._window.content.addChild(this.var_764);
         }
      ...
      private function showConfirmationView() : void
      {
         if(!this.var_763)
         {
            this.var_763 = this.var_27.buildXmlWindow("welcome_name_confirmation") as IWindowContainer;
            if(!this.var_763)
            {
               return;
            }
            this._window.content.addChild(this.var_763);
         }
         this._window.caption = this.var_27.localization.getKey("tutorial.name_change.title.confirm");
         var _loc1_:ITextWindow = this.var_763.findChildByName("final_name") as ITextWindow;
         if(_loc1_)
         {
            _loc1_.text = this.var_522;
         }
         this.showView(this.var_763);
      }
      ...
      public function setNameNotAvailableView(param1:int, param2:String, param3:Array) : void
      {
         ...
         _loc5_.visible = true;
         this.var_1170 = new NameSuggestionListRenderer(this.var_27);
         var _loc6_:int = this.var_1170.render(param3,_loc5_);
         var _loc7_:int = 0;
         while(_loc7_ < _loc5_.numChildren)
         {
            _loc8_ = _loc5_.getChildAt(_loc7_);
            _loc8_.color = var_1452;
      ...
      private function windowEventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            ...
            case "confirm_name_button":
               this.var_27.method_5(this.var_522);
               break;
