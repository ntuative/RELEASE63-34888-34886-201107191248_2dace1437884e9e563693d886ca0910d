package com.sulake.habbo.help.tutorial
{
   ...
   public class TutorialUI implements INameChangeUI
   {
      ...
      public static const const_326:String = "TUI_NAME_VIEW";
      
      public static const const_413:String = "TUI_CLOTHES_VIEW";
      
      public static const const_644:String = "TUI_GUIDEBOT_VIEW";
      ...
      private var var_370:NameChangeView;
      ...
      public function TutorialUI(param1:HabboHelp, param2:Boolean = true)
      {
         ...
         this.var_35.events.addEventListener(HabboHelpTutorialEvent.const_505,this.onTaskDoneEvent);
         this.var_35.events.addEventListener(HabboHelpTutorialEvent.const_547,this.onTaskDoneEvent);
         this.var_35.events.addEventListener(HabboHelpTutorialEvent.const_510,this.onTaskDoneEvent);
         if(this.var_35.sessionDataManager != null)
         {
            this.var_35.sessionDataManager.events.addEventListener(HabboSessionFigureUpdatedEvent.const_327,this.onFigureUpdate);
         }
      }
      ...
      {
         return this.var_1187 && this.var_1186 && this.var_1472;
      }
      ...
      public function dispose() : void
      {
         ...
         if(this.var_35)
         {
            this.var_35.events.removeEventListener(HabboHelpTutorialEvent.const_505,this.onTaskDoneEvent);
            this.var_35.events.removeEventListener(HabboHelpTutorialEvent.const_547,this.onTaskDoneEvent);
            this.var_35.events.removeEventListener(HabboHelpTutorialEvent.const_510,this.onTaskDoneEvent);
            if(this.var_35.sessionDataManager != null)
            {
               this.var_35.sessionDataManager.events.removeEventListener(HabboSessionFigureUpdatedEvent.const_327,this.onFigureUpdate);
            }
            this.var_35 = null;
         }
      }
      ...
      public function onTaskDoneEvent(param1:HabboHelpTutorialEvent) : void
      {
         switch(param1.type)
         {
            case HabboHelpTutorialEvent.const_505:
               this.var_1472 = true;
               if(this.var_53 != null && this.var_53.id == const_644)
               {
                  this.showView(const_96);
               }
               break;
            case HabboHelpTutorialEvent.const_547:
               if(this.var_53 != null && this.var_53.id == const_413)
               {
                  this.var_1801 = true;
                  this.disposeWindow();
               }
               break;
            case HabboHelpTutorialEvent.const_510:
               if(this.var_1801)
               {
                  this.var_1801 = false;
                  this.showView(const_96);
      ...
      public function showView(param1:String) : void
      {
         ...
         if(this._window == null)
         {
            ...
            this.var_2406 = this._window.width - _loc2_.width;
         ...
         switch(param1)
         {
            ...
            case const_326:
               ...
               if(this.var_370 == null)
               {
                  this.var_370 = new NameChangeView(this);
               }
               this.var_370.showMainView();
               this.prepareForTutorial();
               break;
            case const_413:
         ...
         this._window.height = _loc2_.height + this.var_2404;
         this._window.width = _loc2_.width + this.var_2406;
         if(_loc3_)
         {
            if(this._window == null)
            {
      ...
      public function prepareForTutorial() : void
      {
         ...
         this.var_35.hideUI();
         this.var_35.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_127));
      }
      ...
      public function onUserNameChanged(param1:String) : void
      {
         ...
         if(this.var_53 != null && (this.var_53.id == const_326 || this.var_53.id == const_96))
         {
            this.showView(const_96);
         }
      }
      ...
      {
         this.var_1187 = true;
         if(this.var_53 != null && (this.var_53.id == const_413 || this.var_53.id == const_96))
         {
            this.showView(const_96);
         }
      }
      ...
      public function onChangeUserNameResult(param1:ChangeUserNameResultMessageEvent) : void
      {
         ...
         {
            this.var_370.setNameNotAvailableView(_loc2_.resultCode,_loc2_.name,_loc2_.nameSuggestions);
         }
      }
      ...
      public function onCheckUserNameResult(param1:CheckUserNameResultMessageEvent) : void
      {
         ...
         if(_loc2_.resultCode == ChangeUserNameResultMessageEvent.var_505)
         {
            this.var_370.checkedName = _loc2_.name;
         }
         else
         {
            this.var_370.setNameNotAvailableView(_loc2_.resultCode,_loc2_.name,_loc2_.nameSuggestions);
