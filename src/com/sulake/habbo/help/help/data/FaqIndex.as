package com.sulake.habbo.help.help.data
{
   ...
   public class FaqIndex
   {
      ...
      private var var_848:FaqCategory;
      ...
      {
         super();
         this.var_846 = new FaqCategory(-999,"${help.faq.title.urgent}");
         this.var_847 = new FaqCategory(-9999,"${help.faq.title.normal}");
         this.var_848 = new FaqCategory(-99999,"${help.faq.title.searchresults}");
      ...
      public function dispose() : void
      {
         ...
         {
            _loc1_ = 0;
            while(_loc1_ < this.var_184.length)
            {
               _loc2_ = this.var_184.getWithIndex(_loc1_);
               _loc2_.dispose();
               _loc1_++;
            }
      ...
      {
         var _loc4_:FaqCategory = this.var_184.getValue(param1);
      ...
      public function storeAnswerText(param1:int, param2:String) : void
      {
         ...
         if(this.var_848.hasItem(param1))
         {
            this.var_848.getItem(param1).answerText = param2;
         }
         var _loc3_:int = 0;
         while(_loc3_ < this.var_184.length)
         {
            _loc4_ = this.var_184.getWithIndex(_loc3_);
      ...
      private function findItem(param1:int) : FaqItem
      {
         ...
         if(this.var_848.hasItem(param1))
         {
            return this.var_848.getItem(param1);
         }
         var _loc2_:int = 0;
         while(_loc2_ < this.var_184.length)
         {
            _loc3_ = this.var_184.getWithIndex(_loc2_);
