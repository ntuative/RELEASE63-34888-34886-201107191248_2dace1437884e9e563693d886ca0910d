package com.sulake.habbo.help.help
{
   ...
   public class HelpUI
   {
      ...
      private var var_2080:String = "HHVE_HELP_FRONTPAGE";
      ...
      public function HelpUI(param1:HabboHelp, param2:IAssetLibrary, param3:IHabboWindowManager)
      {
         ...
         this._windowManager.registerLocalizationParameter("info.client.version","version",new String(201107191243));
         this.var_141 = new Map();
         this.var_141.add(HabboHelpViewEnum.const_2026,IHelpViewController(new PlaceholderView(this,this._windowManager,this._assetLibrary)));
         this.var_141.add(HabboHelpViewEnum.const_205,IHelpViewController(new HelpMainView(this,this._windowManager,this._assetLibrary)));
         this.var_141.add(HabboHelpViewEnum.const_537,IHelpViewController(new FaqBrowseTopView(this,this._windowManager,this._assetLibrary)));
         this.var_141.add(HabboHelpViewEnum.const_354,IHelpViewController(new FaqBrowseCategoryView(this,this._windowManager,this._assetLibrary)));
         this.var_141.add(HabboHelpViewEnum.const_284,IHelpViewController(new FaqBrowseEntry(this,this._windowManager,this._assetLibrary)));
         this.var_141.add(HabboHelpViewEnum.const_415,IHelpViewController(new CallForHelpTopicSelection(this,this._windowManager,this._assetLibrary)));
         this.var_141.add(HabboHelpViewEnum.const_885,IHelpViewController(new CallForHelpTextInput(this,this._windowManager,this._assetLibrary)));
         this.var_141.add(HabboHelpViewEnum.const_296,IHelpViewController(new CallForHelpSentView(this,this._windowManager,this._assetLibrary,"help_cfh_thanks")));
         this.var_141.add(HabboHelpViewEnum.const_1307,IHelpViewController(new CallForHelpSentView(this,this._windowManager,this._assetLibrary,"help_cfh_abusive")));
         this.var_141.add(HabboHelpViewEnum.const_1262,IHelpViewController(new CallForHelpPendingItemView(this,this._windowManager,this._assetLibrary)));
         this.var_141.add(HabboHelpViewEnum.const_887,IHelpViewController(new CallForHelpReportUserSelection(this,this._windowManager,this._assetLibrary)));
      }
      ...
      public function showUI(param1:String = null, param2:Boolean = true) : void
      {
         ...
         if(param1 == this.var_2080)
         {
            this.var_577 = new Array();
         }
         else if(param2)
         {
            if(this.var_577.length == 0 || param1 != this.var_413)
            {
               this.var_577.push(this.var_413);
            }
         }
         this.var_413 = param1;
         ...
         if(_loc3_ == null)
         {
            Logger.log("* No view controller found for " + this.var_413);
            return;
         }
      ...
      public function showCallForHelpResult(param1:String) : void
      {
         switch(param1)
         {
            case CallForHelpResultEnum.const_296:
               this.showUI(HabboHelpViewEnum.const_296);
               break;
            case CallForHelpResultEnum.const_1315:
               this.showUI(HabboHelpViewEnum.const_1262);
               break;
            case CallForHelpResultEnum.const_1245:
               this.showUI(HabboHelpViewEnum.const_1307);
         }
      }
      ...
      public function updateCallForGuideBotUI(param1:Boolean) : void
      {
         ...
         var _loc2_:IHelpViewController = this.var_141.getValue(HabboHelpViewEnum.const_205) as IHelpViewController;
      ...
      public function handleCallGuideBot() : void
      {
         ...
         this.hideUI();
         this.var_22.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_505));
      }
      ...
      {
         return this.var_141.getValue(this.var_413);
      }
      ...
      private function createWindow() : void
      {
         ...
         this.var_2406 = this._window.width - _loc3_.width;
         this.var_2404 = this._window.height;
      }
      ...
      public function updateWindowDimensions() : void
      {
         ...
         this._window.height = _loc1_.height + this.var_2404;
         this._window.width = _loc1_.width + this.var_2406;
      }
      ...
      {
         var _loc3_:* = null;
         if(this.var_413 == HabboHelpViewEnum.const_205)
         {
            return;
         }
         if(this.var_709.length < 2)
         {
            _loc3_ = this._assetLibrary.getAssetByName("back_png") as BitmapDataAsset;
            this.var_709.push(_loc3_.content as BitmapData);
            _loc3_ = this._assetLibrary.getAssetByName("back_hi_png") as BitmapDataAsset;
            this.var_709.push(_loc3_.content as BitmapData);
         }
         var _loc2_:IBitmapWrapperWindow = this.var_412.findChildByName("back_image") as IBitmapWrapperWindow;
         if(_loc2_ == null)
         {
            return;
         }
         ...
         if(param1)
         {
            _loc2_.bitmap.copyPixels(this.var_709[1],this.var_709[1].rect,new Point(0,0));
         }
         else
         {
            _loc2_.bitmap.copyPixels(this.var_709[0],this.var_709[0].rect,new Point(0,0));
         }
      }
      ...
      private function addBackButtonWindow() : void
      {
         ...
         var _loc3_:* = null;
         var _loc4_:* = null;
         if(this.var_413 == HabboHelpViewEnum.const_205 || this.var_577.length == 0)
         {
            return;
         }
         if(this.var_412 == null)
         {
            ...
            this.var_412 = this._windowManager.buildFromXML(XML(_loc2_.content)) as IWindowContainer;
            _loc3_ = this.var_412.findChildByName("back_image");
            if(_loc3_ != null)
            {
            ...
            _loc4_ = this.var_412.findChildByName("back_text");
            if(_loc4_ != null)
            {
         ...
         var _loc1_:IItemListWindow = this._window.findChildByName("content_list") as IItemListWindow;
         if(_loc1_ == null || this.var_412 == null)
         {
            return;
         }
         if(_loc1_.getListItemIndex(this.var_412 as IWindow) > -1)
         {
            return;
         }
         _loc1_.addListItem(this.var_412 as IWindow);
         this.setBackButtonActiveState(false);
      }
   }
}
