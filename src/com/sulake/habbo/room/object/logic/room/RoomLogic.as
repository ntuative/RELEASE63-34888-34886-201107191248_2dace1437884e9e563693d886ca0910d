package com.sulake.habbo.room.object.logic.room
{
   ...
   public class RoomLogic extends ObjectLogicBase
   {
      ...
      private var var_1853:int = 255;
      
      private var var_1504:uint = 16777215;
      
      private var var_1851:int = 255;
      
      private var var_1239:uint = 16777215;
      
      private var var_1854:int = 255;
      
      private var var_1240:int = 0;
      
      private var var_1852:int = 1500;
      ...
      {
         var _loc1_:Array = [RoomObjectMouseEvent.const_523,RoomObjectMouseEvent.const_158];
      ...
      override public function initialize(param1:XML) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.setString(RoomObjectVariableEnum.const_897,param1.toString());
            _loc2_.setNumber(RoomObjectVariableEnum.const_864,16777215);
            _loc2_.setNumber(RoomObjectVariableEnum.const_769,1);
            _loc2_.setNumber(RoomObjectVariableEnum.const_1028,1);
            _loc2_.setNumber(RoomObjectVariableEnum.const_908,1);
         }
      }
         ...
         if(this.var_1503)
         {
            if(object != null)
            {
               ...
               if(_loc2_ != null)
               {
                  ...
                  _loc2_.setString(RoomObjectVariableEnum.const_897,_loc3_.toString());
                  _loc2_.setNumber(RoomObjectVariableEnum.const_1397,param1);
      ...
      private function updateBackgroundColor(param1:int) : void
      {
         ...
         if(this.var_1240)
         {
            _loc2_ = param1;
            _loc3_ = this._color;
            _loc4_ = this.var_1853;
            if(_loc2_ - this.var_1240 >= this.var_1852)
            {
               _loc3_ = this.var_1239;
               _loc4_ = this.var_1854;
               this.var_1240 = 0;
            }
            else
            {
               _loc7_ = this.var_1504 >> 16 & 255;
               _loc8_ = this.var_1504 >> 8 & 255;
               _loc9_ = this.var_1504 & 255;
               _loc10_ = this.var_1239 >> 16 & 255;
               _loc11_ = this.var_1239 >> 8 & 255;
               _loc12_ = this.var_1239 & 255;
               _loc13_ = (_loc2_ - this.var_1240) / this.var_1852;
               _loc7_ += (_loc10_ - _loc7_) * _loc13_;
               _loc8_ += (_loc11_ - _loc8_) * _loc13_;
               _loc9_ += (_loc12_ - _loc9_) * _loc13_;
               _loc3_ = (_loc7_ << 16) + (_loc8_ << 8) + _loc9_;
               _loc4_ = this.var_1851 + (this.var_1854 - this.var_1851) * _loc13_;
               this._color = _loc3_;
            ...
            _loc6_.setNumber(RoomObjectVariableEnum.const_864,_loc3_);
         }
      }
      ...
      private function updatePlaneTypes(param1:RoomObjectRoomUpdateMessage, param2:IRoomObjectModelController) : void
      {
         switch(param1.type)
         {
            case RoomObjectRoomUpdateMessage.const_768:
               param2.setString(RoomObjectVariableEnum.const_219,param1.value);
               break;
            case RoomObjectRoomUpdateMessage.const_1016:
               param2.setString(RoomObjectVariableEnum.const_234,param1.value);
               break;
            case RoomObjectRoomUpdateMessage.const_856:
               param2.setString(RoomObjectVariableEnum.const_231,param1.value);
         }
      }
      ...
      private function updatePlaneMasks(param1:RoomObjectRoomMaskUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         switch(param1.type)
         {
            case RoomObjectRoomMaskUpdateMessage.const_604:
               _loc5_ = "null";
               if(param1.maskCategory == RoomObjectRoomMaskUpdateMessage.const_309)
               {
                  _loc5_ = "null";
               }
               this.var_571.addMask(param1.maskId,param1.maskType,param1.maskLocation,_loc5_);
               _loc4_ = true;
               break;
            case RoomObjectRoomMaskUpdateMessage.const_942:
               _loc4_ = this.var_571.removeMask(param1.maskId);
         }
         if(_loc4_)
         {
            _loc6_ = this.var_571.getXML();
            _loc7_ = _loc6_.toXMLString();
            param2.setString(RoomObjectVariableEnum.const_1323,_loc7_);
         }
      }
      ...
      private function updatePlaneVisibilities(param1:RoomObjectRoomPlaneVisibilityUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         switch(param1.type)
         {
            case RoomObjectRoomPlaneVisibilityUpdateMessage.const_1299:
               param2.setNumber(RoomObjectVariableEnum.const_769,_loc3_);
               break;
            case RoomObjectRoomPlaneVisibilityUpdateMessage.const_1209:
               param2.setNumber(RoomObjectVariableEnum.const_1028,_loc3_);
               param2.setNumber(RoomObjectVariableEnum.const_908,_loc3_);
         }
      }
      ...
      private function updatePlaneProperties(param1:RoomObjectRoomPlanePropertyUpdateMessage, param2:IRoomObjectModelController) : void
      {
         switch(param1.type)
         {
            case RoomObjectRoomPlanePropertyUpdateMessage.const_726:
               param2.setNumber(RoomObjectVariableEnum.const_1208,param1.value);
               break;
            case RoomObjectRoomPlanePropertyUpdateMessage.const_1356:
               param2.setNumber(RoomObjectVariableEnum.const_1280,param1.value);
         }
      }
      ...
      private function updateFloorHoles(param1:RoomObjectRoomFloorHoleUpdateMessage, param2:IRoomObjectModelController) : void
      {
         switch(param1.type)
         {
            case RoomObjectRoomFloorHoleUpdateMessage.const_180:
               ...
               this.var_1503 = true;
               break;
            case RoomObjectRoomFloorHoleUpdateMessage.const_157:
      ...
      private function updateColors(param1:RoomObjectRoomColorUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         this.var_1504 = this._color;
         this.var_1851 = this.var_1853;
         this.var_1239 = _loc3_;
         this.var_1854 = _loc4_;
         this.var_1240 = getTimer();
         this.var_1852 = 1500;
      }
      ...
      override public function mouseEvent(param1:RoomSpriteMouseEvent, param2:IRoomGeometry) : void
      {
         ...
         if(_loc5_ < 1 || _loc5_ > this._planeParser.planeCount)
         {
            ...
            {
               _loc4_.setNumber(RoomObjectVariableEnum.const_654,0);
            }
            return;
         }
         _loc5_--;
         ...
         {
            _loc4_.setNumber(RoomObjectVariableEnum.const_1844,_loc19_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1798,_loc20_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1869,_loc21_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_654,_loc5_ + 1);
            var _loc22_:String = "";
            var _loc23_:int = 0;
            var _loc24_:* = null;
            switch(param1.type)
            {
               ...
               case MouseEvent.CLICK:
                  ...
                  if(eventDispatcher != null)
                  {
                     ...
                     else if(_loc12_ == RoomPlaneData.const_267 || _loc12_ == RoomPlaneData.const_444)
                     {
                        _loc26_ = 90;
                        if(_loc11_ != null)
                        {
