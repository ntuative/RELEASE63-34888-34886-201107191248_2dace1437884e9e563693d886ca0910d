package com.sulake.habbo.room.object.logic.furniture
{
   ...
   public class FurnitureRoomDimmerLogic extends FurnitureLogic
   {
      ...
      {
         var _loc1_:Array = [RoomObjectWidgetRequestEvent.const_178,RoomObjectWidgetRequestEvent.const_115,RoomObjectDimmerStateUpdateEvent.const_68];
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_2195)
         {
            if(eventDispatcher != null && object != null)
            {
               ...
               eventDispatcher.dispatchEvent(_loc3_);
               _loc7_ = new RoomObjectWidgetRequestEvent(RoomObjectWidgetRequestEvent.const_115,_loc1_,_loc2_);
