package com.sulake.habbo.room.object.logic.furniture
{
   ...
   public class FurnitureSoundMachineLogic extends FurnitureMultiStateLogic
   {
      ...
      {
         var _loc1_:Array = [RoomObjectFurnitureActionEvent.const_630,RoomObjectFurnitureActionEvent.const_566,RoomObjectFurnitureActionEvent.const_492,RoomObjectFurnitureActionEvent.const_626];
      ...
      private function requestPlayList() : void
      {
         ...
         this.var_1776 = true;
         var _loc1_:RoomObjectFurnitureActionEvent = new RoomObjectFurnitureActionEvent(RoomObjectFurnitureActionEvent.const_630,object.getId(),object.getType());
         eventDispatcher.dispatchEvent(_loc1_);
      }
      ...
      private function requestStopPlaying() : void
      {
         ...
         var _loc1_:RoomObjectFurnitureActionEvent = new RoomObjectFurnitureActionEvent(RoomObjectFurnitureActionEvent.const_566,object.getId(),object.getType());
         eventDispatcher.dispatchEvent(_loc1_);
      }
