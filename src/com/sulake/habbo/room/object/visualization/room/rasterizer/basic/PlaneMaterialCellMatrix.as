package com.sulake.habbo.room.object.visualization.room.rasterizer.basic
{
   ...
   public class PlaneMaterialCellMatrix
   {
      ...
      public static const const_971:int = 6;
      
      public static const const_1931:int = const_449;
      ...
      public static const ALIGN_DEFAULT:int = const_123;
      ...
      private var var_1885:Boolean = true;
      
      private var var_2474:Number = -1.0;
      
      private var _normalMaxX:Number = 1.0;
      
      private var var_2472:Number = -1.0;
      
      private var var_2473:Number = 1.0;
      ...
      public function clearCache() : void
      {
         ...
         {
            _loc2_ = this.var_383[_loc1_] as PlaneMaterialCellColumn;
            if(_loc2_ != null)
            {
               _loc2_.clearCache();
            }
      ...
      {
         if(param1 < 0 || param1 >= this.var_383.length)
         {
            return false;
         }
         var _loc5_:PlaneMaterialCellColumn = new PlaneMaterialCellColumn(param2,param3,param4);
         var _loc6_:PlaneMaterialCellColumn = this.var_383[param1] as PlaneMaterialCellColumn;
         if(_loc6_ != null)
         {
            _loc6_.dispose();
         }
         this.var_383[param1] = _loc5_;
      ...
      public function render(param1:BitmapData, param2:int, param3:int, param4:IVector3d, param5:Boolean, param6:int, param7:Boolean) : BitmapData
      {
         ...
         if(this.isStatic)
         {
            if(this.var_32 != null)
            {
               if(this.var_32.width == param2 && this.var_32.height == param3 && Vector3d.isEqual(this._cachedBitmapNormal,param4))
               {
                  if(param1 != null)
                  {
                     this.copyCachedBitmapOnCanvas(param1,this.var_654,param6,param7);
                     return param1;
                  }
                  return this.var_32;
               }
         ...
         {
            _loc11_ = this.var_383[_loc9_] as PlaneMaterialCellColumn;
            if(_loc11_ != null)
            {
      ...
      private function copyCachedBitmapOnCanvas(param1:BitmapData, param2:int, param3:int, param4:Boolean) : void
      {
         ...
         var _loc5_:* = null;
         if(this._align == const_123)
         {
            _loc5_ = new Rectangle(0,0,this.var_32.width,this.var_654);
         }
         else
         {
            _loc5_ = new Rectangle(0,this.var_32.height - this.var_654,this.var_32.width,this.var_654);
         }
      ...
      private function renderRepeatBorders(param1:BitmapData, param2:Array) : int
      {
         ...
         if(this.var_383.length == 1)
         {
            _loc4_ = this.var_383[0] as BitmapData;
            if(_loc4_ != null)
            {
               _loc6_ = _loc4_.width;
               _loc5_.push(_loc4_);
