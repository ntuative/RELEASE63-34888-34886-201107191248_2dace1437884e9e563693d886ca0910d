package com.sulake.habbo.room.object.visualization.room
{
   ...
   public class RoomVisualization extends RoomObjectSpriteVisualization
   {
      ...
      public static const const_1809:int = 16777215;
      
      public static const const_1926:int = 13421772;
      
      private static const const_1126:int = 16777215;
      
      private static const const_1127:int = 13421772;
      
      private static const const_1129:int = 10066329;
      
      private static const const_1128:int = 10066329;
      
      public static const const_1960:int = 16777215;
      
      public static const const_1966:int = 13421772;
      
      public static const const_1758:int = 10066329;
      ...
      private var var_872:Rectangle = null;
      
      private var var_571:RoomPlaneBitmapMaskParser = null;
      ...
      private var var_1101:Number = NaN;
      
      private var var_1613:Number = NaN;
      
      private var var_2806:Number = NaN;
      
      private var var_2063:String = null;
      
      private var var_1323:uint = 16777215;
      
      private var var_2808:int = 255;
      
      private var var_2807:int = 255;
      
      private var var_2809:int = 255;
      ...
      private const const_2380:int = 250;
      
      private var var_1735:int = -1;
      
      private var var_1583:Number = 0.0;
      
      private var var_2738:Number = 0.0;
      
      private var var_2739:Number = 0.0;
      ...
      public function RoomVisualization()
      {
         ...
         this.var_571 = new RoomPlaneBitmapMaskParser();
      ...
      private function resetRoomPlanes() : void
      {
         ...
         if(this.var_162 != null)
         {
            ...
            {
               _loc2_ = this.var_162[_loc1_] as RoomPlane;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
      ...
      override public function get boundingRectangle() : Rectangle
      {
         ...
         {
            this.var_872 = super.boundingRectangle;
         }
         return new Rectangle(this.var_872.x,this.var_872.y,this.var_872.width,this.var_872.height);
      }
      ...
      protected function defineSprites() : void
      {
         var _loc3_:* = null;
         var _loc4_:* = null;
         var _loc1_:int = this.var_162.length;
         createSprites(_loc1_);
         var _loc2_:int = 0;
         while(_loc2_ < _loc1_)
         {
            _loc3_ = this.var_162[_loc2_] as RoomPlane;
            ...
            if(_loc4_ != null && _loc3_ != null && _loc3_.leftSide != null && _loc3_.rightSide != null)
            {
               ...
               else if(_loc3_.type == RoomPlane.const_110)
               {
      ...
      protected function initializeRoomPlanes() : void
      {
         ...
         if(!isNaN(this.var_1101))
         {
            this._planeParser.floorThicknessMultiplier = this.var_1101;
         }
         if(!isNaN(this.var_1613))
         {
            this._planeParser.wallThicknessMultiplier = this.var_1613;
         }
         var _loc2_:String = _loc1_.getModel().getString(RoomObjectVariableEnum.const_897);
         ...
         var _loc5_:* = 0;
         var _loc6_:int = _loc1_.getModel().getNumber(RoomObjectVariableEnum.const_1351);
         var _loc7_:int = 0;
         while(_loc7_ < this._planeParser.planeCount)
         {
            ...
            else if(_loc12_ == RoomPlaneData.const_267)
            {
               ...
               {
                  _loc13_.color = const_1127;
               }
               else
               {
                  _loc13_.color = const_1129;
               }
               if(this._data != null)
               {
            ...
            else if(_loc12_ == RoomPlaneData.const_444)
            {
               ...
               if(_loc14_.y > 0)
               {
                  _loc13_.color = const_1960;
               }
               else if(_loc14_.y == 0)
               {
                  _loc13_.color = const_1966;
               }
               else
               {
                  _loc13_.color = const_1758;
               }
               if(this._data != null)
               {
            ...
            else if(_loc12_ == RoomPlaneData.const_1803)
            {
               _loc13_ = new RoomPlane(_loc1_.getLocation(),_loc8_,_loc9_,_loc10_,RoomPlane.const_75,true,_loc11_,_loc6_);
               if(_loc9_.length < 1 || _loc10_.length < 1)
               {
      ...
      private function getLandscapeWidth() : Number
      {
         ...
         while(_loc2_ < this._planeParser.planeCount)
         {
            ...
            if(_loc3_ == RoomPlaneData.const_444)
            {
      ...
      override public function update(param1:IRoomGeometry, param2:int, param3:Boolean, param4:Boolean) : void
      {
         ...
         if(_loc9_ < this._lastUpdateTime + this.const_2380 && !_loc6_ && !_loc8_)
         {
            return;
         }
         ...
         {
            _loc10_ = 0;
            while(_loc10_ < this.var_408.length)
            {
               _loc11_ = this.var_705[_loc10_];
               _loc12_ = getSprite(_loc11_);
               _loc13_ = this.var_408[_loc10_] as RoomPlane;
               if(_loc12_ != null && _loc13_ != null && _loc13_.type != RoomPlane.TYPE_LANDSCAPE)
               {
                  if(this.var_2065)
                  {
                     _loc14_ = uint(_loc13_.color);
                     _loc15_ = uint((_loc14_ & 255) * this.var_2809 / 255);
                     _loc16_ = uint((_loc14_ >> 8 & 255) * this.var_2807 / 255);
                     _loc17_ = uint((_loc14_ >> 16 & 255) * this.var_2808 / 255);
      ...
      private function updateGeometry(param1:IRoomGeometry) : Boolean
      {
         ...
         if(param1.updateId != this.var_1735)
         {
            this.var_1735 = param1.updateId;
            this.var_872 = null;
            _loc3_ = param1.direction;
            if(_loc3_ != null && (_loc3_.x != this.var_1583 || _loc3_.y != this.var_2738 || _loc3_.z != this.var_2739 || param1.scale != this.var_2064))
            {
               this.var_1583 = _loc3_.x;
               this.var_2738 = _loc3_.y;
               this.var_2739 = _loc3_.z;
               this.var_2064 = param1.scale;
               _loc2_ = true;
            }
         }
         return _loc2_;
      ...
      private function updateMasksAndColors(param1:IRoomObjectModel) : Boolean
      {
         ...
         {
            _loc3_ = param1.getString(RoomObjectVariableEnum.const_1323);
            if(_loc3_ != this.var_2063)
            {
               this.updatePlaneMasks(_loc3_);
               this.var_2063 = _loc3_;
               _loc2_ = true;
            }
            _loc4_ = uint(param1.getNumber(RoomObjectVariableEnum.const_864));
            if(_loc4_ != this.var_1323)
            {
               this.var_1323 = _loc4_;
               this.var_2809 = this.var_1323 & 255;
               this.var_2807 = this.var_1323 >> 8 & 255;
               this.var_2808 = this.var_1323 >> 16 & 255;
               _loc2_ = true;
            }
            _loc5_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_1353));
            if(_loc5_ != this.var_2065)
            {
      ...
      private function updatePlaneTexturesAndVisibilities(param1:IRoomObjectModel) : Boolean
      {
         ...
         if(var_147 != param1.getUpdateID())
         {
            _loc2_ = param1.getString(RoomObjectVariableEnum.const_234);
            _loc3_ = param1.getString(RoomObjectVariableEnum.const_219);
            _loc4_ = param1.getString(RoomObjectVariableEnum.const_231);
            this.updatePlaneTextureTypes(_loc3_,_loc2_,_loc4_);
            _loc5_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_769));
            _loc6_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_1028));
            _loc7_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_908));
      ...
      private function updatePlaneThicknesses(param1:IRoomObjectModel) : Boolean
      {
         ...
         if(var_147 != param1.getUpdateID())
         {
            _loc2_ = param1.getNumber(RoomObjectVariableEnum.const_1208);
            _loc3_ = param1.getNumber(RoomObjectVariableEnum.const_1280);
            if(!isNaN(_loc2_) && !isNaN(_loc3_) && (_loc2_ != this.var_1101 || _loc3_ != this.var_1613))
            {
               this.var_1101 = _loc2_;
      ...
      private function updateFloorHoles(param1:IRoomObjectModel) : Boolean
      {
         ...
         if(var_147 != param1.getUpdateID())
         {
            _loc2_ = param1.getNumber(RoomObjectVariableEnum.const_1397);
            if(!isNaN(_loc2_) && _loc2_ != this.var_2806)
            {
               this.var_2806 = _loc2_;
               this.resetRoomPlanes();
               return true;
            }
         }
      ...
      protected function updatePlaneTextureTypes(param1:String, param2:String, param3:String) : Boolean
      {
         ...
         var _loc4_:int = 0;
         while(_loc4_ < this.var_162.length)
         {
            _loc5_ = this.var_162[_loc4_] as RoomPlane;
            if(_loc5_ != null)
            {
               if(_loc5_.type == RoomPlane.const_110 && param1 != null)
               {
                  _loc5_.id = param1;
               }
      ...
      protected function updatePlanes(param1:IRoomGeometry, param2:Boolean, param3:int) : Boolean
      {
         ...
         var _loc6_:Array = this.var_408;
         if(this.var_408.length == 0)
         {
            _loc6_ = this.var_162;
         }
         var _loc7_:Boolean = false;
         var _loc8_:* = this.var_408.length > 0;
         var _loc9_:int = 0;
               ...
               if(_loc12_ != null)
               {
                  if(_loc12_.update(param1,_loc5_))
                  {
                     if(_loc12_.visible)
                     {
                        ...
                        if(_loc12_.type != RoomPlane.const_110)
                        {
                  ...
                  if(_loc11_.visible)
                  {
                     if(!_loc8_)
                     {
                        this.var_408.push(_loc12_);
                        this.var_705.push(_loc9_);
                     }
                  }
               }
      ...
      private function updateSprite(param1:IRoomObjectSprite, param2:RoomPlane, param3:String, param4:Number) : void
      {
         ...
         param1.assetName = param3 + "_" + this.var_1322;
      }
      ...
      protected function updatePlaneMasks(param1:String) : void
      {
         ...
         this.var_571.initialize(_loc2_);
         var _loc3_:* = null;
         var _loc4_:* = [];
         var _loc5_:* = [];
         var _loc6_:Boolean = false;
         var _loc7_:int = 0;
         while(_loc7_ < this.var_162.length)
         {
            _loc3_ = this.var_162[_loc7_] as RoomPlane;
            if(_loc3_ != null)
            {
         ...
         var _loc8_:int = 0;
         while(_loc8_ < this.var_571.maskCount)
         {
            _loc10_ = this.var_571.getMaskType(_loc8_);
            _loc11_ = this.var_571.getMaskLocation(_loc8_);
            _loc12_ = this.var_571.getMaskCategory(_loc8_);
            if(_loc11_ != null)
            {
               _loc13_ = 0;
               while(_loc13_ < this.var_162.length)
               {
                  _loc3_ = this.var_162[_loc13_] as RoomPlane;
                     ...
                     if(_loc3_ != null && _loc3_.location != null && _loc3_.normal != null)
                     {
                        ...
                        if(_loc15_ < 0.01)
                        {
                           if(_loc3_.leftSide != null && _loc3_.rightSide != null)
                           {
                              ...
                              if(_loc3_.type == RoomPlane.const_75 || _loc3_.type == RoomPlane.TYPE_LANDSCAPE && _loc12_ == RoomPlaneBitmapMaskData.const_309)
                              {
         ...
         while(_loc9_ < _loc4_.length)
         {
            ...
            {
               _loc3_ = this.var_162[_loc18_] as RoomPlane;
