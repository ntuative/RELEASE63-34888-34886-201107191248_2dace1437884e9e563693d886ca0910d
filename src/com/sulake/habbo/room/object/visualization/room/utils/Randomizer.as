package com.sulake.habbo.room.object.visualization.room.utils
{
   public class Randomizer
   {
      ...
      public static const const_2324:int = 1;
      
      public static const const_2244:int = 16777216;
      ...
      private var var_1956:int = 16777216;
      
      private var var_3089:int = 69069;
      
      private var var_3088:int = 5;
      ...
      {
         var _loc1_:int = this.var_3089 * this.var_1957 + this.var_3088;
         if(_loc1_ < 0)
         {
            _loc1_ = -_loc1_;
         }
         _loc1_ %= this.var_1956;
         this.var_1957 = _loc1_;
         return _loc1_;
      }
      ...
      private function iterateScaled(param1:int, param2:int) : int
      {
         ...
         return int(param1 + _loc3_ / this.var_1956 * param2);
      }
   }
}
