package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureVisualization extends RoomObjectSpriteVisualization
   {
      ...
      private var var_2756:Number = NaN;
      
      private var var_2757:int = -1;
      
      private var _alphaMultiplier:Number = 1.0;
      
      private var var_1306:String = null;
      ...
      protected function updateSprites(param1:int, param2:Boolean, param3:int) : void
      {
         var _loc4_:int = 0;
         var _loc5_:int = 0;
         if(this.var_621 != spriteCount)
         {
            createSprites(this.var_621);
         }
         if(param2)
         {
      ...
      private function updateSprite(param1:int, param2:int) : void
      {
         ...
         if(_loc4_ != null && _loc3_ != null)
         {
            ...
            if(_loc5_ != null && _loc5_.asset != null)
            {
               ...
               _loc4_.clickHandling = this.var_2541;
            }
            else
            {
      ...
      protected function getBlendMode(param1:int) : String
      {
         ...
         switch(param1)
         {
            case LayerData.const_416:
               break;
            case LayerData.const_1337:
               _loc2_ = "null";
               break;
            case LayerData.INK_DARKEN:
               _loc2_ = "null";
               break;
            case LayerData.const_1174:
               _loc2_ = "null";
         }
         return _loc2_;
      }
      ...
      protected function updateObject(param1:Number, param2:Number) : Boolean
      {
         ...
         if(var_508 != _loc3_.getUpdateID() || param1 != var_102 || param2 != this.var_2756)
         {
      ...
      protected function updateModel(param1:Number) : Boolean
      {
         ...
         {
            this.var_2757 = _loc3_.getNumber(RoomObjectVariableEnum.const_297);
            _loc4_ = Number(_loc3_.getNumber(RoomObjectVariableEnum.const_367));
            if(isNaN(_loc4_))
            {
               _loc4_ = 1;
            }
            ...
            this.var_1306 = this.getAdClickUrl(_loc3_);
            if(this.var_1306 == null || this.var_1306.indexOf("http") != 0)
            {
               this.var_1306 = null;
            }
            this.var_2541 = this.var_1306 != null;
            this.var_2760 = _loc3_.getNumber(RoomObjectVariableEnum.const_1024);
      ...
      {
         if(this.var_2761 != param2 || this.var_2758 != param1)
         {
            this.var_1062 = [];
            this.var_1063 = [];
            this.var_853 = [];
            ...
            this.var_2759 = this.getSize(param1);
      ...
      {
         this.var_621 = param1;
         this.var_1592 = this.var_621 - this.getAdditionalSpriteCount();
      }
      ...
      protected function getSpriteAssetName(param1:int, param2:int) : String
      {
         var _loc5_:int = 0;
         var _loc6_:* = null;
         if(this._data == null || param2 >= FurnitureVisualizationData.const_618.length)
         {
            return "";
         }
         var _loc3_:String = this.var_1062[param2];
         var _loc4_:Boolean = this.var_1063[param2];
         if(_loc3_ == null || _loc3_.length == 0)
         {
            _loc5_ = this.var_2759;
            _loc3_ = this._type;
            _loc6_ = "";
            if(param2 != this.var_1592)
            {
               _loc6_ = FurnitureVisualizationData.const_618[param2];
            }
            else
            {
               _loc6_ = "sd";
            ...
            this.var_1062[param2] = _loc3_;
            this.var_1063[param2] = _loc4_;
         }
         if(_loc4_)
         {
      ...
      {
         if(this.var_850[param3] != null && !this.var_2024)
         {
      ...
      {
         if(this.var_854[param2] != null)
         {
            return this.var_854[param2];
         }
         if(this._data == null)
         {
         ...
         this.var_854[param2] = _loc4_;
         return _loc4_;
      }
      
      protected function getSpriteXOffset(param1:int, param2:int, param3:int) : int
      {
         if(this.var_851[param3] != null)
         {
            return this.var_851[param3];
         }
         if(this._data == null)
         {
            return LayerData.const_646;
         }
         var _loc4_:int = this._data.getXOffset(param1,param2,param3);
         this.var_851[param3] = _loc4_;
         return _loc4_;
      }
      ...
      protected function getSpriteYOffset(param1:int, param2:int, param3:int) : int
      {
         ...
         if(param3 != this.var_1592)
         {
            ...
            return LayerData.const_611;
         }
         return Math.ceil(this.var_2760 * (param1 / 2));
      }
