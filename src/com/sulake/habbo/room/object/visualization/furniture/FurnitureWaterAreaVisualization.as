package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureWaterAreaVisualization extends AnimatedFurnitureVisualization
   {
      ...
      private static const const_1520:String = "shore";
      ...
      private function getShoreSpriteIndex(param1:int) : int
      {
         ...
         while(_loc2_ >= 0)
         {
            if(getSpriteTag(param1,direction,_loc2_) == const_1520)
            {
      ...
      private function getInstanceMask(param1:int) : IGraphicAsset
      {
         ...
         if(_loc3_ != null)
         {
            if(this.var_1217.indexOf(_loc2_) < 0)
            {
               this.var_1217.push(_loc2_);
            }
         }
         return _loc3_;
      }
      ...
      private function updateBorderData() : void
      {
         ...
         this.var_1819 = false;
         _loc5_ = 0;
         while(_loc5_ < this.var_440.length)
         {
            if(this.var_440[_loc5_] == true)
            {
               this.var_1819 = true;
            }
            _loc5_++;
      ...
      {
         var _loc2_:* = null;
         if(this.var_529 == 0 || this.var_633 == 0)
         {
            ...
            this.var_529 = _loc2_.getNumber(RoomObjectVariableEnum.const_250);
            this.var_633 = _loc2_.getNumber(RoomObjectVariableEnum.const_373);
         }
         this.var_440 = [];
         this.var_632 = [];
         var _loc1_:int = 0;
         while(_loc1_ < this.var_529 * 2 + this.var_633 * 2)
         {
            this.var_440.push(false);
            this.var_632.push(ShoreMaskCreatorUtility.const_83);
            _loc1_++;
         }
      }
      ...
      {
         if(this.var_79 == null || this.var_79.width < param1 || this.var_79.height < param2)
         {
            if(this.var_79 != null)
            {
               this.var_79.dispose();
            }
            this.var_79 = ShoreMaskCreatorUtility.createEmptyMask(param1,param2);
         }
         return ShoreMaskCreatorUtility.createShoreMask2x2(this.var_79,getSize(param3),this.var_440,this.var_632,assetCollection);
      }
