package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureParticleSystemEmitter extends FurnitureParticleSystemParticle
   {
      ...
      public static const const_1891:String = "cone";
      
      public static const const_1986:String = "plane";
      
      public static const const_1983:String = "sphere";
       
      
      private var _name:String;
      
      private var var_2565:int = -1;
      
      private var var_2566:Number;
      
      private var _direction:Vector3D;
      
      private var var_1005:Number = 0.1;
      ...
      public function reset() : void
      {
         ...
         this.var_1004 = 0;
         this.var_1085 = false;
         this.init(0,0,0,this._direction,this.var_2566,this.var_1005,this.var_2562,true);
      }
      ...
      public function configureParticle(param1:int, param2:Boolean, param3:Array, param4:Boolean) : void
      {
         ...
         _loc5_["fade"] = param4;
         this.var_1251.push(_loc5_);
      }
      
      override protected function ignite() : void
      {
         this.var_1085 = true;
         if(this.var_1004 < this.var_1522)
         {
            if(this.age > 1)
            {
      ...
      private function releaseParticles(param1:FurnitureParticleSystemParticle, param2:Vector3D = null) : void
      {
         ...
         var _loc10_:int = 0;
         while(_loc10_ < this.var_2563)
         {
            switch(this.var_2564)
            {
               case const_1891:
            ...
            _loc4_.init(param1.x,param1.y,param1.z,_loc3_,this._energy,this.var_1005,_loc6_,_loc7_,_loc9_,_loc8_);
            this.var_384.push(_loc4_);
            ++this.var_1004;
            _loc10_++;
         }
      }
      ...
      {
         var _loc1_:int = Math.floor(Math.random() * this.var_1251.length);
         return this.var_1251[_loc1_];
      }
      ...
      override public function update() : void
      {
         ...
         if(!isAlive && this.var_1004 < this.var_1522)
         {
            if(this.age % this.var_2567 == 0)
            {
               this.releaseParticles(this,this.direction);
            }
         }
      ...
      public function verlet() : void
      {
         ...
         if(isAlive || this.var_1004 < this.var_1522)
         {
            ...
            this.y = (2 - this.var_283) * this.y - (1 - this.var_283) * this.lastY + this.var_1886 * this.var_1005 * this.var_1005;
         ...
         for each(_loc2_ in this.var_384)
         {
            ...
            _loc2_.y = (2 - this.var_283) * _loc2_.y - (1 - this.var_283) * _loc2_.lastY + this.var_1886 * this.var_1005 * this.var_1005;
         ...
         for each(_loc2_ in _loc1_)
         {
            ...
            this.var_384.splice(this.var_384.indexOf(_loc2_),1);
            _loc2_.dispose();
         }
      }
