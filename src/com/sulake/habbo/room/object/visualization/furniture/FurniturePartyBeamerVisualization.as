package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurniturePartyBeamerVisualization extends AnimatedFurnitureVisualization
   {
      ...
      private static const const_1075:int = 15;
      
      private static const const_1074:int = 31;
      
      private static const const_1540:int = 2;
      
      private static const const_1539:int = 1;
      ...
      {
         var _loc7_:int = 0;
         var _loc3_:Number = this.var_1230[param2];
         var _loc4_:int = this.var_1232[param2];
         var _loc5_:int = this.var_1231[param2];
         var _loc6_:Number = this.var_1229[param2];
         if(param1 == 32)
         {
            _loc7_ = const_1075;
         }
         ...
         this.var_1230[param2] = _loc3_;
         if(int(_loc9_) == 0)
         {
            this.var_1229[param2] = this.getRandomAmplitudeFactor();
         }
      ...
      private function initItems(param1:Number) : void
      {
         ...
         this.var_1230 = new Array();
         this.var_1230.push(Math.random() * _loc2_ * 1.5);
         this.var_1230.push(Math.random() * _loc2_ * 1.5);
         this.var_1232 = new Array();
         this.var_1232.push(1);
         this.var_1232.push(-1);
         this.var_1231 = new Array();
         this.var_1231.push(const_1540);
         this.var_1231.push(const_1539);
         this.var_1229 = new Array();
         this.var_1229.push(this.getRandomAmplitudeFactor());
         this.var_1229.push(this.getRandomAmplitudeFactor());
      }
