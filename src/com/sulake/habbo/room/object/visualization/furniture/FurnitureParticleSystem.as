package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureParticleSystem
   {
      ...
      private var var_1334:Dictionary;
      ...
      private var var_885:ColorTransform;
      
      private var var_1628:ColorTransform;
      
      private var var_2087:Matrix;
      ...
      {
         super();
         this.var_1334 = new Dictionary();
         this._visualization = param1;
         this.var_885 = new ColorTransform();
         this.var_885.alphaMultiplier = 1;
         this.var_1628 = new ColorTransform();
         this.var_2087 = new Matrix();
      ...
      {
         var _loc1_:* = null;
         for each(_loc1_ in this.var_1334)
         {
            _loc1_.dispose();
         }
         this.var_1334 = null;
      ...
      public function setAnimation(param1:int) : void
      {
         ...
         this.var_117 = this.var_1334[param1];
         this.var_1085 = false;
         this.updateCanvas();
      }
      ...
      private function updateCanvas() : void
      {
         ...
         if(this.var_2088 >= 0)
         {
            this.var_305 = this._visualization.getSprite(this.var_2088);
            if(this.var_305 && this.var_305.asset)
            {
               ...
               {
                  this.var_101 = this.var_305.asset.clone();
                  if(this.var_885.alphaMultiplier != 1)
                  {
                     this.var_712 = new BitmapData(this.var_101.width,this.var_101.height,true,4278190080);
                  }
               }
               this.var_2520 = -this.var_305.offsetX;
               this.var_2519 = -this.var_305.offsetY;
               this.var_305.asset = this.var_101;
            }
            if(this.var_101)
            {
            ...
            if(this.var_712)
            {
               this.var_712.fillRect(this.var_712.rect,4278190080);
            }
         }
      }
      ...
      public function getSpriteYOffset(param1:int, param2:int, param3:int) : int
      {
         ...
         {
            return this.var_117.y * this.var_1333;
         }
         return 0;
      }
      ...
      {
         if(!this.var_117 || !this.var_305)
         {
            return;
         }
         if(this.var_101 && this.var_305.asset != this.var_101)
         {
            this.var_305.asset = this.var_101;
         }
         if(this.var_1085)
      ...
      public function updateAnimation() : void
      {
         ...
         var _loc2_:* = 0;
         var _loc8_:int = 0;
         if(!this.var_1085 && this.var_117.hasIgnited)
         {
            this.var_1085 = true;
         }
         _loc8_ = this.var_1193 * this.var_1333;
         this.var_117.update();
         if(this.var_1085)
         {
            if(this.var_117.roomObjectSpriteId >= 0)
            ...
            {
               this.var_101.draw(this.var_712,this.var_2087,this.var_885,BlendMode.NORMAL,null,false);
            }
            for each(_loc11_ in this.var_117.particles)
            {
               _loc2_ = Number(_loc11_.y);
               _loc3_ = this.var_2520 + (_loc11_.x - _loc11_.z) * 10 / 10 * this.var_1333;
               _loc4_ = this.var_2519 - _loc8_ + (_loc2_ + (_loc11_.x + _loc11_.z) / 2) * 10 / 10 * this.var_1333;
               ...
               if(_loc6_)
               {
                  ...
                  if(_loc11_.fade && _loc11_.alphaMultiplier < 1)
                  {
                     ...
                     this.var_1628.alphaMultiplier = _loc11_.alphaMultiplier;
                     this.var_101.draw(_loc7_,this._translationMatrix,this.var_1628,BlendMode.NORMAL,null,false);
                  }
                  else
                  {
      ...
      public function parseData(param1:XML) : void
      {
         ...
         var _loc23_:* = null;
         var _loc24_:* = null;
         this.var_2852 = parseInt(param1.@size);
         this.var_2088 = !!param1.hasOwnProperty("@canvas_id") ? int(parseInt(param1.@canvas_id)) : -1;
         this.var_1193 = !!param1.hasOwnProperty("@offset_y") ? int(parseInt(param1.@offset_y)) : 10;
         this.var_1333 = this.var_2852 / 64;
         this._blend = !!param1.hasOwnProperty("@blend") ? Number(Number(param1.@blend)) : Number(1);
         this._blend = Math.min(this._blend,1);
         this.var_885.alphaMultiplier = this._blend;
