package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurniturePlane
   {
      ...
      private var var_838:Vector3d = null;
      ...
      public function FurniturePlane(param1:IVector3d, param2:IVector3d, param3:IVector3d)
      {
         ...
         this.var_335.assign(param2);
         this.var_336 = new Vector3d();
         this.var_336.assign(param3);
         this.var_839 = new Vector3d();
         this.var_839.assign(param2);
         this.var_838 = new Vector3d();
         this.var_838.assign(param3);
      ...
      public function dispose() : void
      {
         ...
         if(this.var_225 != null)
         {
            ...
            {
               _loc2_ = this.var_225.getWithIndex(_loc1_) as BitmapData;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
      ...
      {
         if(param1 != this.var_2740)
         {
            if(!param1)
            {
               this.var_335.assign(this.var_839);
               this.var_336.assign(this.var_838);
            }
            else
            {
               this.var_335.assign(this.var_839);
               this.var_335.mul(this.var_838.length / this.var_839.length);
               this.var_336.assign(this.var_838);
               this.var_336.mul(this.var_839.length / this.var_838.length);
            }
            this.var_1735 = -1;
            this.var_1583 = this.var_1583 - 1;
      ...
      {
         var _loc3_:BitmapData = this.var_225.remove(param1) as BitmapData;
      ...
      private function needsNewTexture(param1:IRoomGeometry) : Boolean
      {
         ...
         var _loc3_:BitmapData = this.var_225.getValue(_loc2_) as BitmapData;
      ...
      private function getTexture(param1:IRoomGeometry, param2:int) : BitmapData
      {
         ...
         {
            _loc5_ = Number(this.var_335.length * param1.scale);
            _loc6_ = Number(this.var_336.length * param1.scale);
            if(_loc5_ < 1)
            {
               _loc5_ = 1;
            }
            ...
            _loc4_ = this.var_225.getValue(_loc3_) as BitmapData;
            if(_loc4_ == null)
            {
      ...
      public function update(param1:IRoomGeometry, param2:int) : Boolean
      {
         ...
         var _loc9_:* = null;
         if(param1 == null || this.var_106 == null && this.var_1268 != null || this.var_335 == null || this.var_336 == null || this._normal == null)
         {
            return false;
         }
         ...
         if(param1.updateId != this.var_1735)
         {
            ...
            if(_loc4_ != null && (_loc4_.x != this.var_1583 || _loc4_.y != this.var_2738 || _loc4_.z != this.var_2739 || param1.scale != this.var_2064))
            {
               this.var_1583 = _loc4_.x;
               this.var_2738 = _loc4_.y;
               this.var_2739 = _loc4_.z;
               ...
               _loc6_ = param1.getScreenPosition(this.var_1268);
               _loc7_ = _loc6_.z;
               _loc8_ = Math.max(this.var_173.z - _loc7_,this.var_133.z - _loc7_,this.var_98.z - _loc7_,this.var_134.z - _loc7_);
               this.var_2638 = _loc8_;
