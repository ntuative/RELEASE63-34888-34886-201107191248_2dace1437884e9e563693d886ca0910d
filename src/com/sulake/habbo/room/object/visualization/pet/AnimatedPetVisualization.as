package com.sulake.habbo.room.object.visualization.pet
{
   ...
   public class AnimatedPetVisualization extends AnimatedFurnitureVisualization
   {
      ...
      private static const const_1627:String = "head";
      
      private static const const_711:int = 1;
      
      private static const const_1121:int = 1000;
      
      private static const const_1628:String = "pet_experience_bubble_png";
      
      private static const const_1625:int = 0;
      
      private static const const_1626:int = 1;
      ...
      public function AnimatedPetVisualization()
      {
         ...
         this.var_1067 = [];
         super();
         while(this.var_139.length < ANIMATION_INDEX_COUNT)
         {
            this.var_139.push(new AnimationStateData());
         }
      }
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_139 != null)
         {
            ...
            {
               _loc2_ = this.var_139[_loc1_] as AnimationStateData;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
      ...
      override public function initialize(param1:IRoomObjectVisualizationData) : Boolean
      {
         ...
         {
            _loc3_ = this._animationData.commonAssets.getAssetByName(const_1628) as BitmapDataAsset;
            if(_loc3_ != null)
            {
      ...
      override protected function updateModel(param1:Number) : Boolean
      {
         ...
         if(_loc3_.getUpdateID() != var_147)
         {
            ...
            _loc5_ = _loc3_.getString(RoomObjectVariableEnum.const_143);
            ...
            _loc7_ = _loc3_.getNumber(RoomObjectVariableEnum.const_143);
            if(!isNaN(_loc7_))
            {
            ...
            this.var_1752 = _loc3_.getNumber(RoomObjectVariableEnum.const_275) > 0;
            _loc8_ = _loc3_.getNumber(RoomObjectVariableEnum.const_220);
            if(!isNaN(_loc8_))
            {
               this.var_2035 = _loc8_;
            }
            else
            {
               this.var_2035 = direction;
            }
            this.var_1573 = _loc3_.getNumber(RoomObjectVariableEnum.AVATAR_EXPERIENCE_TIMESTAMP);
            this.var_2391 = _loc3_.getNumber(RoomObjectVariableEnum.const_395);
            _loc9_ = _loc3_.getNumber(RoomObjectVariableEnum.const_1003);
            if(_loc9_ != this.var_2036)
            {
               this.var_2036 = _loc9_;
               this.var_2778 = this.var_2036.toString();
            }
      ...
      private function updateExperienceBubble(param1:int) : void
      {
         ...
         if(this.var_402 != null)
         {
            ...
            if(this.var_1573 > 0)
            {
               _loc2_ = param1 - this.var_1573;
               if(_loc2_ < const_1121)
               {
                  this.var_402.alpha = int(Math.sin(_loc2_ / const_1121 * 0) * 255);
      ...
      private function validateActions(param1:String, param2:String) : void
      {
         ...
         if(param1 != this.var_270)
         {
            ...
            this.setAnimationForIndex(const_1625,_loc3_);
         }
         if(param2 != this.var_1449)
         {
            this.var_1449 = param2;
            _loc3_ = this._animationData.getAnimationForGesture(var_102,param2);
            this.setAnimationForIndex(const_1626,_loc3_);
         }
      }
      ...
      {
         var _loc2_:* = null;
         if(param1 >= 0 && param1 < this.var_139.length)
         {
      ...
      override protected function resetAllAnimationFrames() : void
      {
         var _loc2_:* = null;
         this.var_1596 = false;
         var _loc1_:int = this.var_139.length - 1;
         while(_loc1_ >= 0)
         {
            _loc2_ = this.var_139[_loc1_];
            if(_loc2_ != null)
            {
      ...
      override protected function updateAnimations(param1:Number) : int
      {
         ...
         var _loc3_:* = 0;
         var _loc4_:int = 0;
         while(_loc4_ < this.var_139.length)
         {
      ...
      override protected function getSpriteXOffset(param1:int, param2:int, param3:int) : int
      {
         ...
         var _loc5_:int = this.var_139.length - 1;
         while(_loc5_ >= 0)
         {
            _loc6_ = this.var_139[_loc5_];
            if(_loc6_ != null)
            {
      ...
      override protected function getAsset(param1:String) : IGraphicAsset
      {
         ...
         {
            return assetCollection.getAssetWithPalette(param1,this.var_2778);
         }
         return null;
      }
      ...
      private function getDirection(param1:int, param2:int) : int
      {
         ...
         {
            return this._animationData.getDirectionValue(param1,this.var_2035);
         }
         return direction;
      }
      ...
      {
         if(this.var_1067[param1] == null)
         {
            if(this._animationData.getTag(var_102,DirectionData.USE_DEFAULT_DIRECTION,param1) == const_1627)
            {
               this.var_1067[param1] = true;
            }
            else
            {
               this.var_1067[param1] = false;
            }
         }
