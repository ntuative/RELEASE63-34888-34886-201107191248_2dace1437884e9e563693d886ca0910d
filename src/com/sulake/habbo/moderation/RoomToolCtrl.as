package com.sulake.habbo.moderation
{
   ...
   public class RoomToolCtrl implements IDisposable, TrackedWindow
   {
      ...
      private var var_1102:ICheckBoxWindow;
      
      private var var_1643:ICheckBoxWindow;
      
      private var var_1642:ICheckBoxWindow;
      ...
      {
         this._frame = IFrameWindow(this.var_35.getXmlWindow("roomtool_frame"));
         this.var_35.messageHandler.addRoomInfoListener(this);
         this.var_35.connection.send(new GetModeratorRoomInfoMessageComposer(this.var_424));
         Logger.log("BEGINNING TO SHOW: " + this.var_424);
      }
      
      public function getType() : int
      {
         return WindowTracker.const_1810;
      }
      ...
      public function dispose() : void
      {
         ...
         this._disposed = true;
         this.var_35.messageHandler.removeRoomEnterListener(this);
         if(this._frame != null)
         {
            this._frame.destroy();
            this._frame = null;
      ...
      {
         var _loc2_:Boolean = this._data != null && this._data.flatId == this.var_35.currentFlatId;
         var _loc3_:IButtonWindow = IButtonWindow(this._frame.findChildByName(param1));
         if(_loc2_ && this.var_35.initMsg.roomAlertPermission)
         {
            _loc3_.enable();
         }
         else
      ...
      {
         Logger.log("GOT ROOM INFO: " + param1.flatId + ", " + this.var_424);
         if(param1.flatId != this.var_424)
         {
            Logger.log("NOT THE SAME FLAT: " + param1.flatId + ", " + this.var_424);
            return;
         }
         this._data = param1;
         this.populate();
         this.var_35.messageHandler.removeRoomInfoListener(this);
         this._frame.visible = true;
         this.var_35.messageHandler.addRoomEnterListener(this);
      ...
      public function populate() : void
      {
         ...
         this.var_1102 = ICheckBoxWindow(this._frame.findChildByName("kick_check"));
         this.var_1643 = ICheckBoxWindow(this._frame.findChildByName("lock_check"));
         this.var_1642 = ICheckBoxWindow(this._frame.findChildByName("changename_check"));
         ...
         this.var_35.disableButton(this.var_35.initMsg.chatlogsPermission,this._frame,"chatlog_but");
         if(!this.var_35.initMsg.roomKickPermission)
         {
            this.var_1102.disable();
         }
         this._frame.findChildByName("owner_name_txt").procedure = this.onOwnerName;
         this.onRoomChange();
      }
      
      private function method_3(param1:IItemListWindow, param2:IWindow) : void
      {
      ...
      private function refreshRoomData(param1:RoomData, param2:String) : void
      {
         ...
         if(_loc4_ == null)
         {
            _loc4_ = IWindowContainer(this.var_35.getXmlWindow("roomtool_roomdata"));
            _loc3_.addChild(_loc4_);
         }
         if(!param1.exists)
         {
            this.method_3(this.var_64,_loc3_);
            this.method_3(this.var_64,this.var_64.getListItemByName("event_spacing"));
            return;
         }
      ...
      private function onOwnerName(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_35.windowTracker.show(new UserInfoFrameCtrl(this.var_35,this._data.ownerId),this._frame,false,false,true);
      }
      ...
      private function onEnterRoom(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_35.goToRoom(this._data.flatId);
      }
      ...
      private function onChatlog(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_35.windowTracker.show(new ChatlogCtrl(new GetRoomChatlogMessageComposer(0,this._data.flatId),this.var_35,WindowTracker.const_771,this._data.flatId),this._frame,false,false,true);
      }
      ...
      private function onEditInHk(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_35.openHkPage("roomadmin.url","" + this._data.flatId);
      }
      ...
      private function act(param1:Boolean) : void
      {
         ...
         var _loc2_:int = this.method_9(param1,this.var_1102.isSelected);
         this.var_35.connection.send(new ModeratorActionMessageComposer(ModeratorActionMessageComposer.const_1752,_loc2_,this.var_599.text,"",""));
         if(this.var_1643.isSelected || this.var_1642.isSelected || this.var_1102.isSelected)
         {
            this.var_35.connection.send(new ModerateRoomMessageComposer(this._data.flatId,this.var_1643.isSelected,this.var_1642.isSelected,this.var_1102.isSelected));
         }
         this.dispose();
      }
      
      private function method_9(param1:Boolean, param2:Boolean) : int
      {
         if(param2)
         {
            return !!param1 ? 0 : int(ModeratorActionMessageComposer.const_2019);
         }
         return !!param1 ? 0 : int(ModeratorActionMessageComposer.const_1864);
      }
      ...
      {
         Logger.log("MSG TEMPLATES: " + this.var_35.initMsg.roomMessageTemplates.length);
         param1.populate(this.var_35.initMsg.roomMessageTemplates);
      }
      ...
      private function onSelectTemplate(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:String = this.var_35.initMsg.roomMessageTemplates[this.var_1302.selection];
         if(_loc3_ != null)
         {
            this.var_615 = false;
