package com.sulake.habbo.moderation
{
   ...
   public class ChatlogCtrl implements IDisposable, TrackedWindow
   {
      ...
      private static var var_1025:Array = [];
      
      private static var var_1922:int = 1000;
      
      private static var var_1024:Array = [];
      
      private static var var_1920:int = 200;
      ...
      {
         this.var_809 = IWindowContainer(this.var_35.getXmlWindow("chatlog_roomheader"));
         this.var_808 = IWindowContainer(this.var_35.getXmlWindow("chatlog_chatline"));
         this.var_542 = new Timer(1000,1);
         ...
         this.var_35.connection.send(this.var_1782);
      ...
      private function getChatLineWindow() : IWindowContainer
      {
         if(false)
         {
            return var_1025.pop() as IWindowContainer;
         }
         return IWindowContainer(this.var_808.clone());
      }
      
      private function storeChatLineWindow(param1:IWindowContainer) : void
      {
         var _loc2_:* = null;
         if(var_1025.length < var_1922)
         {
            ...
            param1.width = this.var_808.width;
            param1.height = this.var_808.height;
            var_1025.push(param1);
         }
         else
         {
            param1.dispose();
      ...
      private function getChatHeaderWindow() : IWindowContainer
      {
         if(false)
         {
            return var_1024.pop() as IWindowContainer;
         }
         return IWindowContainer(this.var_809.clone());
      }
      
      private function storeChatHeaderWindow(param1:IWindowContainer) : void
      {
         var _loc2_:* = null;
         if(var_1024.length < var_1920)
         {
            _loc2_ = ITextWindow(param1.findChildByName("room_name_txt"));
            _loc2_.procedure = null;
            param1.width = this.var_809.width;
            param1.height = this.var_809.height;
            var_1024.push(param1);
         }
         else
         {
            param1.dispose();
      ...
      private function populateChatline(param1:IItemListWindow, param2:ChatlineData, param3:Boolean) : void
      {
         ...
         _loc4_.color = this.var_1921[param2.chatterId] != null ? (!!param3 ? 4294623571 : uint(4294959680)) : (!!param3 ? 4288861930 : uint(4294967295));
         ...
         if(param2.chatterId > 0)
         {
            ...
            if(!this.var_1547.getValue(param2.chatterName))
            {
               this.var_1547.add(param2.chatterName,param2.chatterId);
            }
         }
      ...
      private function onChatLogUserClick(param1:WindowMouseEvent) : void
      {
         ...
         var _loc3_:int = this.var_1547.getValue(_loc2_);
      ...
      public function dispose() : void
      {
         ...
         for each(_loc1_ in this.var_1545)
         {
            this.storeChatLineWindow(_loc1_);
         }
         for each(_loc1_ in this.var_1546)
         {
