package com.sulake.habbo.moderation
{
   ...
   public class IssueBrowser
   {
      ...
      private const const_2374:String = "my_issues";
      
      private const const_2375:String = "open_issues";
      
      private const const_2376:String = "picked_issues";
      
      private const const_2386:String = "closed_issues";
      ...
      private var var_1933:IIssueBrowserView;
      
      private var var_1934:IIssueBrowserView;
      
      private var var_1932:PickedIssuesView;
      ...
      private function createMainFrame() : void
      {
         ...
         if(this._window == null)
         {
            ...
            this.var_289 = this._window.findChildByName("tab_context") as ITabContextWindow;
            _loc6_ = 0;
            while(_loc6_ < this.var_289.numTabItems)
            {
               _loc5_ = this.var_289.getTabItemAt(_loc6_);
               _loc5_.addEventListener(WindowEvent.const_48,this.onTabSelected);
               _loc6_++;
            }
         }
         this.var_289 = this._window.findChildByName("tab_context") as ITabContextWindow;
         if(this.var_289 == null || this.var_289.container == null)
         {
            return;
         }
         var _loc1_:ISelectableWindow = this.var_289.selector.getSelectableByName("open_issues");
         this.var_289.selector.setSelected(_loc1_);
      }
      ...
      private function selectView(param1:String) : void
      {
         ...
         this.var_391.view.width = this.var_289.container.width;
         this.var_391.view.height = this.var_289.container.height;
      ...
      private function getView(param1:String) : IIssueBrowserView
      {
         switch(param1)
         {
            case this.const_2374:
               if(this.var_1933 == null)
               {
                  this.var_1933 = new MyIssuesView(this.issueManager,this,this.var_289.container);
               }
               return this.var_1933;
            case this.const_2375:
               if(this.var_1934 == null)
               {
                  this.var_1934 = new OpenIssuesView(this.issueManager,this,this.var_289.container);
               }
               return this.var_1934;
            case this.const_2376:
               if(this.var_1932 == null)
               {
                  this.var_1932 = new PickedIssuesView(this.issueManager,this,this.var_289.container);
               }
