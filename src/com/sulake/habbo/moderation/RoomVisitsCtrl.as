package com.sulake.habbo.moderation
{
   ...
   public class RoomVisitsCtrl implements IDisposable, TrackedWindow
   {
      ...
      private static var var_1003:Array = [];
      
      private static var var_1875:int = 200;
      ...
      {
         this.var_796 = IWindowContainer(this.var_35.getXmlWindow("roomvisits_row"));
         this.var_542 = new Timer(300,1);
         this.var_542.addEventListener(TimerEvent.TIMER,this.onResizeTimer);
         this.var_35.messageHandler.addRoomVisitsListener(this);
         this.var_35.connection.send(new GetRoomVisitsMessageComposer(this._userId));
         this._frame = IFrameWindow(this.var_35.getXmlWindow("roomvisits_frame"));
         this.var_64 = IItemListWindow(this._frame.findChildByName("visits_list"));
      ...
      public function onRoomVisits(param1:RoomVisitsData) : void
      {
         ...
         this.var_35.messageHandler.removeRoomVisitsListener(this);
      }
      
      public function getType() : int
      {
         return WindowTracker.const_1934;
      }
      ...
      private function populate() : void
      {
         var _loc2_:* = null;
         var _loc1_:* = true;
         for each(_loc2_ in this.var_116)
         {
      ...
      private function populateRoomRow(param1:RoomVisitData, param2:Boolean) : void
      {
         ...
         new OpenRoomTool(this._frame,this.var_35,_loc5_,param1.isPublic,param1.roomId);
         _loc5_.color = _loc4_;
         ...
         new OpenRoomInSpectatorMode(this.var_35,_loc7_,param1.isPublic,param1.roomId);
         _loc7_.color = _loc4_;
         this.addRoomRowToList(_loc3_,this.var_64);
      }
      ...
      private function getRoomRowWindow() : IWindowContainer
      {
         if(false)
         {
            return var_1003.pop() as IWindowContainer;
         }
      ...
      {
         var _loc2_:IWindowContainer = IWindowContainer(this.var_64.parent);
         var _loc3_:IWindow = _loc2_.getChildByName("scroller") as IWindow;
         var _loc4_:* = this.var_64.scrollableRegion.height > this.var_64.height;
         if(_loc3_.visible)
         {
            if(!_loc4_)
            {
               _loc3_.visible = false;
               this.var_64.width += 17;
            }
         }
         else if(_loc4_)
         {
      ...
      public function dispose() : void
      {
         ...
         for each(_loc1_ in this.var_1516)
         {
