package com.sulake.habbo.moderation
{
   ...
   public class IssueBundle
   {
      ...
      private var var_915:IssueMessageData = null;
      
      private var var_914:IssueMessageData = null;
      ...
      public function IssueBundle(param1:int, param2:IssueMessageData)
      {
         ...
         this.var_2980 = param2.pickerUserId;
         this.var_2979 = param2.pickerUserName;
         this.var_1644 = param2.reportedUserId;
      ...
      private function addIssue(param1:IssueMessageData) : void
      {
         ...
         this.var_1394 += param1.priority;
         if(param1.message != null && param1.message != "")
         {
            ++this.var_1393;
         }
         if(this.var_915 == null || param1.timeStamp < this.var_915.timeStamp)
         {
            this.var_915 = param1;
         }
         if(this.var_914 == null || param1.priority > this.var_914.timeStamp)
         {
            this.var_914 = param1;
         }
      }
      ...
      public function removeIssue(param1:int) : IssueMessageData
      {
         ...
         if(_loc2_ != null)
         {
            this.var_1394 -= _loc2_.priority;
            if(_loc2_.message != null && _loc2_.message != "")
            {
               --this.var_1393;
            }
            if(this.var_915 == _loc2_)
            {
               this.var_915 = null;
            }
            if(this.var_914 == _loc2_)
            {
               this.var_914 = null;
            }
         }
      ...
      public function getHighestPriorityIssue() : IssueMessageData
      {
         var _loc2_:* = null;
         var _loc3_:int = 0;
         var _loc1_:IssueMessageData = this.var_914;
         if(_loc1_ == null)
         {
      ...
      {
         var _loc3_:* = null;
         var _loc2_:IssueMessageData = this.var_915;
         if(_loc2_ == null)
         {
