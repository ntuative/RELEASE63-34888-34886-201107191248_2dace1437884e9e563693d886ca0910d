package com.sulake.habbo.sound.music
{
   ...
   public class SoundMachinePlayListController implements IPlayListController
   {
      ...
      public function SoundMachinePlayListController(param1:HabboSoundManagerFlash10, param2:HabboMusicController, param3:IEventDispatcher, param4:IEventDispatcher, param5:IConnection)
      {
         ...
         this.var_243 = param2;
         this.var_801 = [];
         this.var_801.push(new PlayListMessageEvent(this.onPlayListMessage));
         this.var_801.push(new PlayListSongAddedMessageEvent(this.onPlayListSongAddedMessage));
         for each(_loc6_ in this.var_801)
         {
         ...
         this._events.addEventListener(SongInfoReceivedEvent.const_99,this.onSongInfoReceivedEvent);
         this.var_93.addEventListener(RoomEngineSoundMachineEvent.const_748,this.onSoundMachinePlayEvent);
         this.var_93.addEventListener(RoomEngineSoundMachineEvent.const_932,this.onSoundMachineStopEvent);
      }
      ...
      public function dispose() : void
      {
         ...
         if(!this._disposed)
         {
            ...
            if(this.var_93)
            {
               this.var_93.removeEventListener(RoomEngineSoundMachineEvent.const_748,this.onSoundMachinePlayEvent);
               this.var_93.removeEventListener(RoomEngineSoundMachineEvent.const_932,this.onSoundMachineStopEvent);
               this.var_93 = null;
            }
            this._disposed = true;
         }
      ...
      {
         var _loc2_:* = null;
         if(this.var_486 == param1)
         {
            this.playCurrentSongAndNotify(this.var_486);
      ...
      public function stopPlaying() : void
      {
         this.var_486 = -1;
         this.var_724 = false;
         this.var_243.stop(HabboMusicPrioritiesEnum.const_131);
      }
      ...
      private function playCurrentSongAndNotify(param1:int) : void
      {
         ...
         if(this.var_243.playSong(param1,HabboMusicPrioritiesEnum.const_131,_loc3_,0,0,0))
         {
