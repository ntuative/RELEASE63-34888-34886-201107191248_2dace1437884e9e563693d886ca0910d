package com.sulake.habbo.sound.music
{
   ...
   public class JukeboxPlayListController implements IPlayListController
   {
      ...
      public function JukeboxPlayListController(param1:HabboSoundManagerFlash10, param2:HabboMusicController, param3:IEventDispatcher, param4:IConnection)
      {
         ...
         this.var_801 = [];
         this.var_801.push(new NowPlayingMessageEvent(this.onNowPlayingMessage));
         this.var_801.push(new JukeboxSongDisksMessageEvent(this.onJukeboxSongDisksMessage));
         this.var_801.push(new JukeboxPlayListFullMessageEvent(this.onJukeboxPlayListFullMessage));
      ...
      {
         return HabboMusicPrioritiesEnum.const_131;
      }
      ...
      {
         if(param1 < 0 || param1 >= this.var_602.length)
         {
            return null;
         }
         return this.var_602[param1];
      }
      ...
      private function onNowPlayingMessage(param1:IMessageEvent) : void
      {
         ...
         this.var_724 = _loc3_.currentSongId != -1;
         if(_loc3_.currentSongId >= 0)
         {
            this.var_243.playSong(_loc3_.currentSongId,HabboMusicPrioritiesEnum.const_131,_loc3_.syncCount / 1000,0,1,1);
            this.var_486 = _loc3_.currentSongId;
         }
         else
         {
            this.stopPlaying();
         ...
         this.var_2191 = _loc3_.currentPosition;
         this._soundManager.events.dispatchEvent(new NowPlayingEvent(NowPlayingEvent.const_106,HabboMusicPrioritiesEnum.const_131,_loc3_.currentSongId,_loc3_.currentPosition));
      }
      ...
      private function onJukeboxSongDisksMessage(param1:IMessageEvent) : void
      {
         ...
         while(_loc4_ < _loc3_.songDisks.length)
         {
            ...
            if(_loc7_ == null)
            {
               ...
               if(this.var_920.indexOf(_loc5_) < 0)
               {
                  this.var_920.push(_loc5_);
      ...
      private function onJukeboxPlayListFullMessage(param1:IMessageEvent) : void
      {
         ...
         this._events.dispatchEvent(new PlayListStatusEvent(PlayListStatusEvent.const_177));
      }
         ...
         while(_loc2_ < this.length)
         {
            ...
            if(_loc4_.id == param1.id)
            {
               ...
               if(_loc6_ != null)
               {
                  ...
                  this.var_602[_loc2_] = _loc6_;
               }
               break;
            }
            _loc2_++;
         }
         var _loc3_:int = this.var_920.indexOf(param1.id);
         if(_loc3_ >= 0)
         {
            this.var_920.splice(_loc3_,1);
         }
         if(this.var_920.length == 0)
         {
            this._events.dispatchEvent(new PlayListStatusEvent(PlayListStatusEvent.const_102));
