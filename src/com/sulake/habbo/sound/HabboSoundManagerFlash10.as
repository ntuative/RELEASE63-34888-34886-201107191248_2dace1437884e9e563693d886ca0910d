package com.sulake.habbo.sound
{
   ...
   public class HabboSoundManagerFlash10 extends Component implements IHabboSoundManager, IUpdateReceiver
   {
      ...
      private static const const_1696:int = 60;
      
      private static const const_1695:int = 25165823;
      
      private static const const_1694:int = 16777215;
      ...
      public function HabboSoundManagerFlash10(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null, param4:Boolean = true)
      {
         ...
         this.var_1390 = new Map();
         this.var_1675 = new ByteArray();
         ...
         events.addEventListener(TraxSongLoadEvent.const_762,this.onTraxLoadComplete);
      ...
      public function playSound(param1:String) : void
      {
         ...
         var _loc4_:* = null;
         var _loc5_:* = null;
         var _loc2_:HabboSound = this.var_1122.getValue(param1);
         if(_loc2_ == null)
         {
            _loc3_ = "";
            switch(param1)
            {
               case HabboSoundTypesEnum.const_1391:
                  ...
                  break;
               case HabboSoundTypesEnum.const_1885:
                  _loc3_ = "sound_guide_received_invitation";
                  break;
               case HabboSoundTypesEnum.const_1244:
               ...
               case HabboSoundTypesEnum.const_1363:
                  ...
                  break;
               case HabboSoundTypesEnum.const_1817:
            ...
            this.var_1122.add(param1,_loc2_);
         }
      ...
      private function loadSample(param1:int) : void
      {
         ...
         var _loc2_:String = this.var_131.getKey("flash.dynamic.download.url","furniture/");
         _loc2_ += this.var_131.getKey("flash.dynamic.download.samples.template","mp3/sound_machine_sample_%typeid%.mp3");
         ...
         _loc4_.load(_loc3_);
         this.var_737.add(_loc4_,param1);
      }
      ...
      private function addTraxSongForDownload(param1:int, param2:String) : IHabboSound
      {
         ...
         if(!_loc3_.ready)
         {
            this.var_1390.add(param1,_loc3_);
         }
         return _loc3_;
      }
      ...
      private function createTraxInstance(param1:int, param2:String, param3:Boolean = true) : TraxSequencer
      {
         ...
         var _loc5_:TraxSequencer = new TraxSequencer(param1,_loc4_,this.var_309,events);
      ...
      private function validateSampleAvailability(param1:TraxSequencer, param2:Boolean) : void
      {
         ...
         {
            if(this.var_309.getValue(int(_loc4_[_loc6_])) == null)
            {
               if(param2)
               {
      ...
      public function notifyPlayedSong(param1:String, param2:String) : void
      {
         ...
         this.var_1123.addSongPlayingNotification(param1,param2);
      }
      ...
      private function onHabboConfigurationInit(param1:IID = null, param2:IUnknown = null) : void
      {
         if(param2 != null)
         {
            ...
            if(this.var_131.getBoolean("trax.player.sample.memory.purge.enabled",false))
            {
               this.var_2969 = true;
            }
         }
      ...
      private function onNotificationsReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_1123 = IHabboNotifications(param2);
      }
      ...
      {
         if(this.var_131 == null || this._connection == null || this._roomEngine == null || this.var_243 != null)
         {
            return;
         }
      ...
      {
         events.dispatchEvent(new TraxSongLoadEvent(TraxSongLoadEvent.const_1937,this.var_913));
         this.var_913 = -1;
         this.var_912 = null;
      }
      ...
      {
         this.var_996 = param1;
         this.var_243.updateVolume(this.var_996);
      }
      ...
      private function processLoadedSample(param1:Sound) : void
      {
         ...
         var _loc4_:* = null;
         if(this.var_737.getValue(param1) != null)
         {
            _loc2_ = this.var_737.remove(param1);
            if(this.var_309.getValue(_loc2_) == null)
            {
               this.var_1675.clear();
               _loc3_ = param1.length;
               param1.extract(this.var_1675,int(_loc3_ * 44.1));
               _loc4_ = new TraxSample(this.var_1675,_loc2_,TraxSample.const_1730,TraxSample.const_1807);
               this.var_309.add(_loc2_,_loc4_);
            }
         }
      }
      ...
      private function processLoadedSamples() : void
      {
         ...
         var _loc3_:* = null;
         var _loc4_:int = 0;
         if(this.var_1389.length > 0)
         {
            _loc1_ = getTimer();
            _loc2_ = _loc1_;
            while(_loc2_ - _loc1_ < const_1696 && this.var_1389.length > 0)
            {
               _loc3_ = this.var_1389.splice(0,1)[0];
               this.processLoadedSample(_loc3_);
               _loc2_ = getTimer();
            }
            if(this.var_737.length == 0 && this.var_913 != -1)
            {
               this.var_912.ready = true;
               _loc4_ = this.var_913;
               this.var_913 = -1;
               this.var_912 = null;
               events.dispatchEvent(new TraxSongLoadEvent(TraxSongLoadEvent.const_762,_loc4_));
               if(this.var_2969)
               {
      ...
      private function loadNextSong() : void
      {
         var _loc1_:int = 0;
         var _loc2_:* = null;
         if(this.var_912 == null && this.var_1390.length > 0)
         {
            _loc1_ = this.var_1390.getKey(0);
            _loc2_ = this.var_1390.remove(_loc1_);
            if(_loc2_ != null && !_loc2_.disposed)
            {
               this.validateSampleAvailability(_loc2_,true);
               if(_loc2_.ready)
               {
                  events.dispatchEvent(new TraxSongLoadEvent(TraxSongLoadEvent.const_762,_loc1_));
               }
               else
               {
                  this.var_912 = _loc2_;
      ...
      private function processSampleMemoryUsage() : void
      {
         ...
         {
            _loc5_ = this.var_309.getKey(_loc4_);
            _loc6_ = this.var_309.getWithIndex(_loc4_);
         ...
         if(_loc1_ > const_1695)
         {
            ...
            _loc8_ = 0;
            _loc9_ = 0;
            while(_loc8_ < _loc1_ - const_1694 && _loc9_ < _loc2_.length)
            {
            ...
            if(_loc7_.length > 0)
            {
               for each(_loc11_ in _loc7_)
               {
                  ...
                  _loc12_ = this.var_309.getValue(_loc11_) as TraxSample;
                  _loc12_.dispose();
                  this.var_309.remove(_loc11_);
               }
