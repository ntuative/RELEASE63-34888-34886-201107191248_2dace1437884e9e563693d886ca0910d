package com.sulake.habbo.sound.trax
{
   ...
   public class TraxSequencer implements IHabboSound, IDisposable
   {
      ...
      private static const const_1152:uint = 88000;
      
      private static const const_731:uint = 88000;
      ...
      private var var_1119:Sound;
      
      private var var_498:SoundChannel;
      
      private var var_497:TraxData;
      
      private var var_1671:Map;
      ...
      {
         this.var_1674 = uint(30);
         super();
         this._events = param4;
         this.var_1672 = param1;
         this.var_996 = 1;
         this.var_1119 = new Sound();
         this.var_498 = null;
      ...
      {
         this.var_189 = uint(param1 * const_119);
      }
      ...
      {
         return this.var_496 / const_119;
      }
      
      public function set fadeOutSeconds(param1:Number) : void
      {
         this.var_496 = int(param1 * const_119);
      }
      
      public function get fadeInSeconds() : Number
      {
         return this.var_910 / const_119;
      }
      
      public function set fadeInSeconds(param1:Number) : void
      {
         this.var_910 = int(param1 * const_119);
      }
      ...
      public function prepare() : Boolean
      {
         ...
         if(!this.var_1670)
         {
            ...
            {
               this.var_1669 = false;
               if(this.var_497.hasMetaData)
               {
                  this.var_1669 = this.var_497.metaCutMode;
               }
               if(this.var_1669)
               {
      ...
      private function prepareLegacySequence() : Boolean
      {
         ...
         var _loc2_:int = 0;
         while(_loc2_ < this.var_497.channels.length)
         {
            _loc3_ = new Map();
            _loc4_ = this.var_497.channels[_loc2_] as TraxChannel;
            _loc5_ = 0;
            _loc6_ = 0;
            _loc7_ = 0;
            while(_loc7_ < _loc4_.itemCount)
            {
               ...
               _loc9_ = this.var_1671.getValue(_loc8_) as TraxSample;
               _loc9_.setUsageFromSong(this.var_1672,_loc1_);
               if(_loc9_ == null)
               {
               ...
               while(_loc12_ < _loc11_)
               {
                  ...
                  _loc6_ += _loc10_;
                  _loc5_ = uint(_loc6_ * const_731);
                  _loc12_++;
               }
               if(this.var_308 < _loc5_)
               {
                  this.var_308 = _loc5_;
               }
               _loc7_++;
      ...
      private function prepareSequence() : Boolean
      {
         ...
         while(_loc2_ < this.var_497.channels.length)
         {
            ...
            while(_loc8_ < _loc4_.itemCount)
            {
               ...
               _loc10_ = this.var_1671.getValue(_loc9_) as TraxSample;
               _loc10_.setUsageFromSong(this.var_1672,_loc1_);
               if(_loc10_ == null)
               {
      ...
      public function play(param1:Number = 0.0) : Boolean
      {
         ...
         this.var_596 = 0;
         this.var_736 = false;
         this.var_1119.addEventListener(SampleDataEvent.SAMPLE_DATA,this.onSampleData);
         this.var_1673 = param1 * const_119;
         this.var_1388 = 0;
         this.var_2168 = 0;
         this.var_498 = this.var_1119.play();
      ...
      {
         if(this.var_496 > 0 && !this.var_736)
         {
      ...
      private function stopImmediately() : void
      {
         ...
         {
            this.var_1119.removeEventListener(SampleDataEvent.SAMPLE_DATA,this.onSampleData);
         }
      }
      ...
      private function stopWithFadeout() : void
      {
         if(this.var_735 == null)
         {
            this.var_911 = true;
            this.var_596 = 0;
            this.var_735 = new Timer(this.var_1674 + this.var_496 / (const_119 / 1000),1);
            this.var_735.start();
            this.var_735.addEventListener(TimerEvent.TIMER_COMPLETE,this.onFadeOutComplete);
         }
      }
      ...
      private function getSampleBars(param1:uint) : int
      {
         if(this.var_1669)
         {
            return Math.round(param1 / const_1152);
         }
         return Math.ceil(param1 / const_1152);
      }
      ...
      private function getChannelSequenceOffsets() : Array
      {
         ...
         if(this.var_348 != null)
         {
            _loc2_ = this.var_348.length;
            _loc3_ = 0;
            while(_loc3_ < _loc2_)
            {
               _loc4_ = this.var_348[_loc3_];
               _loc5_ = 0;
               while(_loc5_ < _loc4_.length && _loc4_.getKey(_loc5_) < this.var_189)
               {
                  _loc5_++;
               }
      ...
      private function mixChannelsIntoBuffer() : void
      {
         ...
         var _loc2_:int = this.var_348.length;
         var _loc3_:* = null;
         var _loc4_:int = _loc2_ - 1;
         while(_loc4_ >= 0)
         {
            _loc5_ = this.var_348[_loc4_];
            ...
            _loc8_ = const_120;
            if(this.var_308 - this.var_189 < _loc8_)
            {
               _loc8_ = this.var_308 - this.var_189;
            }
            _loc9_ = 0;
            while(_loc9_ < _loc8_)
            {
               ...
               if(_loc6_ < _loc5_.length - 1)
               {
                  ...
                  if(_loc8_ + this.var_189 >= _loc13_)
                  {
                     _loc12_ = _loc13_ - this.var_189;
                  }
               }
      ...
      {
         var _loc1_:int = this.var_308 < this.var_1673 ? int(this.var_308) : (this.var_1673 > 0 ? int(this.var_1673) : int(this.var_308));
         if(this.var_189 > _loc1_ + this.var_1674 * (const_119 / 1000) && !this.var_736)
         {
            this.var_736 = true;
            if(this.var_499 != null)
            {
               this.var_499.reset();
               this.var_499.removeEventListener(TimerEvent.TIMER_COMPLETE,this.onPlayingComplete);
            }
            this.var_499 = new Timer(2,1);
            this.var_499.start();
            this.var_499.addEventListener(TimerEvent.TIMER_COMPLETE,this.onPlayingComplete);
         }
         else if(this.var_189 > _loc1_ - this.var_496 && !this.var_911)
         {
            this.var_1120 = false;
            this.var_911 = true;
            this.var_596 = 0;
      ...
      {
         if(param1.position > this.var_1388)
         {
            ++this.var_2168;
            Logger.log("Audio buffer under run...");
            this.var_1388 = param1.position;
         }
         if(this.volume > 0)
         {
         ...
         if(this.var_308 - this.var_189 < _loc2_)
         {
            _loc2_ = this.var_308 - this.var_189;
            if(_loc2_ < 0)
            {
               _loc2_ = 0;
            }
         ...
         this.var_189 += const_120;
         this.var_1388 += const_120;
         if(this.var_498 != null)
         {
            this.var_1674 = param1.position / const_119 * 1000 - this.var_498.position;
         }
      ...
      private function writeAudioToOutputStream(param1:ByteArray, param2:int) : void
      {
         ...
         if(param2 > 0)
         {
            ...
            else
            {
               if(this.var_1120)
               {
                  _loc5_ = 1 / this.var_910;
                  _loc6_ = this.var_1121 / Number(this.var_910);
                  this.var_1121 += const_120;
                  if(this.var_1121 > this.var_910)
                  {
                     this.var_1120 = false;
                  }
               }
               else if(this.var_911)
               {
                  _loc5_ = -1 / this.var_496;
                  _loc6_ = 1 - this.var_596 / Number(this.var_496);
                  this.var_596 += const_120;
                  if(this.var_596 > this.var_496)
                  {
                     this.var_596 = this.var_496;
                  }
               }
      ...
      {
         this.stopImmediately();
         this._events.dispatchEvent(new SoundCompleteEvent(SoundCompleteEvent.TRAX_SONG_COMPLETE,this.var_1672));
      }
      ...
      private function removeFadeoutStopTimer() : void
      {
         if(this.var_735 != null)
         {
            this.var_735.removeEventListener(TimerEvent.TIMER_COMPLETE,this.onFadeOutComplete);
            this.var_735.reset();
            this.var_735 = null;
         }
      }
