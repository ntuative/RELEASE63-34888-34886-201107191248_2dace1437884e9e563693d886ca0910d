package com.sulake.habbo.messenger
{
   ...
   public class ConversationView
   {
      ...
      private static const const_1588:int = 10;
      
      private static const const_1105:int = 100;
      
      private static const const_1587:int = 20;
       
      
      private var var_153:HabboMessenger;
      
      private var var_2682:IScrollbarWindow;
      
      private var var_1958:IContainerButtonWindow;
      ...
      public function ConversationView(param1:HabboMessenger, param2:IWindowContainer)
      {
         super();
         this.var_153 = param1;
         this.var_1958 = this.initButton("follow_friend",this.onFollowButtonClick,param2);
         this.var_64 = IItemListWindow(param2.findChildByName("msg_list"));
         this.var_2682 = IScrollbarWindow(param2.findChildByName("scroller"));
      ...
      public function addMessage(param1:Message) : void
      {
         ...
         if(_loc2_ >= const_1105 + const_1587)
         {
            this.refreshList();
            this.afterResize();
         }
      ...
      private function refreshTextDims(param1:ITextWindow) : void
      {
         ...
         param1.height = param1.textHeight + const_1588;
         param1.invalidate();
      }
      ...
      public function refresh() : void
      {
         ...
         if(this.var_553 == null || _loc1_.id != this.var_553.id)
         {
            this.var_553 = _loc1_;
            this.refreshList();
            this.afterResize();
      ...
      {
         if(this.var_553.followingAllowed)
         {
            this.var_1958.enable();
         }
         else
         {
            this.var_1958.disable();
         }
      }
      ...
      private function refreshList() : void
      {
         ...
         this.var_64.autoArrangeItems = false;
         var _loc1_:int = 0;
         var _loc2_:int = Math.max(0,this.var_553.messages.length - const_1105);
         _loc1_ = 0;
         while(_loc1_ + _loc2_ < this.var_553.messages.length)
         {
            this.refreshEntry(true,_loc1_,this.var_553.messages[_loc1_ + _loc2_]);
            _loc1_++;
         }
         while(true)
         {
      ...
      private function refreshEntry(param1:Boolean, param2:int, param3:Message) : Boolean
      {
         ...
         _loc4_.visible = true;
         var _loc5_:String = param3.type == Message.const_863 || param3.type == Message.const_999 ? param3.time + ": " : "";
      ...
      private function onMinimailButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         _loc3_["recipientid"] = "" + this.var_553.id;
      ...
      private function onFollowButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_153.send(new FollowFriendMessageComposer(this.var_553.id));
      ...
      {
         if(param1 == Message.const_863)
         {
            return 4294967295;
         }
         if(param1 == Message.const_999)
         {
            return 4292801535;
         }
         if(param1 == Message.const_1182)
         {
            return 4294927974;
         }
         ...
         if(param1 == Message.const_985)
         {
            return 4293454056;
         }
         if(param1 == Message.const_1408)
         {
            return 4288269465;
         }
         return 4291611852;
