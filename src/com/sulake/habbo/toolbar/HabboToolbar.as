package com.sulake.habbo.toolbar
{
   ...
   public class HabboToolbar extends Component implements IHabboToolbar
   {
      ...
      private static const const_1575:String = "purse";
      
      private static const const_1574:String = "extra_tools";
      ...
      private var var_667:ExtraToolsExtension;
      
      private var _connection:IConnection;
      
      private var _catalog:IHabboCatalog;
      
      private var var_1270:PurseExtension;
      
      private var var_1556:ClubDiscountPromoExtension;
      
      private var _localization:ICoreLocalizationManager;
      
      private var var_12:IHabboInventory;
      
      private var var_668:ExtensionView;
      ...
      private function onCommunicationManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this._connection = this.var_303.getHabboMainConnection(null);
         this.tryInitialize();
      }
      ...
      {
         if(this.var_303 && this._windowManager && this._config && this._localization && this.var_12 && this._catalog)
         {
            this.var_303.addHabboConnectionMessageEvent(new AuthenticationOKMessageEvent(this.onAuthenticationOK));
            unlock();
         }
      }
      ...
      private function onAuthenticationOK(param1:IMessageEvent) : void
      {
         ...
         {
            this.var_668 = new ExtensionView(this._windowManager,this._assetLibrary,this);
            if(this.var_668)
            {
               this.var_1270 = new PurseExtension(this._windowManager,this._assetLibrary,this._config,this._catalog,this.var_12,this._localization);
               this.var_667 = new ExtraToolsExtension(this,this._windowManager,this._assetLibrary,events,this._config);
               if(this._config.getBoolean("club.membership.extend.promotion.enabled",false))
               {
                  this.var_1556 = new ClubDiscountPromoExtension(this,this._windowManager,this._assetLibrary,events,this._config,this._localization,this.var_12,this._catalog,this._connection);
               }
               this.var_668.attachExtension(const_1575,this.var_1270.window,ExtensionFixedSlotsEnum.const_1842);
               this.var_668.attachExtension(const_1574,this.var_667.window,ExtensionFixedSlotsEnum.const_1832);
            }
         }
         if(this._view == null)
         {
      ...
      private function toolbarExtensionVisible(param1:Boolean) : void
      {
         ...
         if(param1)
         {
            this.var_667.showRoomInfo();
         }
         else
         {
            this.var_667.hideRoomInfo();
         }
      }
