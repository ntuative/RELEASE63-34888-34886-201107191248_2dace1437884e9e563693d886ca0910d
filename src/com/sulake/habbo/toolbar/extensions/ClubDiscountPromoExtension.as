package com.sulake.habbo.toolbar.extensions
{
   ...
   public class ClubDiscountPromoExtension
   {
      ...
      private static const const_712:String = "club_promo";
      
      private static const const_1593:int = 13;
      
      private static const const_1107:int = 14;
      
      private static const const_1607:uint = 16777215;
      
      private static const const_1608:uint = 12247545;
      ...
      private var var_668:IExtensionView;
      ...
      private var var_1311:IRegionWindow;
      ...
      public function ClubDiscountPromoExtension(param1:HabboToolbar, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IEventDispatcher, param5:IHabboConfigurationManager, param6:ICoreLocalizationManager, param7:IHabboInventory, param8:IHabboCatalog, param9:IConnection)
      {
         ...
         this.var_668 = param1.extensionView;
         if(this.var_12)
         {
            this.var_12.events.addEventListener(HabboInventoryHabboClubEvent.const_357,this.onClubChanged);
         }
      }
         ...
         if(_loc4_)
         {
            ...
            if(_loc3_)
            {
               ...
               if(this.var_87)
               {
                  ...
                  if(_loc5_)
                  {
                     this.var_862 = _loc5_.content as BitmapData;
                     if(this.var_862)
                     {
                        this.var_87.bitmap = this.var_862.clone();
                     }
                  }
                  this.var_87.visible = false;
               }
               this.var_1311 = _loc3_.findChildByName("text_region") as IRegionWindow;
               if(this.var_1311)
               {
                  this.var_1311.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onTextRegionClicked);
                  this.var_1311.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER,this.onTextRegionMouseOver);
                  this.var_1311.addEventListener(WindowMouseEvent.const_25,this.onTextRegionMouseOut);
               }
               this.assignState();
            }
         }
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            if(this.var_668)
            {
               this.var_668.detachExtension(const_712);
               this.var_668 = null;
            }
            this.animate(false);
            this.clearAnimation();
            ...
            if(this.var_12)
            {
               this.var_12.events.removeEventListener(HabboInventoryHabboClubEvent.const_357,this.onClubChanged);
               this.var_12 = null;
            }
            this._catalog = null;
      ...
      private function onClubChanged(param1:HabboInventoryHabboClubEvent) : void
      {
         if(this.var_12.clubIsExpiring)
         {
            if(!this._view)
            {
               ...
               this.assignState();
               this.var_668.attachExtension(const_712,this._view,ExtensionFixedSlotsEnum.const_1737);
            }
         }
         else
         {
      ...
      private function animate(param1:Boolean) : void
      {
         if(param1)
         {
            ...
            this.var_695 = new Timer(15000);
            this.var_695.addEventListener(TimerEvent.TIMER,this.onTriggerTimer);
            this.var_695.start();
         }
         else
         {
      ...
      private function resetAnimationVariables() : void
      {
         ...
         this.var_2037 = this._view.width - 7 - this.var_87.bitmap.width;
         this.var_1597 = 0;
      }
      
      private function startAnimationTimer() : void
      {
         this.var_688 = new Timer(25,26);
         this.var_688.addEventListener(TimerEvent.TIMER,this.onAnimationTimer);
         this.var_688.addEventListener(TimerEvent.TIMER_COMPLETE,this.onAnimationTimerComplete);
         this.var_688.start();
      }
      ...
      private function onAnimationTimer(param1:TimerEvent) : void
      {
         var _loc2_:int = 0;
         var _loc3_:* = null;
         this.var_87.x = 3 + this.var_1597 / 20 * this.var_2037;
         if(this.var_87.x > this.var_2037)
         {
            _loc2_ = this._view.width - 4 - this.var_87.x;
            _loc3_ = new BitmapData(_loc2_,this.var_862.height);
            _loc3_.copyPixels(this.var_862,new Rectangle(0,0,_loc2_,this.var_862.height),new Point(0,0));
