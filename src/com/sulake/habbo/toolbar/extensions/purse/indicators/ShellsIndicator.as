package com.sulake.habbo.toolbar.extensions.purse.indicators
{
   ...
   public class ShellsIndicator extends CurrencyIndicatorBase
   {
      ...
      private static const const_473:Array = ["icon_shell_0_png","icon_shell_1_png","icon_shell_2_png","icon_shell_3_png"];
       
      
      private const const_1594:uint = 4.283212437E9;
      
      private const const_1595:uint = 4.282748017E9;
      ...
      public function ShellsIndicator(param1:IHabboWindowManager, param2:IAssetLibrary, param3:IHabboCatalog, param4:ICoreLocalizationManager)
      {
         ...
         this.bgColorLight = this.const_1594;
         this.bgColorDark = this.const_1595;
         this.textElementName = "amount";
         this.textElementShadowName = "amount_shadow";
         this.iconAnimationSequence = const_473.concat(const_473).concat(const_473);
         this.iconAnimationDelay = 50;
         this.amountZeroText = param4.getKey("purse.shells.zero.amount.text","Info");
         createWindow("purse_indicator_shells_xml",const_473[0]);
         this.setAmount(0);
      }
      ...
      {
         this._catalog.openCatalogPage(CatalogPageName.const_1971,true);
      }
      ...
      private function onShellBalance(param1:PurseEvent) : void
      {
         ...
         if(this.var_1830 != 0)
         {
            if(this.var_1830 > param1.balance)
            {
