package com.sulake.habbo.toolbar.extensions.purse
{
   ...
   public class CurrencyIndicatorBase implements ICurrencyIndicator
   {
      ...
      private var var_687:IBitmapWrapperWindow;
      
      private var var_2748:uint;
      
      private var var_2749:uint;
      
      private var var_2017:String;
      
      private var var_2019:String;
      
      private var var_296:Vector.<BitmapData>;
      
      private var var_2750:uint;
      
      private var var_2747:String = null;
      ...
      {
         this.var_296 = new Vector.<BitmapData>();
         super();
         this._view = null;
      ...
      protected function createWindow(param1:String, param2:String) : void
      {
         ...
         if(_loc3_)
         {
            ...
            if(this._view)
            {
               ...
               {
                  this.var_687 = _loc4_[0] as IBitmapWrapperWindow;
      ...
      protected function animateIcon(param1:int) : void
      {
         ...
         if(this.var_687 && this.var_296.length > 0)
         {
            ...
            {
               this.var_295 = this.var_296.length - 1;
            }
            this.var_688 = new Timer(this.var_2750,this.var_296.length);
      ...
      protected function setText(param1:String) : void
      {
         if(this._view)
         {
            ...
            this._view.findChildByName(this.var_2019).caption = param1;
         }
      }
      ...
      protected function setTextUnderline(param1:Boolean) : void
      {
         ...
         if(this._view)
         {
            _loc2_ = this._view.findChildByName(this.var_2017) as ITextWindow;
            _loc3_ = this._view.findChildByName(this.var_2019) as ITextWindow;
      ...
      protected function set iconAnimationSequence(param1:Array) : void
      {
         ...
         for each(_loc2_ in param1)
         {
            ...
            if(_loc3_)
            {
               ...
               if(_loc4_)
               {
                  this.var_296.push(_loc4_.clone());
               }
            }
         }
      }
      ...
      private function onAnimationTimer(param1:TimerEvent) : void
      {
         if(this.var_687 && this.var_296.length > 0)
         {
            this.setIconBitmap(this.var_296[this.var_295]);
            if(this.var_2018 == ANIM_DIRECTION_FORWARD)
            {
               ++this.var_295;
               this.var_295 = this.var_295 < this.var_296.length ? int(this.var_295) : int(this.var_296.length - 1);
            }
            else
            {
               --this.var_295;
               this.var_295 = this.var_295 >= 0 ? int(this.var_295) : 0;
            }
         }
      }
      ...
      private function onAnimationTimerComplete(param1:TimerEvent) : void
      {
         ...
         {
            this.setIconBitmap(this.var_296[0]);
         }
      }
      ...
      private function setIconBitmap(param1:BitmapData) : void
      {
         if(this.var_687)
         {
            this.var_687.bitmap = param1.clone();
            this.var_687.width = param1.width;
            this.var_687.height = param1.height;
            this.var_687.invalidate();
         }
      }
      
      private function onContainerMouseOver(param1:WindowMouseEvent) : void
      {
         this._view.color = this.var_2749;
      }
      
      private function onContainerMouseOut(param1:WindowMouseEvent) : void
      {
         this._view.color = this.var_2748;
      }
   }
}
