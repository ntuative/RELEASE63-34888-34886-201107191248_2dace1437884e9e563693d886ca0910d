package com.sulake.habbo.navigator
{
   ...
   public class HabboNavigator extends Component implements IHabboNavigator
   {
      ...
      private var var_333:MainViewCtrl;
      
      private var var_677:RoomInfoViewCtrl;
      
      private var var_1279:RoomCreateViewCtrl;
      
      private var _data:NavigatorData;
      
      private var var_436:Tabs;
      ...
      private var var_1106:GuestRoomPasswordInput;
      
      private var var_349:GuestRoomDoorbell;
      
      private var var_1280:OfficialRoomEntryManager;
      
      public function HabboNavigator(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         this.var_2680 = new Array();
         ...
         this.var_333 = new MainViewCtrl(this);
         this.var_677 = new RoomInfoViewCtrl(this);
         this.var_1279 = new RoomCreateViewCtrl(this);
         this.var_2681 = new RoomThumbnailRenderer(this);
         this.var_1106 = new GuestRoomPasswordInput(this);
         this.var_349 = new GuestRoomDoorbell(this);
         this.var_436 = new Tabs(this);
         this.var_1280 = new OfficialRoomEntryManager(this);
      }
      ...
      public function getButton(param1:String, param2:String, param3:Function, param4:int = 0, param5:int = 0, param6:int = 0) : IBitmapWrapperWindow
      {
         ...
         var _loc8_:IBitmapWrapperWindow = IBitmapWrapperWindow(this._windowManager.createWindow(param1,"",HabboWindowType.const_369,HabboWindowStyle.const_47,0 | 0,new Rectangle(param4,param5,_loc7_.width,_loc7_.height),param3,param6));
      ...
      private function onHabboToolbarEvent(param1:HabboToolbarEvent) : void
      {
         if(param1.type == HabboToolbarEvent.const_49)
         {
            ...
            {
               this.var_333.onNavigatorToolBarIconClick();
            }
      ...
      private function onConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var _loc3_:String = this.var_131.getKey("navigator.default_tab");
         switch(_loc3_)
         {
            case "popular":
               _loc4_ = 0;
      ...
      public function performTagSearch(param1:String) : void
      {
         ...
         this.var_333.startSearch(Tabs.const_255,Tabs.const_535,param1);
         this.trackNavigationDataPoint("Search","search.tag",param1);
         this.var_333.mainWindow.activate();
      }
      ...
      public function showOwnRooms() : void
      {
         ...
         this.var_333.startSearch(Tabs.const_300,Tabs.const_312);
         this.var_436.getTab(Tabs.const_300).tabPageDecorator.tabSelected();
      }
