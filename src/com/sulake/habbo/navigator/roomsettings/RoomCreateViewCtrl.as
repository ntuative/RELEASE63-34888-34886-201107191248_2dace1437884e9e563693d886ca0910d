package com.sulake.habbo.navigator.roomsettings
{
   ...
   public class RoomCreateViewCtrl
   {
      ...
      private var var_1207:RoomLayout;
      ...
      public function RoomCreateViewCtrl(param1:HabboNavigator)
      {
         ...
         this.var_46.push(new RoomLayout(HabboClubLevelEnum.const_54,104,"a"));
         this.var_46.push(new RoomLayout(HabboClubLevelEnum.const_54,94,"b"));
         this.var_46.push(new RoomLayout(HabboClubLevelEnum.const_54,36,"c"));
         this.var_46.push(new RoomLayout(HabboClubLevelEnum.const_54,84,"d"));
         this.var_46.push(new RoomLayout(HabboClubLevelEnum.const_54,80,"e"));
         this.var_46.push(new RoomLayout(HabboClubLevelEnum.const_54,80,"f"));
         this.var_46.push(new RoomLayout(HabboClubLevelEnum.const_54,416,"i"));
         this.var_46.push(new RoomLayout(HabboClubLevelEnum.const_54,320,"j"));
         this.var_46.push(new RoomLayout(HabboClubLevelEnum.const_54,448,"k"));
         this.var_46.push(new RoomLayout(HabboClubLevelEnum.const_54,352,"l"));
         this.var_46.push(new RoomLayout(HabboClubLevelEnum.const_54,384,"m"));
         this.var_46.push(new RoomLayout(HabboClubLevelEnum.const_54,372,"n"));
         this.var_46.push(new RoomLayout(HabboClubLevelEnum.const_35,80,"g"));
         this.var_46.push(new RoomLayout(HabboClubLevelEnum.const_35,74,"h"));
         this.var_46.push(new RoomLayout(HabboClubLevelEnum.const_35,416,"o"));
         this.var_46.push(new RoomLayout(HabboClubLevelEnum.const_35,352,"p"));
         this.var_46.push(new RoomLayout(HabboClubLevelEnum.const_35,304,"q"));
         this.var_46.push(new RoomLayout(HabboClubLevelEnum.const_35,336,"r"));
         this.var_46.push(new RoomLayout(HabboClubLevelEnum.const_35,748,"u"));
         this.var_46.push(new RoomLayout(HabboClubLevelEnum.const_35,438,"v"));
         this.var_46.push(new RoomLayout(HabboClubLevelEnum.const_43,540,"t"));
         this.var_46.push(new RoomLayout(HabboClubLevelEnum.const_43,512,"w"));
         this.var_46.push(new RoomLayout(HabboClubLevelEnum.const_43,396,"x"));
         this.var_46.push(new RoomLayout(HabboClubLevelEnum.const_43,440,"y"));
         this.var_46.push(new RoomLayout(HabboClubLevelEnum.const_43,456,"z"));
         this.var_46.push(new RoomLayout(HabboClubLevelEnum.const_43,208,"0"));
      }
      ...
      {
         var _loc3_:IBitmapWrapperWindow = IBitmapWrapperWindow(this.var_1207.view.findChildByName("select_arrow"));
         var _loc6_:int = Math.abs(_loc3_.y - 0) < 2 || Math.abs(_loc3_.y - 15) < 2 ? 1 : 2;
         _loc3_.y += !!this.var_1812 ? _loc6_ : -_loc6_;
         if(_loc3_.y < 0)
         {
            this.var_1812 = true;
            _loc3_.y = 1;
      ...
      private function prepare() : void
      {
         ...
         this.var_196 = IWindowContainer(this._navigator.getXmlWindow("roc_create_room"));
         this.var_64 = IItemListWindow(this.var_196.findChildByName("item_list"));
         ...
         var _loc3_:IWindow = this.var_196.findChildByTag("close");
         this.addMouseClickListener(_loc3_,this.onCancelButtonClick);
         this.var_1208 = new TextFieldManager(this._navigator,ITextFieldWindow(this.var_196.findChildByName("room_name_input")),25,null,this._navigator.getText("navigator.createroom.roomnameinfo"));
         var _loc4_:Rectangle = Util.getLocationRelativeTo(this.var_196.desktop,this.var_196.width,this.var_196.height);
         this.var_196.x = _loc4_.x;
         this.var_196.y = _loc4_.y;
      }
      
      public function refresh() : void
      {
         this.var_1208.goBackToInitialState();
         this.var_1208.input.textBackgroundColor = 4294967295;
         this.var_1207 = this.var_46[0];
         this.refreshRoomThumbnails();
      ...
      private function refreshRoomThumbnails() : void
      {
         ...
         var _loc8_:* = null;
         var _loc9_:* = null;
         while(this.var_64.numListItems > 0)
         {
            _loc6_ = this.var_64.removeListItemAt(0);
            _loc6_.destroy();
         }
         for each(_loc1_ in this.var_46)
         {
         ...
         while(_loc4_ < this.var_46.length)
         {
            ...
            if(this.isAllowed(_loc7_))
            {
               ...
               {
                  _loc3_ = this.getRow();
                  this.var_64.addListItem(_loc3_);
               }
         ...
         if(_loc5_)
         {
            ...
            if(_loc8_)
            {
               ...
               this.var_64.addListItem(_loc8_);
            }
         }
      }
      ...
      private function addThumbnail(param1:IWindowContainer, param2:RoomLayout, param3:Boolean) : void
      {
         ...
         _loc6_.setParamFlag(HabboWindowParam.const_44,false);
      ...
      {
         return IWindowContainer(this._navigator.windowManager.createWindow("","",HabboWindowType.const_79,HabboWindowStyle.const_31,HabboWindowParam.const_63,new Rectangle(0,0,100,300)));
      }
      
      private function isMandatoryFieldsFilled() : Boolean
      {
         return Boolean(this.var_1208.checkMandatory(this._navigator.getText("navigator.createroom.nameerr")));
      }
      
      private function getCreateButton() : IButtonWindow
      {
         return IButtonWindow(this.var_196.findChildByName("create_button"));
      }
      
      private function getCancelButton() : IButtonWindow
      {
         return IButtonWindow(this.var_196.findChildByName("back_button"));
      }
      ...
      {
         var _loc2_:String = this.var_1208.getText();
         var _loc3_:String = "model_" + this.var_1207.name;
