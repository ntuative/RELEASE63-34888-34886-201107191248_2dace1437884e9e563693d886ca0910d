package com.sulake.habbo.navigator.roomsettings
{
   ...
   public class RoomSettingsCtrl
   {
      ...
      private var var_1372:TextFieldManager;
      
      private var var_1008:TextFieldManager;
      
      private var var_1007:TextFieldManager;
      
      private var var_1106:TextFieldManager;
      
      private var var_1368:TextFieldManager;
      
      private var var_1367:ICheckBoxWindow;
      
      private var var_1374:ICheckBoxWindow;
      
      private var var_1373:ICheckBoxWindow;
      
      private var var_904:ICheckBoxWindow;
      
      private var var_2151:ITextWindow;
      
      private var var_1104:IDropMenuWindow;
      
      private var var_1105:IDropMenuWindow;
      
      private var var_2926:IWindowContainer;
      ...
      private var var_1659:IWindowContainer;
      ...
      {
         this.var_424 = param1;
         this._navigator.send(new GetRoomSettingsMessageComposer(this.var_424));
      ...
      {
         if(param1 != this.var_424 || this.var_1375 < 1)
         {
            return;
         }
         this.close();
      ...
      public function onRoomSettingsSaveError(param1:int, param2:int, param3:String) : void
      {
         ...
         this.var_1375 = 0;
         if(param2 == RoomSettingsSaveErrorMessageParser.const_1915)
         {
            this.var_903.displayError("${navigator.roomsettings.roomnameismandatory}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1899)
         {
            this.var_903.displayError("${navigator.roomsettings.unacceptablewords}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1870)
         {
            this.var_1372.displayError("${navigator.roomsettings.unacceptablewords}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1749)
         {
            this.setTagError(this.var_1008,param3,"${navigator.roomsettings.unacceptablewords}");
            this.setTagError(this.var_1007,param3,"${navigator.roomsettings.unacceptablewords}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1988)
         {
            this.setTagError(this.var_1008,param3,"${navigator.roomsettings.nonuserchoosabletag}");
            this.setTagError(this.var_1007,param3,"${navigator.roomsettings.nonuserchoosabletag}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1858)
         {
            this.var_1106.displayError("${navigator.roomsettings.passwordismandatory}");
         }
         else
         {
            this.var_903.displayError("Update failed: error " + param2);
         }
      }
      ...
      private function clearErrors() : void
      {
         ...
         this.var_1372.clearErrors();
         this.var_1008.clearErrors();
         this.var_1007.clearErrors();
         this.var_1106.clearErrors();
         this.var_1368.clearErrors();
      }
      ...
      private function prepareWindow(param1:IWindowContainer) : void
      {
         ...
         _loc2_.addEventListener(WindowEvent.const_351,this.onDoorModePasswordSelect);
         _loc2_.addEventListener(WindowEvent.const_501,this.onDoorModePasswordUnselect);
         ...
         this.var_903 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("room_name")),60);
         this.var_1372 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("description")),255);
         this.var_1008 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("tag1")),30);
         this.var_1007 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("tag2")),30);
         this.var_1106 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("password")),30);
         this.var_1368 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("password_confirm")),30);
         this.var_1367 = ICheckBoxWindow(this._window.findChildByName("allow_pets_checkbox"));
         this.var_1374 = ICheckBoxWindow(this._window.findChildByName("allow_foodconsume_checkbox"));
         this.var_1373 = ICheckBoxWindow(this._window.findChildByName("allow_walk_through_checkbox"));
         this.var_904 = ICheckBoxWindow(this._window.findChildByName("hide_walls_checkbox"));
         this.var_2151 = this._window.findChildByName("hide_walls_text") as ITextWindow;
         this.var_1104 = IDropMenuWindow(this._window.findChildByName("wall_thickness"));
         this.var_1105 = IDropMenuWindow(this._window.findChildByName("floor_thickness"));
         this.var_2926 = IWindowContainer(this._window.findChildByName("thumbnail_container"));
         this.var_1371 = IWindowContainer(this._window.findChildByName("basic_settings_container"));
         this.var_1369 = IWindowContainer(this._window.findChildByName("advanced_settings_container"));
         this.var_2150 = IWindowContainer(this._window.findChildByName("switch_view_container"));
         this.var_1659 = IWindowContainer(this._window.findChildByName("footer_container"));
         this.var_264 = IWindowContainer(this._window.findChildByName("flat_controllers_container"));
         this.var_1370 = IWindowContainer(this._window.findChildByName("password_container"));
         this.var_1658 = ITextWindow(this._window.findChildByName("switch_view_text"));
         this.var_1658.mouseThreshold = 0;
         this.var_1658.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onSwitchView);
         this.var_1370.visible = false;
         if(!this.var_1660)
         {
      ...
      public function refresh(param1:IWindowContainer) : void
      {
         ...
         this.var_2150.visible = this.var_1660;
         this.populateForm();
         if(this.var_905)
         {
            ...
            this.var_1369.height = Util.getLowestPoint(this.var_1369) + 4;
         }
         else
         {
            this.var_1371.visible = true;
            this.var_1659.visible = true;
            this.var_2926.visible = this.var_1660;
            this.var_1371.height = Util.getLowestPoint(this.var_1371) + 4;
         }
         this.var_1658.text = !!this.var_905 ? "${navigator.roomsettings.tobasicsettings}" : "${navigator.roomsettings.toadvancedsettings}";
         Util.moveChildrenToColumn(this._window,[this.var_1371.name,this.var_1369.name,this.var_1659.name,this.var_2150.name],0,0);
      ...
      private function populateForm() : void
      {
         ...
         this.var_903.setText(_loc1_.name);
         this.var_1372.setText(_loc1_.description);
         this.var_1106.setText("");
         this.var_1368.setText("");
         ...
         {
            case RoomSettingsData.const_213:
         ...
         this.setTag(this.var_1008,_loc1_.tags[0]);
         this.setTag(this.var_1007,_loc1_.tags[1]);
         if(this.var_1367)
         {
            if(_loc1_.allowPets)
            {
         ...
         if(this.var_1374)
         {
            ...
            {
               this.var_1374.select();
            }
            else
            {
               this.var_1374.unselect();
            }
         }
         if(this.var_1373)
         {
            ...
            {
               this.var_1373.select();
            }
            else
            {
               this.var_1373.unselect();
            }
         }
         if(!this.VIPFeaturesAllowed())
         {
            this.disableWindow(this.var_904);
            this.disableWindow(this.var_1104);
            this.disableWindow(this.var_1105);
            this.disableWindow(this.var_2151);
         }
         else
         {
            this.enableWindow(this.var_904);
            this.enableWindow(this.var_1104);
            this.enableWindow(this.var_1105);
            this.enableWindow(this.var_2151);
         }
         if(this.var_904)
         {
            if(_loc1_.hideWalls)
            ...
            {
               this.var_904.unselect();
            }
         }
         if(this.var_1104)
         {
            this.var_1104.selection = this.getThicknessSelectionIndex(_loc1_.wallThickness);
         }
         if(this.var_1105)
         {
            this.var_1105.selection = this.getThicknessSelectionIndex(_loc1_.floorThickness);
         }
         this.clearErrors();
      }
      ...
      private function onSaveButtonClick(param1:WindowMouseEvent) : void
      {
         ...
         _loc2_.name = this.var_903.getText();
         _loc2_.description = this.var_1372.getText();
         var _loc3_:ISelectorWindow = this._window.findChildByName("doormode") as ISelectorWindow;
         var _loc4_:IWindow = _loc3_.getSelected();
         switch(_loc4_.name)
         {
            case "doormode_doorbell":
               _loc2_.doorMode = RoomSettingsFlatInfo.const_213;
               break;
            case "doormode_password":
               _loc2_.doorMode = RoomSettingsFlatInfo.const_125;
               break;
            default:
               _loc2_.doorMode = RoomSettingsFlatInfo.const_595;
         }
         if(_loc2_.doorMode == RoomSettingsFlatInfo.const_125)
         {
            _loc8_ = this.var_1106.getText();
            _loc9_ = this.var_1368.getText();
            if(_loc8_ != _loc9_)
            {
               this.var_1106.clearErrors();
               this.var_1368.displayError("${navigator.roomsettings.invalidconfirm}");
               return;
            }
            if(_loc8_ != "")
            {
         ...
         _loc2_.allowPets = this.var_1367.isSelected;
         _loc2_.allowFoodConsume = this.var_1374.isSelected;
         _loc2_.allowWalkThrough = this.var_1373.isSelected;
         _loc2_.hideWalls = this.var_904.isSelected;
         _loc2_.wallThickness = this.var_1104.selection - 2;
         _loc2_.floorThickness = this.var_1105.selection - 2;
         _loc2_.tags = new Array();
         this.addTag(this.var_1008,_loc2_.tags);
         this.addTag(this.var_1007,_loc2_.tags);
         this.clearErrors();
         this.var_1375 = _loc2_.roomId;
      ...
      {
         Logger.log("[RoomSettingsCtrl.onDeleteButtonClick] " + this.var_424);
         if(this.var_57 == null)
         {
            return;
         }
         this._navigator.registerParameter("navigator.roomsettings.deleteroom.confirm.message","room_name",this.var_57.name);
         var _loc2_:ConfirmDialogView = new ConfirmDialogView(IFrameWindow(this._navigator.getXmlWindow("ros_room_delete_confirm")),this,this.onConfirmRoomDelete,[this.var_424]);
         _loc2_.show();
      }
      ...
      {
         return IWindowContainer(this._navigator.windowManager.createWindow(param1,"",HabboWindowType.const_79,HabboWindowStyle.const_31,HabboWindowParam.const_63,new Rectangle(0,0,100,20)));
      }
      ...
      private function onRemoveAllFlatCtrlsClick(param1:WindowEvent) : void
      {
         ...
         this._navigator.send(new RemoveAllRightsMessageComposer(this.var_424));
      }
