package com.sulake.habbo.navigator.mainview
{
   ...
   public class MainViewCtrl implements IUpdateReceiver, IDisposable
   {
      ...
      private var var_1013:GuestRoomListCtrl;
      
      private var var_1258:OfficialRoomListCtrl;
      
      private var var_289:ITabContextWindow;
      ...
      private var var_1535:IWindow;
      
      private var var_800:IRegionWindow;
      
      private var var_2591:int = 0;
      
      private var var_1260:TextSearchInputs;
      ...
      private const const_2079:Point = new Point(100,10);
      ...
      public function MainViewCtrl(param1:HabboNavigator)
      {
         ...
         this.var_1013 = new GuestRoomListCtrl(this._navigator);
         this.var_1258 = new OfficialRoomListCtrl(this._navigator);
         this.var_542 = new Timer(300,1);
         this.var_542.addEventListener(TimerEvent.TIMER,this.onResizeTimer);
      }
      ...
      public function onNavigatorToolBarIconClick() : Boolean
      {
         ...
         {
            this.var_799 = new WindowToggle(this.var_16,this.var_16.desktop,this.reloadData,this.close);
         }
         var _loc1_:int = this.var_799.toggle();
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            if(this.var_542)
            {
               this.var_542.removeEventListener(TimerEvent.TIMER,this.onResizeTimer);
               this.var_542.reset();
               this.var_542 = null;
            }
            if(this.var_1012)
      ...
      private function prepare() : void
      {
         ...
         this.var_289 = ITabContextWindow(this.var_16.findChildByName("tab_context"));
         this.var_196 = IWindowContainer(this.var_16.findChildByName("tab_content"));
         this.var_252 = IWindowContainer(this.var_16.findChildByName("custom_content"));
         this.var_222 = IWindowContainer(this.var_16.findChildByName("list_content"));
         this.var_285 = IWindowContainer(this.var_16.findChildByName("custom_footer"));
         this.var_1535 = this.var_16.findChildByName("loading_text");
         ...
         this.var_800 = IRegionWindow(this.var_16.findChildByName("to_hotel_view"));
         if(this.var_800 != null)
         {
            this.var_800.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER,this.onHotelViewMouseOver);
            this.var_800.addEventListener(WindowMouseEvent.const_25,this.onHotelViewMouseOut);
            this.var_800.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onHotelViewMouseClick);
         }
         this.refreshToHotelViewButton(false);
         this.var_16.addEventListener(WindowEvent.const_40,this.onWindowResized);
         for each(_loc2_ in this._navigator.tabs.tabs)
         {
            _loc3_ = this.var_289.getTabItemByID(_loc2_.id);
            if(_loc3_ != null)
            {
         ...
         this.var_16.scaler.setParamFlag(HabboWindowParam.const_993,false);
         this.var_16.scaler.setParamFlag(HabboWindowParam.const_1906,true);
         this.var_16.position = this.const_2079;
      ...
      private function createSearchInput() : void
      {
         ...
         if(this.var_1260 == null)
         {
            ...
            this.var_1260 = new TextSearchInputs(this._navigator,_loc3_);
         }
      ...
      public function refresh() : void
      {
         ...
         var _loc1_:int = this.var_222.y;
         Util.moveChildrenToColumn(this.var_196,["custom_content","list_content"],this.var_252.y,8);
         this.var_222.height = this.var_222.height + _loc1_ - this.var_222.y - this.var_285.height + this.var_2591;
         Util.moveChildrenToColumn(this.var_196,["list_content","custom_footer"],this.var_222.y,0);
         this.var_2591 = this.var_285.height;
      ...
      {
         var _loc1_:Tab = this._navigator.tabs.getSelected();
         var _loc2_:ISelectableWindow = this.var_289.selector.getSelected();
         if(_loc1_.button != _loc2_)
         {
            this.var_1900 = true;
            this.var_289.selector.setSelected(_loc1_.button);
         }
      }
      ...
      {
         this.refreshList(param1,param2,this.var_1013,"guest_rooms");
      }
      ...
      {
         this.refreshList(param1,param2,this.var_1258,"official_rooms");
      }
      ...
      private function refreshList(param1:Boolean, param2:Boolean, param3:IViewCtrl, param4:String) : void
      {
         ...
         if(param2)
         {
            ...
            {
               _loc5_ = this.var_222.findChildByName(param4);
      ...
      public function update(param1:uint) : void
      {
         ...
         if(this.var_657 == const_1087)
         {
            _loc3_ = Math.min(1,Math.max(0,this.var_222.blend - _loc2_));
            this.var_222.blend = _loc3_;
            this.var_252.blend = !!this.var_1259 ? Number(_loc3_) : Number(1);
            this.var_285.blend = !!this.var_1259 ? Number(_loc3_) : Number(1);
            if(_loc3_ == 0)
            {
               this.var_657 = const_702;
            }
         }
         else if(this.var_657 == const_702)
         {
            if(this.var_1534 % 10 == 1)
            {
               this.var_1535.visible = !this.var_1535.visible;
            }
            ++this.var_1534;
         ...
         else if(this.var_657 == const_1086)
         {
            this.refresh();
         ...
         {
            this.var_1535.visible = false;
            _loc3_ = Math.min(1,Math.max(0,this.var_222.blend + _loc2_));
            this.var_222.blend = _loc3_;
            this.var_252.blend = !!this.var_1259 ? Number(_loc3_) : Number(1);
            this.var_285.blend = !!this.var_1259 ? Number(_loc3_) : Number(1);
            if(this.var_222.blend >= 1)
            {
      ...
      private function onResizeTimer(param1:TimerEvent) : void
      {
         ...
         this.refreshScrollbar(this.var_1013);
      }
      ...
      {
         this._navigator.refreshButton(this.var_800,"icon_hotelview",!param1,null,0);
         this._navigator.refreshButton(this.var_800,"icon_hotelview_reactive",param1,null,0);
      }
