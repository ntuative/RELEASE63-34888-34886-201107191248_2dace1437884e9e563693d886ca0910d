package com.sulake.habbo.navigator.mainview
{
   ...
   public class GuestRoomListCtrl implements IViewCtrl
   {
      ...
      private var var_597:RoomPopupCtrl;
      
      private var var_609:IScrollbarWindow;
      
      private var var_1391:UserCountRenderer;
      ...
      public function GuestRoomListCtrl(param1:HabboNavigator)
      {
         ...
         this.var_597 = new RoomPopupCtrl(this._navigator,5,-5);
         this.var_1391 = new UserCountRenderer(this._navigator);
      }
      ...
      public function set content(param1:IWindowContainer) : void
      {
         ...
         this.var_609 = IScrollbarWindow(this.var_196.findChildByName("scroller"));
      }
      ...
      public function refresh() : void
      {
         ...
         {
            this.var_609.scrollV = 0;
         }
         this.var_196.findChildByName("no_rooms_found").visible = _loc1_.length < 1;
      }
      ...
      private function getVisibleEntryCount() : int
      {
         var _loc1_:int = 0;
         var _loc2_:int = 0;
         while(_loc2_ < this.var_64.numListItems)
         {
            if(this.var_64.getListItemAt(_loc2_).visible)
            {
               _loc1_++;
            }
            _loc2_++;
      ...
      private function getListEntry(param1:int) : IWindowContainer
      {
         ...
         _loc2_.addEventListener(WindowMouseEvent.const_186,this.onMouseMove);
         ...
         _loc2_.setParamFlag(HabboWindowParam.const_1816,true);
      ...
      public function refreshEntryDetails(param1:IWindowContainer, param2:GuestRoomData) : void
      {
         ...
         this._navigator.refreshButton(param1,"doormode_doorbell_small",param2.doorMode == RoomSettingsFlatInfo.const_213,null,0);
         this._navigator.refreshButton(param1,"doormode_password_small",param2.doorMode == RoomSettingsFlatInfo.const_125,null,0);
         this.refreshRoomName(param1,param2);
         this.var_1391.refreshUserCount(param2.maxUserCount,param1,param2.userCount,"${navigator.usercounttooltip.users}",233,2);
      }
      ...
      private function onMouseOver(param1:WindowEvent) : void
      {
         ...
         if(this.var_597.visible && this.var_2971)
         {
            return;
         }
         ...
         this.var_597.room = _loc4_;
         this.var_597.showPopup(_loc2_);
      }
      ...
      private function hilite(param1:IWindowContainer) : void
      {
         ...
         {
            _loc2_ = this.var_1676.tags[0];
            this.var_1676.color = this.getBgColor(_loc2_);
         }
      ...
      private function checkFastHorizontalMove(param1:WindowEvent) : void
      {
         ...
         var _loc3_:int = Math.abs(this.var_2970 - _loc2_.stageX);
         this.var_2970 = _loc2_.stageX;
         this.var_2971 = _loc3_ > 2;
      }
   }
}
