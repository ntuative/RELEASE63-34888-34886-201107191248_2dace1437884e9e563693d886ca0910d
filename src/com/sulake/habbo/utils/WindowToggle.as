package com.sulake.habbo.utils
{
   ...
   public class WindowToggle implements IDisposable
   {
      ...
      public static const const_1981:int = 1;
      ...
      private var var_1490:Function;
      
      private var var_982:Function;
      ...
      public function show() : void
      {
         ...
         {
            if(this._window.parent != this.var_983)
            {
               this.var_983.addChild(this._window);
            }
