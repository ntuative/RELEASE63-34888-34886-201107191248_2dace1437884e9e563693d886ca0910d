package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ProductViewCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private var var_557:IDisplayObjectWrapper;
      
      private var var_1978:Point;
      
      private var var_556:IItemGridWindow;
      
      private var var_1574:IScrollbarWindow;
      
      protected var var_2177:XML;
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_207.removeEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onClickRoomView);
            this.var_207 = null;
         }
      }
      ...
      override public function init() : Boolean
      {
         ...
         this.var_1048 = _window.findChildByName("ctlg_product_name") as ITextWindow;
         this.var_1290 = _window.findChildByName("ctlg_description") as ITextWindow;
         this.var_99 = _window.findChildByName("ctlg_teaserimg_1") as IBitmapWrapperWindow;
         this.var_207 = _window.findChildByName("room_canvas_container") as IWindowContainer;
         if(this.var_207 != null)
         {
            this.var_207.visible = false;
            this.var_557 = this.var_207.findChildByName("room_canvas") as IDisplayObjectWrapper;
            _loc3_ = (page.viewer.catalog as HabboCatalog).roomPreviewer;
            if(this.var_557 != null && _loc3_ != null)
            {
               this.var_207.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onClickRoomView);
               _loc3_.reset();
               _loc4_ = _loc3_.getRoomCanvas(this.var_557.width,this.var_557.height);
               if(_loc4_ != null)
               {
                  this.var_557.setDisplayObject(_loc4_);
               }
            }
            else
            {
         ...
         this.var_1978 = new Point(this.var_99.x,this.var_99.y);
         this.var_556 = _window.findChildByName("bundleGrid") as IItemGridWindow;
         this.var_1574 = _window.findChildByName("bundleGridScrollbar") as IScrollbarWindow;
         if(this.var_556 == null)
         {
            Logger.log("[ProductViewCatalogWidget] Bundle Grid not initialized!");
         }
         var _loc1_:XmlAsset = page.viewer.catalog.assets.getAssetByName("gridItem") as XmlAsset;
         this.var_2177 = _loc1_.content as XML;
      ...
      private function onPreviewProduct(param1:SelectProductEvent) : void
      {
         ...
         if(this.var_556 != null)
         {
            this.var_556.visible = false;
            this.var_556.destroyGridItems();
         }
         ...
         this.var_1048.text = _loc4_;
         this.var_1290.text = _loc5_;
         this.var_1048.height = this.var_1048.textHeight + 5;
         this.var_1290.y = this.var_1048.y + this.var_1048.height;
         this.var_1290.height = Math.max(130,this.var_1290.textHeight + 5);
         ...
         else
         {
            ...
            switch(_loc2_.pricingModel)
            {
               case Offer.const_599:
                  ...
                  if(this.var_556 != null)
                  {
                     this.var_556.visible = true;
                     _loc11_ = _loc2_.productContainer as BundleProductContainer;
                     _loc11_.populateItemGrid(this.var_556,this.var_1574,this.var_2177);
                     this.var_556.scrollV = 0;
                  }
                  if(this.var_207 != null)
                  {
                     this.var_207.visible = false;
               ...
               case Offer.const_457:
                  ...
                  if(this.var_207 != null)
                  {
                     if(_loc9_.productType == ProductTypeEnum.const_69 || _loc9_.productType == ProductTypeEnum.const_65 || _loc9_.productType == ProductTypeEnum.const_183)
                     {
                  ...
                  switch(_loc9_.productType)
                  {
                     case ProductTypeEnum.const_69:
                        if(_loc8_ != null && this.var_557 != null)
                        {
                     ...
                     case ProductTypeEnum.const_183:
                        ...
                        else
                        {
                           ...
                           if(_loc17_.avatarRenderManager != null)
                           {
                              ...
                              if(_loc18_ != null)
                              {
                                 _loc18_.setDirection(AvatarSetType.const_55,3);
                                 _loc18_.initActionAppends();
                                 _loc18_.appendAction(AvatarAction.const_372,AvatarAction.const_559);
                                 _loc18_.appendAction(AvatarAction.const_377,_loc9_.productClassId);
      ...
      {
         var _loc1_:* = null;
         for each(_loc1_ in this.var_2711)
         {
            _window.removeChild(_loc1_);
            _loc1_.dispose();
            _loc1_ = null;
         }
         this.var_2711 = new Array();
      }
      ...
      private function setPreviewImage(param1:BitmapData, param2:Boolean, param3:Point = null) : void
      {
         ...
         if(this.var_99 != null && true)
         {
            ...
            this.var_99.x = this.var_1978.x;
            this.var_99.y = this.var_1978.y;
            if(param3 != null)
            {
