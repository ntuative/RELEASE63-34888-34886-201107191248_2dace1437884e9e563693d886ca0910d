package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class SongDiskProductViewCatalogWidget extends ProductViewCatalogWidget
   {
      ...
      private var var_444:IButtonWindow;
      ...
      {
         super(param1);
         this.var_444 = _window.findChildByName("listen") as IButtonWindow;
         this.var_1164 = _window.findChildByName("ctlg_song_length") as ITextWindow;
         if(this.var_444 != null)
         {
            this.var_444.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onClickPlay);
            this.var_444.disable();
         }
      ...
      override public function dispose() : void
      {
         if(this.var_444 != null)
         {
            this.var_444.removeEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onClickPlay);
         }
         if(this._soundManager != null && this._soundManager.musicController != null)
         {
            this._soundManager.musicController.stop(HabboMusicPrioritiesEnum.const_223);
      ...
      private function onClickPlay(param1:WindowMouseEvent) : void
      {
         if(this._soundManager != null && this._soundManager.musicController != null)
         {
            ...
            this.forceNoFadeoutOnPlayingSong(HabboMusicPrioritiesEnum.const_223);
            this._soundManager.musicController.playSong(this.var_952,HabboMusicPrioritiesEnum.const_223,15,40,0.5,2);
         }
      }
      ...
      private function onSelectProduct(param1:SelectProductEvent) : void
      {
         ...
         {
            this.var_952 = parseInt(_loc2_.extraParam);
            if(this.var_1165 != null)
            {
      ...
      private function updateView() : void
      {
         ...
         if(_loc2_ >= 0)
         {
            ...
            {
               this.var_1164.text = _loc8_;
            }
         }
         else if(this.var_1164 != null)
         {
            this.var_1164.text = "";
         }
         if(this.var_444 != null)
      ...
      private function getSongLength() : int
      {
         ...
         if(this._soundManager != null && this._soundManager.musicController != null)
         {
            _loc1_ = this._soundManager.musicController.getSongInfo(this.var_952);
            if(_loc1_ != null)
            {
               return _loc1_.length / 1000;
            }
            this._soundManager.musicController.requestSongInfoWithoutSamples(this.var_952);
         }
         return -1;
      }
