package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class NewPetsCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private var var_220:Array = null;
      ...
      override public function init() : Boolean
      {
         ...
         this.var_564 = this.getPetTypeIndexFromProduct(_loc2_.localizationId);
         if(this.var_564 < 8)
         {
            return false;
         }
         this.var_2521 = _loc2_.localizationId;
         this.updateAvailableBreeds(_loc2_.localizationId);
         if(this.var_220 != null && this.var_220.length > 0)
         {
            this.var_403 = this.var_220[0];
         }
         else
         {
            this.var_403 = -1;
         }
         this._offers.add(this.var_564,_loc2_);
      ...
      private function initializeBreedSelection() : void
      {
         ...
         if(this.var_220 != null)
         {
            _loc1_ = [];
            _loc2_ = 0;
            while(_loc2_ < const_1629 && _loc2_ < this.var_220.length)
            {
               _loc3_ = (page.viewer.catalog as HabboCatalog).roomEngine.getPetColor(this.var_564,this.var_220[_loc2_]);
               if(_loc3_ != null)
               {
      ...
      private function selectedBreed(param1:int) : void
      {
         if(this.var_220 != null && this.var_220.length > 0)
         {
            ...
            this.var_403 = this.var_220[param1];
            this.updateImage();
         }
      }
      ...
      private function getPetLocalization() : String
      {
         ...
         if(page != null && false)
         {
            ...
            {
               return _loc1_.localization.getKey(this.getRaceLocalizationKey(this.var_564,this.var_403),this.getRaceLocalizationKey(this.var_564,this.var_403));
            }
         }
         return this.getRaceLocalizationKey(this.var_564,this.var_403);
      }
      ...
      private function updateImage() : void
      {
         ...
         if(_loc1_ == null || this.var_403 < 0)
         {
            return;
         }
         var _loc2_:int = this.var_564;
         var _loc3_:int = this.var_403;
      ...
      private function getPurchaseParameters() : String
      {
         ...
         var p:String = this._name + String.fromCharCode(10) + this.var_403 + String.fromCharCode(10) + this.addZeroPadding(color.toString(16).toUpperCase(),6);
         return p;
      }
