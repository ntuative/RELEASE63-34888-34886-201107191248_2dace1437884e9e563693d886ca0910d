package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class SpacesCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      private var var_1661:String = "default";
      ...
      private var var_1662:String = "1.1";
      
      private var var_1108:Dictionary;
      
      private var var_1377:Dictionary;
      
      private var var_1379:Dictionary;
      ...
      override public function init() : Boolean
      {
         ...
         this.var_1108 = this.parseElements(_loc2_.floors.pattern);
         this.var_1377 = this.parseElements(_loc2_.walls.pattern);
         this.var_1379 = this.parseElements(_loc2_.landscapes.pattern);
         for each(_loc3_ in page.offers)
         {
            ...
            {
               case "floor":
                  for(_loc10_ in this.var_1108)
                  {
                     _loc11_ = this.var_1108[_loc10_];
               ...
               case "wallpaper":
                  ...
                  break;
               case "landscape":
                  if(this.var_1379[_loc8_] != null)
                  {
                     this.var_908.push(_loc8_);
         ...
         events.dispatchEvent(new CatalogWidgetUpdateRoomPreviewEvent(this._floorType,this.var_1661,this.var_1662,64));
         return true;
      }
      ...
      private function onClick(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc2_.name)
         {
            ...
            case "ctlg_wall_color_next":
               ...
               break;
            case "ctlg_buy_wall":
               _loc3_ = this.var_1378[this.var_494];
               if(_loc3_ != null)
               {
                  (page.viewer.catalog as HabboCatalog).showPurchaseConfirmation(_loc3_,page.pageId,this.var_1661);
               }
               break;
            ...
            case "ctlg_floor_color_next":
               ...
               break;
            case "ctlg_buy_floor":
               _loc3_ = this.var_1376[this.var_491];
               if(_loc3_ != null)
               {
            ...
            case "ctlg_buy_landscape":
               _loc3_ = this._landscapeOffers[this.var_489];
               if(_loc3_ != null)
               {
                  (page.viewer.catalog as HabboCatalog).showPurchaseConfirmation(_loc3_,page.pageId,this.var_1662);
               }
               break;
            default:
      ...
      private function updateConfiguration() : void
      {
         ...
         var _loc2_:String = this.var_732[this.var_491];
         var _loc3_:Array = this.var_1108[_loc2_];
         ...
         var _loc4_:Offer = this.var_1376[this.var_491];
         if(_loc4_ != null)
         {
         ...
         var _loc5_:String = this.var_907[this.var_494];
         var _loc6_:Array = this.var_1377[_loc5_];
         if(_loc6_ != null && this.var_493 >= 0)
         {
            _loc13_ = _loc6_[this.var_493];
            if(_loc13_ != null)
            {
               this.var_1661 = _loc13_;
            }
         }
         var _loc7_:Offer = this.var_1378[this.var_494];
         if(_loc7_ != null)
         {
         ...
         var _loc8_:String = this.var_908[this.var_489];
         var _loc9_:Array = this.var_1379[_loc8_];
         if(_loc9_ != null && this.var_490 >= 0)
         {
            _loc15_ = _loc9_[this.var_490];
            if(_loc15_ != null)
            {
               this.var_1662 = _loc15_;
            }
         }
         var _loc10_:Offer = this._landscapeOffers[this.var_489];
         if(_loc10_ != null)
         {
      ...
      private function changePattern(param1:String, param2:int) : void
      {
         ...
         switch(param1)
         {
            case const_110:
               ...
               if(this.var_491 < 0)
               {
                  this.var_491 = this.var_732.length - 1;
               }
               if(this.var_491 >= this.var_732.length)
               {
                  this.var_491 = 0;
               }
               this.var_492 = 0;
               this.var_1109 = 0;
               _loc5_ = this.var_732[this.var_491];
               _loc6_ = this.var_1108[_loc5_];
               if(_loc6_ != null)
               {
                  this.var_1109 = _loc6_.length;
               }
            ...
            case const_243:
               ...
               if(this.var_494 < 0)
               {
                  this.var_494 = this.var_907.length - 1;
               }
               if(this.var_494 == this.var_907.length)
               {
                  this.var_494 = 0;
               }
               this.var_493 = 0;
               this.var_1110 = 0;
               _loc7_ = this.var_907[this.var_494];
               _loc8_ = this.var_1377[_loc7_];
               if(_loc8_ != null)
               {
                  this.var_1110 = _loc8_.length;
               }
            ...
            case TYPE_LANDSCAPE:
               ...
               if(this.var_489 < 0)
               {
                  this.var_489 = this.var_908.length - 1;
               }
               if(this.var_489 >= this.var_908.length)
               {
                  this.var_489 = 0;
               }
               this.var_490 = 0;
               this.var_1107 = 0;
               _loc9_ = this.var_908[this.var_489];
               _loc10_ = this.var_1379[_loc9_];
               if(_loc10_ != null)
               {
                  this.var_1107 = _loc10_.length;
               }
