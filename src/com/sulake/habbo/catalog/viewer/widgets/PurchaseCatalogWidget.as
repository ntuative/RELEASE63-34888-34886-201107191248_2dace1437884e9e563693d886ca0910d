package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class PurchaseCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      private var var_2961:XML;
      
      private var var_2959:XML;
      
      private var var_2958:XML;
      
      private var var_2962:XML;
      
      private var var_2963:XML;
      
      private var var_2960:XML;
      
      private var var_1115:IWindowContainer;
      
      private var var_734:IButtonWindow;
      
      private var var_3126:IButtonWindow;
      
      private var var_2163:IButtonWindow;
      ...
      override public function dispose() : void
      {
         ...
         events.removeEventListener(WidgetEvent.const_749,this.onSetParameter);
      ...
      override public function init() : Boolean
      {
         ...
         if(_loc1_ != null)
         {
            this.var_2961 = _loc1_.content as XML;
         }
         var _loc2_:XmlAsset = page.viewer.catalog.assets.getAssetByName("purchaseWidgetPixelsStub") as XmlAsset;
         if(_loc2_ != null)
         {
            this.var_2959 = _loc2_.content as XML;
         }
         var _loc3_:XmlAsset = page.viewer.catalog.assets.getAssetByName("purchaseWidgetCreditsPixelsStub") as XmlAsset;
         if(_loc3_ != null)
         {
            this.var_2958 = _loc3_.content as XML;
         }
      ...
      private function attachStub(param1:String, param2:int) : void
      {
         ...
         if(this.var_33.hasUserRight(null,param2))
         {
            switch(param1)
            {
               case Offer.const_862:
                  _loc3_ = page.viewer.catalog.windowManager.buildFromXML(this.var_2961) as IWindowContainer;
                  break;
               case Offer.const_1409:
                  _loc3_ = page.viewer.catalog.windowManager.buildFromXML(this.var_2959) as IWindowContainer;
                  break;
               case Offer.const_1269:
                  _loc3_ = page.viewer.catalog.windowManager.buildFromXML(this.var_2958) as IWindowContainer;
                  break;
               default:
         ...
         else
         {
            switch(param2)
            {
               ...
               case HabboClubLevelEnum.const_43:
                  ...
                  {
                     _loc3_ = page.viewer.catalog.windowManager.buildFromXML(this.var_2960) as IWindowContainer;
                  }
            }
         }
         if(_loc3_ != null)
         {
            ...
            {
               _window.removeChild(this.var_1115);
               this.var_1115.dispose();
            }
            this.var_1115 = _loc3_;
            _window.addChild(_loc3_);
            this.var_1115.x = 0;
            this.var_1115.y = 0;
         }
         this.var_2165 = _window.findChildByName("ctlg_price_credits") as ITextWindow;
         this.var_2166 = _window.findChildByName("ctlg_price_pixels") as ITextWindow;
         this.var_2167 = _window.findChildByName("ctlg_price_credits_pixels") as ITextWindow;
         this.var_3100 = _window.findChildByName("ctlg_special_txt") as ITextWindow;
         this.var_734 = window.findChildByName("ctlg_buy_button") as IButtonWindow;
         this.var_2163 = window.findChildByName("ctlg_buy_club_button") as IButtonWindow;
         if(this.var_734 != null)
         {
            if(this.var_1668 != null)
            {
               this.var_734.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.var_1668);
            }
            else
            {
               this.var_734.removeEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.var_1668);
               this.var_734.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onPurchase);
            }
            this.var_734.disable();
         }
         if(this.var_2163 != null)
         {
            this.var_2163.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onBuyClub);
         }
      }
      ...
      private function onSelectProduct(param1:SelectProductEvent) : void
      {
         ...
         if(this.var_2165 != null)
         {
            ...
            this.var_2165.caption = "${catalog.purchase.price.credits}";
         }
         ...
         if(this.var_2166 != null)
         {
            ...
            this.var_2166.caption = _loc2_.getKey(_loc4_);
         }
         if(this.var_2167 != null)
         {
            ...
            this.var_2167.caption = _loc2_.getKey(_loc4_);
         }
      ...
      private function onPurchase(param1:WindowMouseEvent) : void
      {
         ...
         {
            (page.viewer.catalog as HabboCatalog).showPurchaseConfirmation(this.var_107,page.pageId,this.var_2164);
         }
      }
      ...
      private function initPurchase(param1:CatalogWidgetInitPurchaseEvent) : void
      {
         if(this.var_107 != null)
         {
            (page.viewer.catalog as HabboCatalog).showPurchaseConfirmation(this.var_107,page.pageId,this.var_2164,param1.enableBuyAsGift);
         }
      }
      
      private function onBuyClub(param1:WindowMouseEvent) : void
      {
         (page.viewer.catalog as HabboCatalog).openCatalogPage(CatalogPageName.const_145,true);
