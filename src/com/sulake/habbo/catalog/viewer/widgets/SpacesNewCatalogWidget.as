package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class SpacesNewCatalogWidget extends ItemGridCatalogWidget implements IDisposable, ICatalogWidget, IItemGrid
   {
      ...
      private var var_436:ISelectorWindow;
      ...
      public function SpacesNewCatalogWidget(param1:IWindowContainer, param2:ISessionDataManager)
      {
         ...
         super(param1,param2);
         this.var_436 = _window.findChildByName("groups") as ISelectorWindow;
         if(this.var_436)
         {
            _loc3_ = 0;
            while(_loc3_ < this.var_436.numSelectables)
            {
               _loc4_ = this.var_436.getSelectableAt(_loc3_);
      ...
      override public function init() : Boolean
      {
         ...
         this.switchCategory(this.var_119[this.var_593]);
      ...
      {
         var _loc2_:int = this.var_741[this.var_593];
         var _loc3_:Offer = this.var_231[this.var_593][_loc2_];
      ...
      public function selectIndex(param1:int) : void
      {
         ...
         {
            _loc2_ = this.var_231[this.var_593][param1];
      ...
      override public function select(param1:IGridItem) : void
      {
         ...
         this.var_741[this.var_593] = (this.var_231[this.var_593] as Array).indexOf(_loc2_);
         this.updateRoomPreview();
      }
      
      private function updateRoomPreview() : void
      {
         var _loc1_:int = this.var_741[0];
         var _loc2_:int = this.var_741[1];
         var _loc3_:int = this.var_741[2];
      ...
      private function createOfferGroups() : Boolean
      {
         ...
         {
            if(!(_loc1_.pricingModel == Offer.const_424 || _loc1_.pricingModel == Offer.const_457))
            {
               continue;
            }
            ...
            if(!(_loc2_.productType == ProductTypeEnum.const_65 || _loc2_.productType == ProductTypeEnum.const_69))
            {
               continue;
            }
            ...
            {
               case "floor":
                  (this.var_231[_loc5_] as Array).push(_loc1_);
                  break;
               case "wallpaper":
                  (this.var_231[_loc5_] as Array).push(_loc1_);
                  break;
      ...
      private function onSelectGroup(param1:WindowEvent) : void
      {
         ...
         if(_loc2_)
         {
            _loc3_ = this.var_436.getSelectableIndex(_loc2_);
      ...
      private function switchCategory(param1:String) : void
      {
         ...
         this.var_436.setSelected(this.var_436.getSelectableByName(param1));
         var _loc2_:int = -1;
         switch(param1)
         {
            case "group.walls":
         ...
         if(_loc2_ > -1)
         {
            ...
            page.replaceOffers(this.var_231[this.var_593],false);
            resetTimer();
            populateItemGrid();
            ...
            _loc3_ = this.var_741[this.var_593];
