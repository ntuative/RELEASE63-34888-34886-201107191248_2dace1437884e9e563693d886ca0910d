package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ItemGridCatalogWidget extends CatalogWidget implements ICatalogWidget, IItemGrid, IDragAndDropDoneReceiver
   {
      ...
      protected var var_516:IItemGridWindow;
      ...
      protected var var_223:Boolean = true;
      ...
      public function ItemGridCatalogWidget(param1:IWindowContainer, param2:ISessionDataManager)
      {
         ...
         if(this._scrollBar != null)
         {
            ...
            this._scrollBar.addEventListener(WindowEvent.const_795,this.activateScrollbar);
            this._scrollBar.addEventListener(WindowEvent.const_291,this.activateScrollbar);
            this._scrollBar.addEventListener(WindowEvent.const_954,this.deActivateScrollbar);
            this._scrollBar.addEventListener(WindowEvent.const_283,this.deActivateScrollbar);
         }
         this.var_33 = param2;
      }
      ...
      override public function init() : Boolean
      {
         ...
         this.var_516 = _window.findChildByName("itemGrid") as IItemGridWindow;
      ...
      protected function loadItemGridGraphics(param1:TimerEvent = null) : void
      {
         ...
         if(_loc2_ > 0)
         {
            ...
            while(_loc3_ < 3)
            {
               if(this.var_906 >= 0 && this.var_906 < _loc2_)
               {
                  _loc4_ = page.offers[this.var_906];
                  this.loadGraphics(_loc4_);
                  _loc4_.productContainer.grid = this;
               }
               ++this.var_906;
               if(this.var_906 >= _loc2_)
               {
                  this.resetTimer();
                  break;
               }
      ...
      {
         var _loc2_:IWindowContainer = page.viewer.catalog.windowManager.buildFromXML(this.var_2177) as IWindowContainer;
         this.var_516.addGridItem(_loc2_);
         ...
         if(param1.pricingModel == Offer.const_599)
         {
            ++this.var_2153;
            (param1.productContainer as BundleProductContainer).setBundleCounter(this.var_2153);
         }
      }
