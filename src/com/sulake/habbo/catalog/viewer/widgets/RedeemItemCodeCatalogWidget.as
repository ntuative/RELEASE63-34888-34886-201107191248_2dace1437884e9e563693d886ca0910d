package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class RedeemItemCodeCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      private var var_1130:IButtonWindow;
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_1130.removeEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onRedeem);
            this.var_1130 = null;
         }
         if(this.var_1131 != null)
         {
            this.var_1131.removeEventListener(WindowKeyboardEvent.const_190,this.windowKeyEventProcessor);
            this.var_1131 = null;
         }
      }
      ...
      override public function init() : Boolean
      {
         ...
         this.var_1130 = _window.findChildByName("redeem") as IButtonWindow;
         if(this.var_1130 != null)
         {
            this.var_1130.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onRedeem);
         }
         this.var_1131 = _window.findChildByName("voucher_code") as ITextFieldWindow;
         if(this.var_1131 != null)
         {
            this.var_1131.addEventListener(WindowKeyboardEvent.const_190,this.windowKeyEventProcessor);
         }
         return true;
      }
