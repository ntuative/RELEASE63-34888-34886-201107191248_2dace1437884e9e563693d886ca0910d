package com.sulake.habbo.catalog.viewer
{
   ...
   public class CatalogPage implements ICatalogPage
   {
      ...
      protected static const const_2062:String = "ctlg_";
       
      
      protected var var_2272:XML;
      ...
      private var var_583:EventDispatcher;
      ...
      public function CatalogPage(param1:ICatalogViewer, param2:int, param3:String, param4:IPageLocalization, param5:Array, param6:HabboCatalog)
      {
         ...
         this.var_583 = new EventDispatcher();
      ...
      {
         return this._localization.getLinks(this.var_1345);
      }
      
      public function get hasLinks() : Boolean
      {
         return this._localization.hasLinks(this.var_1345);
      }
      ...
      {
         var _loc2_:String = const_2062 + param1;
         ...
         this._window = this.viewer.catalog.windowManager.buildFromXML(this.var_2272) as IWindowContainer;
         if(this._window == null)
         {
      ...
      private function createWidget(param1:IWindowContainer) : void
      {
         ...
         switch(param1.name)
         {
            case CatalogWidgetEnum.const_1739:
               if(this.var_1346 == null)
               {
                  this.var_1346 = new ItemGridCatalogWidget(param1,this._catalog.sessionDataManager);
                  this.var_38.push(this.var_1346);
               }
               break;
            ...
            case CatalogWidgetEnum.const_1846:
               ...
               break;
            case CatalogWidgetEnum.const_1762:
               this.var_38.push(new PurseCatalogWidget(param1));
               break;
            case CatalogWidgetEnum.const_1903:
            ...
            case CatalogWidgetEnum.const_1862:
               ...
               break;
            case CatalogWidgetEnum.const_1850:
            ...
            case CatalogWidgetEnum.const_1757:
               ...
               break;
            case CatalogWidgetEnum.const_1976:
               this.var_38.push(new RecyclerCatalogWidget(param1));
               break;
            case CatalogWidgetEnum.const_2013:
            ...
            case CatalogWidgetEnum.const_1952:
               ...
               break;
            case CatalogWidgetEnum.const_2002:
               this.var_38.push(new MarketPlaceOwnItemsCatalogWidget(param1));
               break;
            case CatalogWidgetEnum.const_1797:
            ...
            case CatalogWidgetEnum.const_1795:
               ...
               break;
            case CatalogWidgetEnum.const_1997:
      ...
      private function initializeWidgets() : void
      {
         ...
         this.var_583.dispatchEvent(new CatalogWidgetsInitializedEvent());
      }
      ...
      public function dispatchWidgetEvent(param1:Event) : Boolean
      {
         if(this.var_583 != null)
         {
            return this.var_583.dispatchEvent(param1);
         }
         return false;
      }
