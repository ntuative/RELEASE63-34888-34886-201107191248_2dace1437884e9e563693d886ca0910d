package com.sulake.habbo.catalog.viewer
{
   ...
   public class ProductGridItem implements IGridItem
   {
      ...
      private static const const_1161:String = "bg";
       
      
      protected var _view:IWindowContainer;
      
      private var var_214:IItemGrid;
      
      protected var _icon:IBitmapWrapperWindow;
      
      private var _disposed:Boolean = false;
      
      private var var_525:Object;
      ...
      {
         this._view.getChildByName(const_1161).style = HabboWindowStyle.const_31;
      }
      
      public function deActivate() : void
      {
         this._view.getChildByName(const_1161).style = 3;
      }
      ...
      public function set view(param1:IWindowContainer) : void
      {
         ...
         this._view = param1;
         this._view.procedure = this.method_6;
      ...
      public function setDraggable(param1:Boolean) : void
      {
         ...
         {
            (this._view as IInteractiveWindow).setMouseCursorForState(WindowState.const_90,MouseCursorType.const_859);
            (this._view as IInteractiveWindow).setMouseCursorForState(0 | 0,MouseCursorType.const_859);
         }
      }
      ...
      private function method_6(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         else if(param1.type == WindowMouseEvent.const_45)
         {
            ...
            this.var_214.select(this);
            this.var_525 = param2;
         }
         else if(param1.type == WindowMouseEvent.const_25 && this.var_525 != null && this.var_525 == param2)
         {
            _loc3_ = this.var_214.startDragAndDrop(this);
            if(_loc3_)
            {
               this.var_525 = null;
            }
