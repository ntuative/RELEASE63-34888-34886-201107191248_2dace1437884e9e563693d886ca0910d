package com.sulake.habbo.catalog.club
{
   ...
   public class ClubExtendConfirmationDialog
   {
      ...
      private static const const_389:int = 7;
      
      private static const const_1642:String = "your_price_icon";
      
      private static const const_1644:String = "http://images.habbo.com/c_images/catalogue/vip_extend_tsr.png";
      
      private static const const_1641:String = "image/png";
      
      private static const const_1640:int = 2000;
      
      private static const const_1643:int = 75;
      
      protected static const const_2057:uint = 0;
      ...
      private var var_702:IRegionWindow;
      
      private var var_699:ITextWindow;
      
      private var var_406:IBitmapWrapperWindow;
      
      private var var_700:Vector.<BitmapData>;
      ...
      public function ClubExtendConfirmationDialog(param1:ClubExtendController, param2:ClubOfferExtendData)
      {
         ...
         this.var_27 = param1;
         this.var_107 = param2;
         this.var_700 = new Vector.<BitmapData>(const_389);
      }
      ...
      public function dispose() : void
      {
         ...
         if(this.var_702)
         {
            this.var_702.removeEventListener(WindowMouseEvent.const_25,this.onMouseOutLaterRegion);
            this.var_702.removeEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER,this.onMouseOverLaterRegion);
            this.var_702 = null;
         }
         if(this.var_699)
         {
         ...
         if(this.var_700)
         {
            while(_loc1_ < const_389)
            {
               this.var_700[_loc1_].dispose();
               this.var_700[_loc1_] = null;
               _loc1_++;
            }
            this.var_700 = null;
         }
      ...
      public function showConfirmation() : void
      {
         ...
         this.var_702 = this._view.findChildByName("maybe_later_region") as IRegionWindow;
         this.var_699 = this._view.findChildByName("maybe_later_link") as ITextWindow;
         if(!this.var_702 || !this.var_699)
         {
            return;
         }
         this.var_702.addEventListener(WindowMouseEvent.const_25,this.onMouseOutLaterRegion);
         this.var_702.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER,this.onMouseOverLaterRegion);
         ...
         _loc4_.height = 144;
         _loc4_.width = 133;
         this.loadAssetFromUrl("club_teaser","club_teaser",const_1644,const_1641,this.onTeaserLoaded);
      ...
      private function onMouseOutLaterRegion(param1:WindowMouseEvent) : void
      {
         if(this.var_699)
         {
            this.var_699.textColor = const_2057;
         }
      }
      ...
      private function onMouseOverLaterRegion(param1:WindowMouseEvent) : void
      {
         if(this.var_699)
         {
            this.var_699.textColor = LINK_COLOR_HOVER;
         }
      }
      ...
      private function startAnimation() : void
      {
         ...
         this.var_868 = new Timer(const_1640);
         this.var_868.addEventListener(TimerEvent.TIMER,this.onAnimationTrigger);
         this.var_868.start();
      }
      ...
      private function setAnimationFrame() : void
      {
         ...
         if(this.var_406.bitmap)
         {
            this.var_406.bitmap.dispose();
         }
         if(this.var_701 < const_389)
         {
            this.var_406.bitmap = new BitmapData(this.var_406.width,this.var_406.height,true,0);
            this.var_406.bitmap.copyPixels(this.var_700[this.var_701],this.var_700[this.var_701].rect,new Point(0,0));
         }
         else
         {
            Logger.log("Animation frame " + this.var_701);
         }
      }
      
      private function startAnimationFrame() : void
      {
         this.var_466 = new Timer(const_1643,const_389 - 1);
         this.var_466.addEventListener(TimerEvent.TIMER,this.onAnimationFrame);
         this.var_466.addEventListener(TimerEvent.TIMER_COMPLETE,this.onAnimationFrameComplete);
         this.var_466.start();
      }
