package com.sulake.habbo.catalog
{
   ...
   public class HabboCatalog extends Component implements IHabboCatalog, IProductDataListener, IUpdateReceiver
   {
      ...
      private static const const_700:uint = 1;
      ...
      private var var_1238:IRoomSession;
      ...
      private var var_218:CatalogViewer;
      
      private var var_247:ICatalogNavigator;
      
      private var var_113:Purse;
      
      private var var_105:RecyclerLogic;
      
      private var var_157:IMarketPlace;
      
      private var _mainContainer:IWindowContainer;
      
      private var _confirmationDialog:PurchaseConfirmationDialog;
      
      private var var_219:ChargeConfirmationDialog;
      ...
      private var var_2509:GiftWrappingConfiguration;
      
      private var var_1237:ClubGiftController;
      
      private var var_538:ClubBuyController;
      
      private var var_647:ClubExtendController;
      
      private var var_789:Map;
      
      private var var_1236:Boolean = false;
      
      private var var_790:IPurchasableOffer;
      
      private var var_1501:IDragAndDropDoneReceiver;
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_15 != null)
         {
            this.var_15.events.removeEventListener(RoomSessionEvent.const_71,this.onRoomSessionEvent);
      ...
      private function reset(param1:Boolean = false) : void
      {
         ...
         if(!param1)
         {
            ...
            {
               Core.crash("Could not reload product data after reset() because _sessionDataManager was null",Core.const_1951);
               return;
            }
            events.dispatchEvent(new CatalogEvent(CatalogEvent.CATALOG_NOT_READY));
            _loc2_ = this.var_379.loadProductData(this);
            if(_loc2_)
            {
               this.init();
            }
      ...
      public function showPurchaseConfirmation(param1:IPurchasableOffer, param2:int, param3:String = "", param4:Boolean = true) : void
      {
         ...
         if(param1.priceInCredits > 0 && param1.priceInCredits > this.var_113.credits)
         {
            this.showNotEnoughCreditsAlert();
            return;
         }
         if(param1.priceInActivityPoints > 0 && param1.priceInActivityPoints > this.var_113.getActivityPointsForType(param1.activityPointType))
         {
      ...
      private function sessionDataManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_379.loadProductData(this);
      }
      ...
      private function onRoomEngineReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this._roomEngine.events.addEventListener(RoomEngineObjectEvent.const_162,this.onObjectPlaced);
         this.initializeRoomPreviewer();
      }
      ...
      {
         if(this._roomEngine != null && this.var_131 != null && this.var_131.getKey("catalog.furniture.animation","false") == "true")
         {
            if(this.var_648 == null)
            {
               this.var_648 = new RoomPreviewer(this._roomEngine);
            }
         }
      }
      ...
      {
         return this.var_131.getBoolean("toolbar.new_additions.notification.enabled",false);
      }
      ...
      public function openCatalogPage(param1:String, param2:Boolean = false) : void
      {
         ...
         if(!this.var_865 || !this.var_247 || !this.var_247.isInitialized())
         {
            this.toggleCatalog(true);
            this.var_992 = -1;
            this.var_791 = param1;
      ...
      public function openCatalogPageById(param1:int, param2:int) : void
      {
         ...
         {
            this.toggleCatalog(true);
            this.var_247.openPageById(param1,param2);
         }
         else
         {
            this.toggleCatalog();
      ...
      public function openCreditsHabblet() : void
      {
         ...
         var _loc1_:* = this.var_131.getKey("client.credits.embed.enabled","false") == "true";
         if(false && _loc1_)
         {
         ...
         {
            _loc2_ = this.var_131.getKey("link.format.credits","/credits");
      ...
      {
         var _loc3_:* = null;
         if(param2 == ProductTypeEnum.const_69)
         {
      ...
      {
         var _loc2_:Array = this.var_789.getValue(param1);
         if(_loc2_ != null)
         {
            return _loc2_.slice();
         }
      ...
      private function updatePurse() : void
      {
         ...
         this._localization.registerParameter("catalog.purse.creditbalance","balance",String(this.var_113.credits));
         this._localization.registerParameter("catalog.purse.pixelbalance","balance",String(this.var_113.getActivityPointsForType(ActivityPointTypeEnum.PIXEL)));
         var _loc1_:int = 0;
         if(!this.var_113.hasClubLeft)
         {
            _loc2_ = "catalog.purse.club.join";
         }
         else
         {
            if(this.var_113.isVIP)
            {
            ...
            this._localization.registerParameter(_loc2_,"days",String(this.var_113.clubDays));
            this._localization.registerParameter(_loc2_,"months",String(this.var_113.clubPeriods));
         }
      ...
      private function getCurrentLayoutCode() : String
      {
         ...
         return this.var_218.getCurrentLayoutCode();
      }
      ...
      private function createCatalogNavigator() : void
      {
         ...
         this.var_247 = new CatalogNavigator(this,_loc1_) as ICatalogNavigator;
      ...
      private function createCatalogViewer() : void
      {
         ...
         this.var_218 = new CatalogViewer(this,_loc1_,this._roomEngine);
         this.var_218.habboCatalog = this;
      }
      
      private function createMainWindow() : void
      {
         var _loc1_:String = "catalog";
         if(this.var_131.getBoolean("catalog.show.purse",false))
         {
            _loc1_ = "catalog_with_purse";
         }
         var _loc2_:XmlAsset = assets.getAssetByName(_loc1_) as XmlAsset;
         this._mainContainer = this._windowManager.buildFromXML(_loc2_.content as XML,const_700) as IWindowContainer;
         this._mainContainer.tags.push("habbo_catalog");
         this._mainContainer.position = this.const_2079;
         this.hideMainWindow();
         ...
         _loc4_.setParamFlag(WindowParam.const_303,false);
      ...
      private function onRoomSessionEvent(param1:RoomSessionEvent) : void
      {
         switch(param1.type)
         {
            case RoomSessionEvent.const_71:
               this.var_1849 = param1.session.isPrivateRoom;
               this.var_1238 = param1.session;
               if(this.var_105 != null)
               {
      ...
      private function createMarketPlace() : void
      {
         ...
         {
            this.var_157 = new MarketPlaceLogic(this,this._windowManager,this._roomEngine);
         }
      }
      ...
      private function createClubGiftController() : void
      {
         ...
         {
            this.var_1237 = new ClubGiftController(this);
         }
      }
      ...
      private function createClubExtendController() : void
      {
         if(this.var_647 == null)
         {
            this.var_647 = new ClubExtendController(this);
         }
      }
      ...
      private function onWindowClose(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(this.var_218 != null)
         {
            this.var_218.catalogWindowClosed();
         }
         if(this.var_105 != null && this.getCurrentLayoutCode() == "recycler")
         {
            this.var_105.cancel();
      ...
      private function onCatalogIndex(param1:IMessageEvent) : void
      {
         ...
         this.var_1502 = (param1 as CatalogIndexMessageEvent).newAdditionsAvailable;
         this.var_247.buildCatalogIndex(_loc2_);
         if(this.var_791 && this.var_791 != "")
         {
            this.var_247.openPage(this.var_791);
            this.var_791 = "";
            this.var_992 = -1;
         }
         else if(this.var_992 > -1)
         {
            this.var_247.openPageById(this.var_992,this.var_1848);
            this.var_992 = -1;
            this.var_1848 = -1;
            this.var_791 = "";
         }
         else if(this.var_1502 && this.var_2510)
         {
            events.dispatchEvent(new CatalogEvent(CatalogEvent.CATALOG_NEW_ITEMS_SHOW));
            this.var_247.loadNewAdditionsPage(this.getLocalizedPageName(CatalogPageName.const_2023));
         }
         else
         {
            this.var_247.loadFrontPage();
         }
      }
      ...
      private function onCatalogPage(param1:IMessageEvent) : void
      {
         ...
         this.var_218.showCatalogPage(_loc4_,_loc5_,_loc8_,_loc3_.offers,_loc9_);
      }
      ...
      {
         if(param1 == null || this.var_218 == null)
         {
            return;
         }
         var _loc2_:ApproveNameMessageParser = param1.getParser();
         this.var_218.dispatchWidgetEvent(new CatalogWidgetApproveNameResultEvent(_loc2_.result,_loc2_.nameValidationInfo));
      }
      ...
      private function onCreditBalance(param1:IMessageEvent) : void
      {
         ...
         this.var_113.credits = _loc3_.balance;
         this.updatePurse();
         if(!this.var_2507 && this._soundManager != null)
         {
            this._soundManager.playSound(HabboSoundTypesEnum.const_1363);
         }
         this.var_2507 = false;
         if(this.var_219 != null && !this.var_219.disposed)
         {
            this.var_219.refresh();
         }
         events.dispatchEvent(new PurseEvent(PurseEvent.const_126,this.var_113.credits));
      ...
      private function onActivityPointNotification(param1:IMessageEvent) : void
      {
         ...
         this.var_113.activityPoints[_loc2_.type] = _loc2_.amount;
         this.updatePurse();
         if(!this.var_2508 && this._soundManager != null)
         {
            this._soundManager.playSound(HabboSoundTypesEnum.const_1314);
         }
         this.var_2508 = false;
         if(this.var_219 != null && !this.var_219.disposed)
         {
         ...
         {
            events.dispatchEvent(new PurseEvent(PurseEvent.const_320,_loc2_.amount));
         }
         if(_loc2_.type == ActivityPointTypeEnum.const_865)
         {
      ...
      private function onActivityPoints(param1:IMessageEvent) : void
      {
         ...
         this.var_113.activityPoints = _loc2_.points;
         this.updatePurse();
         if(_loc2_.points["null"] != null)
         {
            events.dispatchEvent(new PurseEvent(PurseEvent.const_320,_loc2_.points["null"]));
         }
         if(_loc2_.points["null"] != null)
         {
      ...
      private function onSubscriptionInfo(param1:IMessageEvent) : void
      {
         ...
         this.var_113.clubDays = Math.max(0,_loc2_.daysToPeriodEnd);
         this.var_113.clubPeriods = Math.max(0,_loc2_.periodsSubscribedAhead);
         this.var_113.isVIP = _loc2_.isVIP;
         this.var_113.pastClubDays = _loc2_.pastClubDays;
         this.var_113.pastVipDays = _loc2_.pastVipDays;
         this.var_113.isExpiring = _loc2_.responseType == ScrSendUserInfoMessageParser.const_1293 ? true : false;
         this.updatePurse();
      ...
      private function onClubGiftInfo(param1:ClubGiftInfoEvent) : void
      {
         ...
         this.var_1237.setInfo(_loc2_.daysUntilNextGift,_loc2_.giftsAvailable,_loc2_.offers,_loc2_.giftData);
      }
      ...
      private function onMarketPlaceOwnOffers(param1:IMessageEvent) : void
      {
         if(this.var_157 != null)
         {
            this.var_157.onOwnOffers(param1);
         }
      }
      ...
      private function onMarketPlaceBuyResult(param1:IMessageEvent) : void
      {
         if(this.var_157 != null)
         {
            this.var_157.onBuyResult(param1);
         }
      }
      ...
      private function onMarketPlaceCancelResult(param1:IMessageEvent) : void
      {
         if(this.var_157 != null)
         {
            this.var_157.onCancelResult(param1);
         }
      }
      ...
      private function onGiftWrappingConfiguration(param1:GiftWrappingConfigurationEvent) : void
      {
         ...
         this.var_2509 = new GiftWrappingConfiguration(param1);
      }
      ...
      private function onMarketplaceConfiguration(param1:MarketplaceConfigurationEvent) : void
      {
         ...
         this.var_157.averagePricePeriod = _loc2_.averagePricePeriod;
      }
      ...
      {
         if(this.var_647 != null && this.var_131.getBoolean("club.membership.extend.promotion.enabled",false))
         {
            this.var_647.onOffer(param1);
         }
      }
      ...
      private function onChargeInfo(param1:ChargeInfoMessageEvent) : void
      {
         ...
         if(this.var_219 == null || this.var_219.disposed)
         {
            this.var_219 = new ChargeConfirmationDialog(this,this._localization);
         }
         this.var_219.showChargeInfo(_loc2_);
      }
      ...
      private function onSellableBreeds(param1:SellablePetBreedsMessageEvent) : void
      {
         ...
         this.var_789.remove(_loc2_.productCode);
         var _loc3_:Array = _loc2_.sellableBreeds;
         if(_loc3_ != null)
         {
            this.var_789.add(_loc2_.productCode,_loc3_.slice());
            this.var_218.dispatchWidgetEvent(new CatalogWidgetSellablePetBreedsEvent(_loc2_.productCode,_loc3_.slice()));
         }
      }
      ...
      private function noCreditsConfirmDialogEventProcessor(param1:IConfirmDialog, param2:WindowEvent) : void
      {
         ...
         {
            if(false && "true" == this.var_131.getKey("client.credits.embed.enabled"))
            {
               ExternalInterface.call("FlashExternalInterface.openHabblet","credits");
            }
            else
            {
               _loc3_ = this.var_131.getKey("link.format.credits");
               if(_loc3_ != "")
               {
                  this._windowManager.alert("${catalog.alert.external.link.title}","${catalog.alert.external.link.desc}",0,this.onExternalLink);
      ...
      private function noPixelsConfirmDialogEventProcessor(param1:IConfirmDialog, param2:WindowEvent) : void
      {
         ...
         if(param2.type == WindowEvent.const_152)
         {
            _loc3_ = this.var_131.getKey("link.format.pixels");
            if(_loc3_ != "")
            {
               this._windowManager.alert("${catalog.alert.external.link.title}","${catalog.alert.external.link.desc}",0,this.onExternalLink);
               HabboWebTools.navigateToURL(_loc3_,"habboMain");
      ...
      {
         if(!this.var_131.keyExists("catalog.drag_and_drop") || this.var_131.getKey("catalog.drag_and_drop") != "true")
         {
            return false;
         }
         if(!this.var_1238 || !this.var_1238.isRoomOwner)
         {
            return false;
         }
         ...
         switch(_loc2_.productType)
         {
            case ProductTypeEnum.const_183:
               _loc3_ = false;
               break;
            case ProductTypeEnum.const_368:
               _loc3_ = false;
         }
         return _loc3_;
      }
      ...
      {
         var _loc3_:String = this._roomEngine.getRoomStringValue(this._roomEngine.activeRoomId,this._roomEngine.activeRoomCategory,RoomObjectVariableEnum.const_234);
         ...
         var _loc5_:String = this._roomEngine.getRoomStringValue(this._roomEngine.activeRoomId,this._roomEngine.activeRoomCategory,RoomObjectVariableEnum.const_231);
      ...
      private function onObjectPlaced(param1:RoomEngineObjectPlacedEvent) : void
      {
         ...
         var _loc5_:* = null;
         var _loc6_:* = null;
         if(this.var_1236 && param1.type == RoomEngineObjectEvent.const_162)
         {
            this.resetPlacedOfferData(true);
            if(this.var_790 == null || this.var_790.disposed)
            {
               this.resetObjectMover();
               return;
            }
            _loc2_ = param1.category;
            _loc3_ = this.var_790.productContainer.firstProduct;
            _loc4_ = false;
            ...
            this.var_65 = new PlacedObjectPurchaseData(param1.roomId,param1.roomCategory,param1.objectId,param1.category,param1.wallLocation,param1.x,param1.y,param1.direction,this.var_790);
            _loc5_ = this.var_1501;
            if(_loc5_ != null)
            {
            ...
            if(_loc6_)
            {
               _loc6_.getModelController().setNumber(RoomObjectVariableEnum.const_367,0.5);
            }
         }
      }
            ...
            if(this.var_65.roomCategory == this._roomEngine.activeRoomCategory && this.var_65.roomId == this._roomEngine.activeRoomId)
            {
               ...
               switch(param1.category)
               {
                  case FurniCategory.const_379:
                     _loc8_ = this._roomEngine.getRoomStringValue(this._roomEngine.activeRoomId,this._roomEngine.activeRoomCategory,RoomObjectVariableEnum.const_219);
                  ...
                  case FurniCategory.const_345:
                     _loc9_ = this._roomEngine.getRoomStringValue(this._roomEngine.activeRoomId,this._roomEngine.activeRoomCategory,RoomObjectVariableEnum.const_234);
                  ...
                  case FurniCategory.const_378:
                     _loc10_ = this._roomEngine.getRoomStringValue(this._roomEngine.activeRoomId,this._roomEngine.activeRoomCategory,RoomObjectVariableEnum.const_231);
      ...
      private function retrievePreviewAsset(param1:String, param2:Function) : void
      {
         ...
         var _loc3_:String = this.var_131.getKey("image.library.catalogue.url");
      ...
      private function showMainWindow() : void
      {
         ...
         {
            _loc1_ = this._windowManager.getDesktop(const_700);
            if(_loc1_ != null)
            {
      ...
      public function update(param1:uint) : void
      {
         if(this.var_648 != null)
         {
            this.var_648.updatePreviewRoomView();
         }
      }
   }
}
