package com.sulake.habbo.catalog.recycler
{
   ...
   public class RecyclerLogic implements IRecycler
   {
      ...
      private static const const_1103:int = 0;
      ...
      {
         return this.var_675 != const_1103;
      }
      
      private function get systemActive() : Boolean
      {
         return this.var_1953 != RecyclerStatusMessageEvent.const_1220;
      }
      
      private function get ready() : Boolean
      {
         return this.active && this.var_675 == const_478;
      }
      ...
      {
         this.var_675 = const_1104;
         this.var_137 = new Array(const_215);
         if(param1 == null)
         {
            return;
         }
      ...
      public function cancel() : void
      {
         ...
         var _loc1_:int = 0;
         while(_loc1_ < const_215)
         {
            this.releaseSlot(_loc1_);
            _loc1_++;
         }
         this.var_675 = const_1103;
      }
      ...
      public function setSystemStatus(param1:int, param2:int) : void
      {
         ...
         {
            case RecyclerStatusMessageEvent.const_1821:
               this.var_675 = const_478;
               ...
               this.updateRecyclerButton();
               break;
            case RecyclerStatusMessageEvent.const_1220:
               if(this._view == null || this._view.disposed)
               {
                  return;
               }
               ...
               this._catalog.setupInventoryForRecycler(false);
               break;
            case RecyclerStatusMessageEvent.const_1924:
               if(this._view == null || this._view.disposed)
               {
                  return;
               }
      ...
      public function setFinished(param1:int, param2:int) : void
      {
         ...
         switch(status)
         {
            case RecyclerFinishedMessageEvent.const_1165:
               if(this._view != null)
               {
                  this._view.displayFinishedView();
               }
               break;
            case RecyclerFinishedMessageEvent.const_1904:
      ...
      public function placeObjectAtSlot(param1:int, param2:int, param3:int, param4:int, param5:String) : void
      {
         ...
         {
            oldObjectData = this.var_137[0];
            newSlotId = 0;
            while(oldObjectData != null && newSlotId < const_215)
            {
               oldObjectData = this.var_137[newSlotId];
         ...
         this.var_137[slotId] = new FurniSlotItem(itemId,category,typeId,xxxExtra);
         this.updateRecyclerSlots();
         this.updateRecyclerButton();
      }
      ...
      public function releaseSlot(param1:int) : void
      {
         ...
         if(this.var_137[param1] == null)
         {
            return;
         }
         if(!this._catalog.returnInventoryFurniFromRecycler(this.var_137[param1].id))
         {
            return;
         }
      ...
      public function executeRecycler() : void
      {
         ...
         var _loc2_:int = 0;
         while(_loc2_ < this.var_137.length)
         {
            _loc3_ = this.var_137[_loc2_];
            if(_loc3_ == null)
            {
               return;
            }
      ...
      private function isPoolFull() : Boolean
      {
         ...
         if(this.var_137.length < const_215)
         {
            return false;
         }
         var _loc1_:int = 0;
