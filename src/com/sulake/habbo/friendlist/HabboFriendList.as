package com.sulake.habbo.friendlist
{
   ...
   public class HabboFriendList extends Component implements IHabboFriendList, IAvatarImageListener
   {
      ...
      public static const const_194:String = "face";
      ...
      private var var_805:ISessionDataManager;
      
      private var var_2624:FriendListLookAndFeel;
      
      private var var_436:FriendListTabs;
      
      private var _view:FriendListView;
      
      private var var_1914:OpenedToWebPopup;
      
      private var var_2623:int;
      
      var var_119:FriendCategories;
      
      private var var_122:FriendRequests;
      
      private var var_1913:AvatarSearchResults;
      
      private var _toolbar:IHabboToolbar;
      
      private var var_1123:IHabboNotifications;
      
      private var var_661:Timer;
      
      public function HabboFriendList(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         this.var_2624 = new FriendListLookAndFeel();
         super(param1,param2,param3);
         this.var_119 = new FriendCategories(new FriendCategoriesDeps(this));
         this.var_1913 = new AvatarSearchResults(new AvatarSearchDeps(this));
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_661.stop();
            this.var_661.removeEventListener(TimerEvent.TIMER,this.sendFriendListUpdate);
            this.var_661 = null;
         }
         ...
         if(this.var_1123)
         {
            this.var_1123.release(new IIDHabboNotifications());
            this.var_1123 = null;
         }
         if(this._toolbar)
         {
         ...
         if(this.var_805)
         {
            this.var_805.release(new IIDSessionDataManager());
            this.var_805 = null;
         }
         super.dispose();
      }
      ...
      public function openHabboWebPage(param1:String, param2:Dictionary, param3:int, param4:int) : void
      {
         ...
         {
            this.var_1914 = new OpenedToWebPopup(this);
         }
         this.var_1914.show(x,y);
      }
      ...
      public function getFriend(param1:int) : IFriend
      {
         ...
         return this.var_119.findFriend(param1);
      }
      ...
      {
         this.openFriendListWithTab(FriendListTab.const_87);
      }
      
      public function openFriendSearch() : void
      {
         this.openFriendListWithTab(FriendListTab.const_405);
      }
      ...
      public function getFriendCount(param1:Boolean, param2:Boolean) : int
      {
         ...
         return this.var_119.getFriendCount(param1,param2);
      }
      ...
      public function getButton(param1:String, param2:String, param3:Function, param4:int = 0, param5:int = 0, param6:int = 0) : IBitmapWrapperWindow
      {
         ...
         var _loc8_:IBitmapWrapperWindow = this._windowManager.createWindow(param1,"",HabboWindowType.const_369,HabboWindowStyle.const_47,0 | 0,new Rectangle(param4,param5,_loc7_.width,_loc7_.height),param3,param6) as IBitmapWrapperWindow;
      ...
      {
         var _loc2_:IAvatarImage = this.var_611.createAvatarImage(param1,AvatarScaleType.const_116,null,this);
         if(!_loc2_)
         {
            return null;
         }
         var _loc3_:BitmapData = _loc2_.getCroppedImage(AvatarSetType.const_55);
         _loc2_.dispose();
         return _loc3_;
      }
      ...
      {
         var _loc1_:String = this.var_131.getKey("client.minimail.embed.enabled");
         return _loc1_ == "true";
      }
      
      private function getVariable(param1:String, param2:Dictionary) : String
      {
         return this.var_131.getKey(param1,param1,param2);
      }
      ...
      {
         this.var_1123 = param2 as IHabboNotifications;
      ...
      {
         this.var_805 = param2 as ISessionDataManager;
      }
      ...
      private function onMessengerInit(param1:IMessageEvent) : void
      {
         ...
         this.var_122 = new FriendRequests(new FriendRequestsDeps(this),_loc2_.userFriendLimit,_loc2_.extendedFriendLimit,_loc2_.evenMoreExtendedFriendLimit);
         for each(_loc3_ in _loc2_.categories)
         {
            this.var_119.addCategory(new FriendCategory(_loc3_.id,_loc3_.name));
         }
         this.var_119.addCategory(new FriendCategory(FriendCategory.const_1266,this.getText("friendlist.friends")));
         this.var_119.addCategory(new FriendCategory(FriendCategory.const_411,this.getText("friendlist.friends.offlinecaption")));
         for each(_loc4_ in this.getSortedFriends(_loc2_.friends))
         {
            this.var_119.addFriend(new Friend(_loc4_));
         }
         this.var_436 = new FriendListTabs(new FriendListTabsDeps(this));
         if(!this.var_661)
         {
            this.var_661 = new Timer(120000);
            this.var_661.addEventListener(TimerEvent.TIMER,this.sendFriendListUpdate);
            this.var_661.start();
         }
         this.getBuddyRequests();
         this.registerListeners();
         if(this.var_119.getFriendCount(true,false) == 0)
         {
            _loc5_ = this.var_119.findCategory(FriendCategory.const_411);
            if(_loc5_)
            {
               _loc5_.setOpen(true);
            }
      ...
      private function onBuddyRequests(param1:IMessageEvent) : void
      {
         ...
         this.var_122.clearAndUpdateView(false);
         for each(_loc3_ in _loc2_.reqs)
         {
            this.var_122.addRequest(new FriendRequest(_loc3_));
         }
         if(_loc2_.reqs.length > 0)
         {
            this.var_436.findTab(FriendListTab.const_87).setNewMessageArrived(true);
         }
      ...
      private function onNewBuddyRequest(param1:IMessageEvent) : void
      {
         ...
         this.var_122.addRequestAndUpdateView(_loc3_);
         var _loc4_:FriendListTab = this.var_436.findTab(FriendListTab.const_87);
      ...
      private function onHabboSearchResult(param1:IMessageEvent) : void
      {
         ...
         this.var_1913.searchReceived(_loc2_.friends,_loc2_.others);
      ...
      {
         this.var_119.onFriendListUpdate(param1);
      ...
      public function getFriendNames() : Array
      {
         ...
         return this.var_119.getFriendNames();
      }
      
      public function acceptFriendRequest(param1:int) : void
      {
         var _loc2_:FriendListTab = this.var_436.findTab(FriendListTab.const_87);
         if(!_loc2_)
         {
            return;
         }
      ...
      {
         var _loc1_:FriendListTab = this.var_436.findTab(FriendListTab.const_87);
         if(!_loc1_)
         {
            return;
         }
      ...
      {
         if(!this.var_805 || !this.var_122)
         {
            return;
         }
         var _loc2_:int = 0;
         if(this.var_805.hasUserRight("fuse_super_extended_buddylist",HabboClubLevelEnum.const_43))
         {
            _loc2_ = this.var_122.vipLimit;
         }
         else if(this.var_805.hasUserRight("fuse_extended_buddylist",HabboClubLevelEnum.const_35))
         {
            _loc2_ = this.var_122.clubLimit;
         }
         if(_loc2_ > this.var_122.limit)
         {
            this.var_122.limit = _loc2_;
         }
      }
      ...
      public function avatarImageReady(param1:String) : void
      {
         ...
         var _loc5_:* = null;
         var _loc6_:* = null;
         if(disposed || this.var_119 == null)
         {
            return;
         }
         var _loc2_:Dictionary = this.var_119.getAllFriends();
         if(_loc2_ == null)
         {
            return;
         }
         for each(_loc3_ in _loc2_)
         {
            if(_loc3_ != null && !_loc3_.disposed && _loc3_.figure == param1)
            {
               ...
               if(_loc3_.face != null)
               {
                  ...
                  if(_loc4_ != null)
                  {
                     _loc5_ = _loc4_.getChildByName(const_194) as IBitmapWrapperWindow;
