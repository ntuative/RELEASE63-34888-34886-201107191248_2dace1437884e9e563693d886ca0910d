package com.sulake.habbo.friendlist
{
   ...
   public class FriendsView implements ITabView, IFriendsView
   {
      ...
      public static const const_2164:String = "bg";
       
      
      private var _friendList:HabboFriendList;
      
      private var var_2467:IContainerButtonWindow;
      
      private var var_2468:IContainerButtonWindow;
      
      private var var_2469:IContainerButtonWindow;
      
      private var var_2466:IContainerButtonWindow;
      
      private var var_64:IItemListWindow;
      
      private var var_689:AvatarPopupCtrl;
      ...
      public function init(param1:HabboFriendList) : void
      {
         ...
         this.var_689 = new AvatarPopupCtrl(this._friendList);
      }
      ...
      {
         this.var_2467 = this.initButton("open_minimail",this.onMinimailButtonClick,param1);
         this.var_2468 = this.initButton("open_homepage",this.onHomeButtonClick,param1);
         this.var_2469 = this.initButton("room_invite",this.onInviteButtonClick,param1);
         this.var_2466 = this.initButton("remove_friend",this.onRemoveButtonClick,param1);
         this.refreshButtons();
      }
      ...
      private function refreshEntry(param1:Boolean, param2:int, param3:FriendCategory, param4:Friend) : Boolean
      {
         ...
         var _loc6_:IWindowContainer = this.var_64.getListItemAt(param2) as IWindowContainer;
         if(_loc6_ == null)
         {
            if(!param1)
            {
            ...
            this.var_64.addListItem(_loc6_);
         }
      ...
      private function refreshButtons() : void
      {
         ...
         this.setEnabled(this.var_2467,this.isEnableMinimailButton(_loc1_));
         this.setEnabled(this.var_2468,this.isEnableHomeButton(_loc1_));
         this.setEnabled(this.var_2469,this.isEnableInviteButton(_loc1_));
         this.setEnabled(this.var_2466,this.isEnableRemoveButton(_loc1_));
      }
      ...
      private function onFriendClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER)
         {
            ...
            this.var_689.setData(_loc3_.online,_loc3_.name,_loc3_.motto,_loc3_.figure,_loc3_.lastAccess);
            this.var_689.showPopup(this._friendList.view.mainWindow,_loc3_.view);
         }
         else if(param1.type == WindowMouseEvent.const_25)
         {
            this.var_689.closePopup();
         }
