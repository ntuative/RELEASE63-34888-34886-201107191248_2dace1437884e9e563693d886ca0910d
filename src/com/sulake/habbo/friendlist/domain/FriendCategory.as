package com.sulake.habbo.friendlist.domain
{
   ...
   public class FriendCategory implements IDisposable
   {
      ...
      public static const const_437:int = 100;
      
      public static const const_1266:int = 0;
      ...
      {
         var _loc4_:* = null;
         if(this.var_246.indexOf(param1) >= 0)
         {
            return;
         }
         ...
         while(_loc3_ < this.var_246.length)
         {
            ...
            {
               this.var_246.splice(_loc3_,0,param1);
               return;
            }
            _loc3_++;
         }
      ...
      public function getFriendCount(param1:Boolean, param2:Boolean = false) : int
      {
         var _loc4_:* = null;
         var _loc3_:int = 0;
         for each(_loc4_ in this.var_246)
         {
      ...
      public function removeFriend(param1:int) : Friend
      {
         ...
         if(_loc2_ != null)
         {
            Util.remove(this.var_246,_loc2_);
            return _loc2_;
         }
         return null;
      }
      ...
      {
         if(this.var_987 >= this.getPageCount())
         {
            this.var_987 = Math.max(0,this.getPageCount() - 1);
         }
      }
      
      public function getPageCount() : int
      {
         return Math.ceil(this.var_246.length / const_437);
      }
      
      public function getStartFriendIndex() : int
      {
         this.checkPageIndex();
         return this.var_987 * const_437;
      }
      
      public function getEndFriendIndex() : int
      {
         this.checkPageIndex();
         return Math.min((this.var_987 + 1) * const_437,this.var_246.length);
      }
