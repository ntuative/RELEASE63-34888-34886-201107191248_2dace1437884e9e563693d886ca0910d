package com.sulake.habbo.avatar
{
   ...
   public class AvatarImage implements IAvatarImage, IDisposable
   {
      ...
      private static const const_1489:String = "Default";
      
      private static const const_1487:int = 2;
      
      private static const const_1488:String = AvatarSetType.const_42;
      ...
      protected var var_313:IActiveActionData;
      ...
      protected var var_604:IAvatarDataContainer;
      
      protected var var_361:Array;
      
      protected var var_47:BitmapData;
      
      private var var_1014:IActiveActionData;
      ...
      private var var_2402:String = null;
      ...
      public function AvatarImage(param1:AvatarStructure, param2:AssetAliasCollection, param3:AvatarFigureContainer, param4:String)
      {
         ...
         this.setDirection(const_1488,const_1487);
         this.var_361 = new Array();
         this.var_1014 = new ActiveActionData(AvatarAction.const_436);
         this.var_1014.definition = this._structure.getActionDefinition(const_1489);
         this.resetActions();
      ...
      {
         param2 += this.var_1799;
         if(param2 < AvatarDirectionAngle.const_1390)
         {
      ...
      private function getFullImageCacheKey() : String
      {
         ...
         if(this.var_273.length == 1 && this.var_103 == this.var_2035)
         {
            return this.var_103 + this.var_527 + this.var_625 % 4;
         }
         if(this.var_273.length == 2)
         {
            for each(_loc1_ in this.var_273)
            {
               ...
               {
                  return this.var_103 + this.var_527 + 0;
               }
               if(_loc1_.actionType == "fx" && (_loc1_.actionParameter == "38" || _loc1_.actionParameter == "39"))
               {
                  _loc2_ = this.var_625 % 11;
                  return this.var_103 + "_" + this.var_2035 + this.var_527 + _loc2_;
               }
            }
         }
         return null;
      ...
      {
         if(param3 != this.var_2401 || param2 != this.var_2403 || param1 != this.var_2402)
         {
            this.var_2401 = param3;
            this.var_2403 = param2;
            this.var_2402 = param1;
            this.var_1800 = this._structure.getBodyParts(param1,param2,param3);
         }
      ...
      public function getImage(param1:String, param2:Boolean) : BitmapData
      {
         ...
         var _loc5_:AvatarCanvas = this._structure.getCanvas(this._scale,this.var_313.definition.geometryType);
         if(_loc5_ == null)
         {
            return null;
         }
         if(this.var_1416 || this.var_47 == null || (this.var_47.width != _loc5_.width || this.var_47.height != _loc5_.height))
         {
            if(this.var_47 != null && !this.var_1416)
            {
               this.var_47.dispose();
            }
         ...
         var _loc6_:Array = this.getBodyParts(param1,this.var_313.definition.geometryType,this.var_103);
         this.var_47.lock();
         ...
         {
            if(this.var_604.paletteIsGrayscale)
            {
               ...
               this.var_47 = _loc13_;
               this.var_47.paletteMap(this.var_47,this.var_47.rect,new Point(0,0),this.var_604.reds,[],[]);
            }
            else
            {
      ...
      public function getCroppedImage(param1:String) : BitmapData
      {
         ...
         var _loc3_:AvatarCanvas = this._structure.getCanvas(this._scale,this.var_313.definition.geometryType);
         if(_loc3_ == null)
         {
            return null;
         }
         var _loc4_:BitmapData = new BitmapData(_loc3_.width,_loc3_.height,true,16777215);
         var _loc5_:Array = this._structure.getBodyParts(param1,this.var_313.definition.geometryType,this.var_103);
      ...
      protected function addActionData(param1:String, param2:String = "") : void
      {
         ...
         this.var_361.push(new ActiveActionData(param1,param2,this.var_625));
      }
      ...
      private function resetActions() : Boolean
      {
         ...
         this.var_313 = this.var_1014;
         this.var_313.definition = this.var_1014.definition;
         this.resetBodyPartCache(this.var_1014);
         return true;
      }
      ...
      private function isHeadTurnPreventedByAction() : Boolean
      {
         ...
         for each(_loc3_ in this.var_273)
         {
      ...
      private function sortActions() : Boolean
      {
         ...
         var _loc1_:Boolean = false;
         this.var_527 = "";
         this.var_273 = this._structure.sortActions(this.var_361);
         if(this.var_273 == null)
         {
         ...
         {
            this.var_815 = this._structure.getCanvasOffsets(this.var_273,this._scale,this.var_103);
            for each(_loc4_ in this.var_273)
            {
               this.var_527 += _loc4_.actionType + _loc4_.actionParameter;
               if(_loc4_.actionType == AvatarAction.const_377)
               {
                  _loc5_ = parseInt(_loc4_.actionParameter);
                  if(this.var_1470 != _loc5_)
                  {
                     _loc2_ = true;
                  }
            ...
            if(this.var_1185 != this.var_527)
            {
               _loc1_ = true;
               this.var_1185 = this.var_527;
            }
         }
         this.var_1471 = true;
         return _loc1_;
      ...
      private function setActionsToParts() : void
      {
         ...
         for each(_loc1_ in this.var_273)
         {
            if(!(!_loc1_ || !_loc1_.definition))
            {
               ...
               {
                  this.var_1015 = _loc1_.definition.isAnimated(_loc1_.actionParameter);
                  _loc2_ = this._structure.getAnimation(_loc1_.definition.state + "." + _loc1_.actionParameter);
                  if(_loc2_ != null)
                  {
                     this.var_221 = this.var_221.concat(_loc2_.spriteData);
                     if(_loc2_.hasDirectionData())
                     {
                        this.var_1799 = _loc2_.directionData.offset;
                     }
                     if(_loc2_.hasAvatarData())
                     {
                        this.var_604 = _loc2_.avatarData;
                     }
                  }
               }
               if(_loc1_.actionType == AvatarAction.const_322 || _loc1_.actionType == AvatarAction.const_287 || _loc1_.actionType == AvatarAction.const_427)
               {
                  this.var_1015 = true;
               }
            }
