package com.sulake.habbo.avatar
{
   ...
   public class AvatarEditorView
   {
      ...
      public static var var_1408:IWindowContainer;
      
      public static var var_1702:IWindowContainer;
      
      public static var var_2224:int = 6710886;
      
      private static const const_1576:int = 5000;
      
      private static const const_1548:Point = new Point(100,30);
      ...
      public function AvatarEditorView(param1:HabboAvatarEditor, param2:Array)
      {
         ...
         var _loc5_:* = null;
         this.var_1271 = [];
         this.var_1562 = [AvatarEditorFigureCategory.const_958,AvatarEditorFigureCategory.const_55,AvatarEditorFigureCategory.const_260,AvatarEditorFigureCategory.const_1017,AvatarEditorFigureCategory.HOTLOOKS,AvatarEditorFigureCategory.const_117];
         super();
         this.var_23 = param1;
         if(var_1408 == null)
         {
            _loc4_ = this.var_23.manager.assets.getAssetByName("AvatarEditorThumb") as XmlAsset;
            var_1408 = this.var_23.manager.windowManager.buildFromXML(_loc4_.content as XML) as IWindowContainer;
         }
         if(var_1702 == null)
         {
         ...
         this._saveTimer = new Timer(const_1576,1);
         this._saveTimer.addEventListener(TimerEvent.TIMER,this.onUpdate);
         if(param2 == null)
         {
            param2 = this.var_1562;
         }
         for each(_loc3_ in param2)
         {
            this.var_1271.push(_loc3_);
         }
         this.createWindow();
      }
      ...
      public function getFrame(param1:Array, param2:String = null) : IFrameWindow
      {
         ...
         this.var_84.position = const_1548;
      ...
      public function embedToContext(param1:IWindowContainer, param2:Array) : Boolean
      {
         ...
         else
         {
            if(this.var_671 == null)
            {
               this.var_671 = this.var_23.manager.windowManager.createWindow("avatarEditorContainer","",HabboWindowType.const_79,HabboWindowStyle.const_31,0 | 0,new Rectangle(0,0,2,2),null,0) as IWindowContainer;
               this.var_671.addChild(this.var_58);
            }
            _loc3_ = this.var_671.getChildIndex(this.var_58);
            if(_loc3_)
            {
               param1.removeChildAt(_loc3_);
            }
      ...
      public function validateAvailableCategories(param1:Array) : Boolean
      {
         ...
         if(param1 == null)
         {
            return this.validateAvailableCategories(this.var_1562);
         }
         if(param1.length != this.var_1271.length)
         {
            return false;
         }
      ...
      private function createWindow() : void
      {
         ...
         this.var_255 = this.var_58.findChildByName("mainTabs") as ITabSelectorWindow;
         var _loc1_:int = this.var_255.numSelectables - 1;
         while(_loc1_ >= 0)
         {
            _loc2_ = this.var_255.getSelectableAt(_loc1_);
            if(_loc2_ != null && this.var_1271.indexOf(_loc2_.name) < 0)
            {
      ...
      private function attachImages() : void
      {
         ...
         var _loc6_:* = null;
         var _loc7_:* = null;
         var _loc1_:Array = this.var_1562;
      ...
      public function update() : void
      {
         ...
         if(this.var_23.manager.sessionData && this.var_23.manager.sessionData.clubLevel >= HabboClubLevelEnum.const_35 && (this.var_1561 == AvatarEditorSideCategory.const_117 || this.var_2656))
         {
            _loc4_ = "null";
         }
         ...
         this.setViewToCategory(this.var_413);
      }
      ...
      {
         if(this.var_1561 == AvatarEditorSideCategory.const_117)
         {
            this.var_2656 = false;
            this.setSideContent(AvatarEditorSideCategory.const_675);
         }
         else
         {
            this.setSideContent(AvatarEditorSideCategory.const_117);
         }
      }
      ...
      private function setSideContent(param1:String) : void
      {
         ...
         switch(param1)
         {
            case AvatarEditorSideCategory.const_675:
               break;
            case AvatarEditorSideCategory.const_670:
               _loc3_ = this.var_23.getSideContentWindowContainer(AvatarEditorSideCategory.const_670);
               break;
            case AvatarEditorSideCategory.const_117:
               _loc3_ = this.var_23.getSideContentWindowContainer(AvatarEditorSideCategory.const_117);
         }
      ...
      private function displayStripClubDialog() : void
      {
         ...
         if(!this.var_332)
         {
            ...
            this.var_332 = this.var_23.manager.windowManager.buildFromXML(_loc2_,2) as IFrameWindow;
            this.var_332.procedure = this.stripClubDialogEventProc;
            this.var_332.center();
         }
         else
         {
      ...
      private function openCatalogClubPage() : void
      {
         ...
         {
            this.var_23.manager.catalog.openCatalogPage(CatalogPageName.const_145,true);
         }
      }
   }
}
