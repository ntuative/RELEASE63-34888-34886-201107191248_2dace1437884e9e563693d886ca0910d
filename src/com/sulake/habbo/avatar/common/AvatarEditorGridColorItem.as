package com.sulake.habbo.avatar.common
{
   ...
   public class AvatarEditorGridColorItem
   {
      ...
      private var var_968:IPartColor;
      ...
      private function updateThumbData() : void
      {
         ...
         if(_loc1_ != null)
         {
            _loc1_.bitmap = new BitmapData(this.var_717.width,this.var_717.height,true,0);
            _loc1_.bitmap.copyPixels(this.var_717,this.var_717.rect,new Point(0,0));
         }
         var _loc2_:IBitmapWrapperWindow = this._window.findChildByTag("COLOR_IMAGE") as IBitmapWrapperWindow;
         if(_loc2_ != null)
         {
            _loc2_.bitmap = new BitmapData(this.var_1098.width,this.var_1098.height,true,0);
            _loc5_ = this.var_1098.clone();
            _loc5_.colorTransform(_loc5_.rect,this.var_968.colorTransform);
         ...
         if(_loc3_ != null)
         {
            if(this._isSelected)
            {
               _loc3_.bitmap = new BitmapData(this.var_969.width,this.var_969.height,true,16777215);
               _loc3_.bitmap.copyPixels(this.var_969,this.var_969.rect,new Point(0,0),null,null,true);
               _loc3_.visible = true;
            }
            else
            {
         ...
         if(_loc4_)
         {
            if(this.var_968)
            {
               switch(this.var_968.clubLevel)
               {
                  case HabboClubLevelEnum.const_54:
                     _loc4_.visible = false;
                     break;
                  case HabboClubLevelEnum.const_35:
                     _loc4_.style = HabboIconType.const_961;
                     _loc4_.visible = true;
                     break;
                  case HabboClubLevelEnum.const_43:
                     _loc4_.style = HabboIconType.const_736;
                     _loc4_.visible = true;
               }
            }
            else
