package com.sulake.habbo.avatar.animation
{
   ...
   public class AvatarDataContainer implements IAvatarDataContainer
   {
      ...
      public function AvatarDataContainer(param1:XML)
      {
         ...
         this.var_858 = new ColorTransform(this.var_2069,this.var_2068,this.var_2070,this._alphaMultiplier);
         this.var_1395 = this.generatePaletteMapForGrayscale(this.var_2981,this.var_2982);
      }
      ...
      {
         return this.var_1395.getValue("reds") as Array;
      }
      
      public function get greens() : Array
      {
         return this.var_1395.getValue("greens") as Array;
      }
      
      public function get blues() : Array
      {
         return this.var_1395.getValue("blues") as Array;
      }
      
      public function get alphas() : Array
      {
         return this.var_1395.getValue("alphas") as Array;
      }
