package com.sulake.habbo.avatar
{
   ...
   public class PetImage implements IAvatarImage, IDisposable
   {
      ...
      private var var_604:IAvatarDataContainer;
      ...
      public function setDirection(param1:String, param2:int) : void
      {
         ...
         if(param1 == AvatarSetType.const_55)
         {
            ...
            _loc3_ = this._structure.renderManager.petDataManager.getPetData(this.var_1536);
            if(_loc3_ != null)
            {
      ...
      public function getImage(param1:String, param2:Boolean) : BitmapData
      {
         ...
         var _loc4_:AvatarCanvas = this._structure.getCanvas(this._scale,this.var_313.definition.geometryType);
         if(this.var_47 == null || _loc4_ != null && (this.var_47.width != _loc4_.width || this.var_47.height != _loc4_.height))
         {
            _loc4_ = this._structure.getCanvas(this._scale,this.var_313.definition.geometryType);
            if(_loc4_ == null)
            {
               return null;
            }
         ...
         while(_loc7_ >= 0)
         {
            ...
            if(_loc9_ && _loc9_.image && _loc9_.regPoint)
            {
               ...
               _loc16_ = this.var_1536 < 3;
               _loc17_ = !!_loc16_ ? 32 : 67;
               if(this._scale == AvatarScaleType.const_116)
               {
      ...
      public function appendAction(param1:String, ... rest) : Boolean
      {
         ...
         this.var_527 = this.var_527 + param1 + _loc3_;
         switch(param1)
         {
      ...
      private function resetActions() : Boolean
      {
         ...
         this.setActionToParts(this.var_1014);
         this.getCache().resetBodyPartCache(this.var_1014);
         return true;
      }
      ...
      private function sortActions() : void
      {
         ...
         this.var_1537 = this._structure.sortActions(this.var_361);
         ...
         {
            this.var_815 = this._structure.getCanvasOffsets(this.var_1537,this._scale,this.var_103);
         }
      }
      ...
      private function setActionsToParts() : void
      {
         var _loc1_:* = null;
         var _loc2_:* = null;
         for each(_loc1_ in this.var_1537)
         {
            if(!(!_loc1_ || !_loc1_.definition))
            {
               ...
               if(_loc1_.actionType == AvatarAction.const_427)
               {
                  this.var_1015 = true;
               }
               ...
               if(_loc1_.actionType == AvatarAction.const_322)
               {
                  this.var_1015 = true;
               }
            }
         ...
         if(_loc2_ != null)
         {
            ...
            if(_loc3_ != null)
            {
               for each(_loc4_ in _loc3_.parts)
               {
                  if(_loc4_.type == "pbd")
                  {
                     this.var_1277 = _loc4_.id;
                     this.var_1901 = _loc4_.breed;
                     break;
                  }
               }
            }
