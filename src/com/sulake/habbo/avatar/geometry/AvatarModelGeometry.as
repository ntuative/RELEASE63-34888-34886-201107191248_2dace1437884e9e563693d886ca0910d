package com.sulake.habbo.avatar.geometry
{
   ...
   public class AvatarModelGeometry
   {
      ...
      private var var_1779:AvatarSet;
      
      private var var_773:Dictionary;
      
      private var var_1780:Dictionary;
      
      private var var_1175:Matrix4x4;
      
      private var var_960:Vector3D;
      
      private var var_186:Dictionary;
      ...
      public function AvatarModelGeometry(param1:XML)
      {
         ...
         var _loc15_:* = null;
         var _loc16_:* = null;
         this.var_960 = new Vector3D(0,0,10);
         super();
         this.var_1175 = new Matrix4x4();
         this.var_773 = new Dictionary();
         this.var_1780 = new Dictionary();
         this.var_1779 = new AvatarSet(param1.avatarset[0]);
         this.var_186 = new Dictionary();
         ...
         if(_loc2_ != null)
         {
            ...
            this.var_960.x = _loc11_;
            this.var_960.y = _loc12_;
            this.var_960.z = _loc13_;
         }
         ...
         for each(_loc6_ in param1.type)
         {
            ...
            this.var_773[String(_loc6_.@id)] = _loc7_;
            this.var_1780[String(_loc6_.@id)] = _loc8_;
         }
      }
      ...
      {
         var _loc2_:* = [];
         var _loc3_:AvatarSet = this.var_1779.findAvatarSet(param1);
         if(_loc3_ != null)
         {
      ...
      {
         var _loc2_:AvatarSet = this.var_1779.findAvatarSet(param1);
         if(_loc2_ != null)
         {
      ...
      {
         var _loc4_:* = null;
         var _loc3_:Dictionary = this.var_186[param1];
         if(_loc3_ != null)
         {
      ...
      {
         return this.var_773[param1] != null;
      }
      ...
      private function hasBodyPart(param1:String, param2:String) : Boolean
      {
         ...
         {
            _loc3_ = this.var_773[param1] as Dictionary;
      ...
      private function getBodyPartsOfType(param1:String) : Dictionary
      {
         if(this.typeExists(param1))
         {
            return this.var_773[param1] as Dictionary;
         }
      ...
      public function getBodyPartOfItem(param1:String, param2:String) : GeometryBodyPart
      {
         var _loc4_:* = null;
         var _loc5_:* = null;
         var _loc3_:Dictionary = this.var_1780[param1];
         if(_loc3_ != null)
         {
      ...
      public function getBodyPartsAtAngle(param1:String, param2:uint, param3:String) : Array
      {
         ...
         this.var_1175 = Matrix4x4.getYRotationMatrix(param2);
         for each(_loc7_ in _loc5_)
         {
            _loc7_.applyTransform(this.var_1175);
            _loc9_ = _loc7_.getDistance(this.var_960);
      ...
      public function getParts(param1:String, param2:String, param3:uint, param4:Array) : Array
      {
         ...
         if(this.hasBodyPart(param1,param2))
         {
            ...
            this.var_1175 = Matrix4x4.getYRotationMatrix(param3);
            return _loc5_.getParts(this.var_1175,this.var_960,param4);
         }
         return [];
      }
