package com.sulake.habbo.avatar.cache
{
   ...
   public class AvatarImageCache
   {
      ...
      private static const const_2078:int = 60000;
       
      
      private var _structure:AvatarStructure;
      
      private var var_1510:IAvatarImage;
      ...
      private var var_448:AvatarImageBodyPartContainer;
      
      private var var_1485:String;
      
      private var var_128:AvatarImagePartContainer;
      
      private var var_2452:Point;
      ...
      private var var_2450:ByteArray;
      
      private var var_2451:ImageData;
      
      private var var_1057:PaletteMap;
      ...
      public function dispose() : void
      {
         ...
         {
            _loc2_ = this.var_277.getKeys();
            for each(_loc3_ in _loc2_)
            {
               _loc1_ = this.var_277.getValue(_loc3_) as AvatarImageBodyPartCache;
               if(_loc1_ != null)
               {
                  _loc1_.dispose();
               }
      ...
      public function disposeInactiveActions(param1:int = 60000) : void
      {
         ...
         var _loc4_:Array = this.var_277.getKeys();
         for each(_loc5_ in _loc4_)
         {
            _loc3_ = this.var_277.getValue(_loc5_) as AvatarImageBodyPartCache;
            if(_loc3_ != null)
            {
      ...
      public function resetBodyPartCache(param1:IActiveActionData) : void
      {
         var _loc2_:* = null;
         var _loc4_:* = null;
         var _loc3_:Array = this.var_277.getKeys();
         for each(_loc4_ in _loc3_)
         {
            _loc2_ = this.var_277.getValue(_loc4_) as AvatarImageBodyPartCache;
            if(_loc2_ != null)
            {
      ...
      {
         if(this.var_781 == param1)
         {
            return;
         }
         if(this.var_781 == GeometryType.const_1222 && param1 == GeometryType.const_1271 || this.var_781 == GeometryType.const_1271 && param1 == GeometryType.const_1222)
         {
            this.var_781 = param1;
            this.var_101 = null;
            return;
      ...
      public function getImageContainer(param1:String, param2:int) : AvatarImageBodyPartContainer
      {
         ...
         if(this._bodyPartCache == null)
         {
            ...
            this.var_277.add(param1,this._bodyPartCache);
         }
            ...
            if(this.var_372.definition.isAnimation)
            {
               ...
               if(_loc12_ != null)
               {
                  ...
                  if(_loc14_ != null)
                  {
                     ...
                     else if(_loc14_.type == AnimationLayerData.const_586)
                     {
                        _loc3_ = _loc11_;
                     }
         ...
         if(_loc10_ == null)
         {
            _loc15_ = this._structure.getParts(param1,this.var_1510.getFigure(),_loc5_,this.var_781,_loc3_,_loc6_,_loc7_);
            _loc10_ = new AvatarImageDirectionCache(_loc15_);
            _loc9_.updateDirectionCache(_loc3_,_loc10_);
         }
         this.var_448 = _loc10_.getImageContainer(_loc4_);
         if(this.var_448 == null)
         {
            _loc16_ = _loc10_.getPartList();
            this.var_448 = this.renderBodyPart(_loc3_,_loc16_,_loc4_,this.var_372);
            if(this.var_448 == null)
            {
               return null;
            }
            _loc10_.updateImageContainer(this.var_448,_loc4_);
         }
         this.var_448.offset = _loc8_;
         return this.var_448;
      }
      
      public function getBodyPartCache(param1:String) : AvatarImageBodyPartCache
      {
         var _loc2_:AvatarImageBodyPartCache = this.var_277.getValue(param1) as AvatarImageBodyPartCache;
         if(_loc2_ == null)
         {
            _loc2_ = new AvatarImageBodyPartCache();
            this.var_277.add(param1,_loc2_);
         }
         return _loc2_;
      }
      ...
      private function renderBodyPart(param1:int, param2:Array, param3:int, param4:IActiveActionData) : AvatarImageBodyPartContainer
      {
         ...
         if(!this.var_101)
         {
            this.var_101 = this._structure.getCanvas(this._scale,this.var_781);
            if(!this.var_101)
            {
               return null;
            }
            this.var_2452 = new Point(0,this.var_101.height - int(this.var_101.width / 4));
         }
         var _loc5_:int = param1;
         var _loc6_:Boolean = AvatarDirectionAngle.const_1793[param1];
         var _loc9_:String = param4.definition.assetPartDefinition;
         var _loc10_:String = param4.definition.state;
         var _loc11_:Boolean = _loc10_ == AvatarAction.const_826 || _loc10_ == AvatarAction.const_427;
         ...
         while(_loc8_ >= 0)
         {
            ...
            {
               this.var_1485 = this.var_128.bodyPartId;
               this.var_198 = this.var_128.partType;
               this.var_1820 = this.var_128.partId;
               ...
               if(_loc6_)
               {
                  ...
                  else
                  {
                     ...
                     if(this.var_128.flippedPartType != this.var_198)
                     {
                        this.var_198 = this.var_128.flippedPartType;
                     }
                  }
               }
               this.var_1486 = this._scale + "_" + this.var_128.action.assetPartDefinition + "_" + this.var_198 + "_" + this.var_1820 + "_" + _loc5_ + "_" + this._frame;
               this.var_441 = this._assets.getAssetByName(this.var_1486) as BitmapDataAsset;
               if(this.var_441 == null)
               {
                  this.var_1486 = this._scale + "_std_" + this.var_198 + "_" + this.var_1820 + "_" + _loc5_ + "_0";
                  this.var_441 = this._assets.getAssetByName(this.var_1486) as BitmapDataAsset;
               }
               if(!(!this.var_441 || !this.var_441.content))
               {
                  if(this.var_128.paletteMapId > -1)
                  {
                     this.var_1057 = this._structure.renderManager.paletteManager.getPalette(this.var_128.paletteMapId);
                     if(this.var_1057 != null)
                     {
                        this.var_978 = this.var_441.content as BitmapData;
                        this.var_197 = new BitmapData(this.var_978.width,this.var_978.height);
                        this.var_2450 = this.var_1057.colorize(this.var_978.getPixels(this.var_978.rect));
                        this.var_197.setPixels(this.var_197.rect,this.var_2450);
                     }
                     else
                     {
                        this.var_197 = (this.var_441.content as BitmapData).clone();
                     }
                  }
                  else
                  {
                  ...
                  if(_loc11_ && (this.var_1485 == AvatarBodyPartType.const_260 || this.var_1485 == AvatarBodyPartType.const_1815 || this.var_1485 == AvatarBodyPartType.const_1873) && this.var_128.color != null)
                  {
                     _loc16_ = 0.7;
                  ...
                  {
                     this.var_197.colorTransform(this.var_197.rect,this.var_128.color.colorTransform);
                  }
                  if(this.var_128.isBlendable)
                  {
                     this.var_197.colorTransform(this.var_197.rect,this.var_128.blendTransform);
                  }
                  this.var_977 = this.var_441.offset.clone();
                  if(_loc7_)
                  {
                     if(this._scale == AvatarScaleType.const_61)
                     {
                  ...
                  this.var_2451 = new ImageData(this.var_197,this.var_977,_loc7_);
                  this.var_979.push(this.var_2451);
               }
            }
            _loc8_--;
         }
         if(this.var_979.length == 0)
         {
            return null;
         }
         var _loc13_:ImageData = this.createUnionImage(this.var_979,_loc6_);
         var _loc14_:Point = new Point(-1 * _loc13_.regpoint.x,this.var_2452.y - _loc13_.regpoint.y);
         if(_loc6_)
         {
            if(this._scale == AvatarScaleType.const_61)
            {
         ...
         _loc8_ = this.var_979.length - 1;
         while(_loc8_ >= 0)
         {
            _loc15_ = this.var_979.pop();
            if(_loc15_)
            {
               _loc15_.dispose();
            }
