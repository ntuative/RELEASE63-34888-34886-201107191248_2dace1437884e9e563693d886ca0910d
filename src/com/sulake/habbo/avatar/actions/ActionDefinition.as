package com.sulake.habbo.avatar.actions
{
   ...
   public class ActionDefinition implements IActionDefinition
   {
      ...
      public function ActionDefinition(param1:XML)
      {
         ...
         this.var_2662 = parseInt(param1.@precedence);
         this.var_2665 = String(param1.@activepartset);
         this.var_2661 = String(param1.@assetpartdefinition);
         this.var_2664 = String(param1.@lay);
         this.var_781 = String(param1.@geometrytype);
         this.var_2660 = Boolean(parseInt(param1.@main));
         this.var_2663 = Boolean(parseInt(param1.@name_7));
         this.var_2666 = Boolean(parseInt(param1.@animation));
      ...
      public function setOffsets(param1:String, param2:int, param3:Array) : void
      {
         ...
         if(this.var_815.getValue(param1) == null)
         {
            this.var_815.add(param1,new Map());
         }
         var _loc4_:Map = this.var_815.getValue(param1);
      ...
      public function getOffsets(param1:String, param2:int) : Array
      {
         ...
         var _loc3_:Map = this.var_815.getValue(param1) as Map;
         if(_loc3_ == null)
         {
            return null;
         }
