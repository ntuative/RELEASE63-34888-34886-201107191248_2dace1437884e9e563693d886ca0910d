package com.sulake.habbo.friendbar.view.tabs
{
   ...
   public class FriendEntityTab extends Tab
   {
      ...
      private static const const_1584:String = "entity_xml";
      
      private static const const_1583:String = "facebook_piece_xml";
      
      private static const const_1586:String = "controls_piece_xml";
      ...
      protected static const const_683:String = "name";
      
      protected static const const_1122:String = "btn_message";
      
      protected static const const_1038:String = "icon_message";
      
      protected static const const_1422:String = "btn_visit";
      
      protected static const ICON:String = "icon";
      
      protected static const const_1035:String = "label";
      
      protected static const const_562:String = "notification";
      
      private static const const_74:uint = 10338138;
      
      private static const const_1062:uint = 13891476;
      
      private static const const_1102:String = null;
      
      private static const const_704:String = "icon_tag_notify";
      
      private static const const_1585:String = "icon_tag_message";
      ...
      protected var var_148:Vector.<Token>;
      ...
      private static function purgeEntityPieces(param1:IWindowContainer) : void
      {
         ...
         var _loc4_:* = [];
         _loc2_.groupListItemsWithTag(const_562,_loc4_);
         if(_loc4_.length > 0)
         {
      ...
      override public function recycle() : void
      {
         if(!disposed)
         {
            if(!var_170)
            {
               ...
               if(this.var_148)
               {
                  while(this.var_148.length > 0)
                  {
                     this.var_148.pop().dispose();
                  }
                  this.var_148 = null;
               }
               this.var_168 = null;
      ...
      override public function select(param1:Boolean) : void
      {
         ...
         if(!selected)
         {
            ...
            {
               _loc3_ = WINDOWING.buildFromXML(ASSETS.getAssetByName(const_1583).content as XML) as IWindowContainer;
               _loc3_.name = const_1421;
               _loc6_ = _loc3_.getChildByName(const_683) as ITextWindow;
               _loc6_.caption = this.friend.realName;
               if(!_loc6_.wordWrap)
               {
                  var_2236.crop(_loc6_);
               }
            ...
            if(this.var_148)
            {
               for each(_loc7_ in this.var_148)
               {
      ...
      override public function deselect(param1:Boolean) : void
      {
         ...
         if(selected)
         {
            if(_window)
            {
               ...
               if(this.var_148)
               {
                  _loc2_ = this.var_148.length - 1;
                  while(_loc2_ > -1)
                  {
                     _loc3_ = this.var_148[_loc2_];
                     if(_loc3_.viewOnce)
                     {
      ...
      protected function refresh() : void
      {
         ...
         if(this.var_168)
         {
            ...
            _loc1_ = IItemListWindow(_window.getChildByName(const_1039)).getListItemByName(const_465) as IWindowContainer;
            _loc1_.findChildByName(const_683).caption = this.var_168.name;
            var_2236.crop(_loc1_.getChildByName(const_683) as ITextWindow);
            _loc2_ = IBitmapWrapperWindow(_loc1_.findChildByName(const_316));
            _loc2_.bitmap = var_504.getAvatarFaceBitmap(this.var_168.figure);
      ...
      {
         var _loc1_:IWindowContainer = false ? const_477.pop() : WINDOWING.buildFromXML(ASSETS.getAssetByName(const_1584).content as XML) as IWindowContainer;
      ...
      private function onButtonClick(param1:WindowMouseEvent) : void
      {
         if(!disposed && !recycled)
         {
            switch(param1.window.name)
            {
               case const_1122:
               case const_1038:
                  this.removeNotificationToken(FriendNotification.const_445,true);
                  if(var_358 && this.var_168)
                  {
                     var_358.startConversation(this.var_168.id);
                     this.deselect(true);
               ...
               case const_1422:
                  if(var_358 && this.var_168)
                  {
                     var_358.followToRoom(this.var_168.id);
                     this.deselect(true);
                  }
            }
         }
      ...
      public function addNotificationToken(param1:FriendNotification, param2:Boolean) : void
      {
         ...
         {
            case FriendNotification.const_1331:
            ...
            case FriendNotification.TYPE_ACHIEVEMENT:
               _loc4_ = new AchievementToken(this.friend,param1,param2,var_2248);
               _loc4_.iconElement.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,onMouseClick);
               _loc5_ = const_704;
               break;
            case FriendNotification.const_1257:
               _loc4_ = new QuestToken(this.friend,param1,param2,var_2248);
               _loc4_.iconElement.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,onMouseClick);
               _loc5_ = const_704;
               break;
            case FriendNotification.const_445:
      ...
      public function removeNotificationToken(param1:int, param2:Boolean) : void
      {
         ...
         var _loc3_:int = this.var_148.length - 1;
         while(_loc3_ > -1)
         {
            _loc4_ = this.var_148[_loc3_];
            if(_loc4_.typeCode == param1)
            {
               this.var_148.splice(_loc3_,1);
               if(param2)
               {
