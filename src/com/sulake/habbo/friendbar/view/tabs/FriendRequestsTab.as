package com.sulake.habbo.friendbar.view.tabs
{
   ...
   public class FriendRequestsTab extends Tab
   {
      ...
      protected static const const_2046:String = "friend_requests_tab_xml";
      ...
      protected static const const_2044:String = "badge_counter";
      
      protected static const const_2047:String = "button_accept_all";
      
      protected static const const_2045:String = "click_area_discard_all";
      
      protected static const const_1414:String = "button_close";
      
      protected static const const_2043:String = "button_accept";
      
      protected static const const_1036:String = "click_area_discard";
      
      protected static const const_1415:String = "text_discard";
      
      private static var var_1523:FriendRequestsTab;
      
      private static const const_74:uint = 4294625561;
      
      private static const const_1062:uint = 4294957414;
      
      private static const const_1561:uint = 4289431312;
      
      private static const const_1560:uint = 4290616362;
      ...
      {
         var _loc2_:FriendRequestsTab = !!var_1523 ? var_1523 : new FriendRequestsTab();
         _loc2_.var_170 = false;
         _loc2_._requests = param1;
         _loc2_._window.findChildByName(const_2044).caption = String(param1.length);
         return _loc2_;
      }
               ...
               if(_loc2_)
               {
                  ...
                  if(!this.var_1887)
                  {
                     ...
                     if(_loc3_)
                     {
                        ...
                        {
                           _loc4_ = this.var_1252.clone() as IWindowContainer;
                           _loc4_.color = _loc8_ % 2 == 0 ? uint(const_1561) : uint(const_1560);
                           _loc5_ = this._requests[_loc8_];
                           _loc4_.id = _loc5_.id;
                           _loc4_.getChildByName(const_683).caption = _loc5_.name;
      ...
      {
         var _loc5_:* = null;
         var _loc1_:IWindowContainer = WINDOWING.buildFromXML(ASSETS.getAssetByName(const_2046).content as XML) as IWindowContainer;
         ...
         this.var_1252 = _loc7_.removeListItemAt(0) as IWindowContainer;
         return _loc1_;
      }
      ...
      private function releaseRequestsTabWindow(param1:IWindowContainer) : void
      {
         ...
         if(param1 && !param1.disposed)
         {
            ...
            _loc3_.bitmap = null;
            ITextWindow(param1.findChildByTag(const_1035)).underline = false;
         }
      }
      ...
      private function bubbleEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         else if(param1.type == WindowMouseEvent.const_25)
         {
            if(param2.name == const_1036)
            {
               ITextWindow(IWindowContainer(param2).getChildByName(const_1415)).textColor = const_1559;
            }
         }
      }
