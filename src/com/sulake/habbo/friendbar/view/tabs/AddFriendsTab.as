package com.sulake.habbo.friendbar.view.tabs
{
   ...
   public class AddFriendsTab extends Tab
   {
      ...
      private static const const_1490:String = "add_friends_tab_xml";
      
      private static const const_1491:String = "find_friends_icon_png";
      
      private static var var_967:int = -1;
      
      private static const const_74:uint = 6907230;
      
      private static const const_1062:uint = 9209986;
      ...
      {
         var _loc1_:IWindowContainer = false ? const_469.pop() : WINDOWING.buildFromXML(ASSETS.getAssetByName(const_1490).content as XML) as IWindowContainer;
         var _loc2_:IRegionWindow = IRegionWindow(_loc1_.findChildByName(const_465));
