package com.sulake.habbo.roomevents.userdefinedroomevents
{
   ...
   public class UserDefinedRoomEventsCtrl
   {
      ...
      public static var var_359:int = 3;
      
      private static var var_1457:int = 2;
      ...
      private var var_1773:TriggerConfs;
      
      private var var_1775:ActionTypes;
      
      private var var_1774:ConditionTypes;
      
      private var var_271:Dictionary;
      
      private var var_37:Triggerable;
      
      private var var_770:RoomObjectHightLighter;
      
      private var var_206:UserDefinedRoomEventsHelp;
      
      private var var_1172:SliderWindowController;
      
      public function UserDefinedRoomEventsCtrl(param1:HabboUserDefinedRoomEvents)
      {
         this.var_1773 = new TriggerConfs();
         this.var_1775 = new ActionTypes();
         this.var_1774 = new ConditionTypes();
         this.var_271 = new Dictionary();
         super();
         this.var_93 = param1;
         this.var_770 = new RoomObjectHightLighter(param1);
         this.var_206 = new UserDefinedRoomEventsHelp(param1);
      }
      ...
      public function stuffSelected(param1:int, param2:String) : void
      {
         ...
         if(this.var_271[param1])
         {
            delete this.var_271[param1];
            this.var_770.hide(param1);
         }
         else if(this.getStuffIds().length < this.var_37.furniLimit)
         {
            this.var_271[param1] = param2;
            this.var_770.show(param1);
         }
         this.refresh();
      }
      ...
      private function prepareWindow() : void
      {
         ...
         this.var_1172 = new SliderWindowController(this.var_93,IWindowContainer(this.find(this.var_56,"delay_slider_container")),this.var_93.assets,0,20,1);
         this.var_1172.addEventListener(Event.CHANGE,this.onDelaySliderChange);
         this.var_1172.setValue(0);
      ...
      public function close() : void
      {
         if(this._window)
         {
            ...
            this.var_770.hideAll(this.var_271);
         }
      }
      ...
      private function prepareStuffSelectionForUpdate() : void
      {
         ...
         if(this.var_37.stuffTypeSelectionEnabled)
         {
            ...
            else if(_loc2_.requiresFurni == var_359)
            {
      ...
      public function getActionDelay() : int
      {
         ...
         return !!_loc1_.allowDelaying ? int(this.var_1172.getValue()) : 0;
      }
      ...
      private function onHelp(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_206.open(this._window.x + this._window.width + 5,this._window.y);
      }
      ...
      private function onDecStuffSelectionType(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_37.stuffTypeSelectionCode = this.var_37.stuffTypeSelectionCode < 1 ? int(var_1457) : int(this.var_37.stuffTypeSelectionCode - 1);
         this.refreshStuffTypeSelectionToggler();
      }
      ...
      private function onIncStuffSelectionType(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_37.stuffTypeSelectionCode = (this.var_37.stuffTypeSelectionCode + 1) % (var_1457 + 1);
         this.refreshStuffTypeSelectionToggler();
      }
      ...
      private function resolveStuffSelectionType() : int
      {
         ...
         if(_loc1_.requiresFurni == var_359)
         {
      ...
      private function refresh() : void
      {
         ...
         this.refreshConfigureElement(this.var_1773);
         this.refreshConfigureElement(this.var_1775);
         this.refreshConfigureElement(this.var_1774);
