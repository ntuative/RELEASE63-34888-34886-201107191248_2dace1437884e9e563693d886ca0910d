package com.sulake.habbo.roomevents.userdefinedroomevents.conditions
{
   ...
   public class UserCountIn implements ConditionType
   {
      ...
      private var var_1357:SliderWindowController;
      
      private var var_1358:SliderWindowController;
      ...
      {
         return ConditionCodes.var_2233;
      }
      ...
      public function readIntParamsFromForm(param1:IWindowContainer) : Array
      {
         ...
         _loc2_.push(this.var_1357.getValue());
         _loc2_.push(this.var_1358.getValue());
         return _loc2_;
      }
      ...
      {
         this.var_93 = param2;
         this.var_1357 = new SliderWindowController(param2,this.getMinInput(param1),param2.assets,1,50,1);
         this.var_1357.addEventListener(Event.CHANGE,this.onMinSliderChange);
         this.var_1357.setValue(1);
         this.var_1358 = new SliderWindowController(param2,this.getMaxInput(param1),param2.assets,1,50,1);
         this.var_1358.addEventListener(Event.CHANGE,this.onMaxSliderChange);
         this.var_1358.setValue(50);
      }
      ...
      public function onEditStart(param1:IWindowContainer, param2:Triggerable) : void
      {
         ...
         this.var_1357.setValue(_loc3_);
         this.var_1358.setValue(_loc4_);
      }
