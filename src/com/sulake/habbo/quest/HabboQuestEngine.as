package com.sulake.habbo.quest
{
   ...
   public class HabboQuestEngine extends Component implements IHabboQuestEngine, IUpdateReceiver
   {
      ...
      private static const const_1519:int = 5;
      
      private static const const_1517:int = 800;
      
      private static const const_1516:int = 15;
      
      private static const const_1518:int = 300;
      ...
      private var var_1214:QuestController;
      
      private var var_974:AchievementController;
      ...
      public function HabboQuestEngine(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_1214 = new QuestController(this);
         this.var_974 = new AchievementController(this);
         ...
         registerUpdateReceiver(this,const_1519);
      }
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_379.events.removeEventListener(BadgeImageReadyEvent.const_217,this.var_974.onBadgeImageReady);
      ...
      private function onSessionDataManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_379.events.addEventListener(BadgeImageReadyEvent.const_217,this.var_974.onBadgeImageReady);
      }
      ...
      private function onHabboToolbarEvent(param1:HabboToolbarEvent) : void
      {
         if(param1.type == HabboToolbarEvent.const_49)
         {
            ...
            {
               this.var_1214.onToolbarClick();
            }
            if(param1.iconId == HabboToolbarIconEnum.ACHIEVEMENTS)
            {
               this.var_974.onToolbarClick();
            }
         }
      }
      ...
      {
         return this.var_1214.questTracker.isVisible();
      }
