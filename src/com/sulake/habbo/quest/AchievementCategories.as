package com.sulake.habbo.quest
{
   ...
   public class AchievementCategories
   {
      ...
      public function AchievementCategories(param1:Array)
      {
         var _loc2_:* = null;
         var _loc3_:* = null;
         this.var_184 = new Dictionary();
         this.var_1114 = new Array();
         super();
         for each(_loc2_ in param1)
         {
            _loc3_ = this.var_184[_loc2_.category];
            if(_loc3_ == null)
            {
               _loc3_ = new AchievementCategory(_loc2_.category);
               this.var_184[_loc2_.category] = _loc3_;
      ...
      {
         var _loc2_:AchievementCategory = this.var_184[param1.category];
